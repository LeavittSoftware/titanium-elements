import{i as t,h as e,p as a,c as i,x as o,_ as r,e as s,r as n,t as l}from"./v29v6fYj.js";import{S as d}from"./98-jDCgK.js";import"./B0y45SPD.js";import"./6yeshvUa.js";import"./CBDyVHWS.js";import"./B2KI4Khp.js";import"./_oe1tK8G.js";import"./U4O0Q2OC.js";let c=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#e=25;get count(){return this.#e}set count(t){this.#e=t}#a;get data(){return this.#a}set data(t){this.#a=t}#i;get filteredData(){return this.#i}set filteredData(t){this.#i=t}firstUpdated(){this.data=Array(25).fill(null).map((t,e)=>({id:e+1,name:"Bob"})),this.#o()}#o(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[e,a,i`
      :host {
        display: flex;
