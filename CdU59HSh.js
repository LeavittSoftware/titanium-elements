import{r as t,h as a,p as e,i as n,x as o,S as i,Y as r,_ as s,e as d,t as c}from"./B87LNoAb.js";import{S as l}from"./nQDMyLps.js";import"./uXzSm2ar.js";let u=class extends t{static{this.styles=[a,e,n`
      :host {
        display: flex;
    ...
    `]}#t=0;render(){return o`
      ...
      <div>
        <section buttons>
          ...
          <md-outlined-button @click=${()=>this.dispatchEvent(new i("",{overrideTemplate:o`<h1 style="color:red">ALERT!</h1>`}))}
            >Template literal</md-outlined-button
          >

          <md-dialog @open=${t=>r(t.target)} @close=${()=>this.snackbar.dismissAll()}>
