import{i as t,h as e,p as a,c as o,x as i,_ as r,e as s,r as n,t as l}from"./CvsNJZqv.js";import{S as d}from"./DfX2k1C4.js";import"./BzpbO9w3.js";import"./Gr2vaPQR.js";import"./BnhgfNHs.js";import"./BPuf9jWk.js";import"./8ukpyWqT.js";let c=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#e=25;get count(){return this.#e}set count(t){this.#e=t}#a;get data(){return this.#a}set data(t){this.#a=t}#o;get filteredData(){return this.#o}set filteredData(t){this.#o=t}firstUpdated(){this.data=Array(25).fill(null).map((t,e)=>({id:e+1,name:"Bob"})),this.#i()}#i(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[e,a,o`
      :host {
        display: flex;
