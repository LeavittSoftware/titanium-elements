import{A as e,u as t,d as s,L as i,i as a,P as r,S as o,x as n,h as d,p as l,c,_ as p,n as u,r as m,e as h,t as b,f,G as g,E as v}from"./v29v6fYj.js";import{S as x}from"./98-jDCgK.js";import"./B0y45SPD.js";import"./DMG_eEsD.js";import"./eK6ZMnmI.js";const k=new e(new t);k.baseUrl=s?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",k.addHeader("X-LGAppName","IssueTracking"),Object.freeze(k);const w=new e(new t);w.baseUrl=s?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",w.addHeader("X-LGAppName","IssueTracking"),Object.freeze(w);let y=class extends(i(a)){#e=!1;get isActive(){return this.#e}set isActive(e){this.#e=e}#t=0;get activeIndex(){return this.#t}set activeIndex(e){this.#t=e}#s;get textArea(){return this.#s}set textArea(e){this.#s=e}#i;get imageInput(){return this.#i}set imageInput(e){this.#i=e}async updated(e){e.has("isActive")&&this.isActive&&this.reset()}reset(){this.imageInput?.reset(),this.textArea?.reset()}async#a(){if(!this.textArea.reportValidity()||this.isLoading)return;const e={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Bug",Description:this.textArea.value,Attachments:(this.imageInput?.getFiles()??[]).map(e=>e.file)};try{const t=k.postAsync("Issues/ReportIssue",e,{sendAsFormData:!0});this.dispatchEvent(new r(t)),this.loadWhile(t);if(!(await t).entity)throw new Error("Error submitting problem. Please try again.");this.dispatchEvent(new o("",{overrideTemplate:n`Thank you for bringing this issue to our attention!<br />
              <br />
              Our engineering teams will promptly investigate and address it.`})),this.reset()}catch(e){this.dispatchEvent(new o(e))}}async#r(){if(!this.textArea.reportValidity()||this.isLoading)return;const e={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Feedback",Description:this.textArea.value,Attachments:[]};try{const t=w.postAsync("Issues/ReportIssue",e,{sendAsFormData:!0});this.dispatchEvent(new r(t)),this.loadWhile(t);if(!(await t).entity)throw new Error("Error submitting feedback. Please try again.");this.dispatchEvent(new o("We appreciate your input, and we will promptly conduct a review!")),this.reset()}catch(e){this.dispatchEvent(new o(e))}}static{this.styles=[d,l,c`
      :host {
        display: grid;
    ...
    `}};p([m()],_.prototype,"refreshToken",null),_=p([b("leavitt-user-feedback-demo")],_);export{_ as LeavittUserFeedbackDemo};
