import{i as e,p as t,f as i,b as r,A as a,c as s,B as o,_ as l,n as p,r as n,t as c}from"./BwDOgaCl.js";import{S as u}from"./DqlEvKiU.js";import"./BDkKqPD2.js";import"./DZ1f3jXa.js";let h=class extends e{#e;get people(){return this.#e}set people(e){this.#e=e}#t=5;get max(){return this.#t}set max(e){this.#t=e}#i=!1;get enableDirectoryHref(){return this.#i}set enableDirectoryHref(e){this.#i=e}#r=!1;get showFullName(){return this.#r}set showFullName(e){this.#r=e}#a=!1;get autoResize(){return this.#a}set autoResize(e){this.#a=e}#s=30;get size(){return this.#s}set size(e){this.#s=e}#o=8;get overlap(){return this.#o}set overlap(e){this.#o=e}#l=0;get autoMax(){return this.#l}set autoMax(e){this.#l=e}#p;updated(e){e.has("autoResize")&&(this.autoResize?this.#n():this.#p?.disconnect?.()),e.has("overlap")&&this.style.setProperty("--profile-picture-stack-overlap",`${this.overlap}px`)}#n(){this.#p=new ResizeObserver(e=>{for(const t of e)this.autoMax=this.#c(this.size,this.overlap,t?.contentBoxSize?.[0]?.inlineSize||0)}),this.#p.observe(this)}#c(e,t,i){return i<e?0:Math.floor((i-e)/(e-t))}static{this.styles=[t,i,r`
      :host {
        display: flex;
