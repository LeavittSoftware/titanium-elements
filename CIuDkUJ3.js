import{_ as e,n as t,t as l,c as a,S as s,i,A as r,U as o,r as n,e as p}from"./CugzL8O4.js";import{S as c}from"./PFD5O6KE.js";import"./D6-fjwB4.js";import"./DZk7JlF4.js";import{T as h}from"./DoIZvF-0.js";import{F as d}from"./CkDJilkW.js";import{g as m}from"./OXmljVLM.js";import{D as u}from"./DTS7lhmZ.js";import"./o7qB6t9c.js";import"./C6telT-W.js";import"./DFxrepZr.js";let v=class extends h{#e="Person";get label(){return this.#e}set label(e){this.#e=e}#t="Search for a person";get placeholder(){return this.#t}set placeholder(e){this.#t=e}#l="People";get apiControllerName(){return this.#l}set apiControllerName(e){this.#l=e}#a="FullName";get pathToSelectedText(){return this.#a}set pathToSelectedText(e){this.#a=e}#s;get apiService(){return this.#s}set apiService(e){this.#s=e}#i=["top=15","orderby=FullName","select=FullName,CompanyName,Id,ProfilePictureCdnFileName","count=true"];get odataParts(){return this.#i}set odataParts(e){this.#i=e}#r=!1;get enablePeoplePreloading(){return this.#r}set enablePeoplePreloading(e){this.#r=e}#o="remote";get searchType(){return this.#o}set searchType(e){this.#o=e}#n=[];get people(){return this.#n}set people(e){this.#n=e}#p="off";get autocomplete(){return this.#p}set autocomplete(e){this.#p=e}#c=!1;get spellcheck(){return this.#c}set spellcheck(e){this.#c=e}#h=e=>a`<md-menu-item .item=${e}>
