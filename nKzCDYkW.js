import{i as t,h as e,g as i,b as s,A as l,c as o,_ as r,n,t as a}from"./CdKAnjTr.js";async function h(t){let e=t;for(;e;){await(e?.updateComplete);const t=e.scrollContainer;if(null!=t)return t;e=e.parentElement??null}return null}let c=class extends t{#t=!1;get stickyTop(){return this.#t}set stickyTop(t){this.#t=t}#e=null;get scrollableParent(){return this.#e}set scrollableParent(t){this.#e=t}#i=null;get level1Text(){return this.#i}set level1Text(t){this.#i=t}#s=null;get level1Href(){return this.#s}set level1Href(t){this.#s=t}#l=null;get level2Text(){return this.#l}set level2Text(t){this.#l=t}#o=null;get level2Href(){return this.#o}set level2Href(t){this.#o=t}#r=null;get level3Text(){return this.#r}set level3Text(t){this.#r=t}#n=null;get level3Href(){return this.#n}set level3Href(t){this.#n=t}#a=null;get level4Text(){return this.#a}set level4Text(t){this.#a=t}#h=null;get level4Href(){return this.#h}set level4Href(t){this.#h=t}#c=null;get level5Text(){return this.#c}set level5Text(t){this.#c=t}#p=null;get level5Href(){return this.#p}set level5Href(t){this.#p=t}#g=!1;get isScrolled(){return this.#g}set isScrolled(t){this.#g=t}#d=null;static{this.styles=[e,i,s`
      :host {
        display: grid;
        grid:
          'main gap trailing'
    ...
    `]}async connectedCallback(){super.connectedCallback();const t=await h(this);this.#d=this.scrollableParent||t,this.#d&&this.#d.addEventListener("scroll",this.#f.bind(this),!1)}async disconnectedCallback(){this.#d&&this.#d.removeEventListener("scroll",this.#f.bind(this),!1),super.disconnectedCallback()}async updated(t){if(t.has("scrollableParent")){this.#d?.removeEventListener("scroll",this.#f.bind(this),!1);const t=await h(this);this.#d=this.scrollableParent||t,this.#d&&this.#d.addEventListener("scroll",this.#f.bind(this),!1)}}#f(){this.isScrolled=(this.#d?.scrollTop||0)>0}render(){return o`
      <main ellipsis part="main">
        ...
        ${this.level5Text?this.level5Href?o`<md-icon>chevron_right</md-icon>
                <h1 ellipsis><a title=${this.level5Text} href=${this.level5Href}>${this.level5Text}</a></h1>`:o`<md-icon>chevron_right</md-icon>
                <h1 ellipsis>${this.level5Text}</h1>`:l}
      </main>
      <aside part="trailing"><slot name="trailing"></slot></aside>
      <footer part="footer"><slot name="footer"></slot></footer>
    `}};r([n({type:Boolean,reflect:!0,attribute:"sticky-top"})],c.prototype,"stickyTop",null),r([n({type:Object,attribute:"scrollable-parent"})],c.prototype,"scrollableParent",null),r([n({type:String})],c.prototype,"level1Text",null),r([n({type:String})],c.prototype,"level1Href",null),r([n({type:String})],c.prototype,"level2Text",null),r([n({type:String})],c.prototype,"level2Href",null),r([n({type:String})],c.prototype,"level3Text",null),r([n({type:String})],c.prototype,"level3Href",null),r([n({type:String})],c.prototype,"level4Text",null),r([n({type:String})],c.prototype,"level4Href",null),r([n({type:String})],c.prototype,"level5Text",null),r([n({type:String})],c.prototype,"level5Href",null),r([n({type:Boolean,reflect:!0,attribute:"is-scrolled"})],c.prototype,"isScrolled",null),c=r([a("leavitt-app-navigation-header")],c);const p=s`
  [heading1],
  h1 {
