...
`;class L extends d{constructor(){super(...arguments),this.fieldTag=s`md-filled-field`}}let G=class extends L{constructor(){super(...arguments),this.fieldTag=s`md-filled-field`}};G.styles=[n,R],G=l([a("md-filled-text-field")],G);let O=class extends(c(m)){#o;get apiService(){return this.#o}set apiService(e){this.#o=e}#r;get fileExplorerId(){return this.#r}set fileExplorerId(e){this.#r=e}#l;get parentFolderId(){return this.#l}set parentFolderId(e){this.#l=e}#a="";get folderName(){return this.#a}set folderName(e){this.#a=e}#d;get dialog(){return this.#d}set dialog(e){this.#d=e}async open(){return this.folderName="",this.dialog.show(),new Promise((e=>{this.resolve=e}))}async#s(){if(!this.apiService)return;const e={FileExplorerId:this.fileExplorerId,Name:this.folderName,ParentFolderId:this.parentFolderId||void 0};try{const t=this.apiService.postAsync("FileExplorerFolders?expand=CreatorPerson(select=FullName,ProfilePictureCdnFileName)",e);this.dispatchEvent(new f(t)),this.loadWhile(t);const i=(await t)?.entity;return{...i,CreatorProfilePictureCndFileName:i?.CreatorPerson?.ProfilePictureCdnFileName,CreatorFullName:i?.CreatorPerson?.FullName}}catch(e){this.dispatchEvent(new p(e))}return null}static{this.styles=o`
    :host {
      display: block;
    }
  ...
  `}render(){return i`
    ...
    `}};l([v({attribute:!1})],O.prototype,"apiService",null),l([v({type:Number})],O.prototype,"fileExplorerId",null),l([v({type:Number})],O.prototype,"parentFolderId",null),l([h()],O.prototype,"folderName",null),l([u("md-dialog")],O.prototype,"dialog",null),O=l([a("leavitt-add-folder-modal")],O);let K=class extends m{static{this.styles=[g,o`
      :host {
        display: flex;
    ...
    `}};K=l([a("leavitt-file-explorer-no-files")],K);let q=class extends m{static{this.styles=[g,o`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};q=l([a("leavitt-file-explorer-error")],q);let H=class extends m{static{this.styles=[g,o`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};l([v({attribute:!1})],V.prototype,"apiService",null),l([v({type:Boolean})],V.prototype,"enableEditing",null),l([h()],V.prototype,"state",null),l([h()],V.prototype,"file",null),l([h()],V.prototype,"isCopying",null),l([h()],V.prototype,"hasClipboard",null),l([h()],V.prototype,"fileName",null),l([u("md-dialog")],V.prototype,"dialog",null),V=l([a("leavitt-file-modal")],V);let X=class extends(c(m)){#o;get apiService(){return this.#o}set apiService(e){this.#o=e}#n=!1;get enableEditing(){return this.#n}set enableEditing(e){this.#n=e}#c="view";get state(){return this.#c}set state(e){this.#c=e}#u=null;get folder(){return this.#u}set folder(e){this.#u=e}#a;get folderName(){return this.#a}set folderName(e){this.#a=e}#d;get dialog(){return this.#d}set dialog(e){this.#d=e}firstUpdated(){U.subscribe("FileExplorerFolder","Update",(e=>{e.Id===this.folder?.Id&&(this.folder={...this.folder,...e})}))}async#g(){if(!this.apiService||this.folderName===this.folder?.Name||!this.folderName)return;const e={Name:this.folderName};try{const t=this.apiService.patchAsync(`FileExplorerFolders(${this.folder?.Id})`,e);this.loadWhile(t),await t,U.dispatch("FileExplorerFolder","Update",{...this.folder,Name:this.folderName}),this.state="view"}catch(e){this.dispatchEvent(new p(e))}}open(e){this.folder=e,this.state="view",this.dialog.show()}static{this.styles=[x,b,g,y,_,w,o`
      :host {
        display: block;
      }
...
`;let J=class extends C{getRenderClasses(){return{...super.getRenderClasses(),"filled-tonal":!0,"toggle-filled-tonal":this.toggle}}};function Q(e){return"pdf"===e||"txt"===e||"rtf"===e||"doc"===e||"docx"===e||"csv"===e?"article":"pptx"===e||"pptm"===e||"ppt"===e?"slideshow":"xlsx"===e||"xlsx"===e?"text_snippet":"jpg"===e||"jpeg"===e||"png"===e||"webp"===e||"ico"===e||"svg"===e?"photo":"mp4"===e?"movie":"article"}J.styles=[E,Z],J=l([a("md-filled-tonal-icon-button")],J);let W=class extends m{#x;get attachment(){return this.#x}set attachment(e){this.#x=e}static{this.styles=o`
  ...
  `}render(){return i`
    ...
    `}};function ee(e,t=2){if(0===e)return"0 Bytes";const i=t||2,o=Math.floor(Math.log(e)/Math.log(1024));return parseFloat((e/Math.pow(1024,o)).toFixed(i))+" "+["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"][o]}l([v({type:Object})],W.prototype,"attachment",null),W=l([a("leavitt-file-explorer-image")],W);let te=class extends m{#f;get file(){return this.#f}set file(e){this.#f=e}#b=!1;get selected(){return this.#b}set selected(e){this.#b=e}#y=0;get selectedCount(){return this.#y}set selectedCount(e){this.#y=e}#_="grid";get display(){return this.#_}set display(e){this.#_=e}static{this.styles=o`
    :host {
      display: grid;
    }
  ...
  `}render(){return i` <button
    ...
    </button>`}};l([v({type:Object})],te.prototype,"file",null),l([v({type:Boolean,reflect:!0})],te.prototype,"selected",null),l([v({type:Number,reflect:!0,attribute:"selected-count"})],te.prototype,"selectedCount",null),l([v({type:String,reflect:!0,attribute:"display"})],te.prototype,"display",null),te=l([a("file-list-item")],te);let ie=class extends m{#u;get folder(){return this.#u}set folder(e){this.#u=e}#b=!1;get selected(){return this.#b}set selected(e){this.#b=e}#y=0;get selectedCount(){return this.#y}set selectedCount(e){this.#y=e}#_="grid";get display(){return this.#_}set display(e){this.#_=e}#w(e){return Math.abs(e)>999?Math.floor(Math.sign(e)*Math.round(Math.abs(e)/100)/10)+"k+":Math.sign(e)*Math.abs(e)}static{this.styles=o`
    :host {
      display: grid;
    }
...
${this.folder.FilesCount} file${1===this.folder.FilesCount?"":"s"}, ${this.folder.FoldersCount} folder${1===this.folder.FoldersCount?"":"s"}"
    ...
    `}};l([v({attribute:!1})],de.prototype,"apiService",null),l([v({type:Number,attribute:"file-explorer-id"})],de.prototype,"fileExplorerId",null),l([v({type:Number,attribute:"folder-id"})],de.prototype,"folderId",null),l([v({type:String,attribute:"local-storage-display-key"})],de.prototype,"localStorageDisplayKey",null),l([v({type:Boolean,reflect:!0,attribute:"prevent-navigation-up"})],de.prototype,"preventNavigationUp",null),l([v({type:String,reflect:!0,attribute:"display"})],de.prototype,"display",null),l([v({type:String})],de.prototype,"state",null),l([h()],de.prototype,"isAdmin",null),l([h()],de.prototype,"fileExplorer",null),l([h()],de.prototype,"files",null),l([h()],de.prototype,"folders",null),l([h()],de.prototype,"path",null),l([h()],de.prototype,"selected",null),l([u("md-menu[upload-menu]")],de.prototype,"uploadMenu",null),l([u("leavitt-folder-modal")],de.prototype,"folderDialog",null),l([u("leavitt-add-folder-modal")],de.prototype,"addFolderDialog",null),l([u("leavitt-file-modal")],de.prototype,"fileDialog",null),l([u("input[files]")],de.prototype,"fileInput",null),l([u("input[folders]")],de.prototype,"folderInput",null),l([u("titanium-confirm-dialog")],de.prototype,"confirmDialog",null),de=l([a("leavitt-file-explorer")],de);let se=class extends m{static{this.styles=[x,g,o`
      :host {
        display: flex;
        flex-direction: column;
        margin: 24px 12px;
    ...
    `}};l([h()],se.prototype,"fileExplorerApiService",void 0),se=l([a("leavitt-file-explorer-playground")],se);let ne=class extends m{#V=null;get refreshToken(){return this.#V}set refreshToken(e){this.#V=e}static{this.styles=[A,o``]}async firstUpdated(){const e=await M();await e.authenticateAsync(),this.refreshToken=window.localStorage.getItem("LG-AUTH-RT")}render(){return i`
    ...
    `}};l([h()],ne.prototype,"refreshToken",null),ne=l([a("leavitt-file-explorer-demo")],ne);export{ne as LeavittUserFileExplorerDemo};
