import{h as e,a as t,m as a,i as s,k as i,_ as r,n as o,e as l,r as n,t as c,b as d,p as h,Q as m,B as p,E as u,H as g,J as b,K as f,M as v,R as y,D as w,y as x,N as k,O as $,U as S,V as _}from"./CzHvl5jm.js";import{S as A}from"./CYtDMjId.js";import"./BngvSuhr.js";import{D as C,C as T}from"./CwpfgXDY.js";import"./BxTxlHX3.js";import"./o6Fe7m6D.js";import{r as z}from"./D9pokuyX.js";import"./Dx3_tnEg.js";import"./QJssaeMz.js";import"./DMuv4q9m.js";import"./DKPDL8y8.js";import{g as N}from"./BX9sNKay.js";import{D as P}from"./Bbv0u4bt.js";import"./CEI7UKhK.js";import"./DGgUFMLi.js";let D=class extends e{#e;get header(){return this.#e}set header(e){this.#e=e}#t;get localStorageKey(){return this.#t}set localStorageKey(e){this.#t=e}#a=[10,15,20,50];get pageSizes(){return this.#a}set pageSizes(e){this.#a=e}#s=10;get defaultPageSize(){return this.#s}set defaultPageSize(e){this.#s=e}#i;get count(){return this.#i}set count(e){this.#i=e}#r=[];get items(){return this.#r}set items(e){this.#r=e}#o;get searchTerm(){return this.#o}set searchTerm(e){this.#o=e}#l;get singleSelect(){return this.#l}set singleSelect(e){this.#l=e}#n=!1;get disableSelect(){return this.#n}set disableSelect(e){this.#n=e}#c=!1;get disablePaging(){return this.#c}set disablePaging(e){this.#c=e}#d=[];get selected(){return this.#d}set selected(e){this.#d=e}#h;get itemsContainer(){return this.#h}set itemsContainer(e){this.#h=e}#m;get itemsSlot(){return this.#m}set itemsSlot(e){this.#m=e}#p=!1;get narrow(){return this.#p}set narrow(e){this.#p=e}#u;get hasDragItems(){return this.#u}set hasDragItems(e){this.#u=e}#g;get isLoading(){return this.#g}set isLoading(e){this.#g=e}#b;get tableHeaders(){return this.#b}set tableHeaders(e){this.#b=e}#f;get checkbox(){return this.#f}set checkbox(e){this.#f=e}#v;get pageControl(){return this.#v}set pageControl(e){this.#v=e}#y=0;async getTake(){return(await this.pageControl)?.take??0}async getPage(){return(await this.pageControl)?.page??0}async setTake(e){const t=await this.pageControl;t&&(t.take=e)}async setPage(e){const t=await this.pageControl;t&&(t.page=e)}async resetPage(){await this.setPage(0)}async firstUpdated(){if("function"==typeof ResizeObserver){new ResizeObserver((e=>{for(const t of e){const e=t.contentRect;this.narrow=e.width<560,this.updateChildrenIsNarrow()}})).observe(this)}else{const e=window.matchMedia("(max-width: 768px)");e.addEventListener("change",(e=>{this.narrow=e.matches,this.updateChildrenIsNarrow()})),this.narrow=e.matches,this.updateChildrenIsNarrow()}this.addEventListener(C.eventType,(e=>{e.stopPropagation();const t=Math.min(e.hoverIndex,this.items.length-1);if(t!==e.originIndex){const a=this.items[e.originIndex];this.items.splice(e.originIndex,1),this.items.splice(t,0,a),this.dispatchEvent(new M)}})),this.tableHeaders.addEventListener("slotchange",(()=>this.updateChildrenIsNarrow())),this.itemsSlot.addEventListener("slotchange",(()=>this.updateChildrenIsNarrow())),await((await this.pageControl)?.updateComplete)}updateChildrenIsNarrow(){this.hasDragItems=this.itemsSlot.assignedElements().some((e=>e.enableDrag)),this.itemsSlot.assignedElements().forEach((e=>e.narrow=this.narrow)),this.tableHeaders.assignedElements().forEach((e=>e.narrow=this.narrow))}clearSelection(){this.#w(),this.selected.length>0&&(this.selected=[],this.#x())}updated(e){e.has("items")&&e.get("items")!==this.items&&this.clearSelection()}#x(){this.dispatchEvent(new CustomEvent("selected-changed",{composed:!0,detail:this.selected}))}async loadWhile(e){this.isLoading=!0,this.#y++;try{await e}finally{this.#y--,0===this.#y&&(this.isLoading=!1)}}#w(){this.#k().forEach((e=>e.deselect()))}selectAll(){this.singleSelect||this.#k().forEach((e=>e.select()))}#k(){return this.itemsSlot.assignedElements().filter((e=>"function"==typeof e.select&&"function"==typeof e.deselect))}static{this.styles=[t,a,s`
    ...
    `}};r([o({type:String})],D.prototype,"header",null),r([o({type:String})],D.prototype,"localStorageKey",null),r([o({type:Array})],D.prototype,"pageSizes",null),r([o({type:Number,attribute:"default-page-size"})],D.prototype,"defaultPageSize",null),r([o({type:Number})],D.prototype,"count",null),r([o({type:Array})],D.prototype,"items",null),r([o({type:String})],D.prototype,"searchTerm",null),r([o({type:Boolean,attribute:"single-select",reflect:!0})],D.prototype,"singleSelect",null),r([o({type:Boolean,attribute:"disable-select"})],D.prototype,"disableSelect",null),r([o({type:Boolean,attribute:"disable-paging",reflect:!0})],D.prototype,"disablePaging",null),r([o({type:Array})],D.prototype,"selected",null),r([l("div[items-slot]")],D.prototype,"itemsContainer",null),r([l('slot[name="items"]')],D.prototype,"itemsSlot",null),r([o({type:Boolean,reflect:!0,attribute:"narrow"})],D.prototype,"narrow",null),r([o({type:Boolean,attribute:"has-drag-items",reflect:!0})],D.prototype,"hasDragItems",null),r([n()],D.prototype,"isLoading",null),r([l('slot[name="table-headers"]')],D.prototype,"tableHeaders",null),r([l("md-checkbox")],D.prototype,"checkbox",null),r([z("titanium-page-control")],D.prototype,"pageControl",null),D=r([c("titanium-data-table")],D);class M extends Event{static{this.eventType="titanium-data-table-items-reorder"}constructor(){super(M.eventType)}}let j=class extends e{#$=[];get draggableItems(){return this.#$}set draggableItems(e){this.#$=e}firstUpdated(){this.draggableItems=[{Name:"Model 3",Appearance:"slick"},{Name:"Model X",Appearance:"slick"},{Name:"Model Y",Appearance:"slick"},{Name:"Model S",Appearance:"slick"},{Name:"Cybertruck",Appearance:"ugly"},{Name:"Tesla Semi",Appearance:"ugly"},{Name:"Model X Plaid",Appearance:"plaid"},{Name:"Model S Plaid",Appearance:"plaid"},{Name:"Model S Plaid+",Appearance:"plaid"},{Name:"Gen. 2 Roadster",Appearance:"slick"}]}static{this.styles=[t,d,h,s`
      :host {
        display: flex;
        flex-direction: column;
...
`;let U=class extends E{};U.styles=[O],U=r([c("md-switch")],U);class F{constructor(e,t,a=null){this.key=e,this.oDataFilter=t,this.value=a}getOdataFilter(){return null===this.value?null:this.oDataFilter(this.value)}}function L(e,t){if(e instanceof RegExp)return{keys:!1,pattern:e};var a,s,i,r,o=[],l="",n=e.split("/");for(n[0]||n.shift();i=n.shift();)"*"===(a=i[0])?(o.push(a),l+="?"===i[1]?"(?:/(.*))?":"/(.*)"):":"===a?(s=i.indexOf("?",1),r=i.indexOf(".",1),o.push(i.substring(1,~s?s:~r?r:i.length)),l+=~s&&!~r?"(?:/([^/]+?))?":"/([^/]+?)",~r&&(l+=(~s?"?":"")+"\\"+i.substring(r))):l+="/"+i;return{keys:o,pattern:new RegExp("^"+l+"/?$","i")}}class H{#S=new Map;#_=[];#A;get path(){return this.#A}set path(e){this.#A=e}subscribeToFilterChange(e){this.#_.push(e)}unsubscribeFromFilterChange(e){this.#_=this.#_.filter((t=>t!=e))}#C(){this.#_.forEach((e=>e()))}constructor(e){this.path=e;const t=history.pushState.bind(history);history.pushState=(...e)=>{t(...e);L(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()};const a=history.replaceState.bind(history);history.replaceState=(...e)=>{a(...e);L(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()}}loadFromQueryString(){const e=new URLSearchParams(location.search);let t=!1;return this.#S.forEach((a=>{let s=null;e.has(a.key)&&(s=e.get(a.key)),a.value!==s&&(a.value=s,t=!0)})),t&&this.#C(),t}get filters(){return Array.from(this.#S.values())}getActiveFilterOdata(){const e=[];return this.filters.forEach((t=>{const a=t.getOdataFilter();a&&e.push(a)})),e}setValue(e,t){if(this.#S.has(e)){const a=this.#S.get(e);a&&a?.value!==t&&(a.value=t,this.#T())}}getValue(e){if(!this.#S.has(e))return null;const t=this.#S.get(e);return t?.value}setFilter(e,t,a=null){this.#S.set(e,new F(e,t,a))}getFilter(e){return this.#S.get(e)}#z;#T(){clearTimeout(this.#z),this.#N(),this.#z=window.setTimeout((()=>{this.#C()}),50)}#N(){const e=new URLSearchParams(location.search);this.#S.forEach((t=>{void 0!==t.value&&null!==t.value?e.set(t.key,String(t.value)):e.has(t.key)&&e.delete(t.key)}));const t=`${location.pathname}?${e}`;window.history.replaceState({path:t},"",t)}}const G=[{Name:"Model 3",Appearance:"Slick"},{Name:"Model X",Appearance:"Slick"},{Name:"Model Y",Appearance:"Slick"},{Name:"Model S",Appearance:"Slick"},{Name:"Cybertruck",Appearance:"Ugly"},{Name:"Tesla Semi",Appearance:"Ugly"},{Name:"Model X Plaid",Appearance:"Plaid"},{Name:"Model S Plaid",Appearance:"Plaid"},{Name:"Model S Plaid+",Appearance:"Plaid"},{Name:"Gen. 2 Roadster",Appearance:"Slick"}];let K=class extends e{#P=[];get allItems(){return this.#P}set allItems(e){this.#P=e}#r=[];get items(){return this.#r}set items(e){this.#r=e}#d=[];get selected(){return this.#d}set selected(e){this.#d=e}#o="";get searchTerm(){return this.#o}set searchTerm(e){this.#o=e}#D=0;get resultTotal(){return this.#D}set resultTotal(e){this.#D=e}#M="asc";get sortDirection(){return this.#M}set sortDirection(e){this.#M=e}#j="Name";get sortBy(){return this.#j}set sortBy(e){this.#j=e}#B;get filterController(){return this.#B}set filterController(e){this.#B=e}#l=!1;get singleSelect(){return this.#l}set singleSelect(e){this.#l=e}#n=!1;get disableSelect(){return this.#n}set disableSelect(e){this.#n=e}#c=!1;get disablePaging(){return this.#c}set disablePaging(e){this.#c=e}#I;get dataTable(){return this.#I}set dataTable(e){this.#I=e}#R;get filterModal(){return this.#R}set filterModal(e){this.#R=e}constructor(){super(),this.filterController=new H("/titanium-data-table"),this.filterController.setFilter("Appearance",(e=>`BasketId eq ${e}`)),this.filterController.subscribeToFilterChange((async()=>{this.dataTable&&(this.dataTable?.resetPage(),this.#E())})),this.filterController.loadFromQueryString()}firstUpdated(){this.#O(),this.items=this.allItems.slice(0)}#E(){this.getItemsAsync(this.searchTerm)}#O(){this.allItems=G.map((e=>({Name:e.Name,Appearance:e.Appearance}))),this.#E()}#U(e){this.sortDirection=e.detail,this.dataTable.resetPage(),this.#E()}#F(e){this.sortBy=e.detail,this.dataTable.resetPage(),this.#E()}#L=new P((e=>this.getItemsAsync(e)));async getItemsAsync(e){const t=N(e),a=await this.dataTable.getTake(),s=await this.dataTable.getPage(),i="asc"===this.sortDirection?1:-1;let r=this.allItems.filter((e=>t.every((t=>e.Name?.trim().toLowerCase()?.includes(t.trim().toLowerCase())))));const o=this.filterController.getValue("Appearance");o&&(r=r.filter((e=>e.Appearance===o))),this.items=r.slice(0).sort(((e,t)=>e[this.sortBy]===t[this.sortBy]?0:(e[this.sortBy]??"")<(t[this.sortBy]??"")?i:-i)).slice(a*s,a*s+a),this.resultTotal=r.length}static{this.styles=[t,d,h,s`
    ...
    `}};r([n()],K.prototype,"allItems",null),r([n()],K.prototype,"items",null),r([n()],K.prototype,"selected",null),r([n()],K.prototype,"searchTerm",null),r([n()],K.prototype,"resultTotal",null),r([n()],K.prototype,"sortDirection",null),r([n()],K.prototype,"sortBy",null),r([n()],K.prototype,"filterController",null),r([n()],K.prototype,"singleSelect",null),r([n()],K.prototype,"disableSelect",null),r([n()],K.prototype,"disablePaging",null),r([l("titanium-data-table")],K.prototype,"dataTable",null),r([l("data-table-demo-filter-modal")],K.prototype,"filterModal",null),K=r([c("titanium-data-table-full-playground")],K);let W=class extends e{#B;get filterController(){return this.#B}set filterController(e){this.#B=e}#H;get appearance(){return this.#H}set appearance(e){this.#H=e}#G;get dialog(){return this.#G}set dialog(e){this.#G=e}async firstUpdated(){this.filterController.subscribeToFilterChange((async()=>{this.requestUpdate("filterController")}))}async open(){this.dialog.show()}#K(){const e=this.dialog.shadowRoot?.querySelector("dialog"),t=e?.querySelector(".container"),a=t?.querySelector(".scroller");a&&(a.style.overflow="initial"),t&&(t.style.overflow="initial")}#W(){const e=this.dialog.shadowRoot?.querySelector("dialog"),t=e?.querySelector(".container"),a=t?.querySelector(".scroller");a&&(a.style.overflow=""),t&&(t.style.overflow="")}static{this.styles=[s`
      :host {
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    `}};r([n()],W.prototype,"filterController",null),r([n()],W.prototype,"appearance",null),r([l("md-dialog")],W.prototype,"dialog",null),W=r([c("data-table-demo-filter-modal")],W);let q=class extends e{static{this.styles=[A,s``]}render(){return i`
