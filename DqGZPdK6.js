...
`;let j=class extends I{#N;get item(){return this.#N}set item(t){this.#N=t}#x=null;get tableMetaData(){return this.#x}set tableMetaData(t){this.#x=t}#A=null;get supplementalItemStyles(){return this.#A}set supplementalItemStyles(t){this.#A=t}get items(){return Array.from(this.parentElement?.querySelectorAll("titanium-data-table-core-reorder-item")??[])}get itemsContainer(){return this.parentElement}static{this.styles=[I.styles,e`
    ...
    </md-dialog>`}};var B;i([s({type:Object})],Y.prototype,"tableMetaData",null),i([s({type:Object})],Y.prototype,"supplementalItemStyles",null),i([h("md-dialog")],Y.prototype,"dialog",null),i([h("titanium-snackbar-stack")],Y.prototype,"snackbar",null),i([a()],Y.prototype,"items",null),Y=i([n("titanium-data-table-core-reorder-dialog")],Y),function(t){t.csv="text/csv",t.tsv="text/tab-separated-values",t.plain="text/plain"}(B||(B={}));var J=t=>t,T=t=>t,F=J,q=J,R=J,H=J,P=J,U={fieldSeparator:",",decimalSeparator:".",quoteStrings:!0,quoteCharacter:'"',showTitle:!1,title:"My Generated Report",filename:"generated",showColumnHeaders:!0,useTextFile:!1,fileExtension:"csv",mediaType:B.csv,useBom:!0,columnHeaders:[],useKeysAsHeaders:!1,boolDisplay:{true:"TRUE",false:"FALSE"},replaceUndefinedWith:""},K=t=>Object.assign({},U,t);class W extends Error{constructor(t){super(t),this.name="CsvGenerationError"}}class L extends Error{constructor(t){super(t),this.name="EmptyHeadersError"}}class G extends Error{constructor(t){super(t),this.name="CsvDownloadEnvironmentError"}}class V extends Error{constructor(t){super(t),this.name="UnsupportedDataFormatError"}}var X=t=>H("object"==typeof t?t.key:t),Q=t=>P("object"==typeof t?t.displayLabel:t),Z=t=>e=>q(t+e+"\r\n"),tt=t=>(e,i)=>et(t)(R(e+i)),et=t=>e=>e+t.fieldSeparator,it=(t,e)=>{if((t=>+t===t&&(!isFinite(t)||Boolean(t%1)))(e)){if("locale"===t.decimalSeparator)return F(e.toLocaleString());if(t.decimalSeparator)return F(e.toString().replace(".",t.decimalSeparator))}return F(e.toString())},st=(t,e)=>{let i=e;return(t.quoteStrings||t.fieldSeparator&&e.indexOf(t.fieldSeparator)>-1||t.quoteCharacter&&e.indexOf(t.quoteCharacter)>-1||e.indexOf("\n")>-1||e.indexOf("\r")>-1)&&(i=t.quoteCharacter+function(t,e){return'"'==e&&t.indexOf('"')>-1?t.replace(/"/g,'""'):t}(e,t.quoteCharacter)+t.quoteCharacter),F(i)},at=(t,e)=>{if("number"==typeof e)return it(t,e);if("string"==typeof e)return st(t,e);if("boolean"==typeof e&&t.boolDisplay)return((t,e)=>{const i=e?"true":"false";return F(t.boolDisplay[i])})(t,e);if(null==e)return((t,e)=>void 0===e&&void 0!==t.replaceUndefinedWith?st(t,t.replaceUndefinedWith+""):st(t,null===e?"null":""))(t,e);throw new V(`\n    typeof ${typeof e} isn't supported. Only number, string, boolean, null and undefined are supported.\n    Please convert the data in your object to one of those before generating the CSV.\n    `)},ot=t=>e=>{const i=K(t),s=i.useKeysAsHeaders?Object.keys(e[0]):i.columnHeaders;let a=((t,...e)=>e.reduce((t,e)=>e(t),t))(q(""),(t=>e=>t.useBom?q(e+"\ufeff"):e)(i),(t=>e=>t.showTitle?Z(q(e+t.title))(R("")):e)(i),((t,e)=>i=>{if(!t.showColumnHeaders)return i;if(e.length<1)throw new L("Option to show headers but none supplied. Make sure there are keys in your collection or that you've supplied headers through the config options.");let s=R("");for(let i=0;i<e.length;i++){const a=Q(e[i]);s=tt(t)(s,at(t,T(a)))}return s=R(s.slice(0,-1)),Z(i)(s)})(i,s),((t,e,i)=>s=>{let a=s;for(var o=0;o<i.length;o++){let s=R("");for(let a=0;a<e.length;a++){const n=X(e[a]),r=i[o][T(n)];s=tt(t)(s,at(t,r))}s=R(T(s).slice(0,-1)),a=Z(a)(s)}return a})(i,s,e));if(a.length<1)throw new W("Output is empty. Is your data formatted correctly?");return a},nt=t=>e=>{if(!window)throw new G("Downloading only supported in a browser environment.");const i=(t=>e=>{const i=K(t),s=e,a=i.useTextFile?"text/plain":i.mediaType;return new Blob([s],{type:`${a};charset=utf8;`})})(t)(e),s=K(t),a=s.useTextFile?"txt":s.fileExtension,o=`${s.filename}.${a}`,n=document.createElement("a");n.download=o,n.href=URL.createObjectURL(i),n.setAttribute("visibility","hidden"),document.body.appendChild(n),n.click(),document.body.removeChild(n)};function rt(t){return t?.itemMetaData.filter(t=>t.defaultSort).sort((t,e)=>(t.defaultSort?.position??0)-(e.defaultSort?.position??0)).map(t=>({key:t.key,direction:t.defaultSort?.direction??"asc"}))??[]}let lt=class extends(b(t)){#O=[];get items(){return this.#O}set items(t){this.#O=t}#x=null;get tableMetaData(){return this.#x}set tableMetaData(t){this.#x=t}#A=null;get supplementalItemStyles(){return this.#A}set supplementalItemStyles(t){this.#A=t}#f=!1;get disabled(){return this.#f}set disabled(t){this.#f=t}#j=!1;get stickyHeader(){return this.#j}set stickyHeader(t){this.#j=t}#Y="none";get selectionMode(){return this.#Y}set selectionMode(t){this.#Y=t}#b=[];get selected(){return this.#b}set selected(t){this.#b=t}#B;get chooseColumnsDialog(){return this.#B}set chooseColumnsDialog(t){this.#B=t}#J;get sortDialog(){return this.#J}set sortDialog(t){this.#J=t}#T;get reorderDialog(){return this.#T}set reorderDialog(t){this.#T=t}#F="dtc-pref";get localStorageKey(){return this.#F}set localStorageKey(t){this.#F=t}#q=!1;get customSortApplied(){return this.#q}set customSortApplied(t){this.#q=t}#v=!1;get customColumnsApplied(){return this.#v}set customColumnsApplied(t){this.#v=t}get sort(){const t=window.localStorage.getItem(`${this.localStorageKey}-user-sort`);return null===t?rt(this.tableMetaData):JSON.parse(t??"[]")||[]}set sort(t){localStorage.setItem(`${this.localStorageKey}-user-sort`,JSON.stringify(t))}get userSettings(){return JSON.parse(window.localStorage.getItem(`${this.localStorageKey}-user-settings`)??"[]")||[]}set userSettings(t){localStorage.setItem(`${this.localStorageKey}-user-settings`,JSON.stringify(t))}updated(t){if(t.has("items")&&t.get("items")!==this.items&&this.deselectAll(),t.has("sort")||t.has("tableMetaData")){const t=rt(this.tableMetaData),e=JSON.stringify(t)!==JSON.stringify(this.sort);this.customSortApplied!==e&&(this.customSortApplied=e)}}selectAll(){"multi"===this.selectionMode&&(this.selected=this.items,this.#R())}deselectAll(){this.selected.length>0&&(this.selected=[],this.#R())}resetSort(){const t=rt(this.tableMetaData);JSON.stringify(t)!==JSON.stringify(this.sort)&&(this.sort=t,this.dispatchEvent(new Event("sort-changed")))}#R(){this.dispatchEvent(new Event("selected-changed",{composed:!0}))}orderByUserPreference(t,e){return t.sort((t,i)=>{const s=e.findIndex(e=>e.key===t.key),a=e.findIndex(t=>t.key===i.key);return s-a})}static{this.styles=[x,k,e`
      :host {
        display: grid;
                    ...
                    <content-container>
                      ${"none"!==this.selectionMode?o`
                            <md-checkbox
                              ...
                              @change=${()=>{this.selected.includes(t)?this.selected.splice(this.selected.indexOf(t),1):"single"===this.selectionMode?this.selected=[t]:this.selected.push(t),this.requestUpdate("selected"),this.#R()}}
                              ?disabled=${this.disabled}
                            ></md-checkbox>
                          `:p}
                    </content-container>
