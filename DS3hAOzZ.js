...
`;let te=class extends K{#I;get item(){return this.#I}set item(e){this.#I=e}#f=null;get tableMetaData(){return this.#f}set tableMetaData(e){this.#f=e}#B=null;get supplementalItemStyles(){return this.#B}set supplementalItemStyles(e){this.#B=e}get items(){return Array.from(this.parentElement?.querySelectorAll("titanium-data-table-core-reorder-item")??[])}get itemsContainer(){return this.parentElement}static{this.styles=[K.styles,x`
    ...
    </md-dialog>`}};var se,re;a([O("trackLoadingPromise"),d()],ie.prototype,"isLoading",null),a([n({type:Object})],ie.prototype,"tableMetaData",null),a([n({type:Object})],ie.prototype,"supplementalItemStyles",null),a([c("md-dialog")],ie.prototype,"dialog",null),a([c("titanium-snackbar-stack")],ie.prototype,"snackbar",null),a([d()],ie.prototype,"items",null),ie=a([w("titanium-data-table-core-reorder-dialog")],ie),(re=se||={}).csv="text/csv",re.tsv="text/tab-separated-values",re.plain="text/plain";var oe=e=>e,ae=e=>e,ne=oe,de=oe,ce=oe,le=oe,he=oe,me={fieldSeparator:",",decimalSeparator:".",quoteStrings:!0,quoteCharacter:'"',showTitle:!1,title:"My Generated Report",filename:"generated",showColumnHeaders:!0,useTextFile:!1,fileExtension:"csv",mediaType:"text/csv",useBom:!0,columnHeaders:[],useKeysAsHeaders:!1,boolDisplay:{true:"TRUE",false:"FALSE"},replaceUndefinedWith:"",escapeFormulas:!1},ue=e=>Object.assign({},me,e);class pe extends Error{constructor(e){super(e),this.name="CsvGenerationError"}}class ge extends Error{constructor(e){super(e),this.name="EmptyHeadersError"}}class be extends Error{constructor(e){super(e),this.name="CsvDownloadEnvironmentError"}}class ve extends Error{constructor(e){super(e),this.name="UnsupportedDataFormatError"}}var fe=e=>le("object"==typeof e?e.key:e),ye=e=>he("object"==typeof e?e.displayLabel:e),xe=e=>t=>de(e+t+"\r\n"),we=e=>(t,i)=>ke(e)(ce(t+i)),ke=e=>t=>t+e.fieldSeparator,$e=e=>(e=>new RegExp(/^[=+\-@\t\r]/).test(e))(e)?`'${e}`:e,_e=(e,t)=>{if((e=>+e===e&&(!Number.isFinite(e)||Boolean(e%1)))(t)){if("locale"===e.decimalSeparator)return ne(t.toLocaleString());if(e.decimalSeparator)return ne(t.toString().replace(".",e.decimalSeparator))}return ne(t.toString())},Se=(e,t)=>{let i=t;return e.escapeFormulas&&(i=$e(t)),(e.quoteStrings||e.fieldSeparator&&t.indexOf(e.fieldSeparator)>-1||e.quoteCharacter&&t.indexOf(e.quoteCharacter)>-1||t.indexOf("\n")>-1||t.indexOf("\r")>-1)&&(i=e.quoteCharacter+function(e,t){return'"'===t&&e.indexOf('"')>-1?e.replace(/"/g,'""'):e}(i,e.quoteCharacter)+e.quoteCharacter),ne(i)},ze=(e,t)=>{if("number"==typeof t)return _e(e,t);if("string"==typeof t)return Se(e,t);if("boolean"==typeof t&&e.boolDisplay)return((e,t)=>{let i=t?"true":"false";return ne(e.boolDisplay[i])})(e,t);if(null===t||typeof t>"u")return((e,t)=>typeof t>"u"&&void 0!==e.replaceUndefinedWith?Se(e,e.replaceUndefinedWith+""):Se(e,null===t?"null":""))(e,t);throw new ve(`\n    typeof ${typeof t} isn't supported. Only number, string, boolean, null and undefined are supported.\n    Please convert the data in your object to one of those before generating the CSV.\n    `)};var De=e=>t=>{let i=ue(e),s=i.useKeysAsHeaders?Object.keys(t[0]):i.columnHeaders,r=((e,...t)=>t.reduce((e,t)=>t(e),e))(de(""),(e=>t=>e.useBom?de(t+"\ufeff"):t)(i),(e=>t=>e.showTitle?xe(de(t+e.title))(ce("")):t)(i),((e,t)=>i=>{if(!e.showColumnHeaders)return i;if(t.length<1)throw new ge("Option to show headers but none supplied. Make sure there are keys in your collection or that you've supplied headers through the config options.");let s=ce("");for(let i=0;i<t.length;i++){let r=ye(t[i]);s=we(e)(s,ze(e,ae(r)))}return s=ce(s.slice(0,-1)),xe(i)(s)})(i,s),((e,t,i)=>s=>{let r=s;for(let s=0;s<i.length;s++){let o=ce("");for(let r=0;r<t.length;r++){let a=fe(t[r]),n=i[s][ae(a)];o=we(e)(o,ze(e,n))}o=ce(ae(o).slice(0,-1)),r=xe(r)(o)}return r})(i,s,t));if(r.length<1)throw new pe("Output is empty. Is your data formatted correctly?");return r},Ce=e=>t=>{if(!window)throw new be("Downloading only supported in a browser environment.");let i=(e=>t=>{let i=ue(e),s=t,r=i.useTextFile?"text/plain":i.mediaType;return new Blob([s],{type:`${r};charset=utf8;`})})(e)(t),s=ue(e),r=s.useTextFile?"txt":s.fileExtension,o=`${s.filename}.${r}`,a=document.createElement("a");a.download=o,a.href=URL.createObjectURL(i),a.setAttribute("visibility","hidden"),document.body.appendChild(a),a.click(),document.body.removeChild(a)};function Me(e){return e?.itemMetaData.filter(e=>e.defaultSort).sort((e,t)=>(e.defaultSort?.position??0)-(t.defaultSort?.position??0)).map(e=>({key:e.key,direction:e.defaultSort?.direction??"asc"}))??[]}let Ie=class extends o{#O=!1;get isLoading(){return this.#O}set isLoading(e){this.#O=e}#A=[];get items(){return this.#A}set items(e){this.#A=e}#f=null;get tableMetaData(){return this.#f}set tableMetaData(e){this.#f=e}#B=null;get supplementalItemStyles(){return this.#B}set supplementalItemStyles(e){this.#B=e}#v=!1;get disabled(){return this.#v}set disabled(e){this.#v=e}#T=!1;get stickyHeader(){return this.#T}set stickyHeader(e){this.#T=e}#N="none";get selectionMode(){return this.#N}set selectionMode(e){this.#N=e}#b=[];get selected(){return this.#b}set selected(e){this.#b=e}#H;get chooseColumnsDialog(){return this.#H}set chooseColumnsDialog(e){this.#H=e}#R;get sortDialog(){return this.#R}set sortDialog(e){this.#R=e}#Y;get reorderDialog(){return this.#Y}set reorderDialog(e){this.#Y=e}#L="dtc-pref";get localStorageKey(){return this.#L}set localStorageKey(e){this.#L=e}#J=!1;get customSortApplied(){return this.#J}set customSortApplied(e){this.#J=e}#x=!1;get customColumnsApplied(){return this.#x}set customColumnsApplied(e){this.#x=e}get sort(){const e=window.localStorage.getItem(`${this.localStorageKey}-user-sort`);return null===e?Me(this.tableMetaData):JSON.parse(e??"[]")||[]}set sort(e){localStorage.setItem(`${this.localStorageKey}-user-sort`,JSON.stringify(e))}get userSettings(){return JSON.parse(window.localStorage.getItem(`${this.localStorageKey}-user-settings`)??"[]")||[]}set userSettings(e){localStorage.setItem(`${this.localStorageKey}-user-settings`,JSON.stringify(e))}updated(e){if(e.has("items")&&e.get("items")!==this.items&&this.deselectAll(),e.has("sort")||e.has("tableMetaData")){const e=Me(this.tableMetaData),t=JSON.stringify(e)!==JSON.stringify(this.sort);this.customSortApplied!==t&&(this.customSortApplied=t)}}selectAll(){"multi"===this.selectionMode&&(this.selected=this.items,this.#q())}deselectAll(){this.selected.length>0&&(this.selected=[],this.#q())}resetSort(){const e=Me(this.tableMetaData);JSON.stringify(e)!==JSON.stringify(this.sort)&&(this.sort=e,this.dispatchEvent(new Event("sort-changed")))}loadWhile(e){return this.trackLoadingPromise(e)}#q(){this.dispatchEvent(new Event("selected-changed",{composed:!0}))}orderByUserPreference(e,t){return e.sort((e,i)=>{const s=t.findIndex(t=>t.key===e.key),r=t.findIndex(e=>e.key===i.key);return s-r})}static{this.styles=[E,Z,x`
      :host {
        display: grid;
    ...
    `]}render(){return p`
              ...
              <content-container>
                ...
                >
                  ...
                  ${this.items.length>0?p`<md-divider role="separator" tabindex="-1"></md-divider>
                        <md-menu-item
                          .action=${()=>{const e=N().format("YYYY-MM-DD HH-mm-ss"),t=ue({filename:`web export ${e}`,useKeysAsHeaders:!0}),i=this.orderByUserPreference(this.tableMetaData?.itemMetaData?.filter(e=>(!e.hideByDefault&&this.userSettings.find(t=>t.key===e.key)?.show||this.userSettings.find(t=>t.key===e.key)?.show)&&!e.omitFromCsv)??[],this.userSettings)??[],s=this.items.map(e=>{const t={};for(const s of i){t[s.friendlyName??s.key]=s.csvValue?s.csvValue(e):e[s.key]}return t})??[],r=De(t)(s);Ce(t)(r)}}
                        >
      ...
      ></titanium-data-table-core-settings-choose-columns-dialog>
    `}};a([O("trackLoadingPromise"),d()],Ie.prototype,"isLoading",null),a([n({type:Array})],Ie.prototype,"items",null),a([n({type:Object})],Ie.prototype,"tableMetaData",null),a([n({type:Object})],Ie.prototype,"supplementalItemStyles",null),a([n({type:Boolean,reflect:!0})],Ie.prototype,"disabled",null),a([n({type:Boolean,attribute:"sticky-header",reflect:!0})],Ie.prototype,"stickyHeader",null),a([n({type:String,attribute:"selection-mode",reflect:!0})],Ie.prototype,"selectionMode",null),a([n({type:Array})],Ie.prototype,"selected",null),a([c("titanium-data-table-core-settings-choose-columns-dialog")],Ie.prototype,"chooseColumnsDialog",null),a([c("titanium-data-table-core-settings-sort-dialog")],Ie.prototype,"sortDialog",null),a([c("titanium-data-table-core-reorder-dialog")],Ie.prototype,"reorderDialog",null),a([n({type:String,attribute:"local-storage-key"})],Ie.prototype,"localStorageKey",null),a([d()],Ie.prototype,"customSortApplied",null),a([d()],Ie.prototype,"customColumnsApplied",null),a([d()],Ie.prototype,"sort",null),a([d()],Ie.prototype,"userSettings",null),Ie=a([w("titanium-data-table-core")],Ie);class Be extends Event{static{this.eventType="titanium-data-table-items-reorder"}constructor(){super(Be.eventType)}}let Oe=class extends o{#b=[];get selected(){return this.#b}set selected(e){this.#b=e}#F=!1;get hasSelected(){return this.#F}set hasSelected(e){this.#F=e}#P=!1;get hasAddButton(){return this.#P}set hasAddButton(e){this.#P=e}#U;get addButtonElements(){return this.#U}set addButtonElements(e){this.#U=e}updated(e){e.has("selected")&&(this.hasSelected=this.selected.length>0)}static{this.styles=[j,I,x`
      :host {
        display: grid;
        padding: 12px 16px;
        background-color: var(--md-sys-color-surface-container-lowest);
    ...
    `}};a([n({type:Array})],Oe.prototype,"selected",null),a([n({type:Boolean,reflect:!0,attribute:"has-selected"})],Oe.prototype,"hasSelected",null),a([n({type:Boolean,reflect:!0,attribute:"has-add-button"})],Oe.prototype,"hasAddButton",null),a([T({slot:"add-button"})],Oe.prototype,"addButtonElements",null),Oe=a([w("titanium-data-table-action-bar")],Oe);export{Z as n};
