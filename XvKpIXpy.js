import{a1 as t,x as e,c as r,_ as i,t as o,a2 as s,H as a,D as n,a3 as c,r as l,e as d,n as h,L as u,i as g}from"./CU2mI_nZ.js";import"./DwC1M9Xg.js";import"./gwBzphPe.js";import{T as p}from"./BRJMF9Ii.js";class f extends t{renderIndicator(){return this.indeterminate?this.renderIndeterminateContainer():this.renderDeterminateContainer()}renderDeterminateContainer(){const t=100*(1-this.value/this.max);return e`
...
`;let v=class extends f{};v.styles=[m],v=i([o("md-circular-progress")],v);let x=class extends(p(u(g))){constructor(){super(...arguments),this.#t=[],this.#e=[],this.#r="Single select",this.#i=!1,this.#o="Search for a entity",this.#s=null,this.#a=!1,this.#n=!1,this.#c="",this.#l=!1,this.#d=!1,this.#h=!1,this.#u="Name",this.positioning="popover"}#g;get searchTerm(){return this.#g}set searchTerm(t){this.#g=t}#t;get suggestions(){return this.#t}set suggestions(t){this.#t=t}#e;get defaultSuggestions(){return this.#e}set defaultSuggestions(t){this.#e=t}#p;get menu(){return this.#p}set menu(t){this.#p=t}#f;get textfield(){return this.#f}set textfield(t){this.#f=t}#r;get label(){return this.#r}set label(t){this.#r=t}#i;get filled(){return this.#i}set filled(t){this.#i=t}#o;get placeholder(){return this.#o}set placeholder(t){this.#o=t}#s;get selected(){return this.#s}set selected(t){this.#s=t}#a;get disabled(){return this.#a}set disabled(t){this.#a=t}#n;get noAsterisk(){return this.#n}set noAsterisk(t){this.#n=t}#c;get autocomplete(){return this.#c}set autocomplete(t){this.#c=t}#l;get spellcheck(){return this.#l}set spellcheck(t){this.#l=t}#d;get error(){return this.#d}set error(t){this.#d=t}#m;get errorText(){return this.#m}set errorText(t){this.#m=t}#h;get required(){return this.#h}set required(t){this.#h=t}#v;get prefixText(){return this.#v}set prefixText(t){this.#v=t}#x;get suffixText(){return this.#x}set suffixText(t){this.#x=t}#_;get hasLeadingIcon(){return this.#_}set hasLeadingIcon(t){this.#_=t}#b;get hasTrailingIcon(){return this.#b}set hasTrailingIcon(t){this.#b=t}#y;get disableMenuOpenOnFocus(){return this.#y}set disableMenuOpenOnFocus(t){this.#y=t}#T;get supportingText(){return this.#T}set supportingText(t){this.#T=t}#$;get textDirection(){return this.#$}set textDirection(t){this.#$=t}#u;get pathToSelectedText(){return this.#u}set pathToSelectedText(t){this.#u=t}#k;get count(){return this.#k}set count(t){this.#k=t}async firstUpdated(){if(this.textfield&&this.required){const t=this.textfield?.checkValidity;this.textfield.checkValidity=()=>!!this.selected&&t.bind(this.textfield)}}update(t){t.has("positioning")&&"popover"===this.positioning&&!this.showPopover&&(this.positioning="fixed"),super.update(t)}setCustomValidity(t){this.textfield?.setCustomValidity(t)}async reset(){this.softReset(),this.selected=null,this.textfield&&(this.textfield.error=!1,this.textfield.errorText="",this.textfield.reset())}softReset(){this.searchTerm="",this.suggestions=[]}async select(){this.textfield?.select()}async focus(){this.textfield?.focus()}checkValidity(){return this.textfield?.checkValidity()&&this.customCheckValidity()}reportValidity(){return this.textfield?.reportValidity()&&this.customReportValidity()}customCheckValidity(){return this.errorText="Please fill out this field",!(!this.selected&&this.textfield?.value)&&(!this.required&&!this.selected||!!this.selected)}customReportValidity(){return this.customCheckValidity()?(this.error=!1,this.errorText=""):this.error=!0,!this.error}async setSelected(t){const e=this.selected;this.selected=t,this.selected&&(this.softReset(),setTimeout(()=>{this.reportValidity()},0)),e?.Id!==this.selected?.Id&&this.dispatchEvent(new Event("selected"))}onInputChanged(t){console.log(t)}async showSuggestions(t,e){this.suggestions=t,this.count=e,await this.updateComplete,this.menu.show()}async#S(t){!t&&this.defaultSuggestions.length||this.menu.close(),this.setSelected(null),this.suggestions=t?[]:this.defaultSuggestions,this.count=t?0:this.defaultSuggestions.length,this.searchTerm=t,await this.updateComplete,this.onInputChanged(t)}static{this.styles=[r`
    ...
    `]}renderSuggestion(t){return s`<md-menu-item .item=${t} ?selected=${this.selected?.Id===t.Id}>
      <slot name="trailing-icon" slot="trailing-icon"></slot>
      <span slot="headline">${t.Id}</span>
    </md-menu-item>`}renderSelectedLeadingInputSlot(t){}#w(){return s`<div slot="trailing-icon">
    ...
    </div>`}renderTrailingInputSlot(){return s``}renderLeadingInputSlot(){return s`<slot name="leading-icon" slot="leading-icon"><md-icon>search</md-icon></slot>`}renderTrailingSlot(){return s``}renderTrailingMenuSlot(){return s``}render(){return s`
      <${this.filled?c`md-filled-text-field`:c`md-outlined-text-field`}
        id="menu-anchor"
        aria-haspopup="true"
        aria-controls="menu"
        .disabled=${this.disabled}
      ...
      >
        ${this.searchTerm&&!this.isLoading?s`<div summary>Showing ${this.suggestions.length} of ${this.count} result${1===this.count?"":"s"} for '${this.searchTerm}'</div>`:""}
        ${n(this.suggestions,t=>t?.Id,t=>this.renderSuggestion(t))}
        ${this.renderTrailingMenuSlot()}
      </md-menu>
      ${this.renderTrailingSlot()}
    `}};i([l()],x.prototype,"searchTerm",null),i([l()],x.prototype,"suggestions",null),i([l()],x.prototype,"defaultSuggestions",null),i([d("md-menu[suggestions]")],x.prototype,"menu",null),i([d("md-outlined-text-field")],x.prototype,"textfield",null),i([h({type:String})],x.prototype,"label",null),i([h({type:Boolean,attribute:"filled"})],x.prototype,"filled",null),i([h({type:String})],x.prototype,"placeholder",null),i([h({type:Object})],x.prototype,"selected",null),i([h({type:Boolean})],x.prototype,"disabled",null),i([h({type:Boolean,attribute:"no-asterisk"})],x.prototype,"noAsterisk",null),i([h({reflect:!0,type:String})],x.prototype,"autocomplete",null),i([h({reflect:!0,type:Boolean})],x.prototype,"spellcheck",null),i([h({type:Boolean})],x.prototype,"error",null),i([h({type:String})],x.prototype,"errorText",null),i([h({type:Boolean})],x.prototype,"required",null),i([h({type:String})],x.prototype,"prefixText",null),i([h({type:String})],x.prototype,"suffixText",null),i([h({type:Boolean})],x.prototype,"hasLeadingIcon",null),i([h({type:Boolean})],x.prototype,"hasTrailingIcon",null),i([h({type:Boolean,attribute:"disable-menu-open-on-focus"})],x.prototype,"disableMenuOpenOnFocus",null),i([h({type:String})],x.prototype,"supportingText",null),i([h({type:String})],x.prototype,"textDirection",null),i([h({type:String})],x.prototype,"pathToSelectedText",null),i([h()],x.prototype,"positioning",void 0),i([l()],x.prototype,"count",null),x=i([o("titanium-single-select-base")],x);export{x as T};
