import{s as t,p as e,g as i,i as r,x as s,l as o,T as a,_ as n,r as c,n as p,t as l,h as u}from"./f43924bd.js";import{S as m}from"./1c8b19cb.js";import"./3286da59.js";import"./d0c3be22.js";import"./68491de3.js";let h=class extends t{#t;get people(){return this.#t}set people(t){this.#t=t}#e=5;get max(){return this.#e}set max(t){this.#e=t}#i=!1;get enableDirectoryHref(){return this.#i}set enableDirectoryHref(t){this.#i=t}#r=!1;get autoResize(){return this.#r}set autoResize(t){this.#r=t}#s=30;get size(){return this.#s}set size(t){this.#s=t}#o=0;get autoMax(){return this.#o}set autoMax(t){this.#o=t}#a;updated(t){t.has("autoResize")&&(this.autoResize?this.#n():this.#a?.disconnect?.())}#n(){this.#a=new ResizeObserver((t=>{for(const e of t)if(e.contentBoxSize){const t=e.contentBoxSize[0].inlineSize;this.autoMax=Math.floor(t/this.size)}})),this.#a.observe(this)}static{this.styles=[e,i,r`
      :host {
        display: flex;
        flex-direction: row;
        position: relative;
