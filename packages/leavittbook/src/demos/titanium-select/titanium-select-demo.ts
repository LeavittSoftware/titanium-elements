...
import './titanium-select-playground';
...
export class TitaniumSelectElement extends LitElement {
  ...
  render() {
    return html`
      ...
      ></story-header>
      <smart-demo line-numbers resizable project-src="../src/demos/titanium-select/project.json"
        ><titanium-select-playground></titanium-select-playground>
      </smart-demo>
