...
import './titanium-loading-indicator-playground';
...
export class TitaniumLoadingIndicatorDemoElement extends LitElement {
  ...
  render() {
    return html`
      ...
      <smart-demo line-numbers resizable project-src="../src/demos/titanium-loading-indicator/project.json"
        ><titanium-loading-indicator-playground></titanium-loading-indicator-playground>
      </smart-demo>
