...
export class LeavittPersonSelectDemo extends LitElement {
  ...
  render() {
    return html`
      ...
      <p>Person select with pre-loaded data and filtering</p>
      <div row>
      ...
      <p>Person select with local data search</p>
      <div row>
        <leavitt-person-select
          search-type="local"
          .people=${[
      ...
      <p>Person select with custom menu item rendering</p>
      <div row>
        <leavitt-person-select
          search-type="local"
      ...
      <h1>Attributes</h1>
      <p>Default person select with various configurations</p>
      <div>
