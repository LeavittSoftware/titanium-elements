...
import '../demos/data-table-paging-demo';

<Meta title="UI COMPONENTS/titanium-data-table" parameters={{ component: 'titanium-data-table' }} />
...
<ArgsTable of="titanium-data-table" />
...
<Canvas>
  <Story name="Paging">
    {() => {
      return html`<data-table-paging-demo></data-table-paging-demo>
        <titanium-data-table style="display:none"></titanium-data-table> `;
    }}
  </Story>
</Canvas>
