...
let DataTablePagingDemo = class DataTablePagingDemo extends LitElement {
    constructor() {
        super(...arguments);
        this.resultTotal = largeSet === null || largeSet === void 0 ? void 0 : largeSet.length;
        this.cars = largeSet;
        this.filteredCars = [];
        this.selected = [];
    }
    ...
    async _reload() {
        ...
        this.filteredCars = len === 0 ? this.cars.slice(0, take) : this.cars.slice(len * page, take + take * page);
    }
    _later(delay) {
    ...
    render() {
      ...
      >
        ...
        ${repeat(this.filteredCars, i => i.id, (item, i) => {
            var _a, _b, _c, _d;
            return html `
              ...
              >
                <row-item width="75" title=${(_a = item.id) !== null && _a !== void 0 ? _a : ''} large>${item.id} </row-item>
                <row-item ellipsis title=${(_b = item.name) !== null && _b !== void 0 ? _b : ''} large>${item.name} index:${i}</row-item>
                <row-item desktop>${(_c = item.miles) !== null && _c !== void 0 ? _c : '-'}</row-item>
                <row-item desktop>${(_d = item.metadata) !== null && _d !== void 0 ? _d : '-'}</row-item>
...
__decorate([
    state()
], DataTablePagingDemo.prototype, "resultTotal", void 0);
__decorate([
    state()
], DataTablePagingDemo.prototype, "cars", void 0);
__decorate([
    state()
], DataTablePagingDemo.prototype, "filteredCars", void 0);
__decorate([
    state()
], DataTablePagingDemo.prototype, "selected", void 0);
__decorate([
    query('titanium-data-table')
], DataTablePagingDemo.prototype, "dataTable", void 0);
DataTablePagingDemo = __decorate([
    customElement('data-table-paging-demo')
], DataTablePagingDemo);
export default DataTablePagingDemo;
...
//# sourceMappingURL=data-table-paging-demo.js.map