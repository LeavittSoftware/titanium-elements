import{A as e,E as t,L as i,i as s,P as o,S as a,b as r,c as l,_ as n,n as d,r as c,e as h,t as p,p as m,h as u,d as f,a as g,f as x,g as y,m as v,o as b,j as w,k as $,l as _}from"./BwDOgaCl.js";import{S as F}from"./DqlEvKiU.js";import"./BDkKqPD2.js";import"./DZ1f3jXa.js";import{C as k}from"./BW5lVTvV.js";import"./zVjgD-9O.js";import"./DKGGrv-j.js";import{d as E}from"./fEBq_QNq.js";import"./DGg2QPDH.js";import{a as C}from"./BS_tg9SS.js";import"./BPQf_WJy.js";import"./CGD201Wd.js";function N(t,i){return t.map((s,o)=>[s,o<t.length-1?i:e])}const I=new t;Object.freeze(I);let S=class extends(i(s)){#e;get apiService(){return this.#e}set apiService(e){this.#e=e}#t;get fileExplorerId(){return this.#t}set fileExplorerId(e){this.#t=e}#i;get parentFolderId(){return this.#i}set parentFolderId(e){this.#i=e}#s="";get folderName(){return this.#s}set folderName(e){this.#s=e}#o;get dialog(){return this.#o}set dialog(e){this.#o=e}async open(){return this.folderName="",this.dialog.show(),new Promise(e=>{this.resolve=e})}async#a(){if(!this.apiService)return;const e={FileExplorerId:this.fileExplorerId,Name:this.folderName,ParentFolderId:this.parentFolderId||void 0};try{const t=this.apiService.postAsync("FileExplorerFolders?expand=CreatorPerson(select=FullName,ProfilePictureCdnFileName)",e);this.dispatchEvent(new o(t)),this.loadWhile(t);const i=(await t)?.entity;return{...i,CreatorProfilePictureCndFileName:i?.CreatorPerson?.ProfilePictureCdnFileName,CreatorFullName:i?.CreatorPerson?.FullName}}catch(e){this.dispatchEvent(new a(e))}return null}static{this.styles=r`
    :host {
      display: block;
    }
  ...
  `}render(){return l`
      ...
      >
        ...
        <div slot="actions">
          ...
          <md-text-button
            ...
            @click=${async()=>{const e=await this.#a();e&&(this.dialog.close("apply"),this.resolve(e))}}
            >Save</md-text-button
          >
        </div>
      </md-dialog>
    `}};n([d({attribute:!1})],S.prototype,"apiService",null),n([d({type:Number})],S.prototype,"fileExplorerId",null),n([d({type:Number})],S.prototype,"parentFolderId",null),n([c()],S.prototype,"folderName",null),n([h("md-dialog")],S.prototype,"dialog",null),S=n([p("leavitt-add-folder-modal")],S);let z=class extends s{static{this.styles=[m,r`
      :host {
        display: flex;
    ...
    `}};z=n([p("leavitt-file-explorer-no-files")],z);let j=class extends s{static{this.styles=[m,r`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};j=n([p("leavitt-file-explorer-error")],j);let D=class extends s{static{this.styles=[m,r`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};D=n([p("leavitt-file-explorer-no-permission")],D);let M=class extends(i(s)){#e;get apiService(){return this.#e}set apiService(e){this.#e=e}#r=!1;get enableEditing(){return this.#r}set enableEditing(e){this.#r=e}#l="view";get state(){return this.#l}set state(e){this.#l=e}#n=null;get file(){return this.#n}set file(e){this.#n=e}#d=!1;get isCopying(){return this.#d}set isCopying(e){this.#d=e}#c=!1;get hasClipboard(){return this.#c}set hasClipboard(e){this.#c=e}#h;get fileName(){return this.#h}set fileName(e){this.#h=e}#o;get dialog(){return this.#o}set dialog(e){this.#o=e}firstUpdated(){I.subscribe("FileExplorerFileDto","Update",e=>{e.Id===this.file?.Id&&(this.file={...this.file,...e})}),navigator.clipboard&&(this.hasClipboard=!0)}async#p(){if(!this.apiService||this.fileName===this.file?.Name||!this.fileName)return;const e={Name:this.fileName};try{const t=this.apiService.patchAsync(`FileExplorerAttachments(${this.file?.Id})`,e);this.loadWhile(t),await t,I.dispatch("FileExplorerFileDto","Update",{...this.file,Name:this.fileName}),this.state="view"}catch(e){this.dispatchEvent(new a(e))}}async open(e){return this.file=e,this.state="view",await this.dialog.show()}static{this.styles=[u,f,m,g,x,y,r`
      :host {
        display: block;
      }
    ...
    `}};n([d({attribute:!1})],M.prototype,"apiService",null),n([d({type:Boolean})],M.prototype,"enableEditing",null),n([c()],M.prototype,"state",null),n([c()],M.prototype,"file",null),n([c()],M.prototype,"isCopying",null),n([c()],M.prototype,"hasClipboard",null),n([c()],M.prototype,"fileName",null),n([h("md-dialog")],M.prototype,"dialog",null),M=n([p("leavitt-file-modal")],M);let P=class extends(i(s)){#e;get apiService(){return this.#e}set apiService(e){this.#e=e}#r=!1;get enableEditing(){return this.#r}set enableEditing(e){this.#r=e}#l="view";get state(){return this.#l}set state(e){this.#l=e}#m=null;get folder(){return this.#m}set folder(e){this.#m=e}#s;get folderName(){return this.#s}set folderName(e){this.#s=e}#o;get dialog(){return this.#o}set dialog(e){this.#o=e}firstUpdated(){I.subscribe("FileExplorerFolder","Update",e=>{e.Id===this.folder?.Id&&(this.folder={...this.folder,...e})})}async#u(){if(!this.apiService||this.folderName===this.folder?.Name||!this.folderName)return;const e={Name:this.folderName};try{const t=this.apiService.patchAsync(`FileExplorerFolders(${this.folder?.Id})`,e);this.loadWhile(t),await t,I.dispatch("FileExplorerFolder","Update",{...this.folder,Name:this.folderName}),this.state="view"}catch(e){this.dispatchEvent(new a(e))}}open(e){this.folder=e,this.state="view",this.dialog.show()}static{this.styles=[u,f,m,g,x,y,r`
      :host {
        display: block;
      }
    ...
    `}};function U(e){return"pdf"===e||"txt"===e||"rtf"===e||"doc"===e||"docx"===e||"csv"===e?"article":"pptx"===e||"pptm"===e||"ppt"===e?"slideshow":"xlsx"===e||"xlsx"===e?"text_snippet":"jpg"===e||"jpeg"===e||"png"===e||"webp"===e||"ico"===e||"svg"===e?"photo":"mp4"===e?"movie":"article"}n([d({attribute:!1})],P.prototype,"apiService",null),n([d({type:Boolean})],P.prototype,"enableEditing",null),n([c()],P.prototype,"state",null),n([c()],P.prototype,"folder",null),n([c()],P.prototype,"folderName",null),n([h("md-dialog")],P.prototype,"dialog",null),P=n([p("leavitt-folder-modal")],P);let A=class extends s{#f;get attachment(){return this.#f}set attachment(e){this.#f=e}static{this.styles=r`
    :host {
      user-select: none;
      display: flex;
      justify-content: center;
  ...
  `}render(){return l`
    ...
    `}};function Y(e,t=2){if(0===e)return"0 Bytes";const i=t||2,s=Math.floor(Math.log(e)/Math.log(1024));return parseFloat((e/Math.pow(1024,s)).toFixed(i))+" "+["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"][s]}n([d({type:Object})],A.prototype,"attachment",null),A=n([p("leavitt-file-explorer-image")],A);let B=class extends s{#n;get file(){return this.#n}set file(e){this.#n=e}#g=!1;get selected(){return this.#g}set selected(e){this.#g=e}#x=0;get selectedCount(){return this.#x}set selectedCount(e){this.#x=e}#y="grid";get display(){return this.#y}set display(e){this.#y=e}static{this.styles=r`
    :host {
      display: grid;
    }
  ...
  `}render(){return l` <button
    ...
    >
      ...
      ${"list"===this.display?l`
            ...
            <span size>${Y(this.file.Size)}</span>
    ...
    </button>`}};n([d({type:Object})],B.prototype,"file",null),n([d({type:Boolean,reflect:!0})],B.prototype,"selected",null),n([d({type:Number,reflect:!0,attribute:"selected-count"})],B.prototype,"selectedCount",null),n([d({type:String,reflect:!0,attribute:"display"})],B.prototype,"display",null),B=n([p("file-list-item")],B);let L=class extends s{#m;get folder(){return this.#m}set folder(e){this.#m=e}#g=!1;get selected(){return this.#g}set selected(e){this.#g=e}#x=0;get selectedCount(){return this.#x}set selectedCount(e){this.#x=e}#y="grid";get display(){return this.#y}set display(e){this.#y=e}#v(e){return Math.abs(e)>999?Math.floor(Math.sign(e)*Math.round(Math.abs(e)/100)/10)+"k+":Math.sign(e)*Math.abs(e)}static{this.styles=r`
    :host {
      display: grid;
    }
...
${this.folder.FilesCount} file${1===this.folder.FilesCount?"":"s"}, ${this.folder.FoldersCount} folder${1===this.folder.FoldersCount?"":"s"}"
      ...
      <header>
        <aside ellipsis>
          ...
          <file-summary ?hidden=${!this.fileExplorer} ellipsis heading3
            >${this.fileExplorer?.FilesCount} files | ${this.fileExplorer?.FoldersCount} folders | ${Y(this.fileExplorer?.Size)}</file-summary
          >
        </aside>
        <md-icon-button
          ?disabled=${this.isLoading}
    ...
    `}};n([d({attribute:!1})],G.prototype,"apiService",null),n([d({type:Number,attribute:"file-explorer-id"})],G.prototype,"fileExplorerId",null),n([d({type:Number,attribute:"folder-id"})],G.prototype,"folderId",null),n([d({type:String,attribute:"local-storage-display-key"})],G.prototype,"localStorageDisplayKey",null),n([d({type:Boolean,reflect:!0,attribute:"prevent-navigation-up"})],G.prototype,"preventNavigationUp",null),n([d({type:String,reflect:!0,attribute:"display"})],G.prototype,"display",null),n([d({type:String})],G.prototype,"state",null),n([c()],G.prototype,"isAdmin",null),n([c()],G.prototype,"fileExplorer",null),n([c()],G.prototype,"files",null),n([c()],G.prototype,"folders",null),n([c()],G.prototype,"path",null),n([c()],G.prototype,"selected",null),n([h("md-menu[upload-menu]")],G.prototype,"uploadMenu",null),n([h("leavitt-folder-modal")],G.prototype,"folderDialog",null),n([h("leavitt-add-folder-modal")],G.prototype,"addFolderDialog",null),n([h("leavitt-file-modal")],G.prototype,"fileDialog",null),n([h("input[files]")],G.prototype,"fileInput",null),n([h("input[folders]")],G.prototype,"folderInput",null),n([h("titanium-confirm-dialog")],G.prototype,"confirmDialog",null),G=n([p("leavitt-file-explorer")],G);let H=class extends s{connectedCallback(){super.connectedCallback(),C.addHeader("X-LGAppName","FileExplorer")}disconnectedCallback(){super.disconnectedCallback(),"FileExplorer"===C.headers["X-LGAppName"]&&C.addHeader("X-LGAppName","Testing")}static{this.styles=[F]}render(){return l`
    ...
    `}};H=n([p("leavitt-file-explorer-demo")],H);export{H as LeavittFileExplorerDemo};
