import{i as t,b as a,c as e,_ as i,e as o,r as n,t as r}from"./C4zC-QpX.js";import{S as s}from"./BuWE4gAm.js";import"./iIryJ62l.js";import"./C5JZ_0-E.js";import"./DSRpAilH.js";import"./rr-Ivdw2.js";import"./CbTza51h.js";import"./luggfwZ_.js";import"./rrxT2ZHw.js";import"./hR9ebjVF.js";let l=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#a=25;get count(){return this.#a}set count(t){this.#a=t}#e;get data(){return this.#e}set data(t){this.#e=t}#i;get filteredData(){return this.#i}set filteredData(t){this.#i=t}firstUpdated(){this.data=Array(25).fill(null).map((t,a)=>({id:a+1,name:"Bob"})),this.#o()}#o(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[s,a`
