import{s as e,h as t,g as a,i as s,x as i,_ as r,r as o,n as l,e as n,t as c,a as d,p as h,m,o as p,q as u,u as g,T as b,v as f}from"./d0ace671.js";import{S as v}from"./9e8552c1.js";import"./41178c5b.js";import{D as y,C as w}from"./9555855c.js";import"./0a446d6b.js";import{c as x}from"./20123ed4.js";import"./05b95cb7.js";import{r as k}from"./a2e77e56.js";import"./8c1e3b6a.js";import"./ffc1a613.js";import"./70418000.js";import"./3e67aa42.js";import"./3d5c916a.js";import{r as $}from"./f42dd0a8.js";import{m as S,c as _,g as A}from"./c3dfe460.js";import{m as T,g as C,a as j}from"./22c1ed29.js";import"./6b2732d2.js";import{g as z}from"./975570c0.js";import{D as N}from"./b7c4d201.js";import"./ec341a4d.js";import"./725c256f.js";import"./ebc3e1dc.js";import"./1c72d69a.js";import"./62698f2c.js";import"./663a7052.js";import"./7577643e.js";import"./ec5758e0.js";import"./fb6bc6bd.js";import"./dc22cb98.js";let P=class extends e{#e;get header(){return this.#e}set header(e){this.#e=e}#t;get localStorageKey(){return this.#t}set localStorageKey(e){this.#t=e}#a=[10,15,20,50];get pageSizes(){return this.#a}set pageSizes(e){this.#a=e}#s=10;get defaultPageSize(){return this.#s}set defaultPageSize(e){this.#s=e}#i;get count(){return this.#i}set count(e){this.#i=e}#r=[];get items(){return this.#r}set items(e){this.#r=e}#o;get searchTerm(){return this.#o}set searchTerm(e){this.#o=e}#l;get singleSelect(){return this.#l}set singleSelect(e){this.#l=e}#n=!1;get disableSelect(){return this.#n}set disableSelect(e){this.#n=e}#c=!1;get disablePaging(){return this.#c}set disablePaging(e){this.#c=e}#d=[];get selected(){return this.#d}set selected(e){this.#d=e}#h;get itemsContainer(){return this.#h}set itemsContainer(e){this.#h=e}#m;get itemsSlot(){return this.#m}set itemsSlot(e){this.#m=e}#p=!1;get narrow(){return this.#p}set narrow(e){this.#p=e}#u;get hasDragItems(){return this.#u}set hasDragItems(e){this.#u=e}#g;get isLoading(){return this.#g}set isLoading(e){this.#g=e}#b;get tableHeaders(){return this.#b}set tableHeaders(e){this.#b=e}#f;get checkbox(){return this.#f}set checkbox(e){this.#f=e}#v;get pageControl(){return this.#v}set pageControl(e){this.#v=e}#y=0;async getTake(){return(await this.pageControl)?.take??0}async getPage(){return(await this.pageControl)?.page??0}async setTake(e){const t=await this.pageControl;t&&(t.take=e)}async setPage(e){const t=await this.pageControl;t&&(t.page=e)}async resetPage(){await this.setPage(0)}async firstUpdated(){if("function"==typeof ResizeObserver){new ResizeObserver((e=>{for(const t of e){const e=t.contentRect;this.narrow=e.width<560,this.updateChildrenIsNarrow()}})).observe(this)}else{const e=window.matchMedia("(max-width: 768px)");e.addEventListener("change",(e=>{this.narrow=e.matches,this.updateChildrenIsNarrow()})),this.narrow=e.matches,this.updateChildrenIsNarrow()}this.addEventListener(y.eventType,(e=>{e.stopPropagation();const t=Math.min(e.hoverIndex,this.items.length-1);if(t!==e.originIndex){const a=this.items[e.originIndex];this.items.splice(e.originIndex,1),this.items.splice(t,0,a),this.dispatchEvent(new D)}})),this.tableHeaders.addEventListener("slotchange",(()=>this.updateChildrenIsNarrow())),this.itemsSlot.addEventListener("slotchange",(()=>this.updateChildrenIsNarrow())),await((await this.pageControl)?.updateComplete)}updateChildrenIsNarrow(){this.hasDragItems=this.itemsSlot.assignedElements().some((e=>e.enableDrag)),this.itemsSlot.assignedElements().forEach((e=>e.narrow=this.narrow)),this.tableHeaders.assignedElements().forEach((e=>e.narrow=this.narrow))}clearSelection(){this.#w(),this.selected.length>0&&(this.selected=[],this.#x())}updated(e){e.has("items")&&e.get("items")!==this.items&&this.clearSelection()}#x(){this.dispatchEvent(new CustomEvent("selected-changed",{composed:!0,detail:this.selected}))}async loadWhile(e){this.isLoading=!0,this.#y++;try{await e}finally{this.#y--,0===this.#y&&(this.isLoading=!1)}}#w(){this.#k().forEach((e=>e.deselect()))}selectAll(){this.singleSelect||this.#k().forEach((e=>e.select()))}#k(){return this.itemsSlot.assignedElements().filter((e=>"function"==typeof e.select&&"function"==typeof e.deselect))}static{this.styles=[t,a,s`
      :host {
        display: flex;
    ...
    `]}render(){return i`
      ...
      <table-container
        @titanium-data-table-item-selected-changed=${e=>{e.stopPropagation();const t=e.target;t.selected?(this.singleSelect&&this.#k().filter((e=>e.item!==t.item)).forEach((e=>e.deselect())),this.selected.push(t.item),this.requestUpdate(),this.#x()):(this.selected.splice(this.selected.indexOf(t.item),1),this.requestUpdate(),this.#x())}}
      >
        <table-header part="table-header-container">
          ${this.disableSelect||this.singleSelect?"":i`
                <md-checkbox
                  ...
                  @click=${()=>{this.selected.length>0?this.#w():this.selectAll(),this.checkbox.focus()}}
                ></md-checkbox>
              `}
    ...
    `}};r([l({type:String})],P.prototype,"header",null),r([l({type:String})],P.prototype,"localStorageKey",null),r([l({type:Array})],P.prototype,"pageSizes",null),r([l({type:Number,attribute:"default-page-size"})],P.prototype,"defaultPageSize",null),r([l({type:Number})],P.prototype,"count",null),r([l({type:Array})],P.prototype,"items",null),r([l({type:String})],P.prototype,"searchTerm",null),r([l({type:Boolean,attribute:"single-select",reflect:!0})],P.prototype,"singleSelect",null),r([l({type:Boolean,attribute:"disable-select"})],P.prototype,"disableSelect",null),r([l({type:Boolean,attribute:"disable-paging",reflect:!0})],P.prototype,"disablePaging",null),r([l({type:Array})],P.prototype,"selected",null),r([n("div[items-slot]")],P.prototype,"itemsContainer",null),r([n('slot[name="items"]')],P.prototype,"itemsSlot",null),r([l({type:Boolean,reflect:!0,attribute:"narrow"})],P.prototype,"narrow",null),r([l({type:Boolean,attribute:"has-drag-items",reflect:!0})],P.prototype,"hasDragItems",null),r([o()],P.prototype,"isLoading",null),r([n('slot[name="table-headers"]')],P.prototype,"tableHeaders",null),r([n("md-checkbox")],P.prototype,"checkbox",null),r([k("titanium-page-control")],P.prototype,"pageControl",null),P=r([c("titanium-data-table")],P);class D extends Event{static{this.eventType="titanium-data-table-items-reorder"}constructor(){super(D.eventType)}}let B=class extends e{#$=[];get draggableItems(){return this.#$}set draggableItems(e){this.#$=e}firstUpdated(){this.draggableItems=[{Name:"Model 3",Appearance:"slick"},{Name:"Model X",Appearance:"slick"},{Name:"Model Y",Appearance:"slick"},{Name:"Model S",Appearance:"slick"},{Name:"Cybertruck",Appearance:"ugly"},{Name:"Tesla Semi",Appearance:"ugly"},{Name:"Model X Plaid",Appearance:"plaid"},{Name:"Model S Plaid",Appearance:"plaid"},{Name:"Model S Plaid+",Appearance:"plaid"},{Name:"Gen. 2 Roadster",Appearance:"slick"}]}static{this.styles=[t,d,h,s`
      :host {
        display: flex;
        flex-direction: column;
    ...
    `]}render(){return i`
      ...
      <div>
        <titanium-data-table
          ...
          @titanium-data-table-items-reorder=${async()=>{this.draggableItems=this.draggableItems,await this.requestUpdate("draggableItems")}}
        >
          ...
          ${x(this.draggableItems??[],(e=>e.Name),(e=>i`
    ...
    `}};r([o()],B.prototype,"draggableItems",null),B=r([c("draggable-playground")],B);const I=Symbol("dispatchHooks");const M=new WeakMap;const R=S(T(f(e)));class E extends R{constructor(){super(),this.selected=!1,this.icons=!1,this.showOnlySelectedIcon=!1,this.required=!1,this.value="on",this.addEventListener("click",(e=>{p(e)&&this.input&&(this.focus(),u(this.input))})),function(e,...t){let a=M.get(e);a||(a=new Set,M.set(e,a));for(const s of t){if(a.has(s))continue;let t=!1;e.addEventListener(s,(a=>{if(t)return;a.stopImmediatePropagation();const s=Reflect.construct(a.constructor,[a.type,a]),i=new EventTarget;s[I]=i,t=!0;const r=e.dispatchEvent(s);t=!1,r||a.preventDefault(),i.dispatchEvent(new Event("after"))}),{capture:!0}),a.add(s)}}(this,"keydown"),this.addEventListener("keydown",(e=>{!function(e,t){const a=e[I];if(!a)throw new Error(`'${e.type}' event needs setupDispatchHooks().`);a.addEventListener("after",t)}(e,(()=>{e.defaultPrevented||"Enter"!==e.key||this.disabled||!this.input||this.input.click()}))}))}render(){return i`
...
`;let U=class extends E{};U.styles=[O],U=r([c("md-switch")],U);class F{constructor(e,t,a=null){this.key=e,this.oDataFilter=t,this.value=a}getOdataFilter(){return null===this.value?null:this.oDataFilter(this.value)}}function L(e,t){if(e instanceof RegExp)return{keys:!1,pattern:e};var a,s,i,r,o=[],l="",n=e.split("/");for(n[0]||n.shift();i=n.shift();)"*"===(a=i[0])?(o.push(a),l+="?"===i[1]?"(?:/(.*))?":"/(.*)"):":"===a?(s=i.indexOf("?",1),r=i.indexOf(".",1),o.push(i.substring(1,~s?s:~r?r:i.length)),l+=~s&&!~r?"(?:/([^/]+?))?":"/([^/]+?)",~r&&(l+=(~s?"?":"")+"\\"+i.substring(r))):l+="/"+i;return{keys:o,pattern:new RegExp("^"+l+(t?"(?=$|/)":"/?$"),"i")}}class H{#S=new Map;#_=[];#A;get path(){return this.#A}set path(e){this.#A=e}subscribeToFilterChange(e){this.#_.push(e)}unsubscribeFromFilterChange(e){this.#_=this.#_.filter((t=>t!=e))}#T(){this.#_.forEach((e=>e()))}constructor(e){this.path=e;const t=history.pushState.bind(history);history.pushState=(...e)=>{t(...e);L(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()};const a=history.replaceState.bind(history);history.replaceState=(...e)=>{a(...e);L(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()}}loadFromQueryString(){const e=new URLSearchParams(location.search);let t=!1;return this.#S.forEach((a=>{let s=null;e.has(a.key)&&(s=e.get(a.key)),a.value!==s&&(a.value=s,t=!0)})),t&&this.#T(),t}get filters(){return Array.from(this.#S.values())}getActiveFilterOdata(){const e=[];return this.filters.forEach((t=>{const a=t.getOdataFilter();a&&e.push(a)})),e}setValue(e,t){if(this.#S.has(e)){const a=this.#S.get(e);a&&a?.value!==t&&(a.value=t,this.#C())}}getValue(e){if(!this.#S.has(e))return null;const t=this.#S.get(e);return t?.value}setFilter(e,t,a=null){this.#S.set(e,new F(e,t,a))}getFilter(e){return this.#S.get(e)}#j;#C(){clearTimeout(this.#j),this.#z(),this.#j=window.setTimeout((()=>{this.#T()}),50)}#z(){const e=new URLSearchParams(location.search);this.#S.forEach((t=>{void 0!==t.value&&null!==t.value?e.set(t.key,String(t.value)):e.has(t.key)&&e.delete(t.key)}));const t=`${location.pathname}?${e}`;window.history.replaceState({path:t},"",t)}}const G=[{Name:"Model 3",Appearance:"Slick"},{Name:"Model X",Appearance:"Slick"},{Name:"Model Y",Appearance:"Slick"},{Name:"Model S",Appearance:"Slick"},{Name:"Cybertruck",Appearance:"Ugly"},{Name:"Tesla Semi",Appearance:"Ugly"},{Name:"Model X Plaid",Appearance:"Plaid"},{Name:"Model S Plaid",Appearance:"Plaid"},{Name:"Model S Plaid+",Appearance:"Plaid"},{Name:"Gen. 2 Roadster",Appearance:"Slick"}];let K=class extends e{#N=[];get allItems(){return this.#N}set allItems(e){this.#N=e}#r=[];get items(){return this.#r}set items(e){this.#r=e}#d=[];get selected(){return this.#d}set selected(e){this.#d=e}#o="";get searchTerm(){return this.#o}set searchTerm(e){this.#o=e}#P=0;get resultTotal(){return this.#P}set resultTotal(e){this.#P=e}#D="asc";get sortDirection(){return this.#D}set sortDirection(e){this.#D=e}#B="Name";get sortBy(){return this.#B}set sortBy(e){this.#B=e}#I;get filterController(){return this.#I}set filterController(e){this.#I=e}#l=!1;get singleSelect(){return this.#l}set singleSelect(e){this.#l=e}#n=!1;get disableSelect(){return this.#n}set disableSelect(e){this.#n=e}#c=!1;get disablePaging(){return this.#c}set disablePaging(e){this.#c=e}#M;get dataTable(){return this.#M}set dataTable(e){this.#M=e}#R;get filterModal(){return this.#R}set filterModal(e){this.#R=e}constructor(){super(),this.filterController=new H("/titanium-data-table"),this.filterController.setFilter("Appearance",(e=>`BasketId eq ${e}`)),this.filterController.subscribeToFilterChange((async()=>{this.dataTable&&(this.dataTable?.resetPage(),this.#E())})),this.filterController.loadFromQueryString()}firstUpdated(){this.#O(),this.items=this.allItems.slice(0)}#E(){this.getItemsAsync(this.searchTerm)}#O(){this.allItems=G.map((e=>({Name:e.Name,Appearance:e.Appearance}))),this.#E()}#U(e){this.sortDirection=e.detail,this.dataTable.resetPage(),this.#E()}#F(e){this.sortBy=e.detail,this.dataTable.resetPage(),this.#E()}#L=new N((e=>this.getItemsAsync(e)));async getItemsAsync(e){const t=z(e),a=await this.dataTable.getTake(),s=await this.dataTable.getPage(),i="asc"===this.sortDirection?1:-1;let r=this.allItems.filter((e=>t.every((t=>e.Name?.trim().toLowerCase()?.includes(t.trim().toLowerCase())))));const o=this.filterController.getValue("Appearance");o&&(r=r.filter((e=>e.Appearance===o))),this.items=r.slice(0).sort(((e,t)=>e[this.sortBy]===t[this.sortBy]?0:(e[this.sortBy]??"")<(t[this.sortBy]??"")?i:-i)).slice(a*s,a*s+a),this.resultTotal=r.length}static{this.styles=[t,d,h,s`
    ...
    `]}render(){return i`
      ...
      >
        <titanium-search-input
          ...
          @input=${e=>{this.searchTerm=e.target.value,this.dataTable.resetPage(),this.#L.debounce(this.searchTerm)}}
        ></titanium-search-input>
      ...
      <md-icon-button
          ...
          >
            <md-menu-item headline="Reload list (reset)" .action=${()=>this.#O()}>
        ...
        @click=${()=>{const e=G[this.allItems.length%G.length],t={Name:e.Name,Appearance:e.Appearance};this.allItems.push(t),this.#E()}}>
        ...
        <md-icon-button
          ...
          @click=${()=>{this.allItems=this.allItems.filter((e=>!this.selected.includes(e))),this.resultTotal=this.resultTotal-this.selected.length,this.#E()}}
        >
        ...
        <titanium-data-table-header
          ...
          column-name="Name"
          title="Name"
          @sort-by-changed=${this.#F}
          .sortBy=${this.sortBy}
          .sortDirection=${this.sortDirection}
          @sort-direction-changed=${this.#U}
        ></titanium-data-table-header>
    ...
    `}};r([o()],K.prototype,"allItems",null),r([o()],K.prototype,"items",null),r([o()],K.prototype,"selected",null),r([o()],K.prototype,"searchTerm",null),r([o()],K.prototype,"resultTotal",null),r([o()],K.prototype,"sortDirection",null),r([o()],K.prototype,"sortBy",null),r([o()],K.prototype,"filterController",null),r([o()],K.prototype,"singleSelect",null),r([o()],K.prototype,"disableSelect",null),r([o()],K.prototype,"disablePaging",null),r([n("titanium-data-table")],K.prototype,"dataTable",null),r([n("data-table-demo-filter-modal")],K.prototype,"filterModal",null),K=r([c("titanium-data-table-full-playground")],K);let q=class extends e{#I;get filterController(){return this.#I}set filterController(e){this.#I=e}#H;get appearance(){return this.#H}set appearance(e){this.#H=e}#G;get dialog(){return this.#G}set dialog(e){this.#G=e}async firstUpdated(){this.filterController.subscribeToFilterChange((async()=>{this.requestUpdate("filterController")}))}async open(){this.dialog.show()}#K(){const e=this.dialog.shadowRoot?.querySelector("dialog"),t=e?.querySelector(".container"),a=t?.querySelector(".scroller");a&&(a.style.overflow="initial"),t&&(t.style.overflow="initial")}#q(){const e=this.dialog.shadowRoot?.querySelector("dialog"),t=e?.querySelector(".container"),a=t?.querySelector(".scroller");a&&(a.style.overflow=""),t&&(t.style.overflow="")}static{this.styles=[s`
      :host {
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    `}};r([o()],q.prototype,"filterController",null),r([o()],q.prototype,"appearance",null),r([n("md-dialog")],q.prototype,"dialog",null),q=r([c("data-table-demo-filter-modal")],q);let W=class extends e{static{this.styles=[v,s``]}render(){return i`
    ...
    `}};W=r([c("titanium-data-table-demo")],W);export{W as TitaniumDataTableDemo};
