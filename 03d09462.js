import{s as e,h as t,g as a,i as s,x as i,_ as r,r as o,n as l,e as n,t as c,a as d,p as h,m,o as p,q as u,u as g,T as b,v as f}from"./f43924bd.js";import{S as v}from"./1c8b19cb.js";import"./3286da59.js";import{D as y,C as w}from"./ed3946f5.js";import"./c15eb749.js";import{c as x}from"./35db0734.js";import"./f04cd7d4.js";import{r as k}from"./c0a7d937.js";import"./3d169087.js";import"./feb6c099.js";import"./9a8dc7e8.js";import"./7d2261f8.js";import"./3d226a42.js";import{r as $}from"./f42dd0a8.js";import{m as S,c as _,g as A}from"./27c9cb5c.js";import{m as C,g as T,a as j}from"./f7d1f7f2.js";import"./5bcb9e93.js";import{g as z}from"./975570c0.js";import{D as N}from"./b7c4d201.js";import"./68491de3.js";import"./d49dec57.js";import"./a1524b94.js";import"./d8fb47ea.js";import"./75986af6.js";import"./72abf9b4.js";import"./c47213b1.js";import"./08f0fa74.js";import"./ff84c309.js";import"./a0226597.js";let P=class extends e{#e;get header(){return this.#e}set header(e){this.#e=e}#t;get localStorageKey(){return this.#t}set localStorageKey(e){this.#t=e}#a=[10,15,20,50];get pageSizes(){return this.#a}set pageSizes(e){this.#a=e}#s=10;get defaultPageSize(){return this.#s}set defaultPageSize(e){this.#s=e}#i;get count(){return this.#i}set count(e){this.#i=e}#r=[];get items(){return this.#r}set items(e){this.#r=e}#o;get searchTerm(){return this.#o}set searchTerm(e){this.#o=e}#l;get singleSelect(){return this.#l}set singleSelect(e){this.#l=e}#n=!1;get disableSelect(){return this.#n}set disableSelect(e){this.#n=e}#c=!1;get disablePaging(){return this.#c}set disablePaging(e){this.#c=e}#d=[];get selected(){return this.#d}set selected(e){this.#d=e}#h;get itemsContainer(){return this.#h}set itemsContainer(e){this.#h=e}#m;get itemsSlot(){return this.#m}set itemsSlot(e){this.#m=e}#p=!1;get narrow(){return this.#p}set narrow(e){this.#p=e}#u;get hasDragItems(){return this.#u}set hasDragItems(e){this.#u=e}#g;get isLoading(){return this.#g}set isLoading(e){this.#g=e}#b;get tableHeaders(){return this.#b}set tableHeaders(e){this.#b=e}#f;get checkbox(){return this.#f}set checkbox(e){this.#f=e}#v;get pageControl(){return this.#v}set pageControl(e){this.#v=e}#y=0;async getTake(){return(await this.pageControl)?.take??0}async getPage(){return(await this.pageControl)?.page??0}async setTake(e){const t=await this.pageControl;t&&(t.take=e)}async setPage(e){const t=await this.pageControl;t&&(t.page=e)}async resetPage(){await this.setPage(0)}async firstUpdated(){if("function"==typeof ResizeObserver){new ResizeObserver((e=>{for(const t of e){const e=t.contentRect;this.narrow=e.width<560,this.updateChildrenIsNarrow()}})).observe(this)}else{const e=window.matchMedia("(max-width: 768px)");e.addEventListener("change",(e=>{this.narrow=e.matches,this.updateChildrenIsNarrow()})),this.narrow=e.matches,this.updateChildrenIsNarrow()}this.addEventListener(y.eventType,(e=>{e.stopPropagation();const t=Math.min(e.hoverIndex,this.items.length-1);if(t!==e.originIndex){const a=this.items[e.originIndex];this.items.splice(e.originIndex,1),this.items.splice(t,0,a),this.dispatchEvent(new D)}})),this.tableHeaders.addEventListener("slotchange",(()=>this.updateChildrenIsNarrow())),this.itemsSlot.addEventListener("slotchange",(()=>this.updateChildrenIsNarrow())),await((await this.pageControl)?.updateComplete)}updateChildrenIsNarrow(){this.hasDragItems=this.itemsSlot.assignedElements().some((e=>e.enableDrag)),this.itemsSlot.assignedElements().forEach((e=>e.narrow=this.narrow)),this.tableHeaders.assignedElements().forEach((e=>e.narrow=this.narrow))}clearSelection(){this.#w(),this.selected.length>0&&(this.selected=[],this.#x())}updated(e){e.has("items")&&e.get("items")!==this.items&&this.clearSelection()}#x(){this.dispatchEvent(new CustomEvent("selected-changed",{composed:!0,detail:this.selected}))}async loadWhile(e){this.isLoading=!0,this.#y++;try{await e}finally{this.#y--,0===this.#y&&(this.isLoading=!1)}}#w(){this.#k().forEach((e=>e.deselect()))}selectAll(){this.singleSelect||this.#k().forEach((e=>e.select()))}#k(){return this.itemsSlot.assignedElements().filter((e=>"function"==typeof e.select&&"function"==typeof e.deselect))}static{this.styles=[t,a,s`
    ...
    `}};r([o()],B.prototype,"draggableItems",null),B=r([c("draggable-playground")],B);const I=S(C(f(e)));class M extends I{constructor(){super(),this.selected=!1,this.icons=!1,this.showOnlySelectedIcon=!1,this.required=!1,this.value="on",this.addEventListener("click",(e=>{p(e)&&this.input&&(this.focus(),u(this.input))}))}render(){return i`
...
`;let O=class extends M{};O.styles=[R],O=r([c("md-switch")],O);class U{constructor(e,t,a=null){this.key=e,this.oDataFilter=t,this.value=a}getOdataFilter(){return null===this.value?null:this.oDataFilter(this.value)}}function F(e,t){if(e instanceof RegExp)return{keys:!1,pattern:e};var a,s,i,r,o=[],l="",n=e.split("/");for(n[0]||n.shift();i=n.shift();)"*"===(a=i[0])?(o.push(a),l+="?"===i[1]?"(?:/(.*))?":"/(.*)"):":"===a?(s=i.indexOf("?",1),r=i.indexOf(".",1),o.push(i.substring(1,~s?s:~r?r:i.length)),l+=~s&&!~r?"(?:/([^/]+?))?":"/([^/]+?)",~r&&(l+=(~s?"?":"")+"\\"+i.substring(r))):l+="/"+i;return{keys:o,pattern:new RegExp("^"+l+(t?"(?=$|/)":"/?$"),"i")}}class L{#S=new Map;#_=[];#A;get path(){return this.#A}set path(e){this.#A=e}subscribeToFilterChange(e){this.#_.push(e)}unsubscribeFromFilterChange(e){this.#_=this.#_.filter((t=>t!=e))}#C(){this.#_.forEach((e=>e()))}constructor(e){this.path=e;const t=history.pushState.bind(history);history.pushState=(...e)=>{t(...e);F(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()};const a=history.replaceState.bind(history);history.replaceState=(...e)=>{a(...e);F(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()}}loadFromQueryString(){const e=new URLSearchParams(location.search);let t=!1;return this.#S.forEach((a=>{let s=null;e.has(a.key)&&(s=e.get(a.key)),a.value!==s&&(a.value=s,t=!0)})),t&&this.#C(),t}get filters(){return Array.from(this.#S.values())}getActiveFilterOdata(){const e=[];return this.filters.forEach((t=>{const a=t.getOdataFilter();a&&e.push(a)})),e}setValue(e,t){if(this.#S.has(e)){const a=this.#S.get(e);a&&a?.value!==t&&(a.value=t,this.#T())}}getValue(e){if(!this.#S.has(e))return null;const t=this.#S.get(e);return t?.value}setFilter(e,t,a=null){this.#S.set(e,new U(e,t,a))}getFilter(e){return this.#S.get(e)}#j;#T(){clearTimeout(this.#j),this.#z(),this.#j=window.setTimeout((()=>{this.#C()}),50)}#z(){const e=new URLSearchParams(location.search);this.#S.forEach((t=>{void 0!==t.value&&null!==t.value?e.set(t.key,String(t.value)):e.has(t.key)&&e.delete(t.key)}));const t=`${location.pathname}?${e}`;window.history.replaceState({path:t},"",t)}}const E=[{Name:"Model 3",Appearance:"Slick"},{Name:"Model X",Appearance:"Slick"},{Name:"Model Y",Appearance:"Slick"},{Name:"Model S",Appearance:"Slick"},{Name:"Cybertruck",Appearance:"Ugly"},{Name:"Tesla Semi",Appearance:"Ugly"},{Name:"Model X Plaid",Appearance:"Plaid"},{Name:"Model S Plaid",Appearance:"Plaid"},{Name:"Model S Plaid+",Appearance:"Plaid"},{Name:"Gen. 2 Roadster",Appearance:"Slick"}];let H=class extends e{#N=[];get allItems(){return this.#N}set allItems(e){this.#N=e}#r=[];get items(){return this.#r}set items(e){this.#r=e}#d=[];get selected(){return this.#d}set selected(e){this.#d=e}#o="";get searchTerm(){return this.#o}set searchTerm(e){this.#o=e}#P=0;get resultTotal(){return this.#P}set resultTotal(e){this.#P=e}#D="asc";get sortDirection(){return this.#D}set sortDirection(e){this.#D=e}#B="Name";get sortBy(){return this.#B}set sortBy(e){this.#B=e}#I;get filterController(){return this.#I}set filterController(e){this.#I=e}#l=!1;get singleSelect(){return this.#l}set singleSelect(e){this.#l=e}#n=!1;get disableSelect(){return this.#n}set disableSelect(e){this.#n=e}#c=!1;get disablePaging(){return this.#c}set disablePaging(e){this.#c=e}#M;get dataTable(){return this.#M}set dataTable(e){this.#M=e}#R;get filterModal(){return this.#R}set filterModal(e){this.#R=e}constructor(){super(),this.filterController=new L("/titanium-data-table"),this.filterController.setFilter("Appearance",(e=>`BasketId eq ${e}`)),this.filterController.subscribeToFilterChange((async()=>{this.dataTable&&(this.dataTable?.resetPage(),this.#O())})),this.filterController.loadFromQueryString()}firstUpdated(){this.#U(),this.items=this.allItems.slice(0)}#O(){this.getItemsAsync(this.searchTerm)}#U(){this.allItems=E.map((e=>({Name:e.Name,Appearance:e.Appearance}))),this.#O()}#F(e){this.sortDirection=e.detail,this.dataTable.resetPage(),this.#O()}#L(e){this.sortBy=e.detail,this.dataTable.resetPage(),this.#O()}#E=new N((e=>this.getItemsAsync(e)));async getItemsAsync(e){const t=z(e),a=await this.dataTable.getTake(),s=await this.dataTable.getPage(),i="asc"===this.sortDirection?1:-1;let r=this.allItems.filter((e=>t.every((t=>e.Name?.trim().toLowerCase()?.includes(t.trim().toLowerCase())))));const o=this.filterController.getValue("Appearance");o&&(r=r.filter((e=>e.Appearance===o))),this.items=r.slice(0).sort(((e,t)=>e[this.sortBy]===t[this.sortBy]?0:(e[this.sortBy]??"")<(t[this.sortBy]??"")?i:-i)).slice(a*s,a*s+a),this.resultTotal=r.length}static{this.styles=[t,d,h,s`
    ...
    `]}render(){return i`
      ...
      >
        <titanium-search-input
          ...
          @input=${e=>{this.searchTerm=e.target.value,this.dataTable.resetPage(),this.#E.debounce(this.searchTerm)}}
        ></titanium-search-input>
      ...
      <md-icon-button
        ...
        @click=${()=>{const e=E[this.allItems.length%E.length],t={Name:e.Name,Appearance:e.Appearance};this.allItems.push(t),this.#O()}}>
    ...
    `}};r([o()],G.prototype,"filterController",null),r([o()],G.prototype,"appearance",null),r([n("md-dialog")],G.prototype,"dialog",null),G=r([c("data-table-demo-filter-modal")],G);let K=class extends e{static{this.styles=[v,s``]}render(){return i`
    ...
    `}};K=r([c("titanium-data-table-demo")],K);export{K as TitaniumDataTableDemo};
