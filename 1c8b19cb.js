import{Z as e,i as t,m as a,s as o,_ as r,n as i,x as s,u as n,T as l,t as c,h as d,p as h,r as p,e as v,A as m,Y as b,$ as u}from"./f43924bd.js";import"./68491de3.js";function g(t){return(a,o)=>{const{slot:r}=t??{},i="slot"+(r?`[name=${r}]`:":not([name])");return e(a,o,{get(){const e=this.renderRoot?.querySelector(i);return e?.assignedNodes(t)??[]}})}}const y=t`
  titanium-card {
    margin-bottom: 36px;
  }
...
`;class _ extends o{constructor(){super(...arguments),this.disabled=!1,this.alwaysFocusable=!1,this.label="",this.hasIcon=!1}get rippleDisabled(){return this.disabled}focus(e){this.disabled&&!this.alwaysFocusable||super.focus(e)}render(){return s`
      <div class="container ${n(this.getContainerClasses())}">
        ${this.renderContainerContent()}
      </div>
    `}updated(e){e.has("disabled")&&void 0!==e.get("disabled")&&this.dispatchEvent(new Event("update-focus",{bubbles:!0}))}getContainerClasses(){return{disabled:this.disabled,"has-icon":this.hasIcon}}renderContainerContent(){return s`
      ${this.renderOutline()}
    ...
    `}handleIconChange(e){const t=e.target;this.hasIcon=t.assignedElements({flatten:!0}).length>0}}a(_),_.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0},r([i({type:Boolean,reflect:!0})],_.prototype,"disabled",void 0),r([i({type:Boolean,attribute:"always-focusable"})],_.prototype,"alwaysFocusable",void 0),r([i()],_.prototype,"label",void 0),r([i({type:Boolean,reflect:!0,attribute:"has-icon"})],_.prototype,"hasIcon",void 0);class w extends _{constructor(){super(...arguments),this.elevated=!1,this.href="",this.target=""}get primaryId(){return this.href?"link":"button"}get rippleDisabled(){return!this.href&&this.disabled}getContainerClasses(){return{...super.getContainerClasses(),disabled:!this.href&&this.disabled,elevated:this.elevated,link:!!this.href}}renderPrimaryAction(e){const{ariaLabel:t}=this;return this.href?s`
        <a
...
`;let z=class extends ${};z.styles=[x,f,k],z=r([c("md-suggestion-chip")],z);let S=null;const T=async e=>{try{const t=await fetch(e,{method:"GET"}),a=await t.text();return a.length?JSON.parse(a):{}}catch(e){console.warn(e)}return null};let C=class extends o{#e;get name(){return this.#e}set name(e){this.#e=e}#t;get className(){return this.#t}set className(e){this.#t=e}#a;get deprecatedReason(){return this.#a}set deprecatedReason(e){this.#a=e}#o=null;get customElementDeclaration(){return this.#o}set customElementDeclaration(e){this.#o=e}#r=null;get customElementsJSON(){return this.#r}set customElementsJSON(e){this.#r=e}async updated(e){e.has("className")&&this.className&&(this.customElementsJSON=await(async()=>(Boolean(S)||(S=await T("/custom-elements.json")),S))(),this.customElementDeclaration=this.customElementsJSON?.modules.flatMap((e=>e.declarations)).find((e=>e.name===this.className))??null)}static{this.styles=[d,h,t`
    ...
    `}};r([i({type:String})],C.prototype,"name",null),r([i({type:String})],C.prototype,"className",null),r([i({type:String})],C.prototype,"deprecatedReason",null),r([p()],C.prototype,"customElementDeclaration",null),r([p()],C.prototype,"customElementsJSON",null),C=r([c("story-header")],C);const N=Symbol("isFocusable"),I=Symbol("privateIsFocusable"),E=Symbol("externalTabIndex"),B=Symbol("isUpdatingTabIndex"),j=Symbol("updateTabIndex");var F;const D=Symbol("indicator"),A=Symbol("animateIndicator"),O=function(e){var t,a,o;class s extends e{constructor(){super(...arguments),this[t]=!0,this[a]=null,this[o]=!1}get[N](){return this[I]}set[N](e){this[N]!==e&&(this[I]=e,this[j]())}connectedCallback(){super.connectedCallback(),this[j]()}attributeChangedCallback(e,t,a){if("tabindex"===e){if(this.requestUpdate("tabIndex",Number(t??-1)),!this[B])return this.hasAttribute("tabindex")?void(this[E]=this.tabIndex):(this[E]=null,void this[j]())}else super.attributeChangedCallback(e,t,a)}[(t=I,a=E,o=B,j)](){const e=this[N]?0:-1,t=this[E]??e;this[B]=!0,this.tabIndex=t,this[B]=!1}}return r([i({noAccessor:!0})],s.prototype,"tabIndex",void 0),s}(o);class R extends O{get selected(){return this.active}set selected(e){this.active=e}constructor(){super(),this.isTab=!0,this.active=!1,this.hasIcon=!1,this.iconOnly=!1,this.fullWidthIndicator=!1,this.internals=this.attachInternals(),this.internals.role="tab",this.addEventListener("keydown",this.handleKeydown.bind(this))}render(){const e=s`<div class="indicator"></div>`;return s`<div
      class="button"
      role="presentation"
...
`;let P=class extends G{};P.styles=[M],P=r([c("md-tabs")],P);let H=class extends o{#i="simple";get selectedTab(){return this.#i}set selectedTab(e){this.#i=e}#s;get projectSrc(){return this.#s}set projectSrc(e){this.#s=e}#n="index.html";get htmlFile(){return this.#n}set htmlFile(e){this.#n=e}#l;get lineNumbers(){return this.#l}set lineNumbers(e){this.#l=e}#c;get lineWrapping(){return this.#c}set lineWrapping(e){this.#c=e}updated(e){if(e.has("selectedTab")&&"playground"===this.selectedTab)try{import("./808609b6.js")}catch(e){this.dispatchEvent(new u(e))}}static{this.styles=[t`
    ...
    `}};r([i({type:String})],H.prototype,"selectedTab",null),r([i({type:String,attribute:"project-src"})],H.prototype,"projectSrc",null),r([i({type:String,attribute:"html-file"})],H.prototype,"htmlFile",null),r([i({type:Boolean,attribute:"line-numbers"})],H.prototype,"lineNumbers",null),r([i({type:Boolean,attribute:"line-wrapping"})],H.prototype,"lineWrapping",null),r([i({type:Boolean})],H.prototype,"resizable",void 0),H=r([c("smart-demo")],H);export{_ as C,y as S,g as n,x as s};
