import{ak as e,i as t,_ as a,n as o,al as r,k as i,D as s,am as n,t as l,h as c,a as d,p as h,r as p,e as v,a0 as m,R as b,an as u,ao as g}from"./CzHvl5jm.js";function y(t){return(a,o)=>{const{slot:r}=t??{},i="slot"+(r?`[name=${r}]`:":not([name])");return e(a,o,{get(){const e=this.renderRoot?.querySelector(i);return e?.assignedNodes(t)??[]}})}}const f=t`
  titanium-card {
    margin-bottom: 36px;
  }
...
`;class _ extends r{constructor(){super(...arguments),this.elevated=!1,this.href="",this.target=""}get primaryId(){return this.href?"link":"button"}get rippleDisabled(){return!this.href&&(this.disabled||this.softDisabled)}getContainerClasses(){return{...super.getContainerClasses(),disabled:!this.href&&(this.disabled||this.softDisabled),elevated:this.elevated,link:!!this.href}}renderPrimaryAction(e){const{ariaLabel:t}=this;return this.href?i`
        <a
...
`;let $=class extends w{};$.styles=[n,x,k],$=a([l("md-suggestion-chip")],$);let z=null;const S=async e=>{try{const t=await fetch(e,{method:"GET"}),a=await t.text();return a.length?JSON.parse(a):{}}catch(e){console.warn(e)}return null};let T=class extends c{#e;get name(){return this.#e}set name(e){this.#e=e}#t;get className(){return this.#t}set className(e){this.#t=e}#a;get deprecatedReason(){return this.#a}set deprecatedReason(e){this.#a=e}#o=null;get customElementDeclaration(){return this.#o}set customElementDeclaration(e){this.#o=e}#r=null;get customElementsJSON(){return this.#r}set customElementsJSON(e){this.#r=e}async updated(e){e.has("className")&&this.className&&(this.customElementsJSON=await(async()=>(z||(z=await S("/custom-elements.json")),z))(),this.customElementDeclaration=this.customElementsJSON?.modules.flatMap((e=>e.declarations)).find((e=>e.name===this.className))??null)}static{this.styles=[d,h,t`
    ...
    `]}render(){return i`
      ...
      <info-container>
        ...
        ${this.customElementDeclaration?.tagName?i`<p code>${"<"}${this.customElementDeclaration?.tagName}${">"}</p>`:""}
      </info-container>
      <p desc>${this.customElementDeclaration?.description}</p>
      <chip-container>
        ${this.deprecatedReason?i`<md-suggestion-chip disabled label="Deprecated (${this.deprecatedReason})"></md-suggestion-chip>`:s}
      </chip-container>
    `}};a([o({type:String})],T.prototype,"name",null),a([o({type:String})],T.prototype,"className",null),a([o({type:String})],T.prototype,"deprecatedReason",null),a([p()],T.prototype,"customElementDeclaration",null),a([p()],T.prototype,"customElementsJSON",null),T=a([l("story-header")],T);const C=Symbol("isFocusable"),N=Symbol("privateIsFocusable"),E=Symbol("externalTabIndex"),I=Symbol("isUpdatingTabIndex"),j=Symbol("updateTabIndex");var B;const F=Symbol("indicator"),R=Symbol("animateIndicator"),D=function(e){var t,r,i;class s extends e{constructor(){super(...arguments),this[t]=!0,this[r]=null,this[i]=!1}get[C](){return this[N]}set[C](e){this[C]!==e&&(this[N]=e,this[j]())}connectedCallback(){super.connectedCallback(),this[j]()}attributeChangedCallback(e,t,a){if("tabindex"===e){if(this.requestUpdate("tabIndex",Number(t??-1)),!this[I])return this.hasAttribute("tabindex")?void(this[E]=this.tabIndex):(this[E]=null,void this[j]())}else super.attributeChangedCallback(e,t,a)}[(t=N,r=E,i=I,j)](){const e=this[C]?0:-1,t=this[E]??e;this[I]=!0,this.tabIndex=t,this[I]=!1}}return a([o({noAccessor:!0})],s.prototype,"tabIndex",void 0),s}(c);class A extends D{get selected(){return this.active}set selected(e){this.active=e}constructor(){super(),this.isTab=!0,this.active=!1,this.hasIcon=!1,this.iconOnly=!1,this.fullWidthIndicator=!1,this.internals=this.attachInternals(),this.internals.role="tab",this.addEventListener("keydown",this.handleKeydown.bind(this))}render(){const e=i`<div class="indicator"></div>`;return i`<div
      class="button"
      role="presentation"
...
`;let G=class extends L{};G.styles=[M],G=a([l("md-tabs")],G);let H=class extends c{#i="simple";get selectedTab(){return this.#i}set selectedTab(e){this.#i=e}#s;get projectSrc(){return this.#s}set projectSrc(e){this.#s=e}#n="index.html";get htmlFile(){return this.#n}set htmlFile(e){this.#n=e}#l;get lineNumbers(){return this.#l}set lineNumbers(e){this.#l=e}#c;get lineWrapping(){return this.#c}set lineWrapping(e){this.#c=e}updated(e){if(e.has("selectedTab")&&"playground"===this.selectedTab)try{import("./DnTmHi9K.js")}catch(e){this.dispatchEvent(new g(e))}}static{this.styles=[t`
    ...
    `]}render(){return i`
      ...
      ${"playground"===this.selectedTab?i` <playground-ide
          ...
          >
          </playground-ide>`:i`<main><slot></slot></main>`}
    `}};a([o({type:String})],H.prototype,"selectedTab",null),a([o({type:String,attribute:"project-src"})],H.prototype,"projectSrc",null),a([o({type:String,attribute:"html-file"})],H.prototype,"htmlFile",null),a([o({type:Boolean,attribute:"line-numbers"})],H.prototype,"lineNumbers",null),a([o({type:Boolean,attribute:"line-wrapping"})],H.prototype,"lineWrapping",null),a([o({type:Boolean})],H.prototype,"resizable",void 0),H=a([l("smart-demo")],H);export{f as S,y as n};
