...
${this.folder.FilesCount} file${1===this.folder.FilesCount?"":"s"}, ${this.folder.FoldersCount} folder${1===this.folder.FoldersCount?"":"s"}"
    ...
    `}};n([c()],W.prototype,"fileExplorerApiService",void 0),W=n([p("leavitt-file-explorer-playground")],W);let X=class extends s{#G=null;get refreshToken(){return this.#G}set refreshToken(e){this.#G=e}static{this.styles=[N,a``]}async firstUpdated(){const e=C();await(e?.authenticate()),this.refreshToken=e?.refreshToken??null}render(){return l`
    ...
    `}};n([c()],X.prototype,"refreshToken",null),X=n([p("leavitt-file-explorer-demo")],X);export{X as LeavittUserFileExplorerDemo};
