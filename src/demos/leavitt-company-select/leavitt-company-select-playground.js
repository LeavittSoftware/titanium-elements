...
/* playground-fold */
let LeavittPersonCompanySelectPlayground = class LeavittPersonCompanySelectPlayground extends ThemePreference(LitElement) {
...
__decorate([
    state()
], LeavittPersonCompanySelectPlayground.prototype, "disableMenuOpenOnFocus", null);
__decorate([
