...
/* playground-fold */
let TitaniumDataTableItemPlayground = class TitaniumDataTableItemPlayground extends LitElement {
    #selectItem_accessor_storage;
    get selectItem() { return this.#selectItem_accessor_storage; }
    set selectItem(value) { this.#selectItem_accessor_storage = value; }
    static { this.styles = [
        h1,
        p,
        css `
...
__decorate([
    query('titanium-data-table-item[select-demo]')
], TitaniumDataTableItemPlayground.prototype, "selectItem", null);
TitaniumDataTableItemPlayground = __decorate([
    customElement('titanium-data-table-item-playground')
], TitaniumDataTableItemPlayground);
export { TitaniumDataTableItemPlayground };
//# sourceMappingURL=titanium-data-table-item-playground.js.map