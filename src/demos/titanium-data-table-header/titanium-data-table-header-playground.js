...
/* playground-fold */
let TitaniumDataTableHeaderPlayground = class TitaniumDataTableHeaderPlayground extends LitElement {
    static { this.styles = [
        h1,
        p,
        css `
...
TitaniumDataTableHeaderPlayground = __decorate([
    customElement('titanium-data-table-header-playground')
], TitaniumDataTableHeaderPlayground);
export { TitaniumDataTableHeaderPlayground };
//# sourceMappingURL=titanium-data-table-header-playground.js.map