...
__decorate([
    state()
], TitaniumDataTableCoreDemo.prototype, "sort", null);
__decorate([
    state()
], TitaniumDataTableCoreDemo.prototype, "items", null);
__decorate([
    state()
], TitaniumDataTableCoreDemo.prototype, "selected", null);
__decorate([
    query('titanium-data-table-core')
], TitaniumDataTableCoreDemo.prototype, "tableCore", null);
__decorate([
    state()
], TitaniumDataTableCoreDemo.prototype, "tableMetaData", null);
