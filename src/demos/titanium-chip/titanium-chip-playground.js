...
/* playground-fold */
let TitaniumChipPlayground = class TitaniumChipPlayground extends LitElement {
    static { this.styles = [
        h1,
        p,
        css `
...
TitaniumChipPlayground = __decorate([
    customElement('titanium-chip-playground')
], TitaniumChipPlayground);
export { TitaniumChipPlayground };
//# sourceMappingURL=titanium-chip-playground.js.map