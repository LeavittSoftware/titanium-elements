...
/* playground-fold */
let TitaniumDateInputItemPlayground = class TitaniumDateInputItemPlayground extends LitElement {
    ...
    render() {
      ...
      <titanium-card has-footer has-menu>
        ...
        <main card-body>
          <titanium-date-input demo1 label="Start date" @change=${(e) => (this.value = e.target.value)}></titanium-date-input>
        </main>
...
__decorate([
    query('titanium-date-input[demo1]')
], TitaniumDateInputItemPlayground.prototype, "input", null);
__decorate([
    state()
], TitaniumDateInputItemPlayground.prototype, "value", null);
TitaniumDateInputItemPlayground = __decorate([
    customElement('titanium-date-input-playground')
], TitaniumDateInputItemPlayground);
export { TitaniumDateInputItemPlayground };
//# sourceMappingURL=titanium-date-input-playground.js.map