...
/* playground-fold */
let TitaniumStylesPlayground = class TitaniumStylesPlayground extends LitElement {
    static { this.styles = [
        dataRow,
        a,
        ellipsis,
...
TitaniumStylesPlayground = __decorate([
    customElement('titanium-styles-playground')
], TitaniumStylesPlayground);
export { TitaniumStylesPlayground };
//# sourceMappingURL=titanium-styles-playground.js.map