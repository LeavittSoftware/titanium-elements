...
/* playground-fold */
let TitaniumColorInputPlayground = class TitaniumColorInputPlayground extends LitElement {
    #verticalStepValue_accessor_storage = 10;
    get verticalStepValue() { return this.#verticalStepValue_accessor_storage; }
    set verticalStepValue(value) { this.#verticalStepValue_accessor_storage = value; }
    #horizontalStepValue_accessor_storage = 3;
    get horizontalStepValue() { return this.#horizontalStepValue_accessor_storage; }
    set horizontalStepValue(value) { this.#horizontalStepValue_accessor_storage = value; }
    #collapsed_accessor_storage;
    ...
    render() {
      ...
      <div main>
        ...
        <titanium-show-hide collapse-height="200">
          ${new Array(this.verticalStepValue).fill(0).map((_, idx) => html `<credit-card>
      ...
      <div main>
        ...
        <titanium-show-hide horizontal collapse-height="200">
          ${new Array(this.horizontalStepValue).fill(0).map((_, idx) => html `<credit-card>
                <h3>Credit Card ${idx + 1}</h3>
                <p>CARD NUMBER</p>
                <card-number>${this.#getCardNumber()}</card-number>
                <mark-gold>
...
__decorate([
    query('titanium-show-hide[required]')
], TitaniumColorInputPlayground.prototype, "requiredInput", void 0);
__decorate([
    state()
], TitaniumColorInputPlayground.prototype, "verticalStepValue", null);
__decorate([
    state()
], TitaniumColorInputPlayground.prototype, "horizontalStepValue", null);
__decorate([
    state()
], TitaniumColorInputPlayground.prototype, "collapsed", null);
TitaniumColorInputPlayground = __decorate([
    customElement('titanium-show-hide-playground')
], TitaniumColorInputPlayground);
export { TitaniumColorInputPlayground };
//# sourceMappingURL=titanium-show-hide-playground.js.map