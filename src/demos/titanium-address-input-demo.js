...
__decorate([
    state()
], TitaniumAddressInputDemo.prototype, "setLocationResult", null);
__decorate([
    query('google-address-input[demo-a]')
], TitaniumAddressInputDemo.prototype, "googleAddressInputDemoA", null);
__decorate([
    query('google-address-input[demo-a-filled]')
], TitaniumAddressInputDemo.prototype, "googleAddressInputDemoAFilled", null);
__decorate([
    query('titanium-address-input[demo-a]')
], TitaniumAddressInputDemo.prototype, "titaniumAddressInputDemoA", null);
__decorate([
    query('titanium-address-input[demo-a-filled]')
], TitaniumAddressInputDemo.prototype, "titaniumAddressInputDemoAFilled", null);
__decorate([
    state()
], TitaniumAddressInputDemo.prototype, "allowInternational", null);
