...
/* playground-fold */
let TitaniumFullPageLoadingIndicatorPlayground = class TitaniumFullPageLoadingIndicatorPlayground extends LitElement {
    static { this.styles = [
        h1,
        p,
        css `
...
TitaniumFullPageLoadingIndicatorPlayground = __decorate([
    customElement('titanium-full-page-loading-indicator-playground')
], TitaniumFullPageLoadingIndicatorPlayground);
export { TitaniumFullPageLoadingIndicatorPlayground };
//# sourceMappingURL=titanium-full-page-loading-indicator-playground.js.map