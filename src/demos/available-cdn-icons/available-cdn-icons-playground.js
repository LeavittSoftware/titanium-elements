...
/* playground-fold-end */
/* playground-fold */
let AvailableCdnIconsPlayground = class AvailableCdnIconsPlayground extends LitElement {
    constructor() {
        super(...arguments);
        this.icons = [
...
AvailableCdnIconsPlayground = __decorate([
    customElement('available-cdn-icons-playground')
], AvailableCdnIconsPlayground);
export { AvailableCdnIconsPlayground };
//# sourceMappingURL=available-cdn-icons-playground.js.map