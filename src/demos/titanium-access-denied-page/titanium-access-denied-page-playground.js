...
/* playground-fold */
let TitaniumAccessDeniedPlayground = class TitaniumAccessDeniedPlayground extends LitElement {
    static { this.styles = [
        h1,
        p,
        css `
...
TitaniumAccessDeniedPlayground = __decorate([
    customElement('titanium-access-denied-page-playground')
], TitaniumAccessDeniedPlayground);
export { TitaniumAccessDeniedPlayground };
//# sourceMappingURL=titanium-access-denied-page-playground.js.map