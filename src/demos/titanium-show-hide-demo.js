          ...
          <leavitt-app-width-limiter max-width="1000px">
            ...
            <div>
              ...
              <titanium-show-hide collapse-height="200">
                ${new Array(this.verticalStepValue).fill(0).map(() => html `<credit-card>
                      <card-chip></card-chip>
            ...
            <div>
              ...
              <titanium-show-hide horizontal collapse-height="200">
                ${new Array(this.horizontalStepValue).fill(0).map(() => html `<credit-card>
                      <card-chip></card-chip>
                      <h2>${this.#getCardNumber()}</h2>
...
], TitaniumShowHideDemo.prototype, "requiredInput", void 0);
__decorate([
    state()
], TitaniumShowHideDemo.prototype, "verticalStepValue", null);
__decorate([
    state()
], TitaniumShowHideDemo.prototype, "horizontalStepValue", null);
__decorate([
    state()
], TitaniumShowHideDemo.prototype, "collapsed", null);
