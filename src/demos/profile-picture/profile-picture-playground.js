...
/* playground-fold */
let ProfilePicturePlayground = class ProfilePicturePlayground extends LitElement {
    static { this.styles = [
        h1,
        p,
        css `
...
ProfilePicturePlayground = __decorate([
    customElement('profile-picture-playground')
], ProfilePicturePlayground);
export { ProfilePicturePlayground };
//# sourceMappingURL=profile-picture-playground.js.map