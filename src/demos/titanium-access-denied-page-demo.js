...
let TitaniumAccessDeniedPageDemo = class TitaniumAccessDeniedPageDemo extends LitElement {
...
TitaniumAccessDeniedPageDemo = __decorate([
    customElement('titanium-access-denied-page-demo')
], TitaniumAccessDeniedPageDemo);
export { TitaniumAccessDeniedPageDemo };
