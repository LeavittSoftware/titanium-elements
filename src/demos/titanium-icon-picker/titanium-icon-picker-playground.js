...
/* playground-fold */
let TitaniumIconPickerPlayground = class TitaniumIconPickerPlayground extends LitElement {
...
], TitaniumIconPickerPlayground.prototype, "requiredInput", null);
TitaniumIconPickerPlayground = __decorate([
    customElement('titanium-icon-picker-playground')
], TitaniumIconPickerPlayground);
export { TitaniumIconPickerPlayground };
//# sourceMappingURL=titanium-icon-picker-playground.js.map