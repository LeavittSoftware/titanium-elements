...
/* playground-fold */
let TitaniumToolbarPlayground = class TitaniumToolbarPlayground extends LitElement {
    static { this.styles = [
        h1,
        p,
        css `
...
TitaniumToolbarPlayground = __decorate([
    customElement('titanium-toolbar-playground')
], TitaniumToolbarPlayground);
export { TitaniumToolbarPlayground };
//# sourceMappingURL=titanium-toolbar-playground.js.map