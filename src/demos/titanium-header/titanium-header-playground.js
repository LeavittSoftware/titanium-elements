...
/* playground-fold */
let TitaniumHeaderItemPlayground = class TitaniumHeaderItemPlayground extends LitElement {
    static { this.styles = [
        h1,
        p,
        css `
...
TitaniumHeaderItemPlayground = __decorate([
    customElement('titanium-header-playground')
], TitaniumHeaderItemPlayground);
export { TitaniumHeaderItemPlayground };
//# sourceMappingURL=titanium-header-playground.js.map