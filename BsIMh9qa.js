import{_ as e,n as t,t as s,x as r,S as l,i as a,A as i,d as o,h as n,p,c,r as u,f as h,e as d,G as m,E as v}from"./CvsNJZqv.js";import{S as g}from"./DfX2k1C4.js";import"./BzpbO9w3.js";import{T as f}from"./bcFGQsJ0.js";import{F as S}from"./CkDJilkW.js";import{g as y}from"./OXmljVLM.js";import{D as x}from"./DJeBBfF0.js";import"./DZWGtWMy.js";import"./8ukpyWqT.js";let b=class extends f{#e="Person";get label(){return this.#e}set label(e){this.#e=e}#t="Search for a person";get placeholder(){return this.#t}set placeholder(e){this.#t=e}#s="People";get apiControllerName(){return this.#s}set apiControllerName(e){this.#s=e}#r="FullName";get pathToSelectedText(){return this.#r}set pathToSelectedText(e){this.#r=e}#l;get apiService(){return this.#l}set apiService(e){this.#l=e}#a=["top=15","orderby=FullName","select=FullName,CompanyName,Id,ProfilePictureCdnFileName","count=true"];get odataParts(){return this.#a}set odataParts(e){this.#a=e}#i=!1;get enablePeoplePreloading(){return this.#i}set enablePeoplePreloading(e){this.#i=e}#o="remote";get searchType(){return this.#o}set searchType(e){this.#o=e}#n=[];get people(){return this.#n}set people(e){this.#n=e}#p="off";get autocomplete(){return this.#p}set autocomplete(e){this.#p=e}#c=!1;get spellcheck(){return this.#c}set spellcheck(e){this.#c=e}#u="off";get autocorrect(){return this.#u}set autocorrect(e){this.#u=e}#h=e=>r`<md-menu-item .item=${e}>
