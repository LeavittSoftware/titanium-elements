import{i as t,b as a,c as e,_ as i,e as o,r as n,t as r}from"./CugzL8O4.js";import{S as s}from"./PFD5O6KE.js";import"./D6-fjwB4.js";import"./DZk7JlF4.js";import"./DqxFhOmA.js";import"./BNqbUPuv.js";import"./B-t9u6L7.js";import"./CrETY9CP.js";import"./DFxrepZr.js";import"./C6telT-W.js";let l=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#a=25;get count(){return this.#a}set count(t){this.#a=t}#e;get data(){return this.#e}set data(t){this.#e=t}#i;get filteredData(){return this.#i}set filteredData(t){this.#i=t}firstUpdated(){this.data=Array(25).fill(null).map((t,a)=>({id:a+1,name:"Bob"})),this.#o()}#o(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[s,a`
