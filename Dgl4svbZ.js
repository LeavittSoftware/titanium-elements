import{i as t,g as e,b as i,c as o,A as s,_ as a,n,u as r,t as l,U as c,p as d,r as h,h as p}from"./CdKAnjTr.js";import{h as m}from"./nKzCDYkW.js";let g=class extends t{constructor(){super(...arguments),this.#t="",this.#e=!1,this.href="",this.download="",this.target="",this.#i=!1,this.#o=!1,this.#s="close",this.#a=!1,this.#n=!1,this.#r=!1}#t;get label(){return this.#t}set label(t){this.#t=t}#e;get selected(){return this.#e}set selected(t){this.#e=t}#i;get inputChip(){return this.#i}set inputChip(t){this.#i=t}#o;get nonInteractive(){return this.#o}set nonInteractive(t){this.#o=t}#s;get inputChipRemoveIcon(){return this.#s}set inputChipRemoveIcon(t){this.#s=t}#a;get disabled(){return this.#a}set disabled(t){this.#a=t}#n;get hasLeadingItems(){return this.#n}set hasLeadingItems(t){this.#n=t}#r;get hasTrailingItems(){return this.#r}set hasTrailingItems(t){this.#r=t}static{this.styles=[e,i`
      :host {
        display: grid;
        height: 32px;
        width: auto;
