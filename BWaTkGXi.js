import{i as t,h as e,k as s,c as i,x as a,_ as o,n as r,e as n,r as l,t as h}from"./CjNQuVkO.js";import"./CkQSKr6p.js";import{D as d}from"./DV5Bk8uf.js";import{r as c}from"./CNvBKIG6.js";let g=class extends t{#t;get header(){return this.#t}set header(t){this.#t=t}#e;get localStorageKey(){return this.#e}set localStorageKey(t){this.#e=t}#s=[10,15,20,50];get pageSizes(){return this.#s}set pageSizes(t){this.#s=t}#i=10;get defaultPageSize(){return this.#i}set defaultPageSize(t){this.#i=t}#a;get count(){return this.#a}set count(t){this.#a=t}#o=[];get items(){return this.#o}set items(t){this.#o=t}#r;get searchTerm(){return this.#r}set searchTerm(t){this.#r=t}#n;get singleSelect(){return this.#n}set singleSelect(t){this.#n=t}#l=!1;get disableSelect(){return this.#l}set disableSelect(t){this.#l=t}#h=!1;get disablePaging(){return this.#h}set disablePaging(t){this.#h=t}#d=[];get selected(){return this.#d}set selected(t){this.#d=t}#c;get itemsContainer(){return this.#c}set itemsContainer(t){this.#c=t}#g;get itemsSlot(){return this.#g}set itemsSlot(t){this.#g=t}#p=!1;get narrow(){return this.#p}set narrow(t){this.#p=t}#u;get hasDragItems(){return this.#u}set hasDragItems(t){this.#u=t}#m=560;get narrowMaxWidth(){return this.#m}set narrowMaxWidth(t){this.#m=t}#f;get isLoading(){return this.#f}set isLoading(t){this.#f=t}#b;get tableHeaders(){return this.#b}set tableHeaders(t){this.#b=t}#x;get checkbox(){return this.#x}set checkbox(t){this.#x=t}#y;get pageControl(){return this.#y}set pageControl(t){this.#y=t}#w=0;async getTake(){return(await this.pageControl)?.take??0}async getPage(){return(await this.pageControl)?.page??0}async setTake(t){const e=await this.pageControl;e&&(e.take=t)}async setPage(t){const e=await this.pageControl;e&&(e.page=t)}async resetPage(){await this.setPage(0)}async firstUpdated(){if("function"==typeof ResizeObserver){new ResizeObserver(t=>{for(const e of t){const t=e.contentRect;this.narrow=t.width<this.narrowMaxWidth,this.updateChildrenIsNarrow()}}).observe(this)}else{const t=window.matchMedia("(max-width: 768px)");t.addEventListener("change",t=>{this.narrow=t.matches,this.updateChildrenIsNarrow()}),this.narrow=t.matches,this.updateChildrenIsNarrow()}this.addEventListener(d.eventType,t=>{t.stopPropagation();const e=Math.min(t.hoverIndex,this.items.length-1);if(e!==t.originIndex){const s=this.items[t.originIndex];this.items.splice(t.originIndex,1),this.items.splice(e,0,s),this.dispatchEvent(new p)}}),this.tableHeaders.addEventListener("slotchange",()=>this.updateChildrenIsNarrow()),this.itemsSlot.addEventListener("slotchange",()=>this.updateChildrenIsNarrow()),await((await this.pageControl)?.updateComplete)}updateChildrenIsNarrow(){this.hasDragItems=this.itemsSlot.assignedElements().some(t=>t.enableDrag),this.itemsSlot.assignedElements().forEach(t=>t.narrow=this.narrow),this.tableHeaders.assignedElements().forEach(t=>t.narrow=this.narrow)}clearSelection(){this.#v(),this.selected.length>0&&(this.selected=[],this.#_())}updated(t){t.has("items")&&t.get("items")!==this.items&&this.clearSelection()}#_(){this.dispatchEvent(new CustomEvent("selected-changed",{composed:!0,detail:this.selected}))}async loadWhile(t){this.isLoading=!0,this.#w++;try{await t}finally{this.#w--,0===this.#w&&(this.isLoading=!1)}}#v(){this.#S().forEach(t=>t.deselect())}selectAll(){this.singleSelect||this.#S().forEach(t=>t.select())}#S(){return this.itemsSlot.assignedElements().filter(t=>"function"==typeof t.select&&"function"==typeof t.deselect)}static{this.styles=[e,s,i`
    ...
    `}};o([r({type:String})],g.prototype,"header",null),o([r({type:String,attribute:"local-storage-key"})],g.prototype,"localStorageKey",null),o([r({type:Array})],g.prototype,"pageSizes",null),o([r({type:Number,attribute:"default-page-size"})],g.prototype,"defaultPageSize",null),o([r({type:Number})],g.prototype,"count",null),o([r({type:Array})],g.prototype,"items",null),o([r({type:String})],g.prototype,"searchTerm",null),o([r({type:Boolean,attribute:"single-select",reflect:!0})],g.prototype,"singleSelect",null),o([r({type:Boolean,attribute:"disable-select"})],g.prototype,"disableSelect",null),o([r({type:Boolean,attribute:"disable-paging",reflect:!0})],g.prototype,"disablePaging",null),o([r({type:Array})],g.prototype,"selected",null),o([n("div[items-slot]")],g.prototype,"itemsContainer",null),o([n('slot[name="items"]')],g.prototype,"itemsSlot",null),o([r({type:Boolean,reflect:!0,attribute:"narrow"})],g.prototype,"narrow",null),o([r({type:Boolean,attribute:"has-drag-items",reflect:!0})],g.prototype,"hasDragItems",null),o([r({type:Number,attribute:"narrow-max-width",reflect:!0})],g.prototype,"narrowMaxWidth",null),o([l()],g.prototype,"isLoading",null),o([n('slot[name="table-headers"]')],g.prototype,"tableHeaders",null),o([n("md-checkbox")],g.prototype,"checkbox",null),o([c("titanium-page-control")],g.prototype,"pageControl",null),g=o([h("titanium-data-table")],g);class p extends Event{static{this.eventType="titanium-data-table-items-reorder"}constructor(){super(p.eventType)}}class u{constructor(t,e,s=null){this.key=t,this.oDataFilter=e,this.value=s}getOdataFilter(){return null===this.value?null:this.oDataFilter(this.value)}}function m(t,e){if(t instanceof RegExp)return{keys:!1,pattern:t};var s,i,a,o,r=[],n="",l=t.split("/");for(l[0]||l.shift();a=l.shift();)"*"===(s=a[0])?(r.push(s),n+="?"===a[1]?"(?:/(.*))?":"/(.*)"):":"===s?(i=a.indexOf("?",1),o=a.indexOf(".",1),r.push(a.substring(1,~i?i:~o?o:a.length)),n+=~i&&!~o?"(?:/([^/]+?))?":"/([^/]+?)",~o&&(n+=(~i?"?":"")+"\\"+a.substring(o))):n+="/"+a;return{keys:r,pattern:new RegExp("^"+n+"/?$","i")}}class f{#$=new Map;#k=[];#z;get path(){return this.#z}set path(t){this.#z=t}subscribeToFilterChange(t){this.#k.push(t)}unsubscribeFromFilterChange(t){this.#k=this.#k.filter(e=>e!=t)}#C(){this.#k.forEach(t=>t())}constructor(t){this.path=t;const e=history.pushState.bind(history);history.pushState=(...t)=>{e(...t);m(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()};const s=history.replaceState.bind(history);history.replaceState=(...t)=>{s(...t);m(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()}}loadFromQueryString(){const t=new URLSearchParams(location.search);let e=!1;return this.#$.forEach(s=>{let i=null;t.has(s.key)&&(i=t.get(s.key)),s.value!==i&&(s.value=i,e=!0)}),e&&this.#C(),e}get filters(){return Array.from(this.#$.values())}getActiveFilterOdata(){const t=[];return this.filters.forEach(e=>{const s=e.getOdataFilter();s&&t.push(s)}),t}setValue(t,e){if(this.#$.has(t)){const s=this.#$.get(t);s&&s?.value!==e&&(s.value=e,this.#P())}}getValue(t){if(!this.#$.has(t))return null;const e=this.#$.get(t);return e?.value}setFilter(t,e,s=null){this.#$.set(t,new u(t,e,s))}getFilter(t){return this.#$.get(t)}#R;#P(){clearTimeout(this.#R),this.#T(),this.#R=window.setTimeout(()=>{this.#C()},50)}#T(){const t=new URLSearchParams(location.search);this.#$.forEach(e=>{void 0!==e.value&&null!==e.value?t.set(e.key,String(e.value)):t.has(e.key)&&t.delete(e.key)});const e=`${location.pathname}?${t}`;window.history.replaceState({path:e},"",e)}}export{f as F};
