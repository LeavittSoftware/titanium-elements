import{an as e,c as t,_ as a,n as o,ao as r,E as i,x as s,ap as n,t as l,i as c,h as d,p as h,r as p,e as v,H as m,a2 as b,aq as u,ar as g}from"./BF9KQ0mY.js";function y(t){return(a,o)=>{const{slot:r}=t??{},i="slot"+(r?`[name=${r}]`:":not([name])");return e(a,o,{get(){const e=this.renderRoot?.querySelector(i);return e?.assignedNodes(t)??[]}})}}const f=t`
  titanium-card {
    margin-bottom: 36px;
  }
...
`;let H=class extends W{};H.styles=[K],H=a([l("md-tabs")],H);let L=class extends c{#i="simple";get selectedTab(){return this.#i}set selectedTab(e){this.#i=e}#s;get projectSrc(){return this.#s}set projectSrc(e){this.#s=e}#n="index.html";get htmlFile(){return this.#n}set htmlFile(e){this.#n=e}#l;get lineNumbers(){return this.#l}set lineNumbers(e){this.#l=e}#c;get lineWrapping(){return this.#c}set lineWrapping(e){this.#c=e}updated(e){if(e.has("selectedTab")&&"playground"===this.selectedTab)try{import("./Ds3dcie1.js")}catch(e){this.dispatchEvent(new g(e))}}static{this.styles=[t`
    ...
    `}};a([o({type:String})],L.prototype,"selectedTab",null),a([o({type:String,attribute:"project-src"})],L.prototype,"projectSrc",null),a([o({type:String,attribute:"html-file"})],L.prototype,"htmlFile",null),a([o({type:Boolean,attribute:"line-numbers"})],L.prototype,"lineNumbers",null),a([o({type:Boolean,attribute:"line-wrapping"})],L.prototype,"lineWrapping",null),a([o({type:Boolean})],L.prototype,"resizable",void 0),L=a([l("smart-demo")],L);export{f as S,y as n};
