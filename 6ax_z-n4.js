import{i as t,h as e,p as a,c as o,x as i,_ as r,e as s,r as n,t as l}from"./n3tPIZAC.js";import{S as d}from"./DQCHeoLC.js";import"./B7yeTNAx.js";import"./BlZ8wxKD.js";import"./hYw4CDUQ.js";import"./DE1TVVdI.js";import"./Cg6MaDKV.js";let c=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#e=25;get count(){return this.#e}set count(t){this.#e=t}#a;get data(){return this.#a}set data(t){this.#a=t}#o;get filteredData(){return this.#o}set filteredData(t){this.#o=t}firstUpdated(){this.data=Array(25).fill(null).map(((t,e)=>({id:e+1,name:"Bob"}))),this.#i()}#i(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[e,a,o`
      :host {
        display: flex;
