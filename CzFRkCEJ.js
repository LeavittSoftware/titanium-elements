import{L as t,i as e,S as i,c as s,u as a,v as r,w as o,x as l,_ as n,n as h,r as c,e as d,t as m,y as p,E as u,z as g,T as v,B as $,P as y,D as b,k as w,b as f,A as _,d as x,h as D,p as S,G as T}from"./CIAkX42C.js";import{S as j}from"./DzDchJdO.js";import"./kwKBK7yw.js";import{F as A}from"./BeJYr180.js";import"./BiKJFh5Q.js";import"./C5_S1wiF.js";import"./Chs2jgC4.js";import"./Cue-M8d2.js";import{D as R,r as L}from"./D3RqY4El.js";import"./BQTebtbQ.js";import"./C2o_TUlG.js";import"./D8R5CWm5.js";import{d as E}from"./fEBq_QNq.js";import{D as k}from"./DTS7lhmZ.js";import{g as I}from"./OXmljVLM.js";import{T as C}from"./CgF5pHc7.js";import"./C51IRS0_.js";import"./BNsj_PA4.js";import"./B_U6Ee6X.js";import"./Du-zMnDM.js";import"./DpTDlxJu.js";import"./DZ2b-WFt.js";import"./BlDMeqLw.js";import"./DPFAq9c7.js";import"./BD_eJWVt.js";import"./ARW3F0re.js";let B=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#i;get filterController(){return this.#i}set filterController(t){this.#i=t}#s=[];get template(){return this.#s}set template(t){this.#s=t}#a;get templateId(){return this.#a}set templateId(t){this.#a=t}#r=!0;#o;get startDate(){return this.#o}set startDate(t){this.#o=t}#l;get endDate(){return this.#l}set endDate(t){this.#l=t}#n;get dialog(){return this.#n}set dialog(t){this.#n=t}#h;get dateRangeSelect(){return this.#h}set dateRangeSelect(t){this.#h=t}async firstUpdated(){this.filterController.subscribeToFilterChange(async()=>{this.#c(),this.requestUpdate("filterController")})}async updated(t){this.isActive&&t.has("isActive")&&this.#c()}async#c(){this.filterController.getValue("template")&&this.#r&&(this.template=await this.#d())}async#d(){if(!this.apiService)return console.warn("No api service provided"),[];const t=["select=Id,Name,IsExpired","orderby=Name"];try{const e=this.apiService.getAsync(`EmailTemplates?${t.join("&")}`);this.loadWhile(e);const i=(await e).toList();return this.#r=!1,i}catch(t){this.dispatchEvent(new i(t))}return[]}async open(){this.#r&&(this.template=await this.#d()),this.templateId=this.filterController.getValue("template")??"";const t=this.filterController.getValue("dateRange");this.startDate=("custom"===t?this.filterController.getValue("startDate"):R.get(t)?.startDate())||"",this.endDate=("custom"===t?this.filterController.getValue("endDate"):R.get(t)?.endDate())||"",this.dialog.show()}static{this.styles=[s`
    ...
    `}};n([h({type:Boolean})],B.prototype,"isActive",null),n([h({type:Object})],B.prototype,"apiService",null),n([c()],B.prototype,"filterController",null),n([c()],B.prototype,"template",null),n([c()],B.prototype,"templateId",null),n([c()],B.prototype,"startDate",null),n([c()],B.prototype,"endDate",null),n([d("md-dialog")],B.prototype,"dialog",null),n([d("titanium-date-range-selector")],B.prototype,"dateRangeSelect",null),B=n([m("leavitt-email-history-view-list-filter-dialog")],B);class M extends p{constructor(t){if(super(t),this.it=u,t.type!==g.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===u||null==t)return this._t=void 0,this.it=t;if(t===v)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}M.directiveName="unsafeHTML",M.resultType=1;const N=$(M);let Y=class extends(t(e)){#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#m;get emailTemplateLogId(){return this.#m}set emailTemplateLogId(t){this.#m=t}#p;get emailTemplateLog(){return this.#p}set emailTemplateLog(t){this.#p=t}#n;get dialog(){return this.#n}set dialog(t){this.#n=t}#u;async open(t){if(this.emailTemplateLogId=t,this.emailTemplateLog=null,await this.updateComplete,this.emailTemplateLog=await this.#g(t),this.emailTemplateLog)return this.dialog.returnValue="",this.dialog.show(),await new Promise(t=>{this.#u=t})}async#g(t){if(!this.apiService)return console.warn("No api service provided"),null;const e=[];try{const i=this.apiService.getAsync(`EmailTemplateLogs(${t})?${e.join("&")}`);this.loadWhile(i),this.dispatchEvent(new y(i));const s=await i;return s?.entity}catch(t){this.dispatchEvent(new i(t))}return null}static{this.styles=[s`
      md-dialog {
        max-width: 750px;
        width: calc(100vw - 24px);
    ...
    `}};n([h({type:Boolean})],H.prototype,"isActive",null),n([h({type:Object})],H.prototype,"apiService",null),n([h({type:String})],H.prototype,"path",null),n([c()],H.prototype,"logs",null),n([c()],H.prototype,"selected",null),n([c()],H.prototype,"searchTerm",null),n([c()],H.prototype,"resultTotal",null),n([c()],H.prototype,"sortDirection",null),n([c()],H.prototype,"sortBy",null),n([c()],H.prototype,"filterController",null),n([d("titanium-data-table")],H.prototype,"dataTable",null),n([d("leavitt-view-sent-email-dialog")],H.prototype,"viewDialog",null),n([d("leavitt-email-history-view-list-filter-dialog")],H.prototype,"filterModal",null),H=n([m("leavitt-email-history-viewer")],H);let z=class extends(C(e)){#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#k;get demo1(){return this.#k}set demo1(t){this.#k=t}constructor(){super(),this.apiService=new _(new x),this.apiService.baseUrl="https://devapi3.leavitt.com/",this.apiService.addHeader("X-LGAppName","EducationAdminV2")}static{this.styles=[D,S,s`
      :host {
        display: flex;
    ...
    `}};n([c()],z.prototype,"apiService",null),n([d("leavitt-email-history-viewer")],z.prototype,"demo1",null),z=n([m("leavitt-email-history-viewer-playground")],z);let U=class extends e{#I=null;get refreshToken(){return this.#I}set refreshToken(t){this.#I=t}static{this.styles=[j,s``]}async firstUpdated(){const t=await T();await t.authenticateAsync(),this.refreshToken=window.localStorage.getItem("LG-AUTH-RT")}render(){return l`
