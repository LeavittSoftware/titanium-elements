import{i as t,b as i,c as e,_ as a,e as n,t as d}from"./CyOMU7b-.js";import{S as l}from"./DayneWRO.js";import"./D528NSl_.js";import"./jB0Bcmk4.js";import"./Dh23RUMo.js";let u=class extends t{#t;get input(){return this.#t}set input(t){this.#t=t}#i;get secondInput(){return this.#i}set secondInput(t){this.#i=t}static{this.styles=[l,i`
            ...
            <div>
              ...
              <section buttons>
                <md-filled-tonal-button
                  @click=${()=>{this.input.reset(),this.secondInput.reset()}}
                  >Reset</md-filled-tonal-button
                >
                <md-filled-tonal-button
                  @click=${()=>{this.input.reportValidity(),this.secondInput.reportValidity()}}
    ...
    `}};a([n("titanium-date-input[required]")],u.prototype,"input",null),a([n("titanium-date-input:nth-of-type(2)")],u.prototype,"secondInput",null),u=a([d("titanium-date-input-demo")],u);export{u as TitaniumDateInputDemo};
