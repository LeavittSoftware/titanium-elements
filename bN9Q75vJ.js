import{i as t,b as i,C as e,c as l,_ as s,r as a,e as n,t as c}from"./k6PMp29N.js";import{S as o}from"./DwVP1OXS.js";import"./T802Qb7b.js";import"./BrxQwxGL.js";const m=["Dog","Cat","Lion","Hedgehog","Turtle","Monkey","Owl","Peacock","Pigeon","Spider","Tortoise","Zebra"];let d=class extends t{#t=m.slice(0,4);get demoItems(){return this.#t}set demoItems(t){this.#t=t}#i=!1;get disabled(){return this.#i}set disabled(t){this.#i=t}#e="Service animals are welcome.";get supportingText(){return this.#e}set supportingText(t){this.#e=t}#l;get titaniumChipMultiSelect(){return this.#l}set titaniumChipMultiSelect(t){this.#l=t}#s;get titaniumChipMultiSelectFilled(){return this.#s}set titaniumChipMultiSelectFilled(t){this.#s=t}static{this.styles=[o,i`
