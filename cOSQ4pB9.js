import{am as e,c as t,_ as a,n as o,an as r,E as i,x as s,ao as n,t as l,i as c,h as d,p as h,r as p,e as v,a2 as m,Q as b,ap as u,aq as g}from"./-Qu_smub.js";function y(t){return(a,o)=>{const{slot:r}=t??{},i="slot"+(r?`[name=${r}]`:":not([name])");return e(a,o,{get(){const e=this.renderRoot?.querySelector(i);return e?.assignedNodes(t)??[]}})}}const f=t`
  titanium-card {
    margin-bottom: 36px;
  }
