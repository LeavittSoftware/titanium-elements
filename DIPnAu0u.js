import{i as t,b as a,c as e,_ as i,e as o,r as n,t as r}from"./k6PMp29N.js";import{S as s}from"./DwVP1OXS.js";import"./T802Qb7b.js";import"./BrxQwxGL.js";import"./0WC1A8iQ.js";import"./nx_75N1R.js";import"./B29II57E.js";import"./0UAzWemI.js";import"./BBVO9RaT.js";import"./BQwNHKn-.js";let l=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#a=25;get count(){return this.#a}set count(t){this.#a=t}#e;get data(){return this.#e}set data(t){this.#e=t}#i;get filteredData(){return this.#i}set filteredData(t){this.#i=t}firstUpdated(){this.data=Array(25).fill(null).map((t,a)=>({id:a+1,name:"Bob"})),this.#o()}#o(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[s,a`
