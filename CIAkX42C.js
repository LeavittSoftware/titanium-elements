...
`;let Mi=class extends Ei{getRenderClasses(){return{...super.getRenderClasses(),standard:!0}}};Mi.styles=[Ii,Pi],Mi=r([ut("md-icon-button")],Mi);let Oi=class extends ht{constructor(){super(...arguments),this.#yt=40,this.#m=0,this.#u="",this.#d="",this.#zt="",this.positioning="popover"}#yt;get size(){return this.#yt}set size(t){this.#yt=t}#p;get profilePictureFileName(){return this.#p}set profilePictureFileName(t){this.#p=t}#m;get personId(){return this.#m}set personId(t){this.#m=t}#u;get email(){return this.#u}set email(t){this.#u=t}#d;get company(){return this.#d}set company(t){this.#d=t}#zt;get name(){return this.#zt}set name(t){this.#zt=t}#At;get menu(){return this.#At}set menu(t){this.#At=t}firstUpdated(){Rt().addEventListener(Mt.eventName,()=>this.setUserProps()),this.setUserProps()}setUserProps(){this.personId=Rt().personId,this.profilePictureFileName=Rt().profilePictureFileName,this.email=Rt().email,this.company=Rt().company,this.name=Rt().fullname}updated(t){t.has("size")&&t.get("size")!==this.size&&(this.style.width=this.size+"px",this.style.height=this.size+"px"),t.has("positioning")&&"popover"===this.positioning&&!this.showPopover&&(this.positioning="fixed")}static{this.styles=d`
  ...
  `}render(){return V`
    ...
    `}};r([vt({type:Number})],Oi.prototype,"size",null),r([vt({type:String})],Oi.prototype,"profilePictureFileName",null),r([vt({type:Number})],Oi.prototype,"personId",null),r([vt({type:String})],Oi.prototype,"email",null),r([vt({type:String})],Oi.prototype,"company",null),r([vt({type:String})],Oi.prototype,"name",null),r([yt("md-menu")],Oi.prototype,"menu",null),r([vt()],Oi.prototype,"positioning",void 0),Oi=r([ut("profile-picture-menu")],Oi);class Ri extends ht{constructor(){super(...arguments),this.inset=!1,this.insetStart=!1,this.insetEnd=!1}}r([vt({type:Boolean,reflect:!0})],Ri.prototype,"inset",void 0),r([vt({type:Boolean,reflect:!0,attribute:"inset-start"})],Ri.prototype,"insetStart",void 0),r([vt({type:Boolean,reflect:!0,attribute:"inset-end"})],Ri.prototype,"insetEnd",void 0);const Bi=d`:host{box-sizing:border-box;color:var(--md-divider-color, var(--md-sys-color-outline-variant, #cac4d0));display:flex;height:var(--md-divider-thickness, 1px);width:100%}:host([inset]),:host([inset-start]){padding-inline-start:16px}:host([inset]),:host([inset-end]){padding-inline-end:16px}:host::before{background:currentColor;content:"";height:100%;width:100%}@media(forced-colors: active){:host::before{background:CanvasText}}
...
`;let Or=class extends Pr{};Or.styles=[Yi,Mr],Or=r([ut("md-filled-field")],Or);let Rr=class extends Or{constructor(){super(...arguments),this.populated=!0}#St;get evaluator(){return this.#St}set evaluator(t){this.#St=t}firstUpdated(){this.addEventListener("focusin",()=>this.focused=!0),this.addEventListener("focusout",()=>this.focused=!1)}reset(){this.error=!1}reportValidity(){const t=this.checkValidity();return this.error=!t,t}checkValidity(){return!!this.evaluator()}};r([vt({type:Boolean})],Rr.prototype,"populated",void 0),r([vt({type:Object})],Rr.prototype,"evaluator",null),Rr=r([ut("titanium-filled-input-validator")],Rr);let Br=class extends ht{#Tt=!1;get filled(){return this.#Tt}set filled(t){this.#Tt=t}#Ct;get label(){return this.#Ct}set label(t){this.#Ct=t}#Et="No items";get noItemsText(){return this.#Et}set noItemsText(t){this.#Et=t}#It=!1;get required(){return this.#It}set required(t){this.#It=t}#Pt;get hasItems(){return this.#Pt}set hasItems(t){this.#Pt=t}#Mt;get supportingText(){return this.#Mt}set supportingText(t){this.#Mt=t}#Ot;get error(){return this.#Ot}set error(t){this.#Ot=t}#Rt;get errorText(){return this.#Rt}set errorText(t){this.#Rt=t}#Bt;get resizable(){return this.#Bt}set resizable(t){this.#Bt=t}#Nt;get disabled(){return this.#Nt}set disabled(t){this.#Nt=t}#jt;get validator(){return this.#jt}set validator(t){this.#jt=t}updated(t){(t.get("hasItems")&&t.has("hasItems")||this.hasItems&&t.has("hasItems"))&&this.reportValidity()}checkValidity(){return this.validator?.checkValidity()}reportValidity(){return this.validator?.reportValidity()}reset(){this.validator?.reset()}static{this.styles=[d`
    ...
    `}};r([vt({type:Boolean,attribute:"filled"})],Br.prototype,"filled",null),r([vt({type:String})],Br.prototype,"label",null),r([vt({type:String})],Br.prototype,"noItemsText",null),r([vt({type:Boolean})],Br.prototype,"required",null),r([vt({type:Boolean})],Br.prototype,"hasItems",null),r([vt({type:String})],Br.prototype,"supportingText",null),r([vt({type:Boolean})],Br.prototype,"error",null),r([vt({type:String})],Br.prototype,"errorText",null),r([vt({type:Boolean})],Br.prototype,"resizable",null),r([vt({type:Boolean,reflect:!0})],Br.prototype,"disabled",null),r([yt("titanium-outlined-input-validator, titanium-filled-input-validator")],Br.prototype,"validator",null),Br=r([ut("titanium-chip-multi-select")],Br);const Nr="undefined"!=typeof window&&void 0!==window.document,jr=Nr?window:{},Lr=!!Nr&&"ontouchstart"in jr.document.documentElement,Ur=!!Nr&&"PointerEvent"in jr,Fr="cropper",Dr=`${Fr}-canvas`,Gr=`${Fr}-crosshair`,qr=`${Fr}-grid`,Hr=`${Fr}-handle`,Vr=`${Fr}-image`,Wr=`${Fr}-selection`,Xr=`${Fr}-shade`,Yr=`${Fr}-viewer`,Jr="select",Kr="move",Qr="scale",Zr="rotate",to="transform",eo="none",io="n-resize",ro="e-resize",oo="s-resize",so="w-resize",ao="ne-resize",no="nw-resize",lo="se-resize",co="sw-resize",ho=Ur?"pointerdown":Lr?"touchstart":"mousedown",po=Ur?"pointermove":Lr?"touchmove":"mousemove",uo=Ur?"pointerup pointercancel":Lr?"touchend touchcancel":"mouseup",mo="error",fo="keydown",vo="load",go="wheel",bo="action",yo="actionend",xo="actionstart",wo="change",_o="transform";const ko=Number.isNaN||jr.isNaN;function $o(t){return"number"==typeof t&&!ko(t)}function zo(t){return $o(t)&&t>0&&t<1/0}function Ao(t){return"object"==typeof t&&null!==t}const{hasOwnProperty:So}=Object.prototype;function To(t){if(!Ao(t))return!1;try{const{constructor:e}=t,{prototype:i}=e;return e&&i&&So.call(i,"isPrototypeOf")}catch(t){return!1}}function Co(t){return"function"==typeof t}function Eo(t){return"object"==typeof t&&null!==t&&1===t.nodeType}const Io=/([a-z\d])([A-Z])/g;function Po(t){return String(t).replace(Io,"$1-$2").toLowerCase()}const Mo=/-[A-z\d]/g;function Oo(t){return t.replace(Mo,t=>t.slice(1).toUpperCase())}const Ro=/\s\s*/;function Bo(t,e,i,r){e.trim().split(Ro).forEach(e=>{t.removeEventListener(e,i,r)})}function No(t,e,i,r){e.trim().split(Ro).forEach(e=>{t.addEventListener(e,i,r)})}function jo(t,e,i,r){No(t,e,i,Object.assign(Object.assign({},r),{once:!0}))}const Lo={bubbles:!0,cancelable:!0,composed:!0};const Uo=Promise.resolve();function Fo(t){const{documentElement:e}=t.ownerDocument,i=t.getBoundingClientRect();return{left:i.left+(jr.pageXOffset-e.clientLeft),top:i.top+(jr.pageYOffset-e.clientTop)}}const Do=/deg|g?rad|turn$/i;function Go(t){const e=parseFloat(t)||0;if(0!==e){const[i="rad"]=String(t).match(Do)||[];switch(i.toLowerCase()){case"deg":return e/360*(2*Math.PI);case"grad":return e/400*(2*Math.PI);case"turn":return e*(2*Math.PI)}}return e}const qo="contain";function Ho(t,e=qo){const{aspectRatio:i}=t;let{width:r,height:o}=t;const s=zo(r),a=zo(o);if(s&&a){const t=o*i;e===qo&&t>r||"cover"===e&&t<r?o=r/i:r=o*i}else s?o=r/i:a&&(r=o*i);return{width:r,height:o}}function Vo(t,...e){if(0===e.length)return t;const[i,r,o,s,a,n]=t,[l,c,d,h,p,u]=e[0];return Vo(t=[i*l+o*c,r*l+s*c,i*d+o*h,r*d+s*h,i*p+o*u+a,r*p+s*u+n],...e.slice(1))}const Wo=/left|top|width|height/i,Xo="open",Yo=new WeakMap,Jo=new WeakMap,Ko=new Map,Qo=jr.document&&Array.isArray(jr.document.adoptedStyleSheets)&&"replaceSync"in jr.CSSStyleSheet.prototype;class Zo extends HTMLElement{get $sharedStyle(){return(this.themeColor?`:host{--theme-color: ${this.themeColor};}`:"")+":host([hidden]){display:none!important}"}constructor(){var t,e;super(),this.shadowRootMode=Xo,this.slottable=!0;const i=null===(e=null===(t=Object.getPrototypeOf(this))||void 0===t?void 0:t.constructor)||void 0===e?void 0:e.$name;i&&Ko.set(i,this.tagName.toLowerCase())}static get observedAttributes(){return["shadow-root-mode","slottable","theme-color"]}attributeChangedCallback(t,e,i){if(Object.is(i,e))return;const r=Oo(t);let o=i;switch(typeof this[r]){case"boolean":o=null!==i&&"false"!==i;break;case"number":o=Number(i)}switch(this[r]=o,t){case"theme-color":{const t=Jo.get(this),e=this.$sharedStyle;t&&e&&(Qo?t.replaceSync(e):t.textContent=e);break}}}$propertyChangedCallback(t,e,i){if(!Object.is(i,e))switch(t=Po(t),typeof i){case"boolean":!0===i?this.hasAttribute(t)||this.setAttribute(t,""):this.removeAttribute(t);break;case"number":i=ko(i)?"":String(i);default:i?this.getAttribute(t)!==i&&this.setAttribute(t,i):this.removeAttribute(t)}}connectedCallback(){Object.getPrototypeOf(this).constructor.observedAttributes.forEach(t=>{const e=Oo(t);let i=this[e];(function(t){return void 0===t})(i)||this.$propertyChangedCallback(e,void 0,i),Object.defineProperty(this,e,{enumerable:!0,configurable:!0,get:()=>i,set(t){const r=i;i=t,this.$propertyChangedCallback(e,r,t)}})});const t=this.attachShadow({mode:this.shadowRootMode||Xo});if(this.shadowRoot||Yo.set(this,t),Jo.set(this,this.$addStyles(this.$sharedStyle)),this.$style&&this.$addStyles(this.$style),this.$template){const e=document.createElement("template");e.innerHTML=this.$template,t.appendChild(e.content)}if(this.slottable){const e=document.createElement("slot");t.appendChild(e)}}disconnectedCallback(){Jo.has(this)&&Jo.delete(this),Yo.has(this)&&Yo.delete(this)}$getTagNameOf(t){var e;return null!==(e=Ko.get(t))&&void 0!==e?e:t}$setStyles(t){return Object.keys(t).forEach(e=>{let i=t[e];$o(i)&&(i=0!==i&&Wo.test(e)?`${i}px`:String(i)),this.style[e]=i}),this}$getShadowRoot(){return this.shadowRoot||Yo.get(this)}$addStyles(t){let e;const i=this.$getShadowRoot();return Qo?(e=new CSSStyleSheet,e.replaceSync(t),i.adoptedStyleSheets=i.adoptedStyleSheets.concat(e)):(e=document.createElement("style"),e.textContent=t,i.appendChild(e)),e}$emit(t,e,i){return function(t,e,i,r){return t.dispatchEvent(new CustomEvent(e,Object.assign(Object.assign(Object.assign({},Lo),{detail:i}),r)))}(this,t,e,i)}$nextTick(t){return function(t,e){return e?Uo.then(t?e.bind(t):e):Uo}(this,t)}static $define(t,e){Ao(t)&&(e=t,t=""),t||(t=this.$name||this.name),t=Po(t),Nr&&jr.customElements&&!jr.customElements.get(t)&&customElements.define(t,this,e)}}Zo.$version="2.0.0";class ts extends Zo{constructor(){super(...arguments),this.$onPointerDown=null,this.$onPointerMove=null,this.$onPointerUp=null,this.$onWheel=null,this.$wheeling=!1,this.$pointers=new Map,this.$style=':host{display:block;min-height:100px;min-width:200px;overflow:hidden;position:relative;touch-action:none;-webkit-touch-callout:none;-webkit-user-select:none;-moz-user-select:none;user-select:none}:host([background]){background-color:#fff;background-image:repeating-linear-gradient(45deg,#ccc 25%,transparent 0,transparent 75%,#ccc 0,#ccc),repeating-linear-gradient(45deg,#ccc 25%,transparent 0,transparent 75%,#ccc 0,#ccc);background-image:repeating-conic-gradient(#ccc 0 25%,#fff 0 50%);background-position:0 0,.5rem .5rem;background-size:1rem 1rem}:host([disabled]){pointer-events:none}:host([disabled]):after{bottom:0;content:"";cursor:not-allowed;display:block;left:0;pointer-events:none;position:absolute;right:0;top:0}',this.$action=eo,this.background=!1,this.disabled=!1,this.scaleStep=.1,this.themeColor="#39f"}static get observedAttributes(){return super.observedAttributes.concat(["background","disabled","scale-step"])}connectedCallback(){super.connectedCallback(),this.disabled||this.$bind()}disconnectedCallback(){this.disabled||this.$unbind(),super.disconnectedCallback()}$propertyChangedCallback(t,e,i){if(!Object.is(i,e)&&(super.$propertyChangedCallback(t,e,i),"disabled"===t))i?this.$unbind():this.$bind()}$bind(){this.$onPointerDown||(this.$onPointerDown=this.$handlePointerDown.bind(this),No(this,ho,this.$onPointerDown)),this.$onPointerMove||(this.$onPointerMove=this.$handlePointerMove.bind(this),No(this.ownerDocument,po,this.$onPointerMove)),this.$onPointerUp||(this.$onPointerUp=this.$handlePointerUp.bind(this),No(this.ownerDocument,uo,this.$onPointerUp)),this.$onWheel||(this.$onWheel=this.$handleWheel.bind(this),No(this,go,this.$onWheel,{passive:!1,capture:!0}))}$unbind(){this.$onPointerDown&&(Bo(this,ho,this.$onPointerDown),this.$onPointerDown=null),this.$onPointerMove&&(Bo(this.ownerDocument,po,this.$onPointerMove),this.$onPointerMove=null),this.$onPointerUp&&(Bo(this.ownerDocument,uo,this.$onPointerUp),this.$onPointerUp=null),this.$onWheel&&(Bo(this,go,this.$onWheel,{capture:!0}),this.$onWheel=null)}$handlePointerDown(t){const{buttons:e,button:i,type:r}=t;if(this.disabled||("pointerdown"===r&&"mouse"===t.pointerType||"mousedown"===r)&&($o(e)&&1!==e||$o(i)&&0!==i||t.ctrlKey))return;const{$pointers:o}=this;let s="";if(t.changedTouches)Array.from(t.changedTouches).forEach(({identifier:t,pageX:e,pageY:i})=>{o.set(t,{startX:e,startY:i,endX:e,endY:i})});else{const{pointerId:e=0,pageX:i,pageY:r}=t;o.set(e,{startX:i,startY:r,endX:i,endY:r})}o.size>1?s=to:Eo(t.target)&&(s=t.target.action||t.target.getAttribute("action")||""),!1!==this.$emit(xo,{action:s,relatedEvent:t})&&(t.preventDefault(),this.$action=s,this.style.willChange="transform")}$handlePointerMove(t){const{$action:e,$pointers:i}=this;if(this.disabled||e===eo||0===i.size)return;if(!1===this.$emit("actionmove",{action:e,relatedEvent:t}))return;if(t.preventDefault(),t.changedTouches)Array.from(t.changedTouches).forEach(({identifier:t,pageX:e,pageY:r})=>{const o=i.get(t);o&&Object.assign(o,{endX:e,endY:r})});else{const{pointerId:e=0,pageX:r,pageY:o}=t,s=i.get(e);s&&Object.assign(s,{endX:r,endY:o})}const r={action:e,relatedEvent:t};if(e===to){const e=new Map(i);let o=0,s=0,a=0,n=0,l=t.pageX,c=t.pageY;i.forEach((t,i)=>{e.delete(i),e.forEach(e=>{let i=e.startX-t.startX,r=e.startY-t.startY,d=e.endX-t.endX,h=e.endY-t.endY,p=0,u=0,m=0,f=0;if(0===i?r<0?m=2*Math.PI:r>0&&(m=Math.PI):i>0?m=Math.PI/2+Math.atan(r/i):i<0&&(m=1.5*Math.PI+Math.atan(r/i)),0===d?h<0?f=2*Math.PI:h>0&&(f=Math.PI):d>0?f=Math.PI/2+Math.atan(h/d):d<0&&(f=1.5*Math.PI+Math.atan(h/d)),f>0||m>0){const i=f-m,r=Math.abs(i);r>o&&(o=r,a=i,l=(t.startX+e.startX)/2,c=(t.startY+e.startY)/2)}if(i=Math.abs(i),r=Math.abs(r),d=Math.abs(d),h=Math.abs(h),i>0&&r>0?p=Math.sqrt(i*i+r*r):i>0?p=i:r>0&&(p=r),d>0&&h>0?u=Math.sqrt(d*d+h*h):d>0?u=d:h>0&&(u=h),p>0&&u>0){const i=(u-p)/p,r=Math.abs(i);r>s&&(s=r,n=i,l=(t.startX+e.startX)/2,c=(t.startY+e.startY)/2)}})});const d=o>0,h=s>0;d&&h?(r.rotate=a,r.scale=n,r.centerX=l,r.centerY=c):d?(r.action=Zr,r.rotate=a,r.centerX=l,r.centerY=c):h?(r.action=Qr,r.scale=n,r.centerX=l,r.centerY=c):r.action=eo}else{const[t]=Array.from(i.values());Object.assign(r,t)}i.forEach(t=>{t.startX=t.endX,t.startY=t.endY}),r.action!==eo&&this.$emit(bo,r,{cancelable:!1})}$handlePointerUp(t){const{$action:e,$pointers:i}=this;if(!this.disabled&&e!==eo&&!1!==this.$emit(yo,{action:e,relatedEvent:t})){if(t.preventDefault(),t.changedTouches)Array.from(t.changedTouches).forEach(({identifier:t})=>{i.delete(t)});else{const{pointerId:e=0}=t;i.delete(e)}0===i.size&&(this.style.willChange="",this.$action=eo)}}$handleWheel(t){if(this.disabled)return;if(t.preventDefault(),this.$wheeling)return;this.$wheeling=!0,setTimeout(()=>{this.$wheeling=!1},50);const e=(t.deltaY>0?-1:1)*this.scaleStep;this.$emit(bo,{action:Qr,scale:e,relatedEvent:t},{cancelable:!1})}$setAction(t){return"string"==typeof t&&(this.$action=t),this}$toCanvas(t){return new Promise((e,i)=>{if(!this.isConnected)return void i(new Error("The current element is not connected to the DOM."));const r=document.createElement("canvas");let o=this.offsetWidth,s=this.offsetHeight,a=1;To(t)&&(zo(t.width)||zo(t.height))&&(({width:o,height:s}=Ho({aspectRatio:o/s,width:t.width,height:t.height})),a=o/this.offsetWidth),r.width=o,r.height=s;const n=this.querySelector(this.$getTagNameOf(Vr));n?n.$ready().then(i=>{const l=r.getContext("2d");if(l){const[e,c,d,h,p,u]=n.$getTransform();let m=p,f=u,v=i.naturalWidth,g=i.naturalHeight;1!==a&&(m*=a,f*=a,v*=a,g*=a);const b=v/2,y=g/2;l.fillStyle="transparent",l.fillRect(0,0,o,s),To(t)&&Co(t.beforeDraw)&&t.beforeDraw.call(this,l,r),l.save(),l.translate(b,y),l.transform(e,c,d,h,m,f),l.translate(-b,-y),l.drawImage(i,0,0,v,g),l.restore()}e(r)}).catch(i):e(r)})}}ts.$name=Dr,ts.$version="2.0.0";const es=new WeakMap,is=["alt","crossorigin","decoding","importance","loading","referrerpolicy","sizes","src","srcset"];class rs extends Zo{constructor(){super(...arguments),this.$matrix=[1,0,0,1,0,0],this.$onLoad=null,this.$onCanvasAction=null,this.$onCanvasActionEnd=null,this.$onCanvasActionStart=null,this.$actionStartTarget=null,this.$style=":host{display:inline-block}img{display:block;height:100%;max-height:none!important;max-width:none!important;min-height:0!important;min-width:0!important;width:100%}",this.$image=new Image,this.initialCenterSize="contain",this.rotatable=!1,this.scalable=!1,this.skewable=!1,this.slottable=!1,this.translatable=!1}set $canvas(t){es.set(this,t)}get $canvas(){return es.get(this)}static get observedAttributes(){return super.observedAttributes.concat(is,["initial-center-size","rotatable","scalable","skewable","translatable"])}attributeChangedCallback(t,e,i){Object.is(i,e)||(super.attributeChangedCallback(t,e,i),is.includes(t)&&this.$image.setAttribute(t,i))}$propertyChangedCallback(t,e,i){if(!Object.is(i,e)&&(super.$propertyChangedCallback(t,e,i),"initialCenterSize"===t))this.$nextTick(()=>{this.$center(i)})}connectedCallback(){super.connectedCallback();const{$image:t}=this,e=this.closest(this.$getTagNameOf(Dr));e&&(this.$canvas=e,this.$setStyles({display:"block",position:"absolute"}),this.$onCanvasActionStart=t=>{var e,i;this.$actionStartTarget=null===(i=null===(e=t.detail)||void 0===e?void 0:e.relatedEvent)||void 0===i?void 0:i.target},this.$onCanvasActionEnd=()=>{this.$actionStartTarget=null},this.$onCanvasAction=this.$handleAction.bind(this),No(e,xo,this.$onCanvasActionStart),No(e,yo,this.$onCanvasActionEnd),No(e,bo,this.$onCanvasAction)),this.$onLoad=this.$handleLoad.bind(this),No(t,vo,this.$onLoad),this.$getShadowRoot().appendChild(t)}disconnectedCallback(){const{$image:t,$canvas:e}=this;e&&(this.$onCanvasActionStart&&(Bo(e,xo,this.$onCanvasActionStart),this.$onCanvasActionStart=null),this.$onCanvasActionEnd&&(Bo(e,yo,this.$onCanvasActionEnd),this.$onCanvasActionEnd=null),this.$onCanvasAction&&(Bo(e,bo,this.$onCanvasAction),this.$onCanvasAction=null)),t&&this.$onLoad&&(Bo(t,vo,this.$onLoad),this.$onLoad=null),this.$getShadowRoot().removeChild(t),super.disconnectedCallback()}$handleLoad(){const{$image:t}=this;this.$setStyles({width:t.naturalWidth,height:t.naturalHeight}),this.$canvas&&this.$center(this.initialCenterSize)}$handleAction(t){if(this.hidden||!(this.rotatable||this.scalable||this.translatable))return;const{$canvas:e}=this,{detail:i}=t;if(i){const{relatedEvent:t}=i;let{action:r}=i;switch(r!==to||this.rotatable&&this.scalable||(r=this.rotatable?Zr:this.scalable?Qr:eo),r){case Kr:if(this.translatable){let r=null;t&&(r=t.target.closest(this.$getTagNameOf(Wr))),r||(r=e.querySelector(this.$getTagNameOf(Wr))),r&&r.multiple&&!r.active&&(r=e.querySelector(`${this.$getTagNameOf(Wr)}[active]`)),r&&!r.hidden&&r.movable&&!r.dynamic&&this.$actionStartTarget&&r.contains(this.$actionStartTarget)||this.$move(i.endX-i.startX,i.endY-i.startY)}break;case Zr:if(this.rotatable)if(t){const{x:e,y:r}=this.getBoundingClientRect();this.$rotate(i.rotate,t.clientX-e,t.clientY-r)}else this.$rotate(i.rotate);break;case Qr:if(this.scalable)if(t){const e=t.target.closest(this.$getTagNameOf(Wr));if(!e||!e.zoomable||e.zoomable&&e.dynamic){const{x:e,y:r}=this.getBoundingClientRect();this.$zoom(i.scale,t.clientX-e,t.clientY-r)}}else this.$zoom(i.scale);break;case to:if(this.rotatable&&this.scalable){const{rotate:e}=i;let{scale:r}=i;r<0?r=1/(1-r):r+=1;const o=Math.cos(e),s=Math.sin(e),[a,n,l,c]=[o*r,s*r,-s*r,o*r];if(t){const e=this.getBoundingClientRect(),i=t.clientX-e.x,r=t.clientY-e.y,[o,s,d,h]=this.$matrix,p=i-e.width/2,u=r-e.height/2,m=(p*h-d*u)/(o*h-d*s),f=(u*o-s*p)/(o*h-d*s);this.$transform(a,n,l,c,m*(1-a)+f*l,f*(1-c)+m*n)}else this.$transform(a,n,l,c,0,0)}}}}$ready(t){const{$image:e}=this,i=new Promise((t,i)=>{const r=new Error("Failed to load the image source");if(e.complete)e.naturalWidth>0&&e.naturalHeight>0?t(e):i(r);else{const o=()=>{Bo(e,mo,s),t(e)},s=()=>{Bo(e,vo,o),i(r)};jo(e,vo,o),jo(e,mo,s)}});return Co(t)&&i.then(e=>(t(e),e)),i}$center(t){const{parentElement:e}=this;if(!e)return this;const i=e.getBoundingClientRect(),r=i.width,o=i.height,{x:s,y:a,width:n,height:l}=this.getBoundingClientRect(),c=s+n/2,d=a+l/2,h=i.x+r/2,p=i.y+o/2;if(this.$move(h-c,p-d),t&&(n!==r||l!==o)){const e=r/n,i=o/l;switch(t){case"cover":this.$scale(Math.max(e,i));break;case"contain":this.$scale(Math.min(e,i))}}return this}$move(t,e=t){if(this.translatable&&$o(t)&&$o(e)){const[i,r,o,s]=this.$matrix,a=(t*s-o*e)/(i*s-o*r),n=(e*i-r*t)/(i*s-o*r);this.$translate(a,n)}return this}$moveTo(t,e=t){if(this.translatable&&$o(t)&&$o(e)){const[i,r,o,s]=this.$matrix,a=(t*s-o*e)/(i*s-o*r),n=(e*i-r*t)/(i*s-o*r);this.$setTransform(i,r,o,s,a,n)}return this}$rotate(t,e,i){if(this.rotatable){const r=Go(t),o=Math.cos(r),s=Math.sin(r),[a,n,l,c]=[o,s,-s,o];if($o(e)&&$o(i)){const[t,r,o,s]=this.$matrix,{width:d,height:h}=this.getBoundingClientRect(),p=e-d/2,u=i-h/2,m=(p*s-o*u)/(t*s-o*r),f=(u*t-r*p)/(t*s-o*r);this.$transform(a,n,l,c,m*(1-a)-f*l,f*(1-c)-m*n)}else this.$transform(a,n,l,c,0,0)}return this}$zoom(t,e,i){if(!this.scalable||0===t)return this;if(t<0?t=1/(1-t):t+=1,$o(e)&&$o(i)){const[r,o,s,a]=this.$matrix,{width:n,height:l}=this.getBoundingClientRect(),c=e-n/2,d=i-l/2,h=(c*a-s*d)/(r*a-s*o),p=(d*r-o*c)/(r*a-s*o);this.$transform(t,0,0,t,h*(1-t),p*(1-t))}else this.$scale(t);return this}$scale(t,e=t){return this.scalable&&this.$transform(t,0,0,e,0,0),this}$skew(t,e=0){if(this.skewable){const i=Go(t),r=Go(e);this.$transform(1,Math.tan(r),Math.tan(i),1,0,0)}return this}$translate(t,e=t){return this.translatable&&$o(t)&&$o(e)&&this.$transform(1,0,0,1,t,e),this}$transform(t,e,i,r,o,s){return $o(t)&&$o(e)&&$o(i)&&$o(r)&&$o(o)&&$o(s)?this.$setTransform(Vo(this.$matrix,[t,e,i,r,o,s])):this}$setTransform(t,e,i,r,o,s){if((this.rotatable||this.scalable||this.skewable||this.translatable)&&(Array.isArray(t)&&([t,e,i,r,o,s]=t),$o(t)&&$o(e)&&$o(i)&&$o(r)&&$o(o)&&$o(s))){const a=[...this.$matrix],n=[t,e,i,r,o,s];if(!1===this.$emit(_o,{matrix:n,oldMatrix:a}))return this;this.$matrix=n,this.style.transform=`matrix(${n.join(", ")})`}return this}$getTransform(){return this.$matrix.slice()}$resetTransform(){return this.$setTransform([1,0,0,1,0,0])}}rs.$name=Vr,rs.$version="2.0.0";const os=new WeakMap;class ss extends Zo{constructor(){super(...arguments),this.$onCanvasChange=null,this.$onCanvasActionEnd=null,this.$onCanvasActionStart=null,this.$style=":host{display:block;height:0;left:0;outline:var(--theme-color) solid 1px;position:relative;top:0;width:0}:host([transparent]){outline-color:transparent}",this.x=0,this.y=0,this.width=0,this.height=0,this.slottable=!1,this.themeColor="rgba(0, 0, 0, 0.65)"}set $canvas(t){os.set(this,t)}get $canvas(){return os.get(this)}static get observedAttributes(){return super.observedAttributes.concat(["height","width","x","y"])}connectedCallback(){super.connectedCallback();const t=this.closest(this.$getTagNameOf(Dr));if(t){this.$canvas=t,this.style.position="absolute";const e=t.querySelector(this.$getTagNameOf(Wr));e&&(this.$onCanvasActionStart=t=>{e.hidden&&t.detail.action===Jr&&(this.hidden=!1)},this.$onCanvasActionEnd=t=>{e.hidden&&t.detail.action===Jr&&(this.hidden=!0)},this.$onCanvasChange=t=>{const{x:i,y:r,width:o,height:s}=t.detail;this.$change(i,r,o,s),(e.hidden||0===i&&0===r&&0===o&&0===s)&&(this.hidden=!0)},No(t,xo,this.$onCanvasActionStart),No(t,yo,this.$onCanvasActionEnd),No(t,wo,this.$onCanvasChange))}this.$render()}disconnectedCallback(){const{$canvas:t}=this;t&&(this.$onCanvasActionStart&&(Bo(t,xo,this.$onCanvasActionStart),this.$onCanvasActionStart=null),this.$onCanvasActionEnd&&(Bo(t,yo,this.$onCanvasActionEnd),this.$onCanvasActionEnd=null),this.$onCanvasChange&&(Bo(t,wo,this.$onCanvasChange),this.$onCanvasChange=null)),super.disconnectedCallback()}$change(t,e,i=this.width,r=this.height){return $o(t)&&$o(e)&&$o(i)&&$o(r)&&(t!==this.x||e!==this.y||i!==this.width||r!==this.height)?(this.hidden&&(this.hidden=!1),this.x=t,this.y=e,this.width=i,this.height=r,this.$render()):this}$reset(){return this.$change(0,0,0,0)}$render(){return this.$setStyles({transform:`translate(${this.x}px, ${this.y}px)`,width:this.width,height:this.height,outlineWidth:jr.innerWidth})}}ss.$name=Xr,ss.$version="2.0.0";class as extends Zo{constructor(){super(...arguments),this.$onCanvasCropEnd=null,this.$onCanvasCropStart=null,this.$style=':host{background-color:var(--theme-color);display:block}:host([action=move]),:host([action=select]){height:100%;left:0;position:absolute;top:0;width:100%}:host([action=move]){cursor:move}:host([action=select]){cursor:crosshair}:host([action$=-resize]){background-color:transparent;height:15px;position:absolute;width:15px}:host([action$=-resize]):after{background-color:var(--theme-color);content:"";display:block;height:5px;left:50%;position:absolute;top:50%;transform:translate(-50%,-50%);width:5px}:host([action=n-resize]),:host([action=s-resize]){cursor:ns-resize;left:50%;transform:translateX(-50%);width:100%}:host([action=n-resize]){top:-8px}:host([action=s-resize]){bottom:-8px}:host([action=e-resize]),:host([action=w-resize]){cursor:ew-resize;height:100%;top:50%;transform:translateY(-50%)}:host([action=e-resize]){right:-8px}:host([action=w-resize]){left:-8px}:host([action=ne-resize]){cursor:nesw-resize;right:-8px;top:-8px}:host([action=nw-resize]){cursor:nwse-resize;left:-8px;top:-8px}:host([action=se-resize]){bottom:-8px;cursor:nwse-resize;right:-8px}:host([action=se-resize]):after{height:15px;width:15px}@media (pointer:coarse){:host([action=se-resize]):after{height:10px;width:10px}}@media (pointer:fine){:host([action=se-resize]):after{height:5px;width:5px}}:host([action=sw-resize]){bottom:-8px;cursor:nesw-resize;left:-8px}:host([plain]){background-color:transparent}',this.action=eo,this.plain=!1,this.slottable=!1,this.themeColor="rgba(51, 153, 255, 0.5)"}static get observedAttributes(){return super.observedAttributes.concat(["action","plain"])}}as.$name=Hr,as.$version="2.0.0";const ns=new WeakMap;class ls extends Zo{constructor(){super(...arguments),this.$onCanvasAction=null,this.$onCanvasActionStart=null,this.$onCanvasActionEnd=null,this.$onDocumentKeyDown=null,this.$action="",this.$actionStartTarget=null,this.$changing=!1,this.$style=':host{display:block;left:0;position:relative;right:0}:host([outlined]){outline:1px solid var(--theme-color)}:host([multiple]){outline:1px dashed hsla(0,0%,100%,.5)}:host([multiple]):after{bottom:0;content:"";cursor:pointer;display:block;left:0;position:absolute;right:0;top:0}:host([multiple][active]){outline-color:var(--theme-color);z-index:1}:host([multiple])>*{visibility:hidden}:host([multiple][active])>*{visibility:visible}:host([multiple][active]):after{display:none}',this.$initialSelection={x:0,y:0,width:0,height:0},this.x=0,this.y=0,this.width=0,this.height=0,this.aspectRatio=NaN,this.initialAspectRatio=NaN,this.initialCoverage=NaN,this.active=!1,this.linked=!1,this.dynamic=!1,this.movable=!1,this.resizable=!1,this.zoomable=!1,this.multiple=!1,this.keyboard=!1,this.outlined=!1,this.precise=!1}set $canvas(t){ns.set(this,t)}get $canvas(){return ns.get(this)}static get observedAttributes(){return super.observedAttributes.concat(["active","aspect-ratio","dynamic","height","initial-aspect-ratio","initial-coverage","keyboard","linked","movable","multiple","outlined","precise","resizable","width","x","y","zoomable"])}$propertyChangedCallback(t,e,i){if(!Object.is(i,e))switch(super.$propertyChangedCallback(t,e,i),t){case"x":case"y":case"width":case"height":this.$changing||this.$nextTick(()=>{this.$change(this.x,this.y,this.width,this.height,this.aspectRatio,!0)});break;case"aspectRatio":case"initialAspectRatio":this.$nextTick(()=>{this.$initSelection()});break;case"initialCoverage":this.$nextTick(()=>{zo(i)&&i<=1&&this.$initSelection(!0,!0)});break;case"keyboard":this.$nextTick(()=>{this.$canvas&&(i?this.$onDocumentKeyDown||(this.$onDocumentKeyDown=this.$handleKeyDown.bind(this),No(this.ownerDocument,fo,this.$onDocumentKeyDown)):this.$onDocumentKeyDown&&(Bo(this.ownerDocument,fo,this.$onDocumentKeyDown),this.$onDocumentKeyDown=null))});break;case"multiple":this.$nextTick(()=>{if(this.$canvas){const t=this.$getSelections();i?(t.forEach(t=>{t.active=!1}),this.active=!0,this.$emit(wo,{x:this.x,y:this.y,width:this.width,height:this.height})):(this.active=!1,t.slice(1).forEach(t=>{this.$removeSelection(t)}))}});break;case"precise":this.$nextTick(()=>{this.$change(this.x,this.y)});break;case"linked":i&&(this.dynamic=!0)}}connectedCallback(){super.connectedCallback();const t=this.closest(this.$getTagNameOf(Dr));t?(this.$canvas=t,this.$setStyles({position:"absolute",transform:`translate(${this.x}px, ${this.y}px)`}),this.hidden||this.$render(),this.$initSelection(!0),this.$onCanvasActionStart=this.$handleActionStart.bind(this),this.$onCanvasActionEnd=this.$handleActionEnd.bind(this),this.$onCanvasAction=this.$handleAction.bind(this),No(t,xo,this.$onCanvasActionStart),No(t,yo,this.$onCanvasActionEnd),No(t,bo,this.$onCanvasAction)):this.$render()}disconnectedCallback(){const{$canvas:t}=this;t&&(this.$onCanvasActionStart&&(Bo(t,xo,this.$onCanvasActionStart),this.$onCanvasActionStart=null),this.$onCanvasActionEnd&&(Bo(t,yo,this.$onCanvasActionEnd),this.$onCanvasActionEnd=null),this.$onCanvasAction&&(Bo(t,bo,this.$onCanvasAction),this.$onCanvasAction=null)),super.disconnectedCallback()}$getSelections(){let t=[];return this.parentElement&&(t=Array.from(this.parentElement.querySelectorAll(this.$getTagNameOf(Wr)))),t}$initSelection(t=!1,e=!1){const{initialCoverage:i,parentElement:r}=this;if(zo(i)&&r){const o=this.aspectRatio||this.initialAspectRatio;let s=(e?0:this.width)||r.offsetWidth*i,a=(e?0:this.height)||r.offsetHeight*i;zo(o)&&({width:s,height:a}=Ho({aspectRatio:o,width:s,height:a})),this.$change(this.x,this.y,s,a),t&&this.$center(),this.$initialSelection={x:this.x,y:this.y,width:this.width,height:this.height}}}$createSelection(){const t=this.cloneNode(!0);return this.hasAttribute("id")&&t.removeAttribute("id"),t.initialCoverage=NaN,this.active=!1,this.parentElement&&this.parentElement.insertBefore(t,this.nextSibling),t}$removeSelection(t=this){if(this.parentElement){const e=this.$getSelections();if(e.length>1){const i=e.indexOf(t),r=e[i+1]||e[i-1];r&&(t.active=!1,this.parentElement.removeChild(t),r.active=!0,r.$emit(wo,{x:r.x,y:r.y,width:r.width,height:r.height}))}else this.$clear()}}$handleActionStart(t){var e,i;const r=null===(i=null===(e=t.detail)||void 0===e?void 0:e.relatedEvent)||void 0===i?void 0:i.target;this.$action="",this.$actionStartTarget=r,!this.hidden&&this.multiple&&!this.active&&r===this&&this.parentElement&&(this.$getSelections().forEach(t=>{t.active=!1}),this.active=!0,this.$emit(wo,{x:this.x,y:this.y,width:this.width,height:this.height}))}$handleAction(t){const{currentTarget:e,detail:i}=t;if(!e||!i)return;const{relatedEvent:r}=i;let{action:o}=i;if(!o&&this.multiple&&(o=this.$action||(null==r?void 0:r.target.action),this.$action=o),!o||this.hidden&&o!==Jr||this.multiple&&!this.active&&o!==Qr)return;const s=i.endX-i.startX,a=i.endY-i.startY,{width:n,height:l}=this;let{aspectRatio:c}=this;switch(!zo(c)&&r.shiftKey&&(c=zo(n)&&zo(l)?n/l:1),o){case Jr:if(0!==s&&0!==a){const{$canvas:t}=this,r=Fo(e);(this.multiple&&!this.hidden?this.$createSelection():this).$change(i.startX-r.left,i.startY-r.top,Math.abs(s),Math.abs(a),c),s<0?a<0?o=no:a>0&&(o=co):s>0&&(a<0?o=ao:a>0&&(o=lo)),t&&(t.$action=o)}break;case Kr:this.movable&&(this.dynamic||this.$actionStartTarget&&this.contains(this.$actionStartTarget))&&this.$move(s,a);break;case Qr:if(r&&this.zoomable&&(this.dynamic||this.contains(r.target))){const t=Fo(e);this.$zoom(i.scale,r.pageX-t.left,r.pageY-t.top)}break;default:this.$resize(o,s,a,c)}}$handleActionEnd(){this.$action="",this.$actionStartTarget=null}$handleKeyDown(t){if(this.hidden||!this.keyboard||this.multiple&&!this.active||t.defaultPrevented)return;const{activeElement:e}=document;if(!e||!["INPUT","TEXTAREA"].includes(e.tagName)&&!["true","plaintext-only"].includes(e.contentEditable))switch(t.key){case"Backspace":t.metaKey&&(t.preventDefault(),this.$removeSelection());break;case"Delete":t.preventDefault(),this.$removeSelection();break;case"ArrowLeft":t.preventDefault(),this.$move(-1,0);break;case"ArrowRight":t.preventDefault(),this.$move(1,0);break;case"ArrowUp":t.preventDefault(),this.$move(0,-1);break;case"ArrowDown":t.preventDefault(),this.$move(0,1);break;case"+":t.preventDefault(),this.$zoom(.1);break;case"-":t.preventDefault(),this.$zoom(-.1)}}$center(){const{parentElement:t}=this;if(!t)return this;const e=(t.offsetWidth-this.width)/2,i=(t.offsetHeight-this.height)/2;return this.$change(e,i)}$move(t,e=t){return this.$moveTo(this.x+t,this.y+e)}$moveTo(t,e=t){return this.movable?this.$change(t,e):this}$resize(t,e=0,i=0,r=this.aspectRatio){if(!this.resizable)return this;const o=zo(r),{$canvas:s}=this;let{x:a,y:n,width:l,height:c}=this;switch(t){case io:n+=i,c-=i,c<0&&(t=oo,c=-c,n-=c),o&&(a+=(e=i*r)/2,l-=e,l<0&&(l=-l,a-=l));break;case ro:l+=e,l<0&&(t=so,l=-l,a-=l),o&&(n-=(i=e/r)/2,c+=i,c<0&&(c=-c,n-=c));break;case oo:c+=i,c<0&&(t=io,c=-c,n-=c),o&&(a-=(e=i*r)/2,l+=e,l<0&&(l=-l,a-=l));break;case so:a+=e,l-=e,l<0&&(t=ro,l=-l,a-=l),o&&(n+=(i=e/r)/2,c-=i,c<0&&(c=-c,n-=c));break;case ao:o&&(i=-e/r),n+=i,c-=i,l+=e,l<0&&c<0?(t=co,l=-l,c=-c,a-=l,n-=c):l<0?(t=no,l=-l,a-=l):c<0&&(t=lo,c=-c,n-=c);break;case no:o&&(i=e/r),a+=e,n+=i,l-=e,c-=i,l<0&&c<0?(t=lo,l=-l,c=-c,a-=l,n-=c):l<0?(t=ao,l=-l,a-=l):c<0&&(t=co,c=-c,n-=c);break;case lo:o&&(i=e/r),l+=e,c+=i,l<0&&c<0?(t=no,l=-l,c=-c,a-=l,n-=c):l<0?(t=co,l=-l,a-=l):c<0&&(t=ao,c=-c,n-=c);break;case co:o&&(i=-e/r),a+=e,l-=e,c+=i,l<0&&c<0?(t=ao,l=-l,c=-c,a-=l,n-=c):l<0?(t=lo,l=-l,a-=l):c<0&&(t=no,c=-c,n-=c)}return s&&s.$setAction(t),this.$change(a,n,l,c)}$zoom(t,e,i){if(!this.zoomable||0===t)return this;t<0?t=1/(1-t):t+=1;const{width:r,height:o}=this,s=r*t,a=o*t;let n=this.x,l=this.y;return $o(e)&&$o(i)?(n-=(s-r)*((e-this.x)/r),l-=(a-o)*((i-this.y)/o)):(n-=(s-r)/2,l-=(a-o)/2),this.$change(n,l,s,a)}$change(t,e,i=this.width,r=this.height,o=this.aspectRatio,s=!1){return this.$changing||!$o(t)||!$o(e)||!$o(i)||!$o(r)||i<0||r<0?this:(zo(o)&&({width:i,height:r}=Ho({aspectRatio:o,width:i,height:r},"cover")),this.precise||(t=Math.round(t),e=Math.round(e),i=Math.round(i),r=Math.round(r)),t===this.x&&e===this.y&&i===this.width&&r===this.height&&Object.is(o,this.aspectRatio)&&!s?this:(this.hidden&&(this.hidden=!1),!1===this.$emit(wo,{x:t,y:e,width:i,height:r})?this:(this.$changing=!0,this.x=t,this.y=e,this.width=i,this.height=r,this.$changing=!1,this.$render())))}$reset(){const{x:t,y:e,width:i,height:r}=this.$initialSelection;return this.$change(t,e,i,r)}$clear(){return this.$change(0,0,0,0,NaN,!0),this.hidden=!0,this}$render(){return this.$setStyles({transform:`translate(${this.x}px, ${this.y}px)`,width:this.width,height:this.height})}$toCanvas(t){return new Promise((e,i)=>{if(!this.isConnected)return void i(new Error("The current element is not connected to the DOM."));const r=document.createElement("canvas");let{width:o,height:s}=this,a=1;if(To(t)&&(zo(t.width)||zo(t.height))&&(({width:o,height:s}=Ho({aspectRatio:o/s,width:t.width,height:t.height})),a=o/this.width),r.width=o,r.height=s,!this.$canvas)return void e(r);const n=this.$canvas.querySelector(this.$getTagNameOf(Vr));n?n.$ready().then(i=>{const l=r.getContext("2d");if(l){const[e,c,d,h,p,u]=n.$getTransform(),m=-this.x,f=-this.y,v=(m*h-d*f)/(e*h-d*c),g=(f*e-c*m)/(e*h-d*c);let b=e*v+d*g+p,y=c*v+h*g+u,x=i.naturalWidth,w=i.naturalHeight;1!==a&&(b*=a,y*=a,x*=a,w*=a);const _=x/2,k=w/2;l.fillStyle="transparent",l.fillRect(0,0,o,s),To(t)&&Co(t.beforeDraw)&&t.beforeDraw.call(this,l,r),l.save(),l.translate(_,k),l.transform(e,c,d,h,b,y),l.translate(-_,-k),l.drawImage(i,0,0,x,w),l.restore()}e(r)}).catch(i):e(r)})}}ls.$name=Wr,ls.$version="2.0.0";class cs extends Zo{constructor(){super(...arguments),this.$style=":host{display:flex;flex-direction:column;position:relative;touch-action:none;-webkit-user-select:none;-moz-user-select:none;user-select:none}:host([bordered]){border:1px dashed var(--theme-color)}:host([covered]){bottom:0;left:0;position:absolute;right:0;top:0}:host>span{display:flex;flex:1}:host>span+span{border-top:1px dashed var(--theme-color)}:host>span>span{flex:1}:host>span>span+span{border-left:1px dashed var(--theme-color)}",this.bordered=!1,this.columns=3,this.covered=!1,this.rows=3,this.slottable=!1,this.themeColor="rgba(238, 238, 238, 0.5)"}static get observedAttributes(){return super.observedAttributes.concat(["bordered","columns","covered","rows"])}$propertyChangedCallback(t,e,i){Object.is(i,e)||(super.$propertyChangedCallback(t,e,i),"rows"!==t&&"columns"!==t||this.$nextTick(()=>{this.$render()}))}connectedCallback(){super.connectedCallback(),this.$render()}$render(){const t=this.$getShadowRoot(),e=document.createDocumentFragment();for(let t=0;t<this.rows;t+=1){const t=document.createElement("span");t.setAttribute("role","row");for(let e=0;e<this.columns;e+=1){const e=document.createElement("span");e.setAttribute("role","gridcell"),t.appendChild(e)}e.appendChild(t)}t&&(t.innerHTML="",t.appendChild(e))}}cs.$name=qr,cs.$version="2.0.0";class ds extends Zo{constructor(){super(...arguments),this.$style=':host{display:inline-block;height:1em;position:relative;touch-action:none;-webkit-user-select:none;-moz-user-select:none;user-select:none;vertical-align:middle;width:1em}:host:after,:host:before{background-color:var(--theme-color);content:"";display:block;position:absolute}:host:before{height:1px;left:0;top:50%;transform:translateY(-50%);width:100%}:host:after{height:100%;left:50%;top:0;transform:translateX(-50%);width:1px}:host([centered]){left:50%;position:absolute;top:50%;transform:translate(-50%,-50%)}',this.centered=!1,this.slottable=!1,this.themeColor="rgba(238, 238, 238, 0.5)"}static get observedAttributes(){return super.observedAttributes.concat(["centered"])}}ds.$name=Gr,ds.$version="2.0.0";const hs=new WeakMap,ps=new WeakMap,us=new WeakMap,ms=new WeakMap,fs="vertical";class vs extends Zo{constructor(){super(...arguments),this.$onSelectionChange=null,this.$onSourceImageLoad=null,this.$onSourceImageTransform=null,this.$scale=1,this.$style=":host{display:block;height:100%;overflow:hidden;position:relative;width:100%}",this.resize=fs,this.selection="",this.slottable=!1}set $image(t){ps.set(this,t)}get $image(){return ps.get(this)}set $sourceImage(t){ms.set(this,t)}get $sourceImage(){return ms.get(this)}set $canvas(t){hs.set(this,t)}get $canvas(){return hs.get(this)}set $selection(t){us.set(this,t)}get $selection(){return us.get(this)}static get observedAttributes(){return super.observedAttributes.concat(["resize","selection"])}connectedCallback(){super.connectedCallback();let t=null;if(t=this.selection?this.ownerDocument.querySelector(this.selection):this.closest(this.$getTagNameOf(Wr)),Eo(t)){this.$selection=t,this.$onSelectionChange=this.$handleSelectionChange.bind(this),No(t,wo,this.$onSelectionChange);const e=t.closest(this.$getTagNameOf(Dr));if(e){this.$canvas=e;const t=e.querySelector(this.$getTagNameOf(Vr));t&&(this.$sourceImage=t,this.$image=t.cloneNode(!0),this.$getShadowRoot().appendChild(this.$image),this.$onSourceImageLoad=this.$handleSourceImageLoad.bind(this),this.$onSourceImageTransform=this.$handleSourceImageTransform.bind(this),No(t.$image,vo,this.$onSourceImageLoad),No(t,_o,this.$onSourceImageTransform))}this.$render()}}disconnectedCallback(){const{$selection:t,$sourceImage:e}=this;t&&this.$onSelectionChange&&(Bo(t,wo,this.$onSelectionChange),this.$onSelectionChange=null),e&&this.$onSourceImageLoad&&(Bo(e.$image,vo,this.$onSourceImageLoad),this.$onSourceImageLoad=null),e&&this.$onSourceImageTransform&&(Bo(e,_o,this.$onSourceImageTransform),this.$onSourceImageTransform=null),super.disconnectedCallback()}$handleSelectionChange(t){this.$render(t.detail)}$handleSourceImageLoad(){const{$image:t,$sourceImage:e}=this,i=t.getAttribute("src"),r=e.getAttribute("src");r&&r!==i&&(t.setAttribute("src",r),t.$ready(()=>{setTimeout(()=>{this.$render()},50)}))}$handleSourceImageTransform(t){this.$render(void 0,t.detail.matrix)}$render(t,e){const{$canvas:i,$selection:r}=this;t||r.hidden||(t=r),(!t||0===t.x&&0===t.y&&0===t.width&&0===t.height)&&(t={x:0,y:0,width:i.offsetWidth,height:i.offsetHeight});const{x:o,y:s,width:a,height:n}=t,l={},{clientWidth:c,clientHeight:d}=this;let h=c,p=d,u=NaN;switch(this.resize){case"both":u=1,h=a,p=n,l.width=a,l.height=n;break;case"horizontal":u=n>0?d/n:0,h=a*u,l.width=h;break;case fs:u=a>0?c/a:0,p=n*u,l.height=p;break;default:c>0?u=a>0?c/a:0:d>0&&(u=n>0?d/n:0)}this.$scale=u,this.$setStyles(l),this.$sourceImage&&this.$transformImageByOffset(null!=e?e:this.$sourceImage.$getTransform(),-o,-s)}$transformImageByOffset(t,e,i){const{$image:r,$scale:o,$sourceImage:s}=this;if(s&&r&&o>=0){const[s,a,n,l,c,d]=t,h=(e*l-n*i)/(s*l-n*a),p=(i*s-a*e)/(s*l-n*a),u=s*h+n*p+c,m=a*h+l*p+d;r.$ready(t=>{this.$setStyles.call(r,{width:t.naturalWidth*o,height:t.naturalHeight*o})}),r.$setTransform(s,a,n,l,u*o,m*o)}}}function gs(t){if(t.shadowRoot){const e=t.shadowRoot.querySelector(".scrim");e&&(e.style.display="none");const i=t.shadowRoot.querySelector("dialog"),r="<style>dialog::backdrop { display:block;    background: var(--md-sys-color-scrim, #000); opacity: 0.32; transition: all 250ms ease 0s; }</style>";i?.insertAdjacentHTML("beforeend",r)}}vs.$name=Yr,vs.$version="2.0.0",ts.$define(),ds.$define(),cs.$define(),as.$define(),rs.$define(),ls.$define(),ss.$define(),vs.$define();const bs=d`
  .cropper-container {
    direction: ltr;
    font-size: 0;
    line-height: 0;
...
`,Ts=t=>t??X,Cs={"Amazon Silk":"amazon_silk","Android Browser":"android",Bada:"bada",BlackBerry:"blackberry",Chrome:"chrome",Chromium:"chromium",Electron:"electron",Epiphany:"epiphany",Firefox:"firefox",Focus:"focus",Generic:"generic","Google Search":"google_search",Googlebot:"googlebot","Internet Explorer":"ie","K-Meleon":"k_meleon",Maxthon:"maxthon","Microsoft Edge":"edge","MZ Browser":"mz","NAVER Whale Browser":"naver",Opera:"opera","Opera Coast":"opera_coast","Pale Moon":"pale_moon",PhantomJS:"phantomjs",Puffin:"puffin",QupZilla:"qupzilla",QQ:"qq",QQLite:"qqlite",Safari:"safari",Sailfish:"sailfish","Samsung Internet for Android":"samsung_internet",SeaMonkey:"seamonkey",Sleipnir:"sleipnir",Swing:"swing",Tizen:"tizen","UC Browser":"uc",Vivaldi:"vivaldi","WebOS Browser":"webos",WeChat:"wechat","Yandex Browser":"yandex",Roku:"roku"},Es={amazon_silk:"Amazon Silk",android:"Android Browser",bada:"Bada",blackberry:"BlackBerry",chrome:"Chrome",chromium:"Chromium",electron:"Electron",epiphany:"Epiphany",firefox:"Firefox",focus:"Focus",generic:"Generic",googlebot:"Googlebot",google_search:"Google Search",ie:"Internet Explorer",k_meleon:"K-Meleon",maxthon:"Maxthon",edge:"Microsoft Edge",mz:"MZ Browser",naver:"NAVER Whale Browser",opera:"Opera",opera_coast:"Opera Coast",pale_moon:"Pale Moon",phantomjs:"PhantomJS",puffin:"Puffin",qupzilla:"QupZilla",qq:"QQ Browser",qqlite:"QQ Browser Lite",safari:"Safari",sailfish:"Sailfish",samsung_internet:"Samsung Internet for Android",seamonkey:"SeaMonkey",sleipnir:"Sleipnir",swing:"Swing",tizen:"Tizen",uc:"UC Browser",vivaldi:"Vivaldi",webos:"WebOS Browser",wechat:"WeChat",yandex:"Yandex Browser"},Is={tablet:"tablet",mobile:"mobile",desktop:"desktop",tv:"tv",bot:"bot"},Ps={WindowsPhone:"Windows Phone",Windows:"Windows",MacOS:"macOS",iOS:"iOS",Android:"Android",WebOS:"WebOS",BlackBerry:"BlackBerry",Bada:"Bada",Tizen:"Tizen",Linux:"Linux",ChromeOS:"Chrome OS",PlayStation4:"PlayStation 4",Roku:"Roku"},Ms={EdgeHTML:"EdgeHTML",Blink:"Blink",Trident:"Trident",Presto:"Presto",Gecko:"Gecko",WebKit:"WebKit"};class Os{static getFirstMatch(t,e){const i=e.match(t);return i&&i.length>0&&i[1]||""}static getSecondMatch(t,e){const i=e.match(t);return i&&i.length>1&&i[2]||""}static matchAndReturnConst(t,e,i){if(t.test(e))return i}static getWindowsVersionName(t){switch(t){case"NT":return"NT";case"XP":case"NT 5.1":return"XP";case"NT 5.0":return"2000";case"NT 5.2":return"2003";case"NT 6.0":return"Vista";case"NT 6.1":return"7";case"NT 6.2":return"8";case"NT 6.3":return"8.1";case"NT 10.0":return"10";default:return}}static getMacOSVersionName(t){const e=t.split(".").splice(0,2).map(t=>parseInt(t,10)||0);if(e.push(0),10===e[0])switch(e[1]){case 5:return"Leopard";case 6:return"Snow Leopard";case 7:return"Lion";case 8:return"Mountain Lion";case 9:return"Mavericks";case 10:return"Yosemite";case 11:return"El Capitan";case 12:return"Sierra";case 13:return"High Sierra";case 14:return"Mojave";case 15:return"Catalina";default:return}}static getAndroidVersionName(t){const e=t.split(".").splice(0,2).map(t=>parseInt(t,10)||0);if(e.push(0),!(1===e[0]&&e[1]<5))return 1===e[0]&&e[1]<6?"Cupcake":1===e[0]&&e[1]>=6?"Donut":2===e[0]&&e[1]<2?"Eclair":2===e[0]&&2===e[1]?"Froyo":2===e[0]&&e[1]>2?"Gingerbread":3===e[0]?"Honeycomb":4===e[0]&&e[1]<1?"Ice Cream Sandwich":4===e[0]&&e[1]<4?"Jelly Bean":4===e[0]&&e[1]>=4?"KitKat":5===e[0]?"Lollipop":6===e[0]?"Marshmallow":7===e[0]?"Nougat":8===e[0]?"Oreo":9===e[0]?"Pie":void 0}static getVersionPrecision(t){return t.split(".").length}static compareVersions(t,e,i=!1){const r=Os.getVersionPrecision(t),o=Os.getVersionPrecision(e);let s=Math.max(r,o),a=0;const n=Os.map([t,e],t=>{const e=s-Os.getVersionPrecision(t),i=t+new Array(e+1).join(".0");return Os.map(i.split("."),t=>new Array(20-t.length).join("0")+t).reverse()});for(i&&(a=s-Math.min(r,o)),s-=1;s>=a;){if(n[0][s]>n[1][s])return 1;if(n[0][s]===n[1][s]){if(s===a)return 0;s-=1}else if(n[0][s]<n[1][s])return-1}}static map(t,e){const i=[];let r;if(Array.prototype.map)return Array.prototype.map.call(t,e);for(r=0;r<t.length;r+=1)i.push(e(t[r]));return i}static find(t,e){let i,r;if(Array.prototype.find)return Array.prototype.find.call(t,e);for(i=0,r=t.length;i<r;i+=1){const r=t[i];if(e(r,i))return r}}static assign(t,...e){const i=t;let r,o;if(Object.assign)return Object.assign(t,...e);for(r=0,o=e.length;r<o;r+=1){const t=e[r];if("object"==typeof t&&null!==t){Object.keys(t).forEach(e=>{i[e]=t[e]})}}return t}static getBrowserAlias(t){return Cs[t]}static getBrowserTypeByAlias(t){return Es[t]||""}}const Rs=/version\/(\d+(\.?_?\d+)+)/i,Bs=[{test:[/googlebot/i],describe(t){const e={name:"Googlebot"},i=Os.getFirstMatch(/googlebot\/(\d+(\.\d+))/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/opera/i],describe(t){const e={name:"Opera"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:opera)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/opr\/|opios/i],describe(t){const e={name:"Opera"},i=Os.getFirstMatch(/(?:opr|opios)[\s/](\S+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/SamsungBrowser/i],describe(t){const e={name:"Samsung Internet for Android"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:SamsungBrowser)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/Whale/i],describe(t){const e={name:"NAVER Whale Browser"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:whale)[\s/](\d+(?:\.\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/PaleMoon/i],describe(t){const e={name:"Pale Moon"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:PaleMoon)[\s/](\d+(?:\.\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/MZBrowser/i],describe(t){const e={name:"MZ Browser"},i=Os.getFirstMatch(/(?:MZBrowser)[\s/](\d+(?:\.\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/focus/i],describe(t){const e={name:"Focus"},i=Os.getFirstMatch(/(?:focus)[\s/](\d+(?:\.\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/swing/i],describe(t){const e={name:"Swing"},i=Os.getFirstMatch(/(?:swing)[\s/](\d+(?:\.\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/coast/i],describe(t){const e={name:"Opera Coast"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:coast)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/opt\/\d+(?:.?_?\d+)+/i],describe(t){const e={name:"Opera Touch"},i=Os.getFirstMatch(/(?:opt)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/yabrowser/i],describe(t){const e={name:"Yandex Browser"},i=Os.getFirstMatch(/(?:yabrowser)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/ucbrowser/i],describe(t){const e={name:"UC Browser"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:ucbrowser)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/Maxthon|mxios/i],describe(t){const e={name:"Maxthon"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:Maxthon|mxios)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/epiphany/i],describe(t){const e={name:"Epiphany"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:epiphany)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/puffin/i],describe(t){const e={name:"Puffin"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:puffin)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/sleipnir/i],describe(t){const e={name:"Sleipnir"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:sleipnir)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/k-meleon/i],describe(t){const e={name:"K-Meleon"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/(?:k-meleon)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/micromessenger/i],describe(t){const e={name:"WeChat"},i=Os.getFirstMatch(/(?:micromessenger)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/qqbrowser/i],describe(t){const e={name:/qqbrowserlite/i.test(t)?"QQ Browser Lite":"QQ Browser"},i=Os.getFirstMatch(/(?:qqbrowserlite|qqbrowser)[/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/msie|trident/i],describe(t){const e={name:"Internet Explorer"},i=Os.getFirstMatch(/(?:msie |rv:)(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/\sedg\//i],describe(t){const e={name:"Microsoft Edge"},i=Os.getFirstMatch(/\sedg\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/edg([ea]|ios)/i],describe(t){const e={name:"Microsoft Edge"},i=Os.getSecondMatch(/edg([ea]|ios)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/vivaldi/i],describe(t){const e={name:"Vivaldi"},i=Os.getFirstMatch(/vivaldi\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/seamonkey/i],describe(t){const e={name:"SeaMonkey"},i=Os.getFirstMatch(/seamonkey\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/sailfish/i],describe(t){const e={name:"Sailfish"},i=Os.getFirstMatch(/sailfish\s?browser\/(\d+(\.\d+)?)/i,t);return i&&(e.version=i),e}},{test:[/silk/i],describe(t){const e={name:"Amazon Silk"},i=Os.getFirstMatch(/silk\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/phantom/i],describe(t){const e={name:"PhantomJS"},i=Os.getFirstMatch(/phantomjs\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/slimerjs/i],describe(t){const e={name:"SlimerJS"},i=Os.getFirstMatch(/slimerjs\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/blackberry|\bbb\d+/i,/rim\stablet/i],describe(t){const e={name:"BlackBerry"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/(web|hpw)[o0]s/i],describe(t){const e={name:"WebOS Browser"},i=Os.getFirstMatch(Rs,t)||Os.getFirstMatch(/w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/bada/i],describe(t){const e={name:"Bada"},i=Os.getFirstMatch(/dolfin\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/tizen/i],describe(t){const e={name:"Tizen"},i=Os.getFirstMatch(/(?:tizen\s?)?browser\/(\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/qupzilla/i],describe(t){const e={name:"QupZilla"},i=Os.getFirstMatch(/(?:qupzilla)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/firefox|iceweasel|fxios/i],describe(t){const e={name:"Firefox"},i=Os.getFirstMatch(/(?:firefox|iceweasel|fxios)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/electron/i],describe(t){const e={name:"Electron"},i=Os.getFirstMatch(/(?:electron)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/MiuiBrowser/i],describe(t){const e={name:"Miui"},i=Os.getFirstMatch(/(?:MiuiBrowser)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/chromium/i],describe(t){const e={name:"Chromium"},i=Os.getFirstMatch(/(?:chromium)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/chrome|crios|crmo/i],describe(t){const e={name:"Chrome"},i=Os.getFirstMatch(/(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/GSA/i],describe(t){const e={name:"Google Search"},i=Os.getFirstMatch(/(?:GSA)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test(t){const e=!t.test(/like android/i),i=t.test(/android/i);return e&&i},describe(t){const e={name:"Android Browser"},i=Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/playstation 4/i],describe(t){const e={name:"PlayStation 4"},i=Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/safari|applewebkit/i],describe(t){const e={name:"Safari"},i=Os.getFirstMatch(Rs,t);return i&&(e.version=i),e}},{test:[/.*/i],describe(t){const e=-1!==t.search("\\(")?/^(.*)\/(.*)[ \t]\((.*)/:/^(.*)\/(.*) /;return{name:Os.getFirstMatch(e,t),version:Os.getSecondMatch(e,t)}}}];var Ns=[{test:[/Roku\/DVP/],describe(t){const e=Os.getFirstMatch(/Roku\/DVP-(\d+\.\d+)/i,t);return{name:Ps.Roku,version:e}}},{test:[/windows phone/i],describe(t){const e=Os.getFirstMatch(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i,t);return{name:Ps.WindowsPhone,version:e}}},{test:[/windows /i],describe(t){const e=Os.getFirstMatch(/Windows ((NT|XP)( \d\d?.\d)?)/i,t),i=Os.getWindowsVersionName(e);return{name:Ps.Windows,version:e,versionName:i}}},{test:[/Macintosh(.*?) FxiOS(.*?)\//],describe(t){const e={name:Ps.iOS},i=Os.getSecondMatch(/(Version\/)(\d[\d.]+)/,t);return i&&(e.version=i),e}},{test:[/macintosh/i],describe(t){const e=Os.getFirstMatch(/mac os x (\d+(\.?_?\d+)+)/i,t).replace(/[_\s]/g,"."),i=Os.getMacOSVersionName(e),r={name:Ps.MacOS,version:e};return i&&(r.versionName=i),r}},{test:[/(ipod|iphone|ipad)/i],describe(t){const e=Os.getFirstMatch(/os (\d+([_\s]\d+)*) like mac os x/i,t).replace(/[_\s]/g,".");return{name:Ps.iOS,version:e}}},{test(t){const e=!t.test(/like android/i),i=t.test(/android/i);return e&&i},describe(t){const e=Os.getFirstMatch(/android[\s/-](\d+(\.\d+)*)/i,t),i=Os.getAndroidVersionName(e),r={name:Ps.Android,version:e};return i&&(r.versionName=i),r}},{test:[/(web|hpw)[o0]s/i],describe(t){const e=Os.getFirstMatch(/(?:web|hpw)[o0]s\/(\d+(\.\d+)*)/i,t),i={name:Ps.WebOS};return e&&e.length&&(i.version=e),i}},{test:[/blackberry|\bbb\d+/i,/rim\stablet/i],describe(t){const e=Os.getFirstMatch(/rim\stablet\sos\s(\d+(\.\d+)*)/i,t)||Os.getFirstMatch(/blackberry\d+\/(\d+([_\s]\d+)*)/i,t)||Os.getFirstMatch(/\bbb(\d+)/i,t);return{name:Ps.BlackBerry,version:e}}},{test:[/bada/i],describe(t){const e=Os.getFirstMatch(/bada\/(\d+(\.\d+)*)/i,t);return{name:Ps.Bada,version:e}}},{test:[/tizen/i],describe(t){const e=Os.getFirstMatch(/tizen[/\s](\d+(\.\d+)*)/i,t);return{name:Ps.Tizen,version:e}}},{test:[/linux/i],describe:()=>({name:Ps.Linux})},{test:[/CrOS/],describe:()=>({name:Ps.ChromeOS})},{test:[/PlayStation 4/],describe(t){const e=Os.getFirstMatch(/PlayStation 4[/\s](\d+(\.\d+)*)/i,t);return{name:Ps.PlayStation4,version:e}}}],js=[{test:[/googlebot/i],describe:()=>({type:Is.bot,vendor:"Google"})},{test:[/huawei/i],describe(t){const e=Os.getFirstMatch(/(can-l01)/i,t)&&"Nova",i={type:Is.mobile,vendor:"Huawei"};return e&&(i.model=e),i}},{test:[/nexus\s*(?:7|8|9|10).*/i],describe:()=>({type:Is.tablet,vendor:"Nexus"})},{test:[/ipad/i],describe:()=>({type:Is.tablet,vendor:"Apple",model:"iPad"})},{test:[/Macintosh(.*?) FxiOS(.*?)\//],describe:()=>({type:Is.tablet,vendor:"Apple",model:"iPad"})},{test:[/kftt build/i],describe:()=>({type:Is.tablet,vendor:"Amazon",model:"Kindle Fire HD 7"})},{test:[/silk/i],describe:()=>({type:Is.tablet,vendor:"Amazon"})},{test:[/tablet(?! pc)/i],describe:()=>({type:Is.tablet})},{test(t){const e=t.test(/ipod|iphone/i),i=t.test(/like (ipod|iphone)/i);return e&&!i},describe(t){const e=Os.getFirstMatch(/(ipod|iphone)/i,t);return{type:Is.mobile,vendor:"Apple",model:e}}},{test:[/nexus\s*[0-6].*/i,/galaxy nexus/i],describe:()=>({type:Is.mobile,vendor:"Nexus"})},{test:[/Nokia/i],describe(t){const e=Os.getFirstMatch(/Nokia\s+([0-9]+(\.[0-9]+)?)/i,t),i={type:Is.mobile,vendor:"Nokia"};return e&&(i.model=e),i}},{test:[/[^-]mobi/i],describe:()=>({type:Is.mobile})},{test:t=>"blackberry"===t.getBrowserName(!0),describe:()=>({type:Is.mobile,vendor:"BlackBerry"})},{test:t=>"bada"===t.getBrowserName(!0),describe:()=>({type:Is.mobile})},{test:t=>"windows phone"===t.getBrowserName(),describe:()=>({type:Is.mobile,vendor:"Microsoft"})},{test(t){const e=Number(String(t.getOSVersion()).split(".")[0]);return"android"===t.getOSName(!0)&&e>=3},describe:()=>({type:Is.tablet})},{test:t=>"android"===t.getOSName(!0),describe:()=>({type:Is.mobile})},{test:t=>"macos"===t.getOSName(!0),describe:()=>({type:Is.desktop,vendor:"Apple"})},{test:t=>"windows"===t.getOSName(!0),describe:()=>({type:Is.desktop})},{test:t=>"linux"===t.getOSName(!0),describe:()=>({type:Is.desktop})},{test:t=>"playstation 4"===t.getOSName(!0),describe:()=>({type:Is.tv})},{test:t=>"roku"===t.getOSName(!0),describe:()=>({type:Is.tv})}],Ls=[{test:t=>"microsoft edge"===t.getBrowserName(!0),describe(t){if(/\sedg\//i.test(t))return{name:Ms.Blink};const e=Os.getFirstMatch(/edge\/(\d+(\.?_?\d+)+)/i,t);return{name:Ms.EdgeHTML,version:e}}},{test:[/trident/i],describe(t){const e={name:Ms.Trident},i=Os.getFirstMatch(/trident\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:t=>t.test(/presto/i),describe(t){const e={name:Ms.Presto},i=Os.getFirstMatch(/presto\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test(t){const e=t.test(/gecko/i),i=t.test(/like gecko/i);return e&&!i},describe(t){const e={name:Ms.Gecko},i=Os.getFirstMatch(/gecko\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/(apple)?webkit\/537\.36/i],describe:()=>({name:Ms.Blink})},{test:[/(apple)?webkit/i],describe(t){const e={name:Ms.WebKit},i=Os.getFirstMatch(/webkit\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}}];class Us{constructor(t,e=!1){if(null==t||""===t)throw new Error("UserAgent parameter can't be empty");this._ua=t,this.parsedResult={},!0!==e&&this.parse()}getUA(){return this._ua}test(t){return t.test(this._ua)}parseBrowser(){this.parsedResult.browser={};const t=Os.find(Bs,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.browser=t.describe(this.getUA())),this.parsedResult.browser}getBrowser(){return this.parsedResult.browser?this.parsedResult.browser:this.parseBrowser()}getBrowserName(t){return t?String(this.getBrowser().name).toLowerCase()||"":this.getBrowser().name||""}getBrowserVersion(){return this.getBrowser().version}getOS(){return this.parsedResult.os?this.parsedResult.os:this.parseOS()}parseOS(){this.parsedResult.os={};const t=Os.find(Ns,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.os=t.describe(this.getUA())),this.parsedResult.os}getOSName(t){const{name:e}=this.getOS();return t?String(e).toLowerCase()||"":e||""}getOSVersion(){return this.getOS().version}getPlatform(){return this.parsedResult.platform?this.parsedResult.platform:this.parsePlatform()}getPlatformType(t=!1){const{type:e}=this.getPlatform();return t?String(e).toLowerCase()||"":e||""}parsePlatform(){this.parsedResult.platform={};const t=Os.find(js,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.platform=t.describe(this.getUA())),this.parsedResult.platform}getEngine(){return this.parsedResult.engine?this.parsedResult.engine:this.parseEngine()}getEngineName(t){return t?String(this.getEngine().name).toLowerCase()||"":this.getEngine().name||""}parseEngine(){this.parsedResult.engine={};const t=Os.find(Ls,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.engine=t.describe(this.getUA())),this.parsedResult.engine}parse(){return this.parseBrowser(),this.parseOS(),this.parsePlatform(),this.parseEngine(),this}getResult(){return Os.assign({},this.parsedResult)}satisfies(t){const e={};let i=0;const r={};let o=0;if(Object.keys(t).forEach(s=>{const a=t[s];"string"==typeof a?(r[s]=a,o+=1):"object"==typeof a&&(e[s]=a,i+=1)}),i>0){const t=Object.keys(e),i=Os.find(t,t=>this.isOS(t));if(i){const t=this.satisfies(e[i]);if(void 0!==t)return t}const r=Os.find(t,t=>this.isPlatform(t));if(r){const t=this.satisfies(e[r]);if(void 0!==t)return t}}if(o>0){const t=Object.keys(r),e=Os.find(t,t=>this.isBrowser(t,!0));if(void 0!==e)return this.compareVersion(r[e])}}isBrowser(t,e=!1){const i=this.getBrowserName().toLowerCase();let r=t.toLowerCase();const o=Os.getBrowserTypeByAlias(r);return e&&o&&(r=o.toLowerCase()),r===i}compareVersion(t){let e=[0],i=t,r=!1;const o=this.getBrowserVersion();if("string"==typeof o)return">"===t[0]||"<"===t[0]?(i=t.substr(1),"="===t[1]?(r=!0,i=t.substr(2)):e=[],">"===t[0]?e.push(1):e.push(-1)):"="===t[0]?i=t.substr(1):"~"===t[0]&&(r=!0,i=t.substr(1)),e.indexOf(Os.compareVersions(o,i,r))>-1}isOS(t){return this.getOSName(!0)===String(t).toLowerCase()}isPlatform(t){return this.getPlatformType(!0)===String(t).toLowerCase()}isEngine(t){return this.getEngineName(!0)===String(t).toLowerCase()}is(t,e=!1){return this.isBrowser(t,e)||this.isOS(t)||this.isPlatform(t)}some(t=[]){return t.some(t=>this.is(t))}}class Fs{static getParser(t,e=!1){if("string"!=typeof t)throw new Error("UserAgent should be a string");return new Us(t,e)}static parse(t){return new Us(t).getResult()}static get BROWSER_MAP(){return Es}static get ENGINE_MAP(){return Ms}static get OS_MAP(){return Ps}static get PLATFORMS_MAP(){return Is}}const Ds=new URL(new URL("D9xn2E7Y.gif",import.meta.url).href).href;let Gs=class extends(Et(ht)){#lt;get dialog(){return this.#lt}set dialog(t){this.#lt=t}#Lt;get main(){return this.#Lt}set main(t){this.#Lt=t}#Ut;get cropperCanvas(){return this.#Ut}set cropperCanvas(t){this.#Ut=t}#Ft;get cropperSelection(){return this.#Ft}set cropperSelection(t){this.#Ft=t}#Dt;get cropperImage(){return this.#Dt}set cropperImage(t){this.#Dt=t}#Gt;get cropperShade(){return this.#Gt}set cropperShade(t){this.#Gt=t}#qt;get forcePNGOutput(){return this.#qt}set forcePNGOutput(t){this.#qt=t}#Ht;get options(){return this.#Ht}set options(t){this.#Ht=t}#mt="";get fileName(){return this.#mt}set fileName(t){this.#mt=t}#Vt="";get src(){return this.#Vt}set src(t){this.#Vt=t}#Wt="";#Xt="";#Yt=!1;firstUpdated(){const t=Fs.getParser(window.navigator.userAgent),e=t?.getOS?.()?.name??"";this.#Wt="iOS"===e||"macOS"===e||this.forcePNGOutput?"image/png":"image/webp",this.#Xt="iOS"===e||"macOS"===e||this.forcePNGOutput?"png":"webp",this.#Jt()}#Kt;#Jt(){this.#Kt=new ResizeObserver(()=>{this.#Yt&&this.cropperImage.$center("cover")}),this.#Kt.observe(this.main)}#Qt;#j;async open(t,e,i){return this.#Yt=!1,this.#Qt=i,this.dialog.returnValue="",this.reset(),this.fileName=e,this.src=t,await this.updateComplete,this.dialog.show(),this.cropperImage.$ready(async t=>{this.cropperCanvas.style.width=`${t.naturalWidth}px`,this.cropperCanvas.style.aspectRatio=`${t.naturalWidth} / ${t.naturalHeight}`;const e=this.cropperCanvas.getBoundingClientRect(),i=e.width/e.height,r=this.options?.selectionAspectRatio??i;this.options||(this.options={});const o=this.options.constrainSelectionTo;this.options.constrainSelectionTo=null,this.options?.maximizeSelection?(this.cropperSelection.width=i>r?e.height*r:e.width,this.cropperSelection.height=i<r?e.width/r:e.height):(this.cropperSelection.width=e.width/2,this.cropperSelection.height=e.height/2),this.cropperImage.$center("cover"),this.cropperSelection.$center(),this.options.constrainSelectionTo=o,this.#Yt=!0}),await new Promise(t=>{this.#j=t})}reset(){this.cropperImage.$resetTransform()}blobToFile(t,e){return new File([t],e,{lastModified:(new Date).getTime()})}#Zt(t,e){return t.slice(0,t.lastIndexOf("."))+`.${e}`}async#te(t){const e=document.createElement("canvas"),i=new Image,r=new Promise(t=>{i.onload=()=>{const r=Math.min(i.naturalWidth,i.naturalHeight);e.width=r,e.height=r;const o=e.getContext("2d");o.drawImage(i,0,0),o.globalCompositeOperation="destination-in",o.fillStyle="#000",o.beginPath(),o.arc(.5*r,.5*r,.5*r,0,2*Math.PI),o.fill(),o.globalCompositeOperation="source-over",t(e.toDataURL())}});return i.src=t,await r}#ee(t,e){return t.x>=e.x&&t.y>=e.y&&t.x+t.width<=e.x+e.width&&t.y+t.height<=e.y+e.height}#ie(t){if(!this.cropperCanvas||"image"!==this.options?.constrainSelectionTo)return;const e=this.cropperImage,i=this.cropperSelection,r=this.cropperCanvas.getBoundingClientRect(),o=e.cloneNode();o.style.transform=`matrix(${t.detail.matrix.join(", ")})`,o.style.opacity="0",this.cropperCanvas.appendChild(o);const s=o.getBoundingClientRect();this.cropperCanvas.removeChild(o);const a=i,n={x:s.left-r.left,y:s.top-r.top,width:s.width,height:s.height};this.#ee(a,n)||t.preventDefault()}#re(t){if(!this.cropperCanvas||!this.options?.constrainSelectionTo)return;const e=this.cropperCanvas.getBoundingClientRect(),i={x:t.detail.x,y:t.detail.y,width:t.detail.width-1,height:t.detail.height-1};switch(this.options?.constrainSelectionTo){case"canvas":{const r={x:0,y:0,width:e.width,height:e.height};this.#ee(i,r)||(t.preventDefault(),this.#oe());break}case"image":{if(!this.#Yt)return;const r=this.cropperImage.getBoundingClientRect(),o={x:r.left-e.left,y:r.top-e.top,width:r.width,height:r.height};this.#ee(i,o)||(t.preventDefault(),this.#oe());break}}}#oe(){setTimeout(()=>this.cropperShade.$change(this.cropperSelection.x,this.cropperSelection.y,this.cropperSelection.width,this.cropperSelection.height),0)}static{this.styles=[ys,$s,bs,d`
      :host {
        display: block;
      }
    ...
    `}};r([yt("md-dialog")],Gs.prototype,"dialog",null),r([yt("main")],Gs.prototype,"main",null),r([yt("cropper-canvas")],Gs.prototype,"cropperCanvas",null),r([yt("cropper-selection")],Gs.prototype,"cropperSelection",null),r([yt("cropper-image")],Gs.prototype,"cropperImage",null),r([yt("cropper-shade")],Gs.prototype,"cropperShade",null),r([vt({type:Boolean,reflect:!0,attribute:"force-png"})],Gs.prototype,"forcePNGOutput",null),r([vt({type:Object})],Gs.prototype,"options",null),r([gt()],Gs.prototype,"fileName",null),r([gt()],Gs.prototype,"src",null),Gs=r([ut("crop-and-save-image-dialog")],Gs);let qs=class extends ht{#se;get imageUrl(){return this.#se}set imageUrl(t){this.#se=t}#ae;get downloadSrc(){return this.#ae}set downloadSrc(t){this.#ae=t}#ne;get filename(){return this.#ne}set filename(t){this.#ne=t}#lt;get dialog(){return this.#lt}set dialog(t){this.#lt=t}async open(t,e,i){return this.imageUrl=void 0,this.filename=i,this.downloadSrc=e,this.imageUrl=t,this.dialog.show()}static{this.styles=[d`
      div[header] {
...
`;let ia=class extends Ks{};ia.styles=[ta,ea,Zs,Qs],ia=r([ut("md-input-chip")],ia);const ra=(t,e,i)=>{const r=new Map;for(let o=e;o<=i;o++)r.set(t[o],o);return r},oa=Wt(class extends Xt{constructor(t){if(super(t),t.type!==Vt.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,i){let r;void 0===i?i=e:void 0!==e&&(r=e);const o=[],s=[];let a=0;for(const e of t)o[a]=r?r(e,a):a,s[a]=i(e,a),a++;return{values:s,keys:o}}render(t,e,i){return this.dt(t,e,i).values}update(t,[e,i,r]){const o=(t=>t._$AH)(t),{values:s,keys:a}=this.dt(e,i,r);if(!Array.isArray(o))return this.ut=a,s;const n=this.ut??=[],l=[];let c,d,h=0,p=o.length-1,u=0,m=s.length-1;for(;h<=p&&u<=m;)if(null===o[h])h++;else if(null===o[p])p--;else if(n[h]===a[u])l[u]=er(o[h],s[u]),h++,u++;else if(n[p]===a[m])l[m]=er(o[p],s[m]),p--,m--;else if(n[h]===a[m])l[m]=er(o[h],s[m]),tr(t,l[m+1],o[h]),h++,m--;else if(n[p]===a[u])l[u]=er(o[p],s[u]),tr(t,o[h],o[p]),p--,u++;else if(void 0===c&&(c=ra(a,u,m),d=ra(n,h,p)),c.has(n[h]))if(c.has(n[p])){const e=d.get(a[u]),i=void 0!==e?o[e]:null;if(null===i){const e=tr(t,o[h]);er(e,s[u]),l[u]=e}else l[u]=er(i,s[u]),tr(t,o[h],i),o[e]=null;u++}else or(o[p]),p--;else or(o[h]),h++;for(;u<=m;){const e=tr(t,l[m+1]);er(e,s[u]),l[u++]=e}for(;h<=p;){const t=o[h++];null!==t&&or(t)}return this.ut=a,rr(t,l),W}}),sa=["tiff","pjp","jfif","bmp","gif","svg","png","xbm","dib","jxl","jpeg","svgz","jpg","webp","ico","tif","pjpeg","avif"];function aa(t){const e=t.split(".");return e?.[e.length-1]||""}function na(t){return"pdf"===t.toLowerCase()?new URL(new URL("BrwlMowD.png",import.meta.url).href).href:new URL(new URL("Ciwo_vsG.png",import.meta.url).href).href}function la(t,e){if(t?.CdnFileName&&!e)return`https://cdn.leavitt.com/${t.CdnFileName}.${t.Extension}?d=${encodeURIComponent(`${t.Name}.${t.Extension}`)}`}function ca(t,e){if(t?.CdnFileName)return t?.PreviewSizes&&t?.PreviewSizes?.split(",").includes(String(e))&&"svg"!==t.Extension?`https://cdn.leavitt.com/${t.CdnFileName}-${e}.${t.PreviewExtension}`:function(t){return"png"===t?.Extension||"jpg"===t?.Extension||"jpeg"===t?.Extension||"gif"===t?.Extension||"svg"===t?.Extension||"webp"===t?.Extension}(t)?`https://cdn.leavitt.com/${t.CdnFileName}.${t.Extension}`:void 0}let da=class extends ht{#le=[];get files(){return this.#le}set files(t){this.#le=t}#ce=!1;get isOver(){return this.#ce}set isOver(t){this.#ce=t}#de=void 0;get previewSrc(){return this.#de}set previewSrc(t){this.#de=t}#he;get input(){return this.#he}set input(t){this.#he=t}#pe;get imagePreviewDialog(){return this.#pe}set imagePreviewDialog(t){this.#pe=t}#ue;get cropperDialog(){return this.#ue}set cropperDialog(t){this.#ue=t}#me;get confirmDeleteDialog(){return this.#me}set confirmDeleteDialog(t){this.#me=t}#fe;get chipMultiSelect(){return this.#fe}set chipMultiSelect(t){this.#fe=t}#ve=[];#ge="image/*,.pdf";get accept(){return this.#ge}set accept(t){this.#ge=t}#be=!1;get multiple(){return this.#be}set multiple(t){this.#be=t}#It=!1;get required(){return this.#It}set required(t){this.#It=t}#Nt=!1;get disabled(){return this.#Nt}set disabled(t){this.#Nt=t}#ye=!1;get confirmDelete(){return this.#ye}set confirmDelete(t){this.#ye=t}#xe="Confirm delete";get confirmDeleteHeader(){return this.#xe}set confirmDeleteHeader(t){this.#xe=t}#we="Are you sure you would like to delete this attachment?";get confirmDeleteText(){return this.#we}set confirmDeleteText(t){this.#we=t}#_e="Add attachment";get addButtonLabel(){return this.#_e}set addButtonLabel(t){this.#_e=t}#Ct="Attachments";get label(){return this.#Ct}set label(t){this.#Ct=t}#Mt;get supportingText(){return this.#Mt}set supportingText(t){this.#Mt=t}#Et="No attachments";get noItemsText(){return this.#Et}set noItemsText(t){this.#Et=t}#Ht;get options(){return this.#Ht}set options(t){this.#Ht=t}#qt;get forcePNGOutput(){return this.#qt}set forcePNGOutput(t){this.#qt=t}#ke=["tiff","pjp","jfif","bmp","gif","svg","png","xbm","dib","jxl","jpeg","svgz","jpg","webp","ico","tif","pjpeg","avif"];get croppableImageFormats(){return this.#ke}set croppableImageFormats(t){this.#ke=t}getFiles(){return this.files}setFiles(...t){this.files=[...t].map(t=>({file:new File([""],t.fileName),previewSrc:t.previewSrc,downloadSrc:t.downloadSrc,id:t.id})),this.#ve=structuredClone(this.files)}setFilesFromDatabaseAttachments(...t){this.files=[...t].filter(t=>t.Name&&t.Extension).map(t=>({id:t.Id,file:new File([""],`${t?.Name}.${t?.Extension}`),previewSrc:ca(t,512),downloadSrc:la(t)})),this.#ve=structuredClone(this.files)}checkValidity(){return this.chipMultiSelect.checkValidity()}reportValidity(){return this.chipMultiSelect.reportValidity()}hasChanges(){return JSON.stringify(this.#ve)!==JSON.stringify(this.files)}async reset(){this.#ve=[],this.previewSrc=void 0,this.files=[],this.isOver=!1,await this.updateComplete,this.chipMultiSelect.reset()}async handleNewFile(t){let e=!1;for(let i=0;i<(t?.length??0);i++){const r=t?.item(i);if(r){const t=this.croppableImageFormats.some(t=>r.name?.toLowerCase()?.endsWith(t?.toLowerCase()));if(t){"cropped"===await this.cropperDialog.open(URL.createObjectURL(r),r.name,async(t,e)=>{const i={file:t,previewSrc:e??void 0};this.multiple?this.files=[...this.files,i]:this.files=[i]})&&(this.reportValidity(),e=!0),await It(500)}else{const t={file:r},i=sa.some(t=>r.name.endsWith(t));if(i)try{const e=await this.toBase64(r);"string"==typeof e&&(t.previewSrc=e??void 0)}catch{}this.multiple?this.files=[...this.files,t]:this.files=[t],this.reportValidity(),e=!0}}}e&&this.#$e()}#ze=null;#Ae(t){const e=this.files.findIndex(e=>e===t);this.files.splice(e,1),this.requestUpdate("files"),this.reportValidity(),this.#$e()}toBase64(t){return new Promise((e,i)=>{const r=new FileReader;r.readAsDataURL(t),r.onload=()=>e(r.result),r.onerror=t=>i(t)})}#$e(){this.dispatchEvent(new Event("change"))}static{this.styles=[$s,d`
    ...
    `]}render(){return V`
      ...
      >
        ...
        >
        ${oa(this.files,t=>t.file.name,t=>V`<md-input-chip
              ...
              @click=${()=>{(t.previewSrc||t.downloadSrc)&&this.imagePreviewDialog.open(t.previewSrc||na(aa(t.file.name)),t.downloadSrc,t.file.name)}}
            >
              <img draggable="false" slot="icon" src=${t.previewSrc||na(aa(t.file.name))} />
            </md-input-chip>`)}
      </titanium-chip-multi-select>
    ...
    `}};r([vt({type:Array})],da.prototype,"files",null),r([vt({type:Boolean,reflect:!0,attribute:"is-over"})],da.prototype,"isOver",null),r([vt({type:String})],da.prototype,"previewSrc",null),r([yt("input")],da.prototype,"input",null),r([yt("image-preview-dialog")],da.prototype,"imagePreviewDialog",null),r([yt("crop-and-save-image-dialog")],da.prototype,"cropperDialog",null),r([yt("md-dialog[confirm-delete]")],da.prototype,"confirmDeleteDialog",null),r([yt("titanium-chip-multi-select")],da.prototype,"chipMultiSelect",null),r([vt({type:String})],da.prototype,"accept",null),r([vt({type:Boolean})],da.prototype,"multiple",null),r([vt({type:Boolean})],da.prototype,"required",null),r([vt({type:Boolean,reflect:!0})],da.prototype,"disabled",null),r([vt({type:Boolean})],da.prototype,"confirmDelete",null),r([vt({type:String})],da.prototype,"confirmDeleteHeader",null),r([vt({type:String})],da.prototype,"confirmDeleteText",null),r([vt({type:String})],da.prototype,"addButtonLabel",null),r([vt({type:String})],da.prototype,"label",null),r([vt({type:String})],da.prototype,"supportingText",null),r([vt({type:String})],da.prototype,"noItemsText",null),r([vt({type:Object})],da.prototype,"options",null),r([vt({type:Boolean,reflect:!0,attribute:"force-png"})],da.prototype,"forcePNGOutput",null),r([vt({type:Array})],da.prototype,"croppableImageFormats",null),da=r([ut("titanium-smart-attachment-input")],da);class ha{async _getBearerTokenAsync(){return await Rt().getAccessTokenAsync()}}class pa{constructor(t,e){this.status=t.status,this.headers=t.headers,this.blob=e}}class ua{constructor(){this.type=null,this.shortType=null}}class ma{constructor(t=new ua){this._odataInfo=t}}class fa{static#Se(t){const e=new Map;return Object.keys(t).filter(t=>0===t.indexOf("@odata")).forEach(i=>e.set(i.replace("@odata.",""),t[i])),e}#Te(t){return null===t.value||void 0===t.value||Array.isArray(t.value)?t:t.value}static#Ce(t){return Array.isArray(t.value)?t.value:[]}get odataCount(){return this.metadata.has("count")?this.metadata.get("count"):0}count(){return this.entities.length}firstOrDefault(){return this.count()>0?this.entities[0]:null}toList(){return this.entities}constructor(t,e){this.status=t.status,this.headers=t.headers,this.metadata=fa.#Se(e),this.entities=fa.#Ce(e),this.entity=0===this.entities.length?this.#Te(e):null}get containsMultipleEntities(){return this.entities.length>0}}const va=new Map;va.set(0,"CORS Error"),va.set(200,"OK"),va.set(201,"Created"),va.set(202,"Accepted"),va.set(203,"Non-Authoritative Information"),va.set(204,"No Content"),va.set(205,"Reset Content"),va.set(206,"Partial Content"),va.set(300,"Multiple Choices"),va.set(301,"Moved Permanently"),va.set(302,"Found"),va.set(303,"See Other"),va.set(304,"Not Modified"),va.set(305,"Use Proxy"),va.set(306,"Unused"),va.set(307,"Temporary Redirect"),va.set(400,"Bad Request"),va.set(401,"Unauthorized"),va.set(402,"Payment Required"),va.set(403,"Forbidden"),va.set(404,"Not Found"),va.set(405,"Method Not Allowed"),va.set(406,"Not Acceptable"),va.set(407,"Proxy Authentication Required"),va.set(408,"Request Timeout"),va.set(409,"Conflict"),va.set(410,"Gone"),va.set(411,"Length Required"),va.set(412,"Precondition Required"),va.set(413,"Request Entry Too Large"),va.set(414,"Request-URI Too Long"),va.set(415,"Unsupported Media Type"),va.set(416,"Requested Range Not Satisfiable"),va.set(417,"Expectation Failed"),va.set(418,"I'm a teapot"),va.set(429,"Too Many Requests"),va.set(500,"Internal Server Error"),va.set(501,"Not Implemented"),va.set(502,"Bad Gateway"),va.set(503,"Service Unavailable"),va.set(504,"Gateway Timeout"),va.set(505,"HTTP Version Not Supported");class ga{constructor(t,e){this.headers={},this.baseUrl="https://api2.leavitt.com/",this.#Ee=t,this.addHeader("Content-Type","application/json"),this.#Ie=e?.appNameHeaderKey?e?.appNameHeaderKey:"X-LGAppName",this.addHeader(this.#Ie,"General")}#Ee;#Ie;addHeader(t,e){this.headers[t]=e}deleteHeader(t){delete this.headers[t]}#Pe(t){return this.baseUrl?.endsWith("/")&&t?.startsWith("/")&&Ct&&alert(`API Service Warning: Malformed url, double slashes present. \r\n\r\n${this.baseUrl}${t}`),`${this.baseUrl}${t}`}async uploadFile(t,e,i,r){try{if(r?.abortController?.signal&&r?.abortController.signal.aborted)throw new ba;const o=4;if(!e||!e.name)throw new Error("ArgumentException: Invalid file passed to uploadFile.");const s=new XMLHttpRequest;s.onabort=function(){throw new ba},r?.abortController?.signal&&(r?.abortController.signal.addEventListener("abort",()=>s.abort()),s.onreadystatechange=function(){s.readyState===o&&r?.abortController?.signal.removeEventListener("abort",()=>s.abort())}),s.upload.addEventListener("progress",t=>{i(t,s)}),s.open("POST",this.#Pe(t),!0);const a={...this.headers},n=await this.#Ee._getBearerTokenAsync();null!==n&&(a.Authorization=`Bearer ${n}`),a["X-LGAttachmentName"]=e.name;for(const t in a)s.setRequestHeader(t,a[t]);return new Promise((i,o)=>{s.addEventListener("loadend",()=>{try{const e={text:()=>s.response,status:s.status};if("blob"===r?.responseType){const r=this.#Me(e,"UPLOAD",t);return i(r)}{const r=this.#Oe(e,"UPLOAD",t);return i(r)}}catch(t){return o(t)}},!1),s.send(e)})}catch(e){return Promise.reject(this.#Re(e,"UPLOAD",t))}}async postAsync(t,e={},i){e instanceof ma&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers};i?.sendAsFormData&&delete r["Content-Type"];const o=await this.#Ee._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#Pe(t),{method:"POST",body:i?.sendAsFormData?this.#Be(e):JSON.stringify(e),headers:r,signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Re(e,"POST",t))}return"blob"===i?.responseType?await this.#Me(s,"POST",t):await this.#Oe(s,"POST",t)}async patchAsync(t,e,i){e instanceof ma&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers},o=await this.#Ee._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#Pe(t),{method:"PATCH",body:JSON.stringify(e),headers:r,signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Re(e,"PATCH",t))}return"blob"===i?.responseType?await this.#Me(s,"PATCH",t):await this.#Oe(s,"PATCH",t)}async patchReturnDtoAsync(t,e,i){e instanceof ma&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers},o=await this.#Ee._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#Pe(t),{method:"PATCH",body:JSON.stringify(e),headers:{...r,Prefer:"return=representation"},signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Re(e,"PATCH",t))}return"blob"===i?.responseType?await this.#Me(s,"PATCH",t):await this.#Oe(s,"PATCH",t)}async deleteAsync(t,e){const i={...this.headers},r=await this.#Ee._getBearerTokenAsync();let o;null!==r&&(i.Authorization=`Bearer ${r}`);try{o=await fetch(this.#Pe(t),{method:"DELETE",headers:i,signal:e?.abortController?.signal})}catch(e){return Promise.reject(this.#Re(e,"DELETE",t))}return"blob"===e?.responseType?await this.#Me(o,"DELETE",t):await this.#Oe(o,"DELETE",t)}async getAsync(t,e){const i={...this.headers},r=await this.#Ee._getBearerTokenAsync();let o;null!==r&&(i.Authorization=`Bearer ${r}`);try{o=await fetch(this.#Pe(t),{method:"GET",headers:i,signal:e?.abortController?.signal})}catch(e){return Promise.reject(this.#Re(e,"GET",t))}return"blob"===e?.responseType?await this.#Me(o,"GET",t):await this.#Oe(o,"GET",t)}#Ne(t,e,i){return i.indexOf(t)===e}async aggregateResponses(t){const e=new Map,i=[],r=t.map(async t=>{try{await t()}catch(t){i.push(t);const r=t.message;e.set(r,(e.get(r)??0)+1)}});if(await Promise.allSettled(r),e.size>0){const r={type:"HttpError",action:i.map(t=>t.action).filter(this.#Ne).join(", "),message:`${i.length} of ${t.length} actions failed`,detail:Array.from(e.keys()).map(t=>`${e.get(t)} error(s):  ${t}`).join("\n"),baseUrl:i.map(t=>t.baseUrl).filter(this.#Ne).join(", "),path:i.map(t=>t.path).filter(this.#Ne).join(", ")};return Promise.reject(r)}}#Re(t,e,i,r=void 0){const o=t?.message?.includes("Failed to fetch")?"Network error. Check your connection and try again.":"AbortError"===t?.name?"Abort error. Request has been aborted.":t?.message||t;return{type:"HttpError",statusCode:r,baseUrl:this.baseUrl,message:o,action:e,path:i}}async#Me(t,e,i){try{if(0===t.status||t.status>=400&&t.status<=600){const r=await t.text(),o=r.length?JSON.parse(r):{},s=o?.error?.message||(o.error&&"string"==typeof o.error?o.error:void 0)||o?.value||va.get(t.status)||"unknown";o?.details&&console.warn(o.details);const a={type:"HttpError",statusCode:t.status,baseUrl:this.baseUrl,message:s,detail:o?.details||o?.error_description,raw:o,action:e,path:i};return Promise.reject(a)}{const e=await t.blob();return Promise.resolve(new pa(t,e))}}catch(t){return Promise.reject(`The server sent back invalid JSON. ${t}`)}}async#Oe(t,e,i){const r=await t.text();let o;try{if(o=r.length?JSON.parse(r):{},0===t.status||t.status>=400&&t.status<=600){const r=o?.error?.message||(o.error&&"string"==typeof o.error?o.error:void 0)||o?.value||va.get(t.status)||"unknown";o?.details&&console.warn(o.details);const s={type:"HttpError",statusCode:t.status,baseUrl:this.baseUrl,message:r,detail:o?.details||o?.error_description,raw:o,action:e,path:i};return Promise.reject(s)}return Promise.resolve(new fa(t,o))}catch(t){return Promise.reject(`The server sent back invalid JSON. ${t}`)}}#Be(t,e,i){const r=e||new FormData;let o;for(const e in t)if(Object.hasOwn(t,e)){if(void 0===t[e])continue;o=i?t[e]instanceof File?i:i+"["+e+"]":e,"object"!=typeof t[e]||t[e]instanceof File?r.append(o,t[e]):this.#Be(t[e],r,o)}return r}}class ba extends Error{constructor(){super(...arguments),this.name="AbortError",this.message="Aborted"}}function ya(t){const e=()=>{t?.open&&t.close("navigation-close")};t.i=e,window.addEventListener("popstate",e,!1)}function xa(t){t?.i&&(window.removeEventListener("popstate",t.i,!1),t.i=void 0)}const wa=new ga(new ha);wa.baseUrl=Ct?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",wa.addHeader("X-LGAppName","IssueTracking"),Object.freeze(wa);let _a=class extends(Et(ht)){#lt;get dialog(){return this.#lt}set dialog(t){this.#lt=t}#je;get snackbar(){return this.#je}set snackbar(t){this.#je=t}#Le;get textArea(){return this.#Le}set textArea(t){this.#Le=t}#Ue;get imageInput(){return this.#Ue}set imageInput(t){this.#Ue=t}show(){this.reset(),this.dialog.show()}reset(){this.dialog.returnValue="",this.imageInput?.reset(),this.textArea?.reset()}async#Fe(){if(!this.textArea.reportValidity()||this.isLoading)return;const t={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Bug",Description:this.textArea.value,Attachments:(this.imageInput?.getFiles()??[]).map(t=>t.file)};try{const e=wa.postAsync("Issues/ReportIssue",t,{sendAsFormData:!0});this.dispatchEvent(new Se(e)),this.loadWhile(e);if(!(await e).entity)throw new Error("Error submitting problem. Please try again.");document.dispatchEvent(new ze("",{overrideTemplate:V`Thank you for bringing this issue to our attention!<br />
              <br />
              Our engineering teams will promptly investigate and address it.`})),this.reset(),this.dialog.close("done")}catch(t){this.dispatchEvent(new ze(t))}}static{this.styles=[ys,$s,d`
      :host {
        display: grid;
        gap: 24px;
      }
    ...
    `]}render(){return V`
      <md-dialog
        @open=${t=>{ya(t.target),gs(t.target)}}
        @close=${t=>{if("cancel"===t.target.returnValue||"done"===t.target.returnValue)return xa(t.target),void this.snackbar.dismissAll();t.preventDefault()}}
      >
        ...
        <div slot="actions">
          ...
          <md-text-button ?disabled=${this.isLoading} @click=${()=>this.#Fe()}>Submit</md-text-button>
        </div>
      </md-dialog>
    `}};r([yt("md-dialog")],_a.prototype,"dialog",null),r([yt("titanium-snackbar-stack")],_a.prototype,"snackbar",null),r([yt("md-outlined-text-field")],_a.prototype,"textArea",null),r([yt("titanium-smart-attachment-input")],_a.prototype,"imageInput",null),_a=r([ut("report-a-problem-dialog")],_a);const ka=new ga(new ha);ka.baseUrl=Ct?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",ka.addHeader("X-LGAppName","IssueTracking"),Object.freeze(ka);let $a=class extends(Et(ht)){#lt;get dialog(){return this.#lt}set dialog(t){this.#lt=t}#je;get snackbar(){return this.#je}set snackbar(t){this.#je=t}#Le;get textArea(){return this.#Le}set textArea(t){this.#Le=t}show(){this.reset(),this.dialog.show()}reset(){this.dialog.returnValue="",this.textArea?.reset()}async#Fe(){if(!this.textArea.reportValidity()||this.isLoading||!this.textArea.value)return;const t={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Feedback",Description:this.textArea.value,Attachments:[]};try{const e=ka.postAsync("Issues/ReportIssue",t,{sendAsFormData:!0});this.dispatchEvent(new Se(e)),this.loadWhile(e);if(!(await e).entity)throw new Error("Error submitting feedback. Please try again.");document.dispatchEvent(new ze("We appreciate your input, and we will promptly conduct a review!")),this.reset(),this.dialog.close("done")}catch(t){this.dispatchEvent(new ze(t))}}static{this.styles=[ys,$s,d`
      :host {
        display: grid;
        gap: 24px;
      }
    ...
    `}};r([yt("md-dialog")],$a.prototype,"dialog",null),r([yt("titanium-snackbar-stack")],$a.prototype,"snackbar",null),r([yt("md-outlined-text-field")],$a.prototype,"textArea",null),$a=r([ut("provide-feedback-dialog")],$a);const za=d`:host{--_container-height: var(--md-outlined-icon-button-container-height, 40px);--_container-width: var(--md-outlined-icon-button-container-width, 40px);--_disabled-icon-color: var(--md-outlined-icon-button-disabled-icon-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-icon-opacity: var(--md-outlined-icon-button-disabled-icon-opacity, 0.38);--_disabled-selected-container-color: var(--md-outlined-icon-button-disabled-selected-container-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-selected-container-opacity: var(--md-outlined-icon-button-disabled-selected-container-opacity, 0.12);--_hover-state-layer-opacity: var(--md-outlined-icon-button-hover-state-layer-opacity, 0.08);--_icon-size: var(--md-outlined-icon-button-icon-size, 24px);--_pressed-state-layer-opacity: var(--md-outlined-icon-button-pressed-state-layer-opacity, 0.12);--_selected-container-color: var(--md-outlined-icon-button-selected-container-color, var(--md-sys-color-inverse-surface, #322f35));--_selected-focus-icon-color: var(--md-outlined-icon-button-selected-focus-icon-color, var(--md-sys-color-inverse-on-surface, #f5eff7));--_selected-hover-icon-color: var(--md-outlined-icon-button-selected-hover-icon-color, var(--md-sys-color-inverse-on-surface, #f5eff7));--_selected-hover-state-layer-color: var(--md-outlined-icon-button-selected-hover-state-layer-color, var(--md-sys-color-inverse-on-surface, #f5eff7));--_selected-icon-color: var(--md-outlined-icon-button-selected-icon-color, var(--md-sys-color-inverse-on-surface, #f5eff7));--_selected-pressed-icon-color: var(--md-outlined-icon-button-selected-pressed-icon-color, var(--md-sys-color-inverse-on-surface, #f5eff7));--_selected-pressed-state-layer-color: var(--md-outlined-icon-button-selected-pressed-state-layer-color, var(--md-sys-color-inverse-on-surface, #f5eff7));--_disabled-outline-color: var(--md-outlined-icon-button-disabled-outline-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-outline-opacity: var(--md-outlined-icon-button-disabled-outline-opacity, 0.12);--_focus-icon-color: var(--md-outlined-icon-button-focus-icon-color, var(--md-sys-color-on-surface-variant, #49454f));--_hover-icon-color: var(--md-outlined-icon-button-hover-icon-color, var(--md-sys-color-on-surface-variant, #49454f));--_hover-state-layer-color: var(--md-outlined-icon-button-hover-state-layer-color, var(--md-sys-color-on-surface-variant, #49454f));--_icon-color: var(--md-outlined-icon-button-icon-color, var(--md-sys-color-on-surface-variant, #49454f));--_outline-color: var(--md-outlined-icon-button-outline-color, var(--md-sys-color-outline, #79747e));--_outline-width: var(--md-outlined-icon-button-outline-width, 1px);--_pressed-icon-color: var(--md-outlined-icon-button-pressed-icon-color, var(--md-sys-color-on-surface, #1d1b20));--_pressed-state-layer-color: var(--md-outlined-icon-button-pressed-state-layer-color, var(--md-sys-color-on-surface, #1d1b20));--_container-shape-start-start: var(--md-outlined-icon-button-container-shape-start-start, var(--md-outlined-icon-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-start-end: var(--md-outlined-icon-button-container-shape-start-end, var(--md-outlined-icon-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-end: var(--md-outlined-icon-button-container-shape-end-end, var(--md-outlined-icon-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-start: var(--md-outlined-icon-button-container-shape-end-start, var(--md-outlined-icon-button-container-shape, var(--md-sys-shape-corner-full, 9999px)))}.outlined{background-color:rgba(0,0,0,0);color:var(--_icon-color);--md-ripple-hover-color: var(--_hover-state-layer-color);--md-ripple-hover-opacity: var(--_hover-state-layer-opacity);--md-ripple-pressed-color: var(--_pressed-state-layer-color);--md-ripple-pressed-opacity: var(--_pressed-state-layer-opacity)}.outlined::before{border-color:var(--_outline-color);border-width:var(--_outline-width)}.outlined:hover{color:var(--_hover-icon-color)}.outlined:focus{color:var(--_focus-icon-color)}.outlined:active{color:var(--_pressed-icon-color)}.outlined:is(:disabled,[aria-disabled=true]){color:var(--_disabled-icon-color)}.outlined:is(:disabled,[aria-disabled=true])::before{border-color:var(--_disabled-outline-color);opacity:var(--_disabled-outline-opacity)}.outlined:is(:disabled,[aria-disabled=true]) .icon{opacity:var(--_disabled-icon-opacity)}.outlined::before{block-size:100%;border-style:solid;border-radius:inherit;box-sizing:border-box;content:"";inline-size:100%;inset:0;pointer-events:none;position:absolute;z-index:-1}.outlined.selected::before{border-width:0}.selected{--md-ripple-hover-color: var(--_selected-hover-state-layer-color);--md-ripple-hover-opacity: var(--_hover-state-layer-opacity);--md-ripple-pressed-color: var(--_selected-pressed-state-layer-color);--md-ripple-pressed-opacity: var(--_pressed-state-layer-opacity)}.selected:not(:disabled,[aria-disabled=true]){color:var(--_selected-icon-color)}.selected:not(:disabled,[aria-disabled=true]):hover{color:var(--_selected-hover-icon-color)}.selected:not(:disabled,[aria-disabled=true]):focus{color:var(--_selected-focus-icon-color)}.selected:not(:disabled,[aria-disabled=true]):active{color:var(--_selected-pressed-icon-color)}.selected:not(:disabled,[aria-disabled=true])::before{background-color:var(--_selected-container-color)}.selected:is(:disabled,[aria-disabled=true])::before{background-color:var(--_disabled-selected-container-color);opacity:var(--_disabled-selected-container-opacity)}@media(forced-colors: active){:host(:is([disabled],[soft-disabled])){--_disabled-outline-opacity: 1}.selected::before{border-color:CanvasText;border-width:var(--_outline-width)}.selected:is(:disabled,[aria-disabled=true])::before{border-color:GrayText;opacity:1}}
`;let Aa=class extends Ei{getRenderClasses(){return{...super.getRenderClasses(),outlined:!0}}};Aa.styles=[Ii,za],Aa=r([ut("md-outlined-icon-button")],Aa);const Sa=new Set(Object.values(Ze));class Ta extends ht{get items(){return this.listController.items}constructor(){super(),this.listController=new ti({isItem:t=>t.hasAttribute("md-list-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>"rtl"===getComputedStyle(this).direction,deactivateItem:t=>{t.tabIndex=-1},activateItem:t=>{t.tabIndex=0},isNavigableKey:t=>Sa.has(t),isActivatable:t=>!t.disabled&&"text"!==t.type}),this.internals=this.attachInternals(),this.internals.role="list",this.addEventListener("keydown",this.listController.handleKeydown)}render(){return V`
      <slot
        @deactivate-items=${this.listController.onDeactivateItems}
        @request-activation=${this.listController.onRequestActivation}
        @slotchange=${this.listController.onSlotchange}>
      </slot>
    `}activateNextItem(){return this.listController.activateNextItem()}activatePreviousItem(){return this.listController.activatePreviousItem()}}r([_t({flatten:!0})],Ta.prototype,"slotItems",void 0);const Ca=d`:host{background:var(--md-list-container-color, var(--md-sys-color-surface, #fef7ff));color:unset;display:flex;flex-direction:column;outline:none;padding:8px 0;position:relative}
`;let Ea=class extends Ta{};Ea.styles=[Ca],Ea=r([ut("md-list")],Ea);class Ia extends ht{constructor(){super(...arguments),this.multiline=!1}render(){return V`
      <slot name="container"></slot>
    ...
    `}handleTextSlotChange(){let t=!1,e=0;for(const i of this.textSlots)if(Pa(i)&&(e+=1),e>1){t=!0;break}this.multiline=t}}function Pa(t){for(const e of t.assignedNodes({flatten:!0})){const t=e.nodeType===Node.ELEMENT_NODE,i=e.nodeType===Node.TEXT_NODE&&e.textContent?.match(/\S/);if(t||i)return!0}return!1}r([vt({type:Boolean,reflect:!0})],Ia.prototype,"multiline",void 0),r([wt(".text slot")],Ia.prototype,"textSlots",void 0);const Ma=d`:host{color:var(--md-sys-color-on-surface, #1d1b20);font-family:var(--md-sys-typescale-body-large-font, var(--md-ref-typeface-plain, Roboto));font-size:var(--md-sys-typescale-body-large-size, 1rem);font-weight:var(--md-sys-typescale-body-large-weight, var(--md-ref-typeface-weight-regular, 400));line-height:var(--md-sys-typescale-body-large-line-height, 1.5rem);align-items:center;box-sizing:border-box;display:flex;gap:16px;min-height:56px;overflow:hidden;padding:12px 16px;position:relative;text-overflow:ellipsis}:host([multiline]){min-height:72px}[name=overline]{color:var(--md-sys-color-on-surface-variant, #49454f);font-family:var(--md-sys-typescale-label-small-font, var(--md-ref-typeface-plain, Roboto));font-size:var(--md-sys-typescale-label-small-size, 0.6875rem);font-weight:var(--md-sys-typescale-label-small-weight, var(--md-ref-typeface-weight-medium, 500));line-height:var(--md-sys-typescale-label-small-line-height, 1rem)}[name=supporting-text]{color:var(--md-sys-color-on-surface-variant, #49454f);font-family:var(--md-sys-typescale-body-medium-font, var(--md-ref-typeface-plain, Roboto));font-size:var(--md-sys-typescale-body-medium-size, 0.875rem);font-weight:var(--md-sys-typescale-body-medium-weight, var(--md-ref-typeface-weight-regular, 400));line-height:var(--md-sys-typescale-body-medium-line-height, 1.25rem)}[name=trailing-supporting-text]{color:var(--md-sys-color-on-surface-variant, #49454f);font-family:var(--md-sys-typescale-label-small-font, var(--md-ref-typeface-plain, Roboto));font-size:var(--md-sys-typescale-label-small-size, 0.6875rem);font-weight:var(--md-sys-typescale-label-small-weight, var(--md-ref-typeface-weight-medium, 500));line-height:var(--md-sys-typescale-label-small-line-height, 1rem)}[name=container]::slotted(*){inset:0;position:absolute}.default-slot{display:inline}.default-slot,.text ::slotted(*){overflow:hidden;text-overflow:ellipsis}.text{display:flex;flex:1;flex-direction:column;overflow:hidden}
`;let Oa=class extends Ia{};Oa.styles=[Ma],Oa=r([ut("md-item")],Oa);const Ra=le(ht);class Ba extends Ra{constructor(){super(...arguments),this.disabled=!1,this.type="text",this.isListItem=!0,this.href="",this.target=""}get isDisabled(){return this.disabled&&"link"!==this.type}willUpdate(t){this.href&&(this.type="link"),super.willUpdate(t)}render(){return this.renderListItem(V`
      <md-item>
        <div slot="container">
...
`;let ja=class extends Ba{};ja.styles=[Na],ja=r([ut("md-list-item")],ja);var La=function(){return La=Object.assign||function(t){for(var e,i=1,r=arguments.length;i<r;i++)for(var o in e=arguments[i])Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o]);return t},La.apply(this,arguments)},Ua=function(){function t(t,e,i){var r=this;this.endVal=e,this.options=i,this.version="2.9.0",this.defaults={startVal:0,decimalPlaces:0,duration:2,useEasing:!0,useGrouping:!0,useIndianSeparators:!1,smartEasingThreshold:999,smartEasingAmount:333,separator:",",decimal:".",prefix:"",suffix:"",enableScrollSpy:!1,scrollSpyDelay:200,scrollSpyOnce:!1},this.finalEndVal=null,this.useEasing=!0,this.countDown=!1,this.error="",this.startVal=0,this.paused=!0,this.once=!1,this.count=function(t){r.startTime||(r.startTime=t);var e=t-r.startTime;r.remaining=r.duration-e,r.useEasing?r.countDown?r.frameVal=r.startVal-r.easingFn(e,0,r.startVal-r.endVal,r.duration):r.frameVal=r.easingFn(e,r.startVal,r.endVal-r.startVal,r.duration):r.frameVal=r.startVal+(r.endVal-r.startVal)*(e/r.duration);var i=r.countDown?r.frameVal<r.endVal:r.frameVal>r.endVal;r.frameVal=i?r.endVal:r.frameVal,r.frameVal=Number(r.frameVal.toFixed(r.options.decimalPlaces)),r.printValue(r.frameVal),e<r.duration?r.rAF=requestAnimationFrame(r.count):null!==r.finalEndVal?r.update(r.finalEndVal):r.options.onCompleteCallback&&r.options.onCompleteCallback()},this.formatNumber=function(t){var e,i,o,s,a=t<0?"-":"";e=Math.abs(t).toFixed(r.options.decimalPlaces);var n=(e+="").split(".");if(i=n[0],o=n.length>1?r.options.decimal+n[1]:"",r.options.useGrouping){s="";for(var l=3,c=0,d=0,h=i.length;d<h;++d)r.options.useIndianSeparators&&4===d&&(l=2,c=1),0!==d&&c%l==0&&(s=r.options.separator+s),c++,s=i[h-d-1]+s;i=s}return r.options.numerals&&r.options.numerals.length&&(i=i.replace(/[0-9]/g,function(t){return r.options.numerals[+t]}),o=o.replace(/[0-9]/g,function(t){return r.options.numerals[+t]})),a+r.options.prefix+i+o+r.options.suffix},this.easeOutExpo=function(t,e,i,r){return i*(1-Math.pow(2,-10*t/r))*1024/1023+e},this.options=La(La({},this.defaults),i),this.formattingFn=this.options.formattingFn?this.options.formattingFn:this.formatNumber,this.easingFn=this.options.easingFn?this.options.easingFn:this.easeOutExpo,this.el="string"==typeof t?document.getElementById(t):t,e=e??this.parse(this.el.innerHTML),this.startVal=this.validateValue(this.options.startVal),this.frameVal=this.startVal,this.endVal=this.validateValue(e),this.options.decimalPlaces=Math.max(this.options.decimalPlaces),this.resetDuration(),this.options.separator=String(this.options.separator),this.useEasing=this.options.useEasing,""===this.options.separator&&(this.options.useGrouping=!1),this.el?this.printValue(this.startVal):this.error="[CountUp] target is null or undefined","undefined"!=typeof window&&this.options.enableScrollSpy&&(this.error?console.error(this.error,t):(window.onScrollFns=window.onScrollFns||[],window.onScrollFns.push(function(){return r.handleScroll(r)}),window.onscroll=function(){window.onScrollFns.forEach(function(t){return t()})},this.handleScroll(this)))}return t.prototype.handleScroll=function(t){if(t&&window&&!t.once){var e=window.innerHeight+window.scrollY,i=t.el.getBoundingClientRect(),r=i.top+window.pageYOffset,o=i.top+i.height+window.pageYOffset;o<e&&o>window.scrollY&&t.paused?(t.paused=!1,setTimeout(function(){return t.start()},t.options.scrollSpyDelay),t.options.scrollSpyOnce&&(t.once=!0)):(window.scrollY>o||r>e)&&!t.paused&&t.reset()}},t.prototype.determineDirectionAndSmartEasing=function(){var t=this.finalEndVal?this.finalEndVal:this.endVal;this.countDown=this.startVal>t;var e=t-this.startVal;if(Math.abs(e)>this.options.smartEasingThreshold&&this.options.useEasing){this.finalEndVal=t;var i=this.countDown?1:-1;this.endVal=t+i*this.options.smartEasingAmount,this.duration=this.duration/2}else this.endVal=t,this.finalEndVal=null;null!==this.finalEndVal?this.useEasing=!1:this.useEasing=this.options.useEasing},t.prototype.start=function(t){this.error||(this.options.onStartCallback&&this.options.onStartCallback(),t&&(this.options.onCompleteCallback=t),this.duration>0?(this.determineDirectionAndSmartEasing(),this.paused=!1,this.rAF=requestAnimationFrame(this.count)):this.printValue(this.endVal))},t.prototype.pauseResume=function(){this.paused?(this.startTime=null,this.duration=this.remaining,this.startVal=this.frameVal,this.determineDirectionAndSmartEasing(),this.rAF=requestAnimationFrame(this.count)):cancelAnimationFrame(this.rAF),this.paused=!this.paused},t.prototype.reset=function(){cancelAnimationFrame(this.rAF),this.paused=!0,this.resetDuration(),this.startVal=this.validateValue(this.options.startVal),this.frameVal=this.startVal,this.printValue(this.startVal)},t.prototype.update=function(t){cancelAnimationFrame(this.rAF),this.startTime=null,this.endVal=this.validateValue(t),this.endVal!==this.frameVal&&(this.startVal=this.frameVal,null==this.finalEndVal&&this.resetDuration(),this.finalEndVal=null,this.determineDirectionAndSmartEasing(),this.rAF=requestAnimationFrame(this.count))},t.prototype.printValue=function(t){var e;if(this.el){var i=this.formattingFn(t);(null===(e=this.options.plugin)||void 0===e?void 0:e.render)?this.options.plugin.render(this.el,i):"INPUT"===this.el.tagName?this.el.value=i:"text"===this.el.tagName||"tspan"===this.el.tagName?this.el.textContent=i:this.el.innerHTML=i}},t.prototype.ensureNumber=function(t){return"number"==typeof t&&!isNaN(t)},t.prototype.validateValue=function(t){var e=Number(t);return this.ensureNumber(e)?e:(this.error="[CountUp] invalid start or end value: ".concat(t),null)},t.prototype.resetDuration=function(){this.startTime=null,this.duration=1e3*Number(this.options.duration),this.remaining=this.duration},t.prototype.parse=function(t){var e=function(t){return t.replace(/([.,'  ])/g,"\\$1")},i=e(this.options.separator),r=e(this.options.decimal),o=t.replace(new RegExp(i,"g"),"").replace(new RegExp(r,"g"),".");return parseFloat(o)},t}();let Fa=class extends ht{#De;get major(){return this.#De}set major(t){this.#De=t}#Ge;get minor(){return this.#Ge}set minor(t){this.#Ge=t}#qe;get rev(){return this.#qe}set rev(t){this.#qe=t}#He;get downloads(){return this.#He}set downloads(t){this.#He=t}#Ve="@leavittsoftware%2Fweb";async firstUpdated(){const t=await this.#We(this.#Ve);if(t){const[e,i,r]=t.version?.split(".")?.map(t=>Number(t))??[],o=new Ua(this.major,e,{suffix:".",duration:1}),s=new Ua(this.minor,i,{suffix:".",duration:1}),a=new Ua(this.rev,r,{duration:1});o.start(),setTimeout(()=>{s.start()},500),setTimeout(()=>{a.start()},1e3);new Ua(this.downloads,t.downloads??0,{useGrouping:!0,suffix:" weekly downloads"}).start()}}async#We(t){try{const e=await fetch(`https://api.npmjs.org/versions/${t}/last-week`,{method:"GET"}),i=await e.text(),r=i.length?JSON.parse(i):{},o=Object.entries(r.downloads).map(t=>({version:t?.[0]?.split(".").map(t=>+t+1e5).join("."),downloads:t?.[1]})).sort((t,e)=>t.version.localeCompare(e.version)).map(t=>({...t,version:t.version?.split(".").map(t=>+t-1e5).join(".")}));return o?.pop()}catch(t){console.warn(t)}return null}static{this.styles=[d`
    ...
    `}};r([yt("span.major")],Fa.prototype,"major",null),r([yt("span.minor")],Fa.prototype,"minor",null),r([yt("span.rev")],Fa.prototype,"rev",null),r([yt("span.downloads")],Fa.prototype,"downloads",null),Fa=r([ut("npm-stats")],Fa);class Da extends CustomEvent{static{this.eventName="change-route"}constructor(t){super(Da.eventName,{bubbles:!0,composed:!0,detail:{path:t}})}}class Ga extends CustomEvent{static{this.eventName="redirect-route"}constructor(t){super(Ga.eventName,{bubbles:!0,composed:!0,detail:{path:t}})}}class qa extends CustomEvent{static{this.eventName="site-error"}constructor(t){super(qa.eventName,{bubbles:!0,composed:!0,detail:t})}}class Ha extends Event{static{this.eventType="confirm-dialog-open"}constructor(t,e){super(Ha.eventType,{bubbles:!0,composed:!0}),this.header=t,this.text=e,this.dialogResult=new Promise(t=>{this.resolver=t})}}const Va=d`
  :host {
    display: grid;
    grid:
...
`;var Wa=Array.isArray||function(t){return"[object Array]"==Object.prototype.toString.call(t)},Xa=ln,Ya=tn,Ja=function(t){return en(tn(t))},Ka=en,Qa=nn,Za=new RegExp(["(\\\\.)","([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^()])+)\\))?|\\(((?:\\\\.|[^()])+)\\))([+*?])?|(\\*))"].join("|"),"g");function tn(t){for(var e,i=[],r=0,o=0,s="";null!=(e=Za.exec(t));){var a=e[0],n=e[1],l=e.index;if(s+=t.slice(o,l),o=l+a.length,n)s+=n[1];else{s&&(i.push(s),s="");var c=e[2],d=e[3],h=e[4],p=e[5],u=e[6],m=e[7],f="+"===u||"*"===u,v="?"===u||"*"===u,g=c||"/",b=h||p||(m?".*":"[^"+g+"]+?");i.push({name:d||r++,prefix:c||"",delimiter:g,optional:v,repeat:f,pattern:on(b)})}}return o<t.length&&(s+=t.substr(o)),s&&i.push(s),i}function en(t){for(var e=new Array(t.length),i=0;i<t.length;i++)"object"==typeof t[i]&&(e[i]=new RegExp("^"+t[i].pattern+"$"));return function(i){for(var r="",o=i||{},s=0;s<t.length;s++){var a=t[s];if("string"!=typeof a){var n,l=o[a.name];if(null==l){if(a.optional)continue;throw new TypeError('Expected "'+a.name+'" to be defined')}if(Wa(l)){if(!a.repeat)throw new TypeError('Expected "'+a.name+'" to not repeat, but received "'+l+'"');if(0===l.length){if(a.optional)continue;throw new TypeError('Expected "'+a.name+'" to not be empty')}for(var c=0;c<l.length;c++){if(n=encodeURIComponent(l[c]),!e[s].test(n))throw new TypeError('Expected all "'+a.name+'" to match "'+a.pattern+'", but received "'+n+'"');r+=(0===c?a.prefix:a.delimiter)+n}}else{if(n=encodeURIComponent(l),!e[s].test(n))throw new TypeError('Expected "'+a.name+'" to match "'+a.pattern+'", but received "'+n+'"');r+=a.prefix+n}}else r+=a}return r}}function rn(t){return t.replace(/([.+*?=^!:${}()[\]|\/])/g,"\\$1")}function on(t){return t.replace(/([=!:$\/()])/g,"\\$1")}function sn(t,e){return t.keys=e,t}function an(t){return t.sensitive?"":"i"}function nn(t,e){for(var i=(e=e||{}).strict,r=!1!==e.end,o="",s=t[t.length-1],a="string"==typeof s&&/\/$/.test(s),n=0;n<t.length;n++){var l=t[n];if("string"==typeof l)o+=rn(l);else{var c=rn(l.prefix),d=l.pattern;l.repeat&&(d+="(?:"+c+d+")*"),o+=d=l.optional?c?"(?:"+c+"("+d+"))?":"("+d+")?":c+"("+d+")"}}return i||(o=(a?o.slice(0,-2):o)+"(?:\\/(?=$))?"),o+=r?"$":i&&a?"":"(?=\\/|$)",new RegExp("^"+o,an(e))}function ln(t,e,i){return Wa(e=e||[])?i||(i={}):(i=e,e=[]),t instanceof RegExp?function(t,e){var i=t.source.match(/\((?!\?)/g);if(i)for(var r=0;r<i.length;r++)e.push({name:r,prefix:null,delimiter:null,optional:!1,repeat:!1,pattern:null});return sn(t,e)}(t,e):Wa(t)?function(t,e,i){for(var r=[],o=0;o<t.length;o++)r.push(ln(t[o],e,i).source);return sn(new RegExp("(?:"+r.join("|")+")",an(i)),e)}(t,e,i):function(t,e,i){for(var r=tn(t),o=nn(r,i),s=0;s<r.length;s++)"string"!=typeof r[s]&&e.push(r[s]);return sn(o,e)}(t,e,i)}Xa.parse=Ya,Xa.compile=Ja,Xa.tokensToFunction=Ka,Xa.tokensToRegExp=Qa;var cn,dn="undefined"!=typeof document,hn="undefined"!=typeof window,pn="undefined"!=typeof history,un="undefined"!=typeof process,mn=dn&&document.ontouchstart?"touchstart":"click",fn=hn&&!(!window.history.location&&!window.location);function vn(){this.callbacks=[],this.exits=[],this.current="",this.len=0,this._decodeURLComponents=!0,this._base="",this._strict=!1,this._running=!1,this._hashbang=!1,this.clickHandler=this.clickHandler.bind(this),this._onpopstate=this._onpopstate.bind(this)}function gn(t,e){if("function"==typeof t)return gn.call(this,"*",t);if("function"==typeof e)for(var i=new xn(t,null,this),r=1;r<arguments.length;++r)this.callbacks.push(i.middleware(arguments[r]));else"string"==typeof t?this["string"==typeof e?"redirect":"show"](t,e):this.start(t)}function bn(t){if(!t.handled){var e=this,i=e._window;(e._hashbang?fn&&this._getBase()+i.location.hash.replace("#!",""):fn&&i.location.pathname+i.location.search)!==t.canonicalPath&&(e.stop(),t.handled=!1,fn&&(i.location.href=t.canonicalPath))}}function yn(t,e,i){var r=this.page=i||gn,o=r._window,s=r._hashbang,a=r._getBase();"/"===t[0]&&0!==t.indexOf(a)&&(t=a+(s?"#!":"")+t);var n=t.indexOf("?");this.canonicalPath=t;var l=new RegExp("^"+function(t){return t.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}(a));if(this.path=t.replace(l,"")||"/",s&&(this.path=this.path.replace("#!","")||"/"),this.title=dn&&o.document.title,this.state=e||{},this.state.path=t,this.querystring=~n?r._decodeURLEncodedURIComponent(t.slice(n+1)):"",this.pathname=r._decodeURLEncodedURIComponent(~n?t.slice(0,n):t),this.params={},this.hash="",!s){if(!~this.path.indexOf("#"))return;var c=this.path.split("#");this.path=this.pathname=c[0],this.hash=r._decodeURLEncodedURIComponent(c[1])||"",this.querystring=this.querystring.split("#")[0]}}function xn(t,e,i){var r=this.page=i||wn,o=e||{};o.strict=o.strict||r._strict,this.path="*"===t?"(.*)":t,this.method="GET",this.regexp=Xa(this.path,this.keys=[],o)}vn.prototype.configure=function(t){var e=t||{};this._window=e.window||hn&&window,this._decodeURLComponents=!1!==e.decodeURLComponents,this._popstate=!1!==e.popstate&&hn,this._click=!1!==e.click&&dn,this._hashbang=!!e.hashbang;var i=this._window;this._popstate?i.addEventListener("popstate",this._onpopstate,!1):hn&&i.removeEventListener("popstate",this._onpopstate,!1),this._click?i.document.addEventListener(mn,this.clickHandler,!1):dn&&i.document.removeEventListener(mn,this.clickHandler,!1),this._hashbang&&hn&&!pn?i.addEventListener("hashchange",this._onpopstate,!1):hn&&i.removeEventListener("hashchange",this._onpopstate,!1)},vn.prototype.base=function(t){if(0===arguments.length)return this._base;this._base=t},vn.prototype._getBase=function(){var t=this._base;if(t)return t;var e=hn&&this._window&&this._window.location;return hn&&this._hashbang&&e&&"file:"===e.protocol&&(t=e.pathname),t},vn.prototype.strict=function(t){if(0===arguments.length)return this._strict;this._strict=t},vn.prototype.start=function(t){var e=t||{};if(this.configure(e),!1!==e.dispatch){var i;if(this._running=!0,fn){var r=this._window.location;i=this._hashbang&&~r.hash.indexOf("#!")?r.hash.substr(2)+r.search:this._hashbang?r.search+r.hash:r.pathname+r.search+r.hash}this.replace(i,null,!0,e.dispatch)}},vn.prototype.stop=function(){if(this._running){this.current="",this.len=0,this._running=!1;var t=this._window;this._click&&t.document.removeEventListener(mn,this.clickHandler,!1),hn&&t.removeEventListener("popstate",this._onpopstate,!1),hn&&t.removeEventListener("hashchange",this._onpopstate,!1)}},vn.prototype.show=function(t,e,i,r){var o=new yn(t,e,this),s=this.prevContext;return this.prevContext=o,this.current=o.path,!1!==i&&this.dispatch(o,s),!1!==o.handled&&!1!==r&&o.pushState(),o},vn.prototype.back=function(t,e){var i=this;if(this.len>0){var r=this._window;pn&&r.history.back(),this.len--}else t?setTimeout(function(){i.show(t,e)}):setTimeout(function(){i.show(i._getBase(),e)})},vn.prototype.redirect=function(t,e){var i=this;"string"==typeof t&&"string"==typeof e&&gn.call(this,t,function(t){setTimeout(function(){i.replace(e)},0)}),"string"==typeof t&&void 0===e&&setTimeout(function(){i.replace(t)},0)},vn.prototype.replace=function(t,e,i,r){var o=new yn(t,e,this),s=this.prevContext;return this.prevContext=o,this.current=o.path,o.init=i,o.save(),!1!==r&&this.dispatch(o,s),o},vn.prototype.dispatch=function(t,e){var i=0,r=0,o=this;function s(){var e=o.callbacks[i++];if(t.path===o.current)return e?void e(t,s):bn.call(o,t);t.handled=!1}e?function t(){var i=o.exits[r++];if(!i)return s();i(e,t)}():s()},vn.prototype.exit=function(t,e){if("function"==typeof t)return this.exit("*",t);for(var i=new xn(t,null,this),r=1;r<arguments.length;++r)this.exits.push(i.middleware(arguments[r]))},vn.prototype.clickHandler=function(t){if(1===this._which(t)&&!(t.metaKey||t.ctrlKey||t.shiftKey||t.defaultPrevented)){var e=t.target,i=t.path||(t.composedPath?t.composedPath():null);if(i)for(var r=0;r<i.length;r++)if(i[r].nodeName&&"A"===i[r].nodeName.toUpperCase()&&i[r].href){e=i[r];break}for(;e&&"A"!==e.nodeName.toUpperCase();)e=e.parentNode;if(e&&"A"===e.nodeName.toUpperCase()){var o="object"==typeof e.href&&"SVGAnimatedString"===e.href.constructor.name;if(!e.hasAttribute("download")&&"external"!==e.getAttribute("rel")){var s=e.getAttribute("href");if((this._hashbang||!this._samePath(e)||!e.hash&&"#"!==s)&&!(s&&s.indexOf("mailto:")>-1)&&!(o?e.target.baseVal:e.target)&&(o||this.sameOrigin(e.href))){var a=o?e.href.baseVal:e.pathname+e.search+(e.hash||"");a="/"!==a[0]?"/"+a:a,un&&a.match(/^\/[a-zA-Z]:\//)&&(a=a.replace(/^\/[a-zA-Z]:\//,"/"));var n=a,l=this._getBase();0===a.indexOf(l)&&(a=a.substr(l.length)),this._hashbang&&(a=a.replace("#!","")),(!l||n!==a||fn&&"file:"===this._window.location.protocol)&&(t.preventDefault(),this.show(n))}}}}},vn.prototype._onpopstate=(cn=!1,hn?(dn&&"complete"===document.readyState?cn=!0:window.addEventListener("load",function(){setTimeout(function(){cn=!0},0)}),function(t){if(cn){var e=this;if(t.state){var i=t.state.path;e.replace(i,t.state)}else if(fn){var r=e._window.location;e.show(r.pathname+r.search+r.hash,void 0,void 0,!1)}}}):function(){}),vn.prototype._which=function(t){return null==(t=t||hn&&this._window.event).which?t.button:t.which},vn.prototype._toURL=function(t){var e=this._window;if("function"==typeof URL&&fn)return new URL(t,e.location.toString());if(dn){var i=e.document.createElement("a");return i.href=t,i}},vn.prototype.sameOrigin=function(t){if(!t||!fn)return!1;var e=this._toURL(t),i=this._window.location;return i.protocol===e.protocol&&i.hostname===e.hostname&&(i.port===e.port||""===i.port&&(80==e.port||443==e.port))},vn.prototype._samePath=function(t){if(!fn)return!1;var e=this._window.location;return t.pathname===e.pathname&&t.search===e.search},vn.prototype._decodeURLEncodedURIComponent=function(t){return"string"!=typeof t?t:this._decodeURLComponents?decodeURIComponent(t.replace(/\+/g," ")):t},yn.prototype.pushState=function(){var t=this.page,e=t._window,i=t._hashbang;t.len++,pn&&e.history.pushState(this.state,this.title,i&&"/"!==this.path?"#!"+this.path:this.canonicalPath)},yn.prototype.save=function(){var t=this.page;pn&&t._window.history.replaceState(this.state,this.title,t._hashbang&&"/"!==this.path?"#!"+this.path:this.canonicalPath)},xn.prototype.middleware=function(t){var e=this;return function(i,r){if(e.match(i.path,i.params))return i.routePath=e.path,t(i,r);r()}},xn.prototype.match=function(t,e){var i=this.keys,r=t.indexOf("?"),o=~r?t.slice(0,r):t,s=this.regexp.exec(decodeURIComponent(o));if(!s)return!1;delete e[0];for(var a=1,n=s.length;a<n;++a){var l=i[a-1],c=this.page._decodeURLEncodedURIComponent(s[a]);void 0===c&&hasOwnProperty.call(e,l.name)||(e[l.name]=c)}return!0};var wn=function t(){var e=new vn;function i(){return gn.apply(e,arguments)}return i.callbacks=e.callbacks,i.exits=e.exits,i.base=e.base.bind(e),i.strict=e.strict.bind(e),i.start=e.start.bind(e),i.stop=e.stop.bind(e),i.show=e.show.bind(e),i.back=e.back.bind(e),i.redirect=e.redirect.bind(e),i.replace=e.replace.bind(e),i.dispatch=e.dispatch.bind(e),i.exit=e.exit.bind(e),i.configure=e.configure.bind(e),i.sameOrigin=e.sameOrigin.bind(e),i.clickHandler=e.clickHandler.bind(e),i.create=t,Object.defineProperty(i,"len",{get:function(){return e.len},set:function(t){e.len=t}}),Object.defineProperty(i,"current",{get:function(){return e.current},set:function(t){e.current=t}}),i.Context=yn,i.Route=xn,i}(),_n=wn,kn=wn;_n.default=kn;class $n{#Xe=[];subscribe(t,e,i){Array.isArray(t)?t.forEach(t=>this.subscribe(t,e,i)):Array.isArray(e)?e.forEach(e=>this.subscribe(t,e,i)):this.#Ye(t,e,i)}subscribeAll(t,e){Array.isArray(t)?t.forEach(t=>this.#Ye(t,"All",e)):this.#Ye(t,"All",e)}#Ye(t,e,i){const r={entityType:t,eventTypes:e,callback:i};this.#Xe.push(r)}unsubscribe(t,e,i){Array.isArray(t)?t.forEach(t=>this.unsubscribe(t,e,i)):Array.isArray(e)?e.forEach(e=>this.unsubscribe(t,e,i)):this.#Je(t,e,i)}#Je(t,e,i){this.#Xe=this.#Xe.filter(r=>r.callback!==i||r.entityType!==t||r.eventTypes!==e)}dispatch(t,e,i){this.#Xe.filter(i=>i.entityType===t&&("All"===i.eventTypes||i.eventTypes===e)).forEach(t=>t.callback(i))}}const zn=new $n;Object.freeze(zn);const An=new URL(new URL("WQLuWBBr.svg",import.meta.url).href).href,Sn=new URL(new URL("BTVD-IEO.svg",import.meta.url).href).href;let Tn=class extends ht{#Ke;get page(){return this.#Ke}set page(t){this.#Ke=t}#Qe="";get fatalErrorMessage(){return this.#Qe}set fatalErrorMessage(t){this.#Qe=t}#Ze=!1;get isWideViewPort(){return this.#Ze}set isWideViewPort(t){this.#Ze=t}#ti=!1;get collapseMainMenu(){return this.#ti}set collapseMainMenu(t){this.#ti=t}#ei;get confirmDialog(){return this.#ei}set confirmDialog(t){this.#ei=t}#ii;get loadingIndicator(){return this.#ii}set loadingIndicator(t){this.#ii=t}#ri;get drawer(){return this.#ri}set drawer(t){this.#ri=t}get themePreference(){return localStorage.getItem("theme-preference")||(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light")}set themePreference(t){localStorage.setItem("theme-preference",t),this.#oi()}get prefersCollapsedMenu(){return JSON.parse(localStorage.getItem("prefers-collapsed-menu")||"false")}set prefersCollapsedMenu(t){localStorage.setItem("prefers-collapsed-menu",t.toString())}#oi(){document.firstElementChild?.setAttribute("data-theme",this.themePreference),zn.dispatch("theme-preference","change",this.themePreference)}async firstUpdated(){this.#oi(),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",({matches:t})=>{this.themePreference=t?"dark":"light",this.#oi()}),((t,e)=>{const i=window.matchMedia(t);i.addEventListener("change",t=>e(t.matches)),e(i.matches)})("(max-width: 920px)",async t=>{this.isWideViewPort=!t,this.isWideViewPort&&(this.drawer.closeQuick(),this.collapseMainMenu=this.prefersCollapsedMenu)}),await this.loadingIndicator.updateComplete,this.addEventListener(Ha.eventType,async t=>{await import("./C4QsPJQs.js"),this.confirmDialog.handleEvent(t)}),this.addEventListener(Da.eventName,t=>{_n.show(t.detail.path)}),this.addEventListener(Ga.eventName,t=>{_n.redirect(t.detail.path)}),this.addEventListener(qa.eventName,t=>{this.fatalErrorMessage=t.detail,this.#si("error")}),_n("*",(t,e)=>{this.drawer?.close(),e()}),_n("/",async()=>{_n.show("/getting-started")}),_n("/getting-started",()=>this.#si("getting-started",()=>import("./RJ8QxX6W.js"))),_n("/titanium-full-page-loading-indicator",()=>this.#si("titanium-full-page-loading-indicator",()=>import("./B94lrGSh.js"))),_n("/available-cdn-icons",()=>this.#si("available-cdn-icons",()=>import("./BYeZjNxE.js"))),_n("/leavitt-company-select",()=>this.#si("leavitt-company-select",()=>import("./B7Qywx19.js"))),_n("/leavitt-file-explorer",()=>this.#si("leavitt-file-explorer",()=>import("./DJe_CbI7.js"))),_n("/titanium-date-range-selector",()=>this.#si("titanium-date-range-selector",()=>import("./ON-UOFBj.js"))),_n("/titanium-data-table-item",()=>this.#si("titanium-data-table-item",()=>import("./Cna1YZYy.js"))),_n("/leavitt-person-select",()=>this.#si("leavitt-person-select",()=>import("./DNElArM3.js"))),_n("/leavitt-person-company-select",()=>this.#si("leavitt-person-company-select",()=>import("./EDDgYiRe.js"))),_n("/leavitt-person-group-select",()=>this.#si("leavitt-person-group-select",()=>import("./Cei7HHCr.js"))),_n("/leavitt-email-history-viewer",()=>this.#si("leavitt-email-history-viewer",()=>import("./CzFRkCEJ.js"))),_n("/leavitt-user-feedback",()=>this.#si("leavitt-user-feedback",()=>import("./Cadd_nDC.js"))),_n("/profile-picture",()=>this.#si("profile-picture",()=>import("./he-0FW83.js"))),_n("/profile-picture-menu",()=>this.#si("profile-picture-menu",()=>import("./Doo3XpND.js"))),_n("/titanium-access-denied-page",()=>this.#si("titanium-access-denied-page",()=>import("./DRFvIKnE.js"))),_n("/titanium-data-table",()=>this.#si("titanium-data-table",()=>import("./DWXNtMDM.js"))),_n("/titanium-data-table-item",()=>this.#si("titanium-data-table-item",()=>import("./Cna1YZYy.js"))),_n("/titanium-drawer",()=>this.#si("titanium-drawer",()=>import("./Dk8MN7q7.js"))),_n("/titanium-error-page",()=>this.#si("titanium-error-page",()=>import("./VXDotuul.js"))),_n("/titanium-address-input",()=>this.#si("titanium-address-input",()=>import("./CFol-5aq.js"))),_n("/titanium-header",()=>this.#si("titanium-header",()=>import("./NFOXt8vn.js"))),_n("/titanium-icon-picker",()=>this.#si("titanium-icon-picker",()=>import("./DQHi4p-E.js"))),_n("/titanium-header",()=>this.#si("titanium-header",()=>import("./NFOXt8vn.js"))),_n("/titanium-chip-multi-select",()=>this.#si("titanium-chip-multi-select",()=>import("./a5Zujp-m.js"))),_n("/titanium-input-validator",()=>this.#si("titanium-input-validator",()=>import("./C44bb7-m.js"))),_n("/titanium-data-table-header",()=>this.#si("titanium-data-table-header",()=>import("./D2-POmMV.js"))),_n("/titanium-data-table-core",()=>this.#si("titanium-data-table-core",()=>import("./CEQMBwsR.js"))),_n("/titanium-full-page-loading-indicator",()=>this.#si("titanium-full-page-loading-indicator",()=>import("./B94lrGSh.js"))),_n("/titanium-page-control",()=>this.#si("titanium-page-control",()=>import("./BV4glKsp.js"))),_n("/titanium-smart-attachment-input",()=>this.#si("titanium-smart-attachment-input",()=>import("./CP6IA3PK.js"))),_n("/titanium-date-input",()=>this.#si("titanium-date-input",()=>import("./DaXK3bII.js"))),_n("/titanium-search-input",()=>this.#si("titanium-search-input",()=>import("./JSeQ_zv7.js"))),_n("/titanium-toolbar",()=>this.#si("titanium-toolbar",()=>import("./BzJstHGZ.js"))),_n("/titanium-styles",()=>this.#si("titanium-styles",()=>import("./C7DwuJDA.js"))),_n("/titanium-snackbar",()=>this.#si("titanium-snackbar",()=>import("./CyX8OvI_.js"))),_n("/titanium-card",()=>this.#si("titanium-card",()=>import("./BX-8gxH6.js"))),_n("/titanium-chip",()=>this.#si("titanium-chip",()=>import("./plO-EUO_.js"))),_n("/titanium-youtube-input",()=>this.#si("titanium-youtube-input",()=>import("./CTbDhgKa.js"))),_n("/titanium-show-hide",()=>this.#si("titanium-show-hide",()=>import("./CTi6G49M.js"))),_n("/titanium-duration-input",()=>this.#si("titanium-duration-input",()=>import("./1PCWphbW.js"))),_n("/titanium-profile-picture-stack",()=>this.#si("titanium-profile-picture-stack",()=>import("./DERi36vJ.js"))),_n("/titanium-confirm-dialog",()=>this.#si("titanium-confirm-dialog",()=>import("./DvDBB_wY.js"))),_n("/titanium-confirmation-dialog",()=>this.#si("titanium-confirmation-dialog",()=>import("./qrsN4IeI.js"))),_n("*",()=>{this.fatalErrorMessage="We were unable to find the page you are looking for",this.#si("error")}),_n.start()}async#si(t,e){this.page=t;try{const t=e?.();t&&this.dispatchEvent(new Se(t)),await t}catch(t){console.warn(t),this.fatalErrorMessage=t,this.page="error"}}static{this.styles=[Va,$s,d`
    ...
    `]}render(){return V`<titanium-full-page-loading-indicator></titanium-full-page-loading-indicator>
      ...
      <titanium-toolbar>
        ...
        <a logo href="/" title="Back to home"><img src=${"dark"===this.themePreference?Sn:An} /></a>
        <h3 title="Leavitt book" @click=${()=>_n.show("/")} main-title>Leavitt book</h3>
        <right-panel>
      ...
      <titanium-drawer ?always-show-content=${this.isWideViewPort&&!this.collapseMainMenu}>
        <a slot="header" logo href="/" title="Back to home"><img src=${"dark"===this.themePreference?Sn:An} /></a>
      ...
      <titanium-service-worker-notifier></titanium-service-worker-notifier>`}};r([gt()],Tn.prototype,"page",null),r([gt()],Tn.prototype,"fatalErrorMessage",null),r([gt()],Tn.prototype,"isWideViewPort",null),r([vt({type:Boolean,reflect:!0,attribute:"collapse-main-menu"})],Tn.prototype,"collapseMainMenu",null),r([yt("titanium-confirm-dialog")],Tn.prototype,"confirmDialog",null),r([yt("titanium-full-page-loading-indicator")],Tn.prototype,"loadingIndicator",null),r([yt("titanium-drawer")],Tn.prototype,"drawer",null),r([gt()],Tn.prototype,"themePreference",null),r([gt()],Tn.prototype,"prefersCollapsedMenu",null),Tn=r([ut("my-app")],Tn);export{le as $,ga as A,Wt as B,Ha as C,oa as D,X as E,Ii as F,Rt as G,ji as H,Ei as I,Ct as J,Va as K,Et as L,ws as M,Pe as N,Si as O,Se as P,zi as Q,Sr as R,ze as S,W as T,Cr as U,zn as V,Ji as W,Ee as X,_t as Y,It as Z,r as _,xs as a,pr as a0,fr as a1,ue as a2,ve as a3,fe as a4,Yt as a5,ur as a6,mr as a7,nr as a8,lr as a9,kr as aa,ct as ab,wr as ac,mi as ad,li as ae,vr as af,pi as ag,ni as ah,We as ai,ai as aj,ei as ak,si as al,ri as am,sr as an,ar as ao,bt as ap,Vs as aq,ta as ar,Jt as as,qa as at,ye as au,Nt as av,_s as aw,e as ax,o as ay,i as az,zs as b,d as c,ha as d,yt as e,wt as f,$n as g,ys as h,ht as i,ks as j,Ss as k,As as l,Pt as m,vt as n,Ts as o,$s as p,ca as q,gt as r,la as s,ut as t,gs as u,ya as v,xa as w,V as x,Xt as y,Vt as z};
