import{r as t,h as e,p as i,i as a,x as s,_ as n,d as r,e as m,t as u}from"./jlnXwjN8.js";import{S as l}from"./B3_5_T76.js";import"./CZXsZd7R.js";let p=class extends t{constructor(){super(...arguments),this.getFilesResult=null,this.hasChanges=!1}#t;get getFilesInput(){return this.#t}set getFilesInput(t){this.#t=t}#e;get preselectFilesInput(){return this.#e}set preselectFilesInput(t){this.#e=t}#i;get preselectDisabledFilesInput(){return this.#i}set preselectDisabledFilesInput(t){this.#i=t}#a;get resetInput(){return this.#a}set resetInput(t){this.#a=t}static{this.styles=[e,i,a`
      :host {
        display: flex;
