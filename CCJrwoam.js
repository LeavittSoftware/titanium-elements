import{x as e,S as t,c as s,_ as a,n as i,t as o,i as l,A as r,d as n,h as c,p,r as d,e as m,f as h,G as u,E as g}from"./C3FxRHaz.js";import{S as y}from"./kaVdmEIP.js";import"./B08RhqQ_.js";import"./DmUDdBMC.js";import{F as v}from"./CkDJilkW.js";import{T as b}from"./CD4EFCHI.js";import{D as S}from"./DTS7lhmZ.js";import{g as f}from"./wLIUKFBh.js";import{T as $}from"./Ci3N8sjE.js";import"./B3E7ArL7.js";import"./DLazVuKu.js";import"./oAxV7t8W.js";let x=class extends b{#e="Company";get label(){return this.#e}set label(e){this.#e=e}#t="Search for a company";get placeholder(){return this.#t}set placeholder(e){this.#t=e}#s="Name";get pathToSelectedText(){return this.#s}set pathToSelectedText(e){this.#s=e}#a=[];get companies(){return this.#a}set companies(e){this.#a=e}#i;get apiService(){return this.#i}set apiService(e){this.#i=e}#o=!1;get disableAutoLoad(){return this.#o}set disableAutoLoad(e){this.#o=e}#l=["orderby=Name","select=Name,ShortName,MarkUrl,DarkMarkUrl,Id"];get odataParts(){return this.#l}set odataParts(e){this.#l=e}#r="Companies";get apiControllerName(){return this.#r}set apiControllerName(e){this.#r=e}#n="off";get autocomplete(){return this.#n}set autocomplete(e){this.#n=e}#c=!1;get spellcheck(){return this.#c}set spellcheck(e){this.#c=e}#p=t=>e`<md-menu-item .item=${t}>
    ...
    </md-menu-item>`;get renderMenuItemContentTemplate(){return this.#p}set renderMenuItemContentTemplate(e){this.#p=e}async firstUpdated(){this.disableAutoLoad||this.companies.length||!this.apiService||this.#d()}async updated(e){e.has("companies")&&this.companies&&(this.defaultSuggestions=this.companies)}async reloadCompanies(){this.disableAutoLoad||console.warn("leavitt-company-select reloadCompanies method has been called manually without setting disableAutoLoad"),await this.#d()}async#d(){this.companies=await this.#m(),this.selected=this.companies.find(e=>e.Id===this.selected?.Id)??null}async#m(){try{const e=this.apiService?.getAsync(`${this.apiControllerName}?${this.odataParts.join("&")}`),t=await e;return t?.toList()??[]}catch(e){this.dispatchEvent(new t(e))}return[]}static{this.styles=[...b.styles,s`
      img[company-mark] {
        width: 40px;
        height: 40px;
      }
    `]}#h=new S(e=>this.#u(e));#g=new AbortController;async#u(e){this.#g.abort(),this.#g=new AbortController;const t={includeScore:!0,keys:["Name","ShortName"],shouldSort:!0,ignoreLocation:!0,threshold:.3};if(this.searchTerm){const s=new v(this.companies,t).search(e);this.showSuggestions(s.map(e=>e.item).slice(0,15),s.length)}}onInputChanged(e){this.#h.debounce(e)}renderSelectedLeadingInputSlot(t){return e` <img leading slot="leading-icon" src=${f(t,this.themePreference)} />`}renderSuggestion(e){return this.renderMenuItemContentTemplate(e)}};a([i({type:String})],x.prototype,"label",null),a([i({type:String})],x.prototype,"placeholder",null),a([i({type:String})],x.prototype,"pathToSelectedText",null),a([i({type:Array})],x.prototype,"companies",null),a([i({attribute:!1})],x.prototype,"apiService",null),a([i({type:Boolean})],x.prototype,"disableAutoLoad",null),a([i({type:Array})],x.prototype,"odataParts",null),a([i({type:String})],x.prototype,"apiControllerName",null),a([i({reflect:!0,type:String})],x.prototype,"autocomplete",null),a([i({reflect:!0,type:Boolean})],x.prototype,"spellcheck",null),a([i({type:Object})],x.prototype,"renderMenuItemContentTemplate",null),x=a([o("leavitt-company-select")],x);let _=class extends($(l)){#i;get apiService(){return this.#i}set apiService(e){this.#i=e}#y=!1;get disableMenuOpenOnFocus(){return this.#y}set disableMenuOpenOnFocus(e){this.#y=e}#v;get methodsSelect(){return this.#v}set methodsSelect(e){this.#v=e}#b;get inputs(){return this.#b}set inputs(e){this.#b=e}constructor(){super(),this.apiService=new r(new n),this.apiService.baseUrl="https://devapi3.leavitt.com/",this.apiService.addHeader("X-LGAppName","Testing")}static{this.styles=[c,p,s`
      :host {
        display: flex;
    ...
    `}};a([d()],_.prototype,"apiService",null),a([d()],_.prototype,"disableMenuOpenOnFocus",null),a([m("leavitt-company-select[methods-demo]")],_.prototype,"methodsSelect",null),a([h("leavitt-company-select")],_.prototype,"inputs",null),_=a([o("leavitt-company-select-playground")],_);let w=class extends l{#S=null;get refreshToken(){return this.#S}set refreshToken(e){this.#S=e}static{this.styles=[y,s``]}async firstUpdated(){const e=await u();await e.authenticateAsync(),this.refreshToken=window.localStorage.getItem("LG-AUTH-RT")}render(){return e`
    ...
    `}};a([d()],w.prototype,"refreshToken",null),w=a([o("leavitt-company-select-demo")],w);export{w as LeavittCompanySelectDemo};
