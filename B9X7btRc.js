import{h as t,a as e,p as a,i as o,k as i,_ as r,r as s,e as n,t as l}from"./CzHvl5jm.js";import{S as d}from"./CYtDMjId.js";import"./BngvSuhr.js";import"./o6Fe7m6D.js";import"./D9pokuyX.js";import"./DMuv4q9m.js";import"./DGgUFMLi.js";let c=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#e=25;get count(){return this.#e}set count(t){this.#e=t}#a;get data(){return this.#a}set data(t){this.#a=t}#o;get filteredData(){return this.#o}set filteredData(t){this.#o=t}firstUpdated(){this.data=Array(25).fill(null).map(((t,e)=>({id:e+1,name:"Bob"}))),this.#i()}#i(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[e,a,o`
      :host {
        display: flex;
