import{i as t,h as i,p as e,c as s,D as l,x as n,_ as o,r as d,e as a,t as m}from"./qx-Pki5z.js";import{S as c}from"./Du2PYyjw.js";import"./Dup9yWAT.js";import"./IUdmnAyS.js";const r=["Dog","Cat","Lion","Hedgehog","Turtle","Monkey","Owl","Peacock","Pigeon","Spider","Tortoise","Zebra"];let u=class extends t{#t=r.slice(0,4);get demoItems(){return this.#t}set demoItems(t){this.#t=t}#i=!1;get disabled(){return this.#i}set disabled(t){this.#i=t}#e="Service animals are welcome.";get supportingText(){return this.#e}set supportingText(t){this.#e=t}#s;get titaniumChipMultiSelect(){return this.#s}set titaniumChipMultiSelect(t){this.#s=t}static{this.styles=[i,e,s`
      :host {
        display: flex;
