import{L as t,i as e,S as i,b as s,u as a,v as l,w as r,c as n,_ as o,n as h,r as c,e as d,t as m,x as p,f as g,y as u,z as v,B as b,p as f,s as y,C as w,d as $,j as _,a as x,D,F as S,G as T,P as k,T as E,A as j,U as C,H as I}from"./C4zC-QpX.js";import{S as A}from"./BuWE4gAm.js";import{f as R}from"./iIryJ62l.js";import"./C5JZ_0-E.js";import"@leavittsoftware/web/leavitt/user-manager/user-manager";import{F as M}from"./CoyWm8y4.js";import"./CoQozzFQ.js";import"./DM7PDHd8.js";import"./NgOX8DlR.js";import"./CviYB_I1.js";import{D as N,r as L}from"./CIoetkZc.js";import"./BZ1uwJd9.js";import{d as Y}from"./fEBq_QNq.js";import{D as B}from"./DTS7lhmZ.js";import{g as O}from"./OXmljVLM.js";import"./DmxoOrAB.js";import"./DSRpAilH.js";import"./luggfwZ_.js";import"./Cv1DIJjG.js";import{n as z}from"./CQGxDFCO.js";import"./BRw9g_ht.js";import"./BDKAny-7.js";import"./rr-Ivdw2.js";import"./BP34EqWG.js";import"./CPBtgqAu.js";import"./C5_Ye6jZ.js";import"./hR9ebjVF.js";import"./rrxT2ZHw.js";import"./CbTza51h.js";let F=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#i;get filterController(){return this.#i}set filterController(t){this.#i=t}#s=[];get template(){return this.#s}set template(t){this.#s=t}#a;get templateId(){return this.#a}set templateId(t){this.#a=t}#l=!0;#r;get startDate(){return this.#r}set startDate(t){this.#r=t}#n;get endDate(){return this.#n}set endDate(t){this.#n=t}#o;get dialog(){return this.#o}set dialog(t){this.#o=t}#h;get dateRangeSelect(){return this.#h}set dateRangeSelect(t){this.#h=t}async firstUpdated(){this.filterController.subscribeToFilterChange(async()=>{this.#c(),this.requestUpdate("filterController")})}async updated(t){this.isActive&&t.has("isActive")&&this.#c()}async#c(){this.filterController.getValue("template")&&this.#l&&(this.template=await this.#d())}async#d(){if(!this.apiService)return console.warn("No api service provided"),[];const t=["select=Id,Name,IsExpired","orderby=Name"];try{const e=this.apiService.getAsync(`EmailTemplates?${t.join("&")}`);this.loadWhile(e);const i=(await e).toList();return this.#l=!1,i}catch(t){this.dispatchEvent(new i(t))}return[]}async open(){this.#l&&(this.template=await this.#d()),this.templateId=this.filterController.getValue("template")??"";const t=this.filterController.getValue("dateRange");this.startDate=("custom"===t?this.filterController.getValue("startDate"):N.get(t)?.startDate())||"",this.endDate=("custom"===t?this.filterController.getValue("endDate"):N.get(t)?.endDate())||"",this.dialog.show()}static{this.styles=[s`
    ...
    `}};o([h({type:Boolean})],F.prototype,"isActive",null),o([h({type:Object})],F.prototype,"apiService",null),o([c()],F.prototype,"filterController",null),o([c()],F.prototype,"template",null),o([c()],F.prototype,"templateId",null),o([c()],F.prototype,"startDate",null),o([c()],F.prototype,"endDate",null),o([d("md-dialog")],F.prototype,"dialog",null),o([d("titanium-date-range-selector")],F.prototype,"dateRangeSelect",null),F=o([m("leavitt-email-history-view-list-filter-dialog")],F);class P extends p{constructor(t){if(super(t),this.it=g,t.type!==u.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===g||null==t)return this._t=void 0,this.it=t;if(t===v)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}P.directiveName="unsafeHTML",P.resultType=1;const H=b(P);let V=class extends(t(e)){#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#m;get emailTemplateLogId(){return this.#m}set emailTemplateLogId(t){this.#m=t}#p;get emailTemplateLog(){return this.#p}set emailTemplateLog(t){this.#p=t}#g;get snackbar(){return this.#g}set snackbar(t){this.#g=t}#o;get dialog(){return this.#o}set dialog(t){this.#o=t}#u;async open(t){return this.emailTemplateLogId=t,this.emailTemplateLog=null,this.dialog.returnValue="",await this.updateComplete,this.dialog.show(),this.emailTemplateLog=await this.#v(t),await new Promise(t=>{this.#u=t})}async#v(t){if(!this.apiService)return console.warn("No api service provided"),null;const e=[];try{const i=this.apiService.getAsync(`EmailTemplateLogs(${t})?${e.join("&")}`);this.loadWhile(i);const s=await i;return s?.entity}catch(t){this.dispatchEvent(new i(t))}return null}static{this.styles=[f,s`
      md-dialog {
        max-width: 750px;
        width: calc(100vw - 24px);
    ...
    `]}render(){return n`
      ...
      >
        ...
        ${this.isLoading?n`<main slot="content">Loading...</main>`:this.emailTemplateLog?n`<main slot="content" email-body>${H(this.emailTemplateLog?.EmailBody??"")}</main>`:n`<main slot="content">No email template log found</main>`}
    ...
    `]}render(){return n`
      ...
      >
        <titanium-search-input
          ...
          @input=${t=>{this.searchTerm=t.target.value,this.dataTable.resetPage(),this.#N.debounce(this.searchTerm)}}
        ></titanium-search-input>
        ...
        ${w(this.logs??[],t=>t.Id,t=>n`
            <titanium-data-table-item disable-select .item=${t} slot="items">
              <row-item width="150px" ellipsis date
                >${t.SentDate?n`${Y(t.SentDate).format("MMM DD, YY")}<br /><span time>${Y(t.SentDate).format("h:mm A")}</span>`:"-"}</row-item
              >
    ...
    `}};o([h({type:Boolean})],U.prototype,"isActive",null),o([h({type:Object})],U.prototype,"apiService",null),o([h({type:String})],U.prototype,"path",null),o([c()],U.prototype,"logs",null),o([c()],U.prototype,"selected",null),o([c()],U.prototype,"searchTerm",null),o([c()],U.prototype,"resultTotal",null),o([c()],U.prototype,"sortDirection",null),o([c()],U.prototype,"sortBy",null),o([c()],U.prototype,"filterController",null),o([d("titanium-data-table")],U.prototype,"dataTable",null),o([d("leavitt-view-sent-email-dialog")],U.prototype,"viewDialog",null),o([d("leavitt-email-history-view-list-filter-dialog")],U.prototype,"filterModal",null),o([d("leavitt-view-email-template-info-dialog")],U.prototype,"viewEmailTemplateInfoDialog",null),U=o([m("leavitt-email-history-viewer")],U);let q=class extends e{#L=!1;get isOverflowed(){return this.#L}set isOverflowed(t){this.#L=t}#Y="640px";get maxWidth(){return this.#Y}set maxWidth(t){this.#Y=t}#B=null;get scrollableParent(){return this.#B}set scrollableParent(t){this.#B=t}#O=!1;get hasLeading(){return this.#O}set hasLeading(t){this.#O=t}#z=!1;get hasTrailing(){return this.#z}set hasTrailing(t){this.#z=t}#F=!1;get hasMain(){return this.#F}set hasMain(t){this.#F=t}#P;get leadingElements(){return this.#P}set leadingElements(t){this.#P=t}#H;get trailingElements(){return this.#H}set trailingElements(t){this.#H=t}#V;get mainElements(){return this.#V}set mainElements(t){this.#V=t}#W=null;#U=null;async connectedCallback(){super.connectedCallback();const t=await R(this);this.#W=this.scrollableParent||t,this.#W&&(this.#U=new ResizeObserver(()=>{this.#q()}),this.#U.observe(this.#W))}disconnectedCallback(){this.#W&&this.#U?.disconnect(),super.disconnectedCallback()}async updated(t){if(t.has("scrollableParent")){this.#U?.disconnect();const t=await R(this);this.#W=this.scrollableParent||t,this.#W&&(this.#U=new ResizeObserver(()=>{this.#q()}),this.#U.observe(this.#W))}}isOverflown(t){return t.scrollHeight>t.clientHeight}#q(){this.#W&&(this.isOverflowed=this.isOverflown(this.#W))}static{this.styles=[s`
      :host {
        display: grid;
    ...
    `}};o([h({type:Boolean,reflect:!0,attribute:"is-overflowed"})],q.prototype,"isOverflowed",null),o([h({type:String,attribute:"max-width"})],q.prototype,"maxWidth",null),o([h({type:Object,attribute:"scrollable-parent"})],q.prototype,"scrollableParent",null),o([h({type:Boolean,reflect:!0,attribute:"has-leading"})],q.prototype,"hasLeading",null),o([h({type:Boolean,reflect:!0,attribute:"has-trailing"})],q.prototype,"hasTrailing",null),o([h({type:Boolean,reflect:!0,attribute:"has-main"})],q.prototype,"hasMain",null),o([S({slot:"leading"})],q.prototype,"leadingElements",null),o([S({slot:"trailing"})],q.prototype,"trailingElements",null),o([S({slot:"main"})],q.prototype,"mainElements",null),q=o([m("leavitt-app-navigation-footer")],q);let G=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#i;get filterController(){return this.#i}set filterController(t){this.#i=t}#s=[];get template(){return this.#s}set template(t){this.#s=t}#a;get templateId(){return this.#a}set templateId(t){this.#a=t}#l=!0;#r;get startDate(){return this.#r}set startDate(t){this.#r=t}#n;get endDate(){return this.#n}set endDate(t){this.#n=t}#o;get dialog(){return this.#o}set dialog(t){this.#o=t}#h;get dateRangeSelect(){return this.#h}set dateRangeSelect(t){this.#h=t}async firstUpdated(){this.filterController.subscribeToFilterChange(async()=>{this.#c(),this.requestUpdate("filterController")})}async updated(t){this.isActive&&t.has("isActive")&&this.#c()}async#c(){this.filterController.getValue("template")&&this.#l&&(this.template=await this.#d())}async#d(){if(!this.apiService)return console.warn("No api service provided"),[];const t=["select=Id,Name,IsExpired","orderby=Name"];try{const e=this.apiService.getAsync(`EmailTemplates?${t.join("&")}`);this.loadWhile(e);const i=(await e).toList();return this.#l=!1,i}catch(t){this.dispatchEvent(new i(t))}return[]}async open(){this.#l&&(this.template=await this.#d()),this.templateId=this.filterController.getValue("template")??"";const t=this.filterController.getValue("dateRange");this.startDate=("custom"===t?this.filterController.getValue("startDate"):N.get(t)?.startDate())||"",this.endDate=("custom"===t?this.filterController.getValue("endDate"):N.get(t)?.endDate())||"",this.dialog.show()}static{this.styles=[s`
      :host {
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    `}};o([h({type:Boolean})],G.prototype,"isActive",null),o([h({type:Object})],G.prototype,"apiService",null),o([c()],G.prototype,"filterController",null),o([c()],G.prototype,"template",null),o([c()],G.prototype,"templateId",null),o([c()],G.prototype,"startDate",null),o([c()],G.prototype,"endDate",null),o([d("md-dialog")],G.prototype,"dialog",null),o([d("titanium-date-range-selector")],G.prototype,"dateRangeSelect",null),G=o([m("leavitt-email-history-viewer-filled-filter-dialog")],G);class K{#G;#K;#X;#J;#Q;#Z;constructor(t,e,i){if(this.#X=null,this.#Q=!1,this.#Z=null,this.searchTerm="",this.#tt=()=>{this.searchTerm=this.#X.value,this.#G.requestUpdate(),this.#K()},this.#G=t,this.#J=i.placeholder,0!==i.debounceDelay){const t=new B(()=>this.#G.isActive?i.onSearch():Promise.resolve(),i.debounceDelay);this.#K=()=>t.debounce()}else this.#K=()=>{this.#G.isActive&&i.onSearch()};new T(t,{context:e,subscribe:!0,callback:t=>this.#et(t)}),t.addController(this)}#et(t){this.#X=t,this.#G.isActive&&this.#it()}#it(){this.#st(),this.#X&&(this.#Z=new AbortController,this.#X.addEventListener("input",this.#tt,{signal:this.#Z.signal}),this.#X.value=this.searchTerm,this.#X.placeholder=this.#J)}#st(){this.#Z?.abort(),this.#Z=null}#tt;clearSearch(){this.searchTerm="",this.#X&&(this.#X.value=""),this.#G.requestUpdate()}hostUpdated(){const t=this.#G.isActive;t&&!this.#Q?this.#it():!t&&this.#Q&&this.#st(),this.#Q=t}hostDisconnected(){this.#st(),this.#X=null,this.#Q=!1}}let X=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#y;get path(){return this.#y}set path(t){this.#y=t}#at;get siteSearchTextFieldContext(){return this.#at}set siteSearchTextFieldContext(t){this.#at=t}#lt="";get toolbarSearchTerm(){return this.#lt}set toolbarSearchTerm(t){this.#lt=t}#_="";get searchTerm(){return this.#_}set searchTerm(t){this.#_=t}#rt=[];get items(){return this.#rt}set items(t){this.#rt=t}#$=[];get selected(){return this.#$}set selected(t){this.#$=t}#nt={uniqueKey:t=>t.Id?.toString()??"",itemMetaData:[{key:"SentDate",friendlyName:"Sent",render:t=>n`<div>
            ${t.SentDate?n`${Y(t.SentDate).format("MMM DD, YY")}<br /><span time>${Y(t.SentDate).format("h:mm A")}</span>`:"-"}
            ...
            ${t.EmailTemplate?.IsExpired?n`<div inactive>Inactive</div>`:""}`,csvValue:t=>t.EmailTemplate?.Name??"",width:"150px"},{key:"Bool1",friendlyName:"Preview",disableSort:!0,render:t=>n`<md-filled-tonal-icon-button @click=${()=>this.viewDialog?.open?.(t?.Id??0)}><md-icon>pageview</md-icon></md-filled-tonal-icon-button>`,csvValue:()=>"",width:"60px"}]};get tableMetaData(){return this.#nt}set tableMetaData(t){this.#nt=t}#x=0;get resultTotal(){return this.#x}set resultTotal(t){this.#x=t}#i;get filterController(){return this.#i}set filterController(t){this.#i=t}#T;get dataTable(){return this.#T}set dataTable(t){this.#T=t}#ot;get filterDialog(){return this.#ot}set filterDialog(t){this.#ot=t}#ht;get pageControl(){return this.#ht}set pageControl(t){this.#ht=t}#ct;get mainContentContainer(){return this.#ct}set mainContentContainer(t){this.#ct=t}#k;get viewDialog(){return this.#k}set viewDialog(t){this.#k=t}#j;get viewEmailTemplateInfoDialog(){return this.#j}set viewEmailTemplateInfoDialog(t){this.#j=t}constructor(){super(),this.filterController=new M(""),this.filterController.setFilter("dateRange",()=>""),this.filterController.setFilter("startDate",()=>""),this.filterController.setFilter("endDate",()=>""),this.filterController.setFilter("template",t=>`EmailTemplateId eq ${t}`),this.filterController.subscribeToFilterChange(async()=>{this.isActive&&(this.pageControl&&(this.pageControl.page=0),this.#I())}),this.filterController.loadFromQueryString()}async updated(t){this.isActive&&t.has("isActive")&&(await(this.mainContentContainer?.updateComplete),this.#I()),this.isActive&&t.has("toolbarSearchTerm")&&this.searchTerm!==this.toolbarSearchTerm&&(this.searchTerm=this.toolbarSearchTerm,this.pageControl&&(this.pageControl.page=0),this.#N.debounce()),t.has("path")&&(this.filterController.path=this.path)}firstUpdated(){if(this.searchController=new K(this,this.siteSearchTextFieldContext,{placeholder:"Search by subject or recipient",onSearch:()=>(this.pageControl&&(this.pageControl.page=0),this.#I())}),$){const t=this.tableMetaData.itemMetaData.length-1;this.tableMetaData.itemMetaData.splice(t,0,{key:"IsTestMessage",friendlyName:"Test",getSortExpression:()=>"IsTestMessage",render:t=>n`<div>${t.IsTestMessage?"Yes":"No"}</div>`,csvValue:t=>t.IsTestMessage?"Yes":"No",width:"50px"})}}async#I(){const{items:t,odataCount:e}=await this.#dt(this.siteSearchTextFieldContext?this.searchController?.searchTerm??null:this.searchTerm??null);this.items=t,this.resultTotal=e}#N=new B(()=>this.#I());renderRecipients(t,e=1){const i=t?.split(",").filter(t=>!!t).map(t=>t.trim()).reverse()??[];return i?.length>e?n`${w(i.slice(0,e),t=>t,t=>n`${t} <br />`)} <span more> ${i.length-e} more... </span>`:w(i,t=>t,t=>n`${t} <br />`)}async#dt(t){let e=[];const s=O(t||""),a=s.map(t=>`(contains(Subject, '${t}') or contains(Recipients, '${t}'))`).join(" and ");s.length>0&&e.push(`${a}`);const l=this.filterController.getValue("dateRange"),r="custom"===l?this.filterController.getValue("startDate"):N.get(l)?.startDate(),n="custom"===l?this.filterController.getValue("endDate"):N.get(l)?.endDate();r&&e.push(`SentDate ge ${Y(r).format("YYYY-MM-DD")}`),n&&e.push(`SentDate le ${Y(n).format("YYYY-MM-DD")}`),e=[...e,...this.filterController.getActiveFilterOdata()];const o=["select=Id,Recipients,SentDate,Subject"+($?",IsTestMessage":""),"expand=EmailTemplate(select=Id,Name,IsExpired)",`top=${this.pageControl?.take}`,"skip="+(this.pageControl?.take??0)*(this.pageControl?.page??0),"count=true"],h=this.dataTable.sort.map(t=>`${this.tableMetaData.itemMetaData.find(e=>e.key===t.key)?.getSortExpression?.()??t.key} ${t.direction}`).join(", ");h&&o.push(`orderby=${h}`),$||e.push("IsTestMessage eq false"),e.length>0&&o.push(`filter=${e.join(" and ")}`);try{if(!this.apiService)throw new Error("No api service provided");const t=this.apiService?.getAsync(`EmailTemplateLogs/?${o.join("&")}`);this.loadWhile(t),this.dataTable.loadWhile(t),this.dispatchEvent(new k(t));const e=await t;return{items:e.toList(),odataCount:e.odataCount}}catch(t){this.dispatchEvent(new i(t,{autoHide:7500}))}return{items:[],odataCount:0}}static{this.styles=[z,_,x,s`
      :host {
        display: grid;
      }
    ...
    `]}render(){return n`
      ...
      <leavitt-view-sent-email-dialog .apiService=${this.apiService}></leavitt-view-sent-email-dialog>
      <leavitt-view-email-template-info-dialog .apiService=${this.apiService}></leavitt-view-email-template-info-dialog>
    `}};o([h({type:Boolean})],X.prototype,"isActive",null),o([h({type:Object})],X.prototype,"apiService",null),o([h({type:String})],X.prototype,"path",null),o([h({type:Object})],X.prototype,"siteSearchTextFieldContext",null),o([h({type:String})],X.prototype,"toolbarSearchTerm",null),o([c()],X.prototype,"searchTerm",null),o([c()],X.prototype,"items",null),o([c()],X.prototype,"selected",null),o([c()],X.prototype,"tableMetaData",null),o([c()],X.prototype,"resultTotal",null),o([c()],X.prototype,"filterController",null),o([d("titanium-data-table-core")],X.prototype,"dataTable",null),o([d("leavitt-email-history-viewer-filled-filter-dialog")],X.prototype,"filterDialog",null),o([d("titanium-page-control")],X.prototype,"pageControl",null),o([d("leavitt-app-main-content-container")],X.prototype,"mainContentContainer",null),o([d("leavitt-view-sent-email-dialog")],X.prototype,"viewDialog",null),o([d("leavitt-view-email-template-info-dialog")],X.prototype,"viewEmailTemplateInfoDialog",null),X=o([m("leavitt-email-history-viewer-filled")],X);let J=class extends(E(e)){#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#mt;get demo1(){return this.#mt}set demo1(t){this.#mt=t}#pt;get demo2(){return this.#pt}set demo2(t){this.#pt=t}constructor(){super(),this.apiService=new j(C),this.apiService.baseUrl="https://devapi3.leavitt.com/",this.apiService.addHeader("X-LGAppName","EducationAdminV2")}static{this.styles=[A,s`
      div[row] {
        display: grid;
        gap: 12px;
      }
    ...
    `}};o([c()],J.prototype,"apiService",null),o([d("leavitt-email-history-viewer")],J.prototype,"demo1",null),o([d("leavitt-email-history-viewer-filled")],J.prototype,"demo2",null),J=o([m("leavitt-email-history-viewer-demo")],J);export{J as LeavittEmailHistoryViewerDemo};
