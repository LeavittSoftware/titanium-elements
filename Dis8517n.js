...
`;let Se=class extends ke{};Se.styles=[Nt,$e],Se=r([pt("md-text-button")],Se);let ze=class extends ht{#j;#L;get open(){return this.#L}set open(t){this.#L=t}#U;get noAction(){return this.#U}set noAction(t){this.#U=t}#F;get actionText(){return this.#F}set actionText(t){this.#F=t}#D;get message(){return this.#D}set message(t){this.#D=t}constructor(){super(),this.popover="manual"}show(t,e){if(this.showPopover?this.showPopover():this.open=!0,this.message=e?.overrideTemplate?e?.overrideTemplate:t,this.noAction=e?.noAction??!1,this.actionText=e?.actionText??"Dismiss",e?.autoHide){const t="number"==typeof e?.autoHide?e?.autoHide:5e3;this.#G=window.setTimeout(()=>this.close("auto-close"),t)}return new Promise(t=>{this.#j=t})}#G=0;close(t=""){clearTimeout(this.#G),this.hidePopover?this.hidePopover():this.open=!1,this.#j(t)}static{this.styles=[d`
    ...
    `}};r([vt({type:Boolean,reflect:!0})],ze.prototype,"open",null),r([vt({type:Boolean,reflect:!0})],ze.prototype,"noAction",null),r([vt({type:String})],ze.prototype,"actionText",null),r([vt({type:String})],ze.prototype,"message",null),ze=r([pt("titanium-simple-snackbar")],ze);let Ae=class extends ht{#j;#L;get open(){return this.#L}set open(t){this.#L=t}#q=[];get httpErrors(){return this.#q}set httpErrors(t){this.#q=t}constructor(){super(),this.popover="manual"}show(t){return this.showPopover?this.showPopover():this.open=!0,this.httpErrors.push(t),new Promise(t=>{this.#j=t})}addError(t){this.httpErrors=[...this.httpErrors,t]}#G=0;close(t=""){clearTimeout(this.#G),this.hidePopover?this.hidePopover():this.open=!1,this.#j(t)}static{this.styles=[...ze.styles,d`
      /* HTTP error styles */
      http-error {
        display: grid;
        gap: 24px;
    ...
    `}};r([vt({type:Boolean,reflect:!0})],Ae.prototype,"open",null),r([vt({type:Array})],Ae.prototype,"httpErrors",null),Ae=r([pt("titanium-http-error-snackbar")],Ae);class Ce extends Event{static{this.eventName="show-snackbar"}constructor(t,e){super(Ce.eventName,{bubbles:!0,composed:!0}),this.SnackbarMessage=t,this.SnackbarOptions=e}}let Te=class extends ht{constructor(){super(...arguments),this.SnackbarStack=[]}#V;get eventListenerTarget(){return this.#V}set eventListenerTarget(t){this.#V=t}connectedCallback(){(this.eventListenerTarget||this.getRootNode()).addEventListener(Ce.eventName,t=>{t.stopImmediatePropagation(),this.open(t.SnackbarMessage,t.SnackbarOptions)})}async open(t,e){let i,r;if("string"==typeof t){const o="<titanium-simple-snackbar newest></titanium-simple-snackbar>";this.insertAdjacentHTML("beforeend",o);const s=this.querySelector("titanium-simple-snackbar[newest]");s.removeAttribute("newest"),e&&(e.close=t=>s.close(t)),this.SnackbarStack.unshift(s),i=s.show(t,e),r=s}else{let o=this.querySelector("titanium-http-error-snackbar");if(o)return void o.addError(t);{const e="<titanium-http-error-snackbar></titanium-http-error-snackbar>";this.insertAdjacentHTML("beforeend",e),o=this.querySelector("titanium-http-error-snackbar"),this.SnackbarStack.unshift(o),i=o.show(t)}e&&(e.close=t=>o.close(t)),r=o}return this.reposition(),await i,this.SnackbarStack.splice(this.SnackbarStack.indexOf(r),1),r.remove(),this.reposition(),i}dismissAll(){this.SnackbarStack.forEach(t=>t.close())}async reposition(){let t=0;for(let e=0;e<this.SnackbarStack.length;e++){const i=this.SnackbarStack[e];await i.updateComplete,0===i.clientHeight&&i.close(),i.style.bottom=`${t}px`,t+=i.clientHeight+12}}};r([vt({type:Object})],Te.prototype,"eventListenerTarget",null),Te=r([pt("titanium-snackbar-stack")],Te);class Ee extends CustomEvent{static{this.eventType="pending-state"}constructor(t){super(Ee.eventType,{bubbles:!0,composed:!0,detail:{promise:t}})}}const Ie="important",Pe=" !"+Ie,Oe=Jt(class extends Kt{constructor(t){if(super(t),t.type!==Vt||"style"!==t.name||t.strings?.length>2)throw Error("The `styleMap` directive must be used in the `style` attribute and must be the only part in the attribute.")}render(t){return Object.keys(t).reduce((e,i)=>{const r=t[i];return null==r?e:e+`${i=i.includes("-")?i:i.replace(/(?:^(webkit|moz|ms|o)|)(?=[A-Z])/g,"-$&").toLowerCase()}:${r};`},"")}update(t,[e]){const{style:i}=t.element;if(void 0===this.ft)return this.ft=new Set(Object.keys(e)),this.render(e);for(const t of this.ft)null==e[t]&&(this.ft.delete(t),t.includes("-")?i.removeProperty(t):i[t]=null);for(const t in e){const r=e[t];if(null!=r){this.ft.add(t);const e="string"==typeof r&&r.endsWith(Pe);t.includes("-")||e?i.setProperty(t,e?r.slice(0,-11):r,e?Ie:""):i[t]=r}}return W}}),Me=he(ht);class Re extends Me{constructor(){super(...arguments),this.value=0,this.max=1,this.indeterminate=!1,this.fourColor=!1}render(){const{ariaLabel:t}=this;return V`
      ...
      >
    `}getRenderClasses(){return{indeterminate:this.indeterminate,"four-color":this.fourColor}}}r([vt({type:Number})],Re.prototype,"value",void 0),r([vt({type:Number})],Re.prototype,"max",void 0),r([vt({type:Boolean})],Re.prototype,"indeterminate",void 0),r([vt({type:Boolean,attribute:"four-color"})],Re.prototype,"fourColor",void 0);class Be extends Re{constructor(){super(...arguments),this.buffer=0}renderIndicator(){const t={transform:`scaleX(${100*(this.indeterminate?1:this.value/this.max)}%)`},e=this.buffer??0,i=e>0,r={transform:`scaleX(${100*(this.indeterminate||!i?1:e/this.max)}%)`},o=this.indeterminate||!i||e>=this.max||this.value>=this.max;return V`
...
`;let je=class extends Be{};je.styles=[Ne],je=r([pt("md-linear-progress")],je);let Le=class extends ht{#L;get open(){return this.#L}set open(t){this.#L=t}#W;#X;#Y=75;#J=350;#K;#Q=0;firstUpdated(){this.popover="manual",this.addEventListener("toggle",t=>this.open="open"===t.newState),window.addEventListener(Ee.eventType,async t=>{this.#Z(),this.#Q++;try{await t.detail.promise}finally{this.#Q--,0===this.#Q&&this.#tt()}})}#Z(){window.clearTimeout(this.#W),window.clearTimeout(this.#X),this.#W=window.setTimeout(()=>{this.#K=performance.now(),this.showPopover?this.showPopover():this.open=!0,this.style.display="block"},this.#Y)}#tt(){window.clearTimeout(this.#W);const t=performance.now()-this.#K,e=Math.max(this.#J-t,0);this.#X=window.setTimeout(()=>{this.hidePopover?this.hidePopover():this.open=!1,this.style.display="none"},e)}static{this.styles=d`
  ...
  `}render(){return V`
    ...
    `}};r([vt({type:String})],Ue.prototype,"message",null),Ue=r([pt("titanium-error-page")],Ue);let Fe=class extends ht{#et;get notificationsStatus(){return this.#et}set notificationsStatus(t){this.#et=t}#it="service-worker.js";get scriptUrl(){return this.#it}set scriptUrl(t){this.#it=t}#rt;#ot=!1;async connectedCallback(){if("serviceWorker"in navigator){const t=await navigator.serviceWorker.getRegistration();t&&(t.addEventListener("updatefound",()=>{this.#rt=t.installing,this.#rt?.addEventListener("statechange",()=>{"installed"===this.#rt?.state&&navigator.serviceWorker.controller&&this.#st()})}),t.waiting&&navigator.serviceWorker.controller&&(this.#rt=t.waiting,this.#st())),navigator.serviceWorker.addEventListener("controllerchange",()=>{this.#ot||(window.location.reload(),this.#ot=!0)})}}async#st(){await this.dispatchEvent(new Ce("Site has been updated",{actionText:"RELOAD"})),this.#rt?.postMessage({type:"SKIP_WAITING"})}render(){return V``}};var De;r([vt({type:String})],Fe.prototype,"notificationsStatus",null),r([vt({type:String})],Fe.prototype,"scriptUrl",null),Fe=r([pt("titanium-service-worker-notifier")],Fe);let Ge=class extends ht{static{De=this}#nt;get dialog(){return this.#nt}set dialog(t){this.#nt=t}#at=!1;get fixed(){return this.#at}set fixed(t){this.#at=t}#lt=!1;get alwayShowContent(){return this.#lt}set alwayShowContent(t){this.#lt=t}#ct="ltr";get direction(){return this.#ct}set direction(t){this.#ct=t}#dt=!1;get hasHeader(){return this.#dt}set hasHeader(t){this.#dt=t}#ht=!1;get hasFooter(){return this.#ht}set hasFooter(t){this.#ht=t}async firstUpdated(){let t=0,e=0;this.addEventListener("touchstart",e=>{t=e.changedTouches[0].screenX}),this.addEventListener("touchend",i=>{e=i.changedTouches[0].screenX,t-e>50&&this.close()}),this.dialog?.addEventListener("click",t=>{t.target instanceof Element&&"DIALOG"===t.target?.nodeName&&this.close()}),this.dialog?.addEventListener("cancel",t=>{t.preventDefault(),this.close()}),window.addEventListener("popstate",()=>this.dialog?.close(),!1),await De.animationsComplete(this.dialog),await De.animationsComplete(this.dialog),this.dialog?.removeAttribute("loading")}static async animationsComplete(t){return await Promise.allSettled(t.getAnimations().map(t=>t.finished))}open(){this.dialog?.showModal(),this.dialog?.removeAttribute("hide"),this.setBodyOverflow("hidden")}async close(){this.dialog?.open&&(this.dialog?.setAttribute("hide",""),await De.animationsComplete(this.dialog),this.dialog?.close(),this.dialog?.removeAttribute("hide"))}closeQuick(){this.dialog?.open&&this.dialog?.close()}setBodyOverflow(t){const e=document.querySelector("html");e&&(e.style.overflow=t)}static{this.styles=d`
    :host {
      display: block;
    }
  ...
  `}render(){return V`<dialog
    ...
    </dialog>`}};r([yt("dialog")],Ge.prototype,"dialog",null),r([vt({type:Boolean,reflect:!0})],Ge.prototype,"fixed",null),r([vt({type:Boolean,reflect:!0,attribute:"always-show-content"})],Ge.prototype,"alwayShowContent",null),r([vt({type:String,reflect:!0})],Ge.prototype,"direction",null),r([vt({type:Boolean,reflect:!0,attribute:"has-header"})],Ge.prototype,"hasHeader",null),r([vt({type:Boolean,reflect:!0,attribute:"has-footer"})],Ge.prototype,"hasFooter",null),r([_t({slot:"header"})],Ge.prototype,"headerElements",void 0),r([_t({slot:"footer"})],Ge.prototype,"footerElements",void 0),Ge=De=r([pt("titanium-drawer")],Ge);class qe extends ht{render(){return V`<slot></slot>`}connectedCallback(){super.connectedCallback();"false"!==this.getAttribute("aria-hidden")?this.setAttribute("aria-hidden","true"):this.removeAttribute("aria-hidden")}}const He=d`:host{font-size:var(--md-icon-size, 24px);width:var(--md-icon-size, 24px);height:var(--md-icon-size, 24px);color:inherit;font-variation-settings:inherit;font-weight:400;font-family:var(--md-icon-font, Material Symbols Outlined);display:inline-flex;font-style:normal;place-items:center;place-content:center;line-height:1;overflow:hidden;letter-spacing:normal;text-transform:none;user-select:none;white-space:nowrap;word-wrap:normal;flex-shrink:0;-webkit-font-smoothing:antialiased;text-rendering:optimizeLegibility;-moz-osx-font-smoothing:grayscale}::slotted(svg){fill:currentColor}::slotted(*){height:100%;width:100%}
`;let Ve=class extends qe{};Ve.styles=[He],Ve=r([pt("md-icon")],Ve);let We=class extends ht{#ut;get fileName(){return this.#ut}set fileName(t){this.#ut=t}#pt="circle";get shape(){return this.#pt}set shape(t){this.#pt=t}#mt;get showRing(){return this.#mt}set showRing(t){this.#mt=t}#ft;get showTestUserIndicator(){return this.#ft}set showTestUserIndicator(t){this.#ft=t}#vt;get profilePictureLinkPersonId(){return this.#vt}set profilePictureLinkPersonId(t){this.#vt=t}#gt=120;get size(){return this.#gt}set size(t){this.#gt=t}#bt=!1;get useIntrinsicImageSize(){return this.#bt}set useIntrinsicImageSize(t){this.#bt=t}#yt=new Set([32,64,128,256,512,1024]);#xt="https://cdn.leavitt.com/icon-user-profile-sq.svg";updated(t){(t.has("size")||t.has("useIntrinsicImageSize"))&&(this.style.width=this.useIntrinsicImageSize||!this.size?"":this.size+"px",this.style.height=this.useIntrinsicImageSize||!this.size?"":this.size+"px")}#wt(t){const e=[...this.#yt];for(let i=0;i<e.length;i++){const r=e[i];if(t<=r)return r}return 512}#_t(t,e){const i=this.#wt(e);return t?`https://cdn.leavitt.com/${t}-${i}.webp`:this.#xt}static{this.styles=d`
    :host {
  ...
  `}renderProfilePicture(){return V`
    ...
    `}render(){return this.profilePictureLinkPersonId?V`<a target="_blank" href="https://${Tt?"dev":""}workforce.leavitt.com/user/${this.profilePictureLinkPersonId}/view"
      ...
      > `:this.renderProfilePicture()}};function Xe(t,e=ei){const i=Ke(t,e);return i&&(i.tabIndex=0,i.focus()),i}function Ye(t,e=ei){const i=Qe(t,e);return i&&(i.tabIndex=0,i.focus()),i}function Je(t,e=ei){for(let i=0;i<t.length;i++){const r=t[i];if(0===r.tabIndex&&e(r))return{item:r,index:i}}return null}function Ke(t,e=ei){for(const i of t)if(e(i))return i;return null}function Qe(t,e=ei){for(let i=t.length-1;i>=0;i--){const r=t[i];if(e(r))return r}return null}function Ze(t,e,i=ei,r=!0){if(e){const o=function(t,e,i=ei,r=!0){for(let o=1;o<t.length;o++){const s=(o+e)%t.length;if(s<e&&!r)return null;const n=t[s];if(i(n))return n}return t[e]?t[e]:null}(t,e.index,i,r);return o&&(o.tabIndex=0,o.focus()),o}return Xe(t,i)}function ti(t,e,i=ei,r=!0){if(e){const o=function(t,e,i=ei,r=!0){for(let o=1;o<t.length;o++){const s=(e-o+t.length)%t.length;if(s>e&&!r)return null;const n=t[s];if(i(n))return n}return t[e]?t[e]:null}(t,e.index,i,r);return o&&(o.tabIndex=0,o.focus()),o}return Ye(t,i)}function ei(t){return!t.disabled}r([vt({reflect:!0,type:String})],We.prototype,"fileName",null),r([vt({reflect:!0,type:String})],We.prototype,"shape",null),r([vt({reflect:!0,type:Boolean,attribute:"show-ring"})],We.prototype,"showRing",null),r([vt({reflect:!0,type:Boolean,attribute:"show-test-user-indicator"})],We.prototype,"showTestUserIndicator",null),r([vt({reflect:!0,type:Number,attribute:"profile-picture-link-person-id"})],We.prototype,"profilePictureLinkPersonId",null),r([vt({type:Number})],We.prototype,"size",null),r([vt({type:Boolean})],We.prototype,"useIntrinsicImageSize",null),We=r([pt("profile-picture")],We);const ii={ArrowDown:"ArrowDown",ArrowLeft:"ArrowLeft",ArrowUp:"ArrowUp",ArrowRight:"ArrowRight",Home:"Home",End:"End"};class ri{constructor(t){this.handleKeydown=t=>{const e=t.key;if(t.defaultPrevented||!this.isNavigableKey(e))return;const i=this.items;if(!i.length)return;const r=Je(i,this.isActivatable);t.preventDefault();const o=this.isRtl();let s=null;switch(e){case ii.ArrowDown:case o?ii.ArrowLeft:ii.ArrowRight:s=Ze(i,r,this.isActivatable,this.wrapNavigation());break;case ii.ArrowUp:case o?ii.ArrowRight:ii.ArrowLeft:s=ti(i,r,this.isActivatable,this.wrapNavigation());break;case ii.Home:s=Xe(i,this.isActivatable);break;case ii.End:s=Ye(i,this.isActivatable)}s&&r&&r.item!==s&&(r.item.tabIndex=-1)},this.onDeactivateItems=()=>{const t=this.items;for(const e of t)this.deactivateItem(e)},this.onRequestActivation=t=>{this.onDeactivateItems();const e=t.target;this.activateItem(e),e.focus()},this.onSlotchange=()=>{const t=this.items;let e=!1;for(const i of t){!(!i.disabled&&i.tabIndex>-1)||e?i.tabIndex=-1:(e=!0,i.tabIndex=0)}if(e)return;const i=Ke(t,this.isActivatable);i&&(i.tabIndex=0)};const{isItem:e,getPossibleItems:i,isRtl:r,deactivateItem:o,activateItem:s,isNavigableKey:n,isActivatable:a,wrapNavigation:l}=t;this.isItem=e,this.getPossibleItems=i,this.isRtl=r,this.deactivateItem=o,this.activateItem=s,this.isNavigableKey=n,this.isActivatable=a,this.wrapNavigation=l??(()=>!0)}get items(){const t=this.getPossibleItems(),e=[];for(const i of t){if(this.isItem(i)){e.push(i);continue}const t=i.item;t&&this.isItem(t)&&e.push(t)}return e}activateNextItem(){const t=this.items,e=Je(t,this.isActivatable);return e&&(e.item.tabIndex=-1),Ze(t,e,this.isActivatable,this.wrapNavigation())}activatePreviousItem(){const t=this.items,e=Je(t,this.isActivatable);return e&&(e.item.tabIndex=-1),ti(t,e,this.isActivatable,this.wrapNavigation())}}const oi=function(t,e){return new CustomEvent("close-menu",{bubbles:!0,composed:!0,detail:{initiator:t,reason:e,itemPath:[t]}})},si={SPACE:"Space",ENTER:"Enter"},ni={CLICK_SELECTION:"click-selection",KEYDOWN:"keydown"},ai={ESCAPE:"Escape",SPACE:si.SPACE,ENTER:si.ENTER};function li(t){return Object.values(ai).some(e=>e===t)}function ci(t){return Object.values(si).some(e=>e===t)}function di(t,e){const i=new Event("md-contains",{bubbles:!0,composed:!0});let r=[];const o=t=>{r=t.composedPath()};e.addEventListener("md-contains",o),t.dispatchEvent(i),e.removeEventListener("md-contains",o);return r.length>0}const hi={NONE:"none",LIST_ROOT:"list-root",FIRST_ITEM:"first-item",LAST_ITEM:"last-item"},ui="end-start",pi="start-start";class mi{constructor(t,e){this.host=t,this.getProperties=e,this.surfaceStylesInternal={display:"none"},this.lastValues={isOpen:!1},this.host.addController(this)}get surfaceStyles(){return this.surfaceStylesInternal}async position(){const{surfaceEl:t,anchorEl:e,anchorCorner:i,surfaceCorner:r,positioning:o,xOffset:s,yOffset:n,disableBlockFlip:a,disableInlineFlip:l,repositionStrategy:c}=this.getProperties(),d=i.toLowerCase().trim(),h=r.toLowerCase().trim();if(!t||!e)return;const u=window.innerWidth,p=window.innerHeight,m=document.createElement("div");m.style.opacity="0",m.style.position="fixed",m.style.display="block",m.style.inset="0",document.body.appendChild(m);const f=m.getBoundingClientRect();m.remove();const v=window.innerHeight-f.bottom,g=window.innerWidth-f.right;this.surfaceStylesInternal={display:"block",opacity:"0"},this.host.requestUpdate(),await this.host.updateComplete,t.popover&&t.isConnected&&t.showPopover();const b=t.getSurfacePositionClientRect?t.getSurfacePositionClientRect():t.getBoundingClientRect(),y=e.getSurfacePositionClientRect?e.getSurfacePositionClientRect():e.getBoundingClientRect(),[x,w]=h.split("-"),[_,k]=d.split("-"),$="ltr"===getComputedStyle(t).direction;let{blockInset:S,blockOutOfBoundsCorrection:z,surfaceBlockProperty:A}=this.calculateBlock({surfaceRect:b,anchorRect:y,anchorBlock:_,surfaceBlock:x,yOffset:n,positioning:o,windowInnerHeight:p,blockScrollbarHeight:v});if(z&&!a){const t="start"===x?"end":"start",e="start"===_?"end":"start",i=this.calculateBlock({surfaceRect:b,anchorRect:y,anchorBlock:e,surfaceBlock:t,yOffset:n,positioning:o,windowInnerHeight:p,blockScrollbarHeight:v});z>i.blockOutOfBoundsCorrection&&(S=i.blockInset,z=i.blockOutOfBoundsCorrection,A=i.surfaceBlockProperty)}let{inlineInset:C,inlineOutOfBoundsCorrection:T,surfaceInlineProperty:E}=this.calculateInline({surfaceRect:b,anchorRect:y,anchorInline:k,surfaceInline:w,xOffset:s,positioning:o,isLTR:$,windowInnerWidth:u,inlineScrollbarWidth:g});if(T&&!l){const t="start"===w?"end":"start",e="start"===k?"end":"start",i=this.calculateInline({surfaceRect:b,anchorRect:y,anchorInline:e,surfaceInline:t,xOffset:s,positioning:o,isLTR:$,windowInnerWidth:u,inlineScrollbarWidth:g});Math.abs(T)>Math.abs(i.inlineOutOfBoundsCorrection)&&(C=i.inlineInset,T=i.inlineOutOfBoundsCorrection,E=i.surfaceInlineProperty)}"move"===c&&(S-=z,C-=T),this.surfaceStylesInternal={display:"block",opacity:"1",[A]:`${S}px`,[E]:`${C}px`},"resize"===c&&(z&&(this.surfaceStylesInternal.height=b.height-z+"px"),T&&(this.surfaceStylesInternal.width=b.width-T+"px")),this.host.requestUpdate()}calculateBlock(t){const{surfaceRect:e,anchorRect:i,anchorBlock:r,surfaceBlock:o,yOffset:s,positioning:n,windowInnerHeight:a,blockScrollbarHeight:l}=t,c="fixed"===n||"document"===n?1:0,d="document"===n?1:0,h="start"===o?1:0,u="end"===o?1:0,p=(r!==o?1:0)*i.height+s,m=h*i.top+u*(a-i.bottom-l);return{blockInset:c*m+d*(h*window.scrollY-u*window.scrollY)+p,blockOutOfBoundsCorrection:Math.abs(Math.min(0,a-m-p-e.height)),surfaceBlockProperty:"start"===o?"inset-block-start":"inset-block-end"}}calculateInline(t){const{isLTR:e,surfaceInline:i,anchorInline:r,anchorRect:o,surfaceRect:s,xOffset:n,positioning:a,windowInnerWidth:l,inlineScrollbarWidth:c}=t,d="fixed"===a||"document"===a?1:0,h="document"===a?1:0,u=e?1:0,p=e?0:1,m="start"===i?1:0,f="end"===i?1:0,v=(r!==i?1:0)*o.width+n,g=u*(m*o.left+f*(l-o.right-c))+p*(m*(l-o.right-c)+f*o.left);let b="start"===i?"inset-inline-start":"inset-inline-end";return"document"!==a&&"fixed"!==a||(b="start"===i&&e||"end"===i&&!e?"left":"right"),{inlineInset:d*g+v+h*(u*(m*window.scrollX-f*window.scrollX)+p*(f*window.scrollX-m*window.scrollX)),inlineOutOfBoundsCorrection:Math.abs(Math.min(0,l-g-v-s.width)),surfaceInlineProperty:b}}hostUpdate(){this.onUpdate()}hostUpdated(){this.onUpdate()}async onUpdate(){const t=this.getProperties();let e=!1;for(const[i,r]of Object.entries(t))if(e=e||r!==this.lastValues[i],e)break;const i=this.lastValues.isOpen!==t.isOpen,r=!!t.anchorEl,o=!!t.surfaceEl;e&&r&&o&&(this.lastValues.isOpen=t.isOpen,t.isOpen?(this.lastValues=t,await this.position(),t.onOpen()):i&&(await t.beforeClose(),this.close(),t.onClose()))}close(){this.surfaceStylesInternal={display:"none"},this.host.requestUpdate();const t=this.getProperties().surfaceEl;t?.popover&&t?.isConnected&&t.hidePopover()}}const fi={INDEX:0,ITEM:1,TEXT:2};class vi{constructor(t){this.getProperties=t,this.typeaheadRecords=[],this.typaheadBuffer="",this.cancelTypeaheadTimeout=0,this.isTypingAhead=!1,this.lastActiveRecord=null,this.onKeydown=t=>{this.isTypingAhead?this.typeahead(t):this.beginTypeahead(t)},this.endTypeahead=()=>{this.isTypingAhead=!1,this.typaheadBuffer="",this.typeaheadRecords=[]}}get items(){return this.getProperties().getItems()}get active(){return this.getProperties().active}beginTypeahead(t){this.active&&("Space"===t.code||"Enter"===t.code||t.code.startsWith("Arrow")||"Escape"===t.code||(this.isTypingAhead=!0,this.typeaheadRecords=this.items.map((t,e)=>[e,t,t.typeaheadText.trim().toLowerCase()]),this.lastActiveRecord=this.typeaheadRecords.find(t=>0===t[fi.ITEM].tabIndex)??null,this.lastActiveRecord&&(this.lastActiveRecord[fi.ITEM].tabIndex=-1),this.typeahead(t)))}typeahead(t){if(t.defaultPrevented)return;if(clearTimeout(this.cancelTypeaheadTimeout),"Enter"===t.code||t.code.startsWith("Arrow")||"Escape"===t.code)return this.endTypeahead(),void(this.lastActiveRecord&&(this.lastActiveRecord[fi.ITEM].tabIndex=-1));"Space"===t.code&&t.preventDefault(),this.cancelTypeaheadTimeout=setTimeout(this.endTypeahead,this.getProperties().typeaheadBufferTime),this.typaheadBuffer+=t.key.toLowerCase();const e=this.lastActiveRecord?this.lastActiveRecord[fi.INDEX]:-1,i=this.typeaheadRecords.length,r=t=>(t[fi.INDEX]+i-e)%i,o=this.typeaheadRecords.filter(t=>!t[fi.ITEM].disabled&&t[fi.TEXT].startsWith(this.typaheadBuffer)).sort((t,e)=>r(t)-r(e));if(0===o.length)return clearTimeout(this.cancelTypeaheadTimeout),this.lastActiveRecord&&(this.lastActiveRecord[fi.ITEM].tabIndex=-1),void this.endTypeahead();const s=1===this.typaheadBuffer.length;let n;n=this.lastActiveRecord===o[0]&&s?o[1]??o[0]:o[0],this.lastActiveRecord&&(this.lastActiveRecord[fi.ITEM].tabIndex=-1),this.lastActiveRecord=n,n[fi.ITEM].tabIndex=0,n[fi.ITEM].focus()}}const gi=200,bi=new Set([ii.ArrowDown,ii.ArrowUp,ii.Home,ii.End]),yi=new Set([ii.ArrowLeft,ii.ArrowRight,...bi]);class xi extends ht{get openDirection(){return"start"===this.menuCorner.split("-")[0]?"DOWN":"UP"}get anchorElement(){return this.anchor?this.getRootNode().querySelector(`#${this.anchor}`):this.currentAnchorElement}set anchorElement(t){this.currentAnchorElement=t,this.requestUpdate("anchorElement")}constructor(){super(),this.anchor="",this.positioning="absolute",this.quick=!1,this.hasOverflow=!1,this.open=!1,this.xOffset=0,this.yOffset=0,this.noHorizontalFlip=!1,this.noVerticalFlip=!1,this.typeaheadDelay=200,this.anchorCorner=ui,this.menuCorner=pi,this.stayOpenOnOutsideClick=!1,this.stayOpenOnFocusout=!1,this.skipRestoreFocus=!1,this.defaultFocus=hi.FIRST_ITEM,this.noNavigationWrap=!1,this.typeaheadActive=!0,this.isSubmenu=!1,this.pointerPath=[],this.isRepositioning=!1,this.openCloseAnimationSignal=function(){let t=null;return{start:()=>(t?.abort(),t=new AbortController,t.signal),finish(){t=null}}}(),this.listController=new ri({isItem:t=>t.hasAttribute("md-menu-item"),getPossibleItems:()=>this.slotItems,isRtl:()=>"rtl"===getComputedStyle(this).direction,deactivateItem:t=>{t.selected=!1,t.tabIndex=-1},activateItem:t=>{t.selected=!0,t.tabIndex=0},isNavigableKey:t=>{if(!this.isSubmenu)return yi.has(t);return t===("rtl"===getComputedStyle(this).direction?ii.ArrowLeft:ii.ArrowRight)||bi.has(t)},wrapNavigation:()=>!this.noNavigationWrap}),this.lastFocusedElement=null,this.typeaheadController=new vi(()=>({getItems:()=>this.items,typeaheadBufferTime:this.typeaheadDelay,active:this.typeaheadActive})),this.currentAnchorElement=null,this.internals=this.attachInternals(),this.menuPositionController=new mi(this,()=>({anchorCorner:this.anchorCorner,surfaceCorner:this.menuCorner,surfaceEl:this.surfaceEl,anchorEl:this.anchorElement,positioning:"popover"===this.positioning?"document":this.positioning,isOpen:this.open,xOffset:this.xOffset,yOffset:this.yOffset,disableBlockFlip:this.noVerticalFlip,disableInlineFlip:this.noHorizontalFlip,onOpen:this.onOpened,beforeClose:this.beforeClose,onClose:this.onClosed,repositionStrategy:this.hasOverflow&&"popover"!==this.positioning?"move":"resize"})),this.onWindowResize=()=>{this.isRepositioning||"document"!==this.positioning&&"fixed"!==this.positioning&&"popover"!==this.positioning||(this.isRepositioning=!0,this.reposition(),this.isRepositioning=!1)},this.handleFocusout=async t=>{const e=this.anchorElement;if(this.stayOpenOnFocusout||!this.open||this.pointerPath.includes(e))return;if(t.relatedTarget){if(di(t.relatedTarget,this)||0!==this.pointerPath.length&&di(t.relatedTarget,e))return}else if(this.pointerPath.includes(this))return;const i=this.skipRestoreFocus;this.skipRestoreFocus=!0,this.close(),await this.updateComplete,this.skipRestoreFocus=i},this.onOpened=async()=>{this.lastFocusedElement=function(t=document){let e=t.activeElement;for(;e&&e?.shadowRoot?.activeElement;)e=e.shadowRoot.activeElement;return e}();const t=this.items,e=Je(t);e&&this.defaultFocus!==hi.NONE&&(e.item.tabIndex=-1);let i=!this.quick;switch(this.quick?this.dispatchEvent(new Event("opening")):i=!!await this.animateOpen(),this.defaultFocus){case hi.FIRST_ITEM:const e=Ke(t);e&&(e.tabIndex=0,e.focus(),await e.updateComplete);break;case hi.LAST_ITEM:const i=Qe(t);i&&(i.tabIndex=0,i.focus(),await i.updateComplete);break;case hi.LIST_ROOT:this.focus()}i||this.dispatchEvent(new Event("opened"))},this.beforeClose=async()=>{this.open=!1,this.skipRestoreFocus||this.lastFocusedElement?.focus?.(),this.quick||await this.animateClose()},this.onClosed=()=>{this.quick&&(this.dispatchEvent(new Event("closing")),this.dispatchEvent(new Event("closed")))},this.onWindowPointerdown=t=>{this.pointerPath=t.composedPath()},this.onDocumentClick=t=>{if(!this.open)return;const e=t.composedPath();this.stayOpenOnOutsideClick||e.includes(this)||e.includes(this.anchorElement)||(this.open=!1)},this.internals.role="menu",this.addEventListener("keydown",this.handleKeydown),this.addEventListener("keydown",this.captureKeydown,{capture:!0}),this.addEventListener("focusout",this.handleFocusout)}get items(){return this.listController.items}willUpdate(t){t.has("open")&&(this.open?this.removeAttribute("aria-hidden"):this.setAttribute("aria-hidden","true"))}update(t){t.has("open")&&(this.open?this.setUpGlobalEventListeners():this.cleanUpGlobalEventListeners()),t.has("positioning")&&"popover"===this.positioning&&!this.showPopover&&(this.positioning="fixed"),super.update(t)}connectedCallback(){super.connectedCallback(),this.open&&this.setUpGlobalEventListeners()}disconnectedCallback(){super.disconnectedCallback(),this.cleanUpGlobalEventListeners()}getBoundingClientRect(){return this.surfaceEl?this.surfaceEl.getBoundingClientRect():super.getBoundingClientRect()}getClientRects(){return this.surfaceEl?this.surfaceEl.getClientRects():super.getClientRects()}render(){return this.renderSurface()}renderSurface(){return V`
      <div
    ...
    `}renderMenuItems(){return V`<slot
      ...
      @slotchange=${this.listController.onSlotchange}></slot>`}renderElevation(){return V`<md-elevation part="elevation"></md-elevation>`}getSurfaceClasses(){return{open:this.open,fixed:"fixed"===this.positioning,"has-overflow":this.hasOverflow}}captureKeydown(t){t.target===this&&!t.defaultPrevented&&li(t.code)&&(t.preventDefault(),this.close()),this.typeaheadController.onKeydown(t)}async animateOpen(){const t=this.surfaceEl,e=this.slotEl;if(!t||!e)return!0;const i=this.openDirection;this.dispatchEvent(new Event("opening")),t.classList.toggle("animating",!0);const r=this.openCloseAnimationSignal.start(),o=t.offsetHeight,s="UP"===i,n=this.items,a=250/n.length,l=t.animate([{height:"0px"},{height:`${o}px`}],{duration:500,easing:Zt.EMPHASIZED}),c=e.animate([{transform:s?`translateY(-${o}px)`:""},{transform:""}],{duration:500,easing:Zt.EMPHASIZED}),d=t.animate([{opacity:0},{opacity:1}],50),h=[];for(let t=0;t<n.length;t++){const e=n[s?n.length-1-t:t],i=e.animate([{opacity:0},{opacity:1}],{duration:250,delay:a*t});e.classList.toggle("md-menu-hidden",!0),i.addEventListener("finish",()=>{e.classList.toggle("md-menu-hidden",!1)}),h.push([e,i])}let u=t=>{};const p=new Promise(t=>{u=t});return r.addEventListener("abort",()=>{l.cancel(),c.cancel(),d.cancel(),h.forEach(([t,e])=>{t.classList.toggle("md-menu-hidden",!1),e.cancel()}),u(!0)}),l.addEventListener("finish",()=>{t.classList.toggle("animating",!1),this.openCloseAnimationSignal.finish(),u(!1)}),await p}animateClose(){let t;const e=new Promise(e=>{t=e}),i=this.surfaceEl,r=this.slotEl;if(!i||!r)return t(!1),e;const o="UP"===this.openDirection;this.dispatchEvent(new Event("closing")),i.classList.toggle("animating",!0);const s=this.openCloseAnimationSignal.start(),n=i.offsetHeight,a=this.items,l=150,c=50/a.length,d=i.animate([{height:`${n}px`},{height:.35*n+"px"}],{duration:l,easing:Zt.EMPHASIZED_ACCELERATE}),h=r.animate([{transform:""},{transform:o?`translateY(-${.65*n}px)`:""}],{duration:l,easing:Zt.EMPHASIZED_ACCELERATE}),u=i.animate([{opacity:1},{opacity:0}],{duration:50,delay:100}),p=[];for(let t=0;t<a.length;t++){const e=a[o?t:a.length-1-t],i=e.animate([{opacity:1},{opacity:0}],{duration:50,delay:50+c*t});i.addEventListener("finish",()=>{e.classList.toggle("md-menu-hidden",!0)}),p.push([e,i])}return s.addEventListener("abort",()=>{d.cancel(),h.cancel(),u.cancel(),p.forEach(([t,e])=>{e.cancel(),t.classList.toggle("md-menu-hidden",!1)}),t(!1)}),d.addEventListener("finish",()=>{i.classList.toggle("animating",!1),p.forEach(([t])=>{t.classList.toggle("md-menu-hidden",!1)}),this.openCloseAnimationSignal.finish(),this.dispatchEvent(new Event("closed")),t(!0)}),e}handleKeydown(t){this.pointerPath=[],this.listController.handleKeydown(t)}setUpGlobalEventListeners(){document.addEventListener("click",this.onDocumentClick,{capture:!0}),window.addEventListener("pointerdown",this.onWindowPointerdown),document.addEventListener("resize",this.onWindowResize,{passive:!0}),window.addEventListener("resize",this.onWindowResize,{passive:!0})}cleanUpGlobalEventListeners(){document.removeEventListener("click",this.onDocumentClick,{capture:!0}),window.removeEventListener("pointerdown",this.onWindowPointerdown),document.removeEventListener("resize",this.onWindowResize),window.removeEventListener("resize",this.onWindowResize)}onCloseMenu(){this.close()}onDeactivateItems(t){t.stopPropagation(),this.listController.onDeactivateItems()}onRequestActivation(t){t.stopPropagation(),this.listController.onRequestActivation(t)}handleDeactivateTypeahead(t){t.stopPropagation(),this.typeaheadActive=!1}handleActivateTypeahead(t){t.stopPropagation(),this.typeaheadActive=!0}handleStayOpenOnFocusout(t){t.stopPropagation(),this.stayOpenOnFocusout=!0}handleCloseOnFocusout(t){t.stopPropagation(),this.stayOpenOnFocusout=!1}close(){this.open=!1;this.slotItems.forEach(t=>{t.close?.()})}show(){this.open=!0}activateNextItem(){return this.listController.activateNextItem()??null}activatePreviousItem(){return this.listController.activatePreviousItem()??null}reposition(){this.open&&this.menuPositionController.position()}}r([yt(".menu")],xi.prototype,"surfaceEl",void 0),r([yt("slot")],xi.prototype,"slotEl",void 0),r([vt()],xi.prototype,"anchor",void 0),r([vt()],xi.prototype,"positioning",void 0),r([vt({type:Boolean})],xi.prototype,"quick",void 0),r([vt({type:Boolean,attribute:"has-overflow"})],xi.prototype,"hasOverflow",void 0),r([vt({type:Boolean,reflect:!0})],xi.prototype,"open",void 0),r([vt({type:Number,attribute:"x-offset"})],xi.prototype,"xOffset",void 0),r([vt({type:Number,attribute:"y-offset"})],xi.prototype,"yOffset",void 0),r([vt({type:Boolean,attribute:"no-horizontal-flip"})],xi.prototype,"noHorizontalFlip",void 0),r([vt({type:Boolean,attribute:"no-vertical-flip"})],xi.prototype,"noVerticalFlip",void 0),r([vt({type:Number,attribute:"typeahead-delay"})],xi.prototype,"typeaheadDelay",void 0),r([vt({attribute:"anchor-corner"})],xi.prototype,"anchorCorner",void 0),r([vt({attribute:"menu-corner"})],xi.prototype,"menuCorner",void 0),r([vt({type:Boolean,attribute:"stay-open-on-outside-click"})],xi.prototype,"stayOpenOnOutsideClick",void 0),r([vt({type:Boolean,attribute:"stay-open-on-focusout"})],xi.prototype,"stayOpenOnFocusout",void 0),r([vt({type:Boolean,attribute:"skip-restore-focus"})],xi.prototype,"skipRestoreFocus",void 0),r([vt({attribute:"default-focus"})],xi.prototype,"defaultFocus",void 0),r([vt({type:Boolean,attribute:"no-navigation-wrap"})],xi.prototype,"noNavigationWrap",void 0),r([_t({flatten:!0})],xi.prototype,"slotItems",void 0),r([gt()],xi.prototype,"typeaheadActive",void 0);const wi=d`:host{--md-elevation-level: var(--md-menu-container-elevation, 2);--md-elevation-shadow-color: var(--md-menu-container-shadow-color, var(--md-sys-color-shadow, #000));min-width:112px;color:unset;display:contents}md-focus-ring{--md-focus-ring-shape: var(--md-menu-container-shape, var(--md-sys-shape-corner-extra-small, 4px))}.menu{border-radius:var(--md-menu-container-shape, var(--md-sys-shape-corner-extra-small, 4px));display:none;inset:auto;border:none;padding:0px;overflow:visible;background-color:rgba(0,0,0,0);color:inherit;opacity:0;z-index:20;position:absolute;user-select:none;max-height:inherit;height:inherit;min-width:inherit;max-width:inherit;scrollbar-width:inherit}.menu::backdrop{display:none}.fixed{position:fixed}.items{display:block;list-style-type:none;margin:0;outline:none;box-sizing:border-box;background-color:var(--md-menu-container-color, var(--md-sys-color-surface-container, #f3edf7));height:inherit;max-height:inherit;overflow:auto;min-width:inherit;max-width:inherit;border-radius:inherit;scrollbar-width:inherit}.item-padding{padding-block:var(--md-menu-top-space, 8px) var(--md-menu-bottom-space, 8px)}.has-overflow:not([popover]) .items{overflow:visible}.has-overflow.animating .items,.animating .items{overflow:hidden}.has-overflow.animating .items{pointer-events:none}.animating ::slotted(.md-menu-hidden){opacity:0}slot{display:block;height:inherit;max-height:inherit}::slotted(:is(md-divider,[role=separator])){margin:8px 0}@media(forced-colors: active){.menu{border-style:solid;border-color:CanvasText;border-width:1px}}
`;let _i=class extends xi{};_i.styles=[wi],_i=r([pt("md-menu")],_i);class ki extends _e{renderElevationOrOutline(){return V`<div class="outline"></div>`}}const $i=d`:host{--_container-height: var(--md-outlined-button-container-height, 40px);--_disabled-label-text-color: var(--md-outlined-button-disabled-label-text-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-label-text-opacity: var(--md-outlined-button-disabled-label-text-opacity, 0.38);--_disabled-outline-color: var(--md-outlined-button-disabled-outline-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-outline-opacity: var(--md-outlined-button-disabled-outline-opacity, 0.12);--_focus-label-text-color: var(--md-outlined-button-focus-label-text-color, var(--md-sys-color-primary, #6750a4));--_hover-label-text-color: var(--md-outlined-button-hover-label-text-color, var(--md-sys-color-primary, #6750a4));--_hover-state-layer-color: var(--md-outlined-button-hover-state-layer-color, var(--md-sys-color-primary, #6750a4));--_hover-state-layer-opacity: var(--md-outlined-button-hover-state-layer-opacity, 0.08);--_label-text-color: var(--md-outlined-button-label-text-color, var(--md-sys-color-primary, #6750a4));--_label-text-font: var(--md-outlined-button-label-text-font, var(--md-sys-typescale-label-large-font, var(--md-ref-typeface-plain, Roboto)));--_label-text-line-height: var(--md-outlined-button-label-text-line-height, var(--md-sys-typescale-label-large-line-height, 1.25rem));--_label-text-size: var(--md-outlined-button-label-text-size, var(--md-sys-typescale-label-large-size, 0.875rem));--_label-text-weight: var(--md-outlined-button-label-text-weight, var(--md-sys-typescale-label-large-weight, var(--md-ref-typeface-weight-medium, 500)));--_outline-color: var(--md-outlined-button-outline-color, var(--md-sys-color-outline, #79747e));--_outline-width: var(--md-outlined-button-outline-width, 1px);--_pressed-label-text-color: var(--md-outlined-button-pressed-label-text-color, var(--md-sys-color-primary, #6750a4));--_pressed-outline-color: var(--md-outlined-button-pressed-outline-color, var(--md-sys-color-outline, #79747e));--_pressed-state-layer-color: var(--md-outlined-button-pressed-state-layer-color, var(--md-sys-color-primary, #6750a4));--_pressed-state-layer-opacity: var(--md-outlined-button-pressed-state-layer-opacity, 0.12);--_disabled-icon-color: var(--md-outlined-button-disabled-icon-color, var(--md-sys-color-on-surface, #1d1b20));--_disabled-icon-opacity: var(--md-outlined-button-disabled-icon-opacity, 0.38);--_focus-icon-color: var(--md-outlined-button-focus-icon-color, var(--md-sys-color-primary, #6750a4));--_hover-icon-color: var(--md-outlined-button-hover-icon-color, var(--md-sys-color-primary, #6750a4));--_icon-color: var(--md-outlined-button-icon-color, var(--md-sys-color-primary, #6750a4));--_icon-size: var(--md-outlined-button-icon-size, 18px);--_pressed-icon-color: var(--md-outlined-button-pressed-icon-color, var(--md-sys-color-primary, #6750a4));--_container-shape-start-start: var(--md-outlined-button-container-shape-start-start, var(--md-outlined-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-start-end: var(--md-outlined-button-container-shape-start-end, var(--md-outlined-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-end: var(--md-outlined-button-container-shape-end-end, var(--md-outlined-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_container-shape-end-start: var(--md-outlined-button-container-shape-end-start, var(--md-outlined-button-container-shape, var(--md-sys-shape-corner-full, 9999px)));--_leading-space: var(--md-outlined-button-leading-space, 24px);--_trailing-space: var(--md-outlined-button-trailing-space, 24px);--_with-leading-icon-leading-space: var(--md-outlined-button-with-leading-icon-leading-space, 16px);--_with-leading-icon-trailing-space: var(--md-outlined-button-with-leading-icon-trailing-space, 24px);--_with-trailing-icon-leading-space: var(--md-outlined-button-with-trailing-icon-leading-space, 24px);--_with-trailing-icon-trailing-space: var(--md-outlined-button-with-trailing-icon-trailing-space, 16px);--_container-color: none;--_disabled-container-color: none;--_disabled-container-opacity: 0}.outline{inset:0;border-style:solid;position:absolute;box-sizing:border-box;border-color:var(--_outline-color);border-start-start-radius:var(--_container-shape-start-start);border-start-end-radius:var(--_container-shape-start-end);border-end-start-radius:var(--_container-shape-end-start);border-end-end-radius:var(--_container-shape-end-end)}:host(:active) .outline{border-color:var(--_pressed-outline-color)}:host(:is([disabled],[soft-disabled])) .outline{border-color:var(--_disabled-outline-color);opacity:var(--_disabled-outline-opacity)}@media(forced-colors: active){:host(:is([disabled],[soft-disabled])) .background{border-color:GrayText}:host(:is([disabled],[soft-disabled])) .outline{opacity:1}}.outline,md-ripple{border-width:var(--_outline-width)}md-ripple{inline-size:calc(100% - 2*var(--_outline-width));block-size:calc(100% - 2*var(--_outline-width));border-style:solid;border-color:rgba(0,0,0,0)}
`;let Si=class extends ki{};Si.styles=[Nt,$i],Si=r([pt("md-outlined-button")],Si);const zi=Symbol.for(""),Ai=t=>{if(t?.r===zi)return t?._$litStatic$},Ci=(t,...e)=>({_$litStatic$:e.reduce((e,i,r)=>e+(t=>{if(void 0!==t._$litStatic$)return t._$litStatic$;throw Error(`Value passed to 'literal' function must be a 'literal' result: ${t}. Use 'unsafeStatic' to pass non-literal values, but\n            take care to ensure page security.`)})(i)+t[r+1],t[0]),r:zi}),Ti=new Map,Ei=(t=>(e,...i)=>{const r=i.length;let o,s;const n=[],a=[];let l,c=0,d=!1;for(;c<r;){for(l=e[c];c<r&&void 0!==(s=i[c],o=Ai(s));)l+=o+e[++c],d=!0;c!==r&&a.push(s),n.push(l),c++}if(c===r&&n.push(e[r]),d){const t=n.join("$$lit$$");void 0===(e=Ti.get(t))&&(n.raw=n,Ti.set(t,e=n)),i=a}return t(e,...i)})(V);function Ii(t,e=!0){return e&&"rtl"===getComputedStyle(t).getPropertyValue("direction").trim()}const Pi=he(ve(ht));class Oi extends Pi{get name(){return this.getAttribute("name")??""}set name(t){this.setAttribute("name",t)}get form(){return this[me].form}get labels(){return this[me].labels}constructor(){super(),this.disabled=!1,this.softDisabled=!1,this.flipIconInRtl=!1,this.href="",this.download="",this.target="",this.ariaLabelSelected="",this.toggle=!1,this.selected=!1,this.type="submit",this.value="",this.flipIcon=Ii(this,this.flipIconInRtl),this.addEventListener("click",this.handleClick.bind(this))}willUpdate(){this.href&&(this.disabled=!1,this.softDisabled=!1)}render(){const t=this.href?Ci`div`:Ci`button`,{ariaLabel:e,ariaHasPopup:i,ariaExpanded:r}=this,o=e&&this.ariaLabelSelected,s=this.toggle?this.selected:X;let n=X;return this.href||(n=o&&this.selected?this.ariaLabelSelected:e),Ei`<${t}
...
`,As=t=>t??X,Cs={"Amazon Silk":"amazon_silk","Android Browser":"android",Bada:"bada",BlackBerry:"blackberry",Chrome:"chrome",Chromium:"chromium",Electron:"electron",Epiphany:"epiphany",Firefox:"firefox",Focus:"focus",Generic:"generic","Google Search":"google_search",Googlebot:"googlebot","Internet Explorer":"ie","K-Meleon":"k_meleon",Maxthon:"maxthon","Microsoft Edge":"edge","MZ Browser":"mz","NAVER Whale Browser":"naver",Opera:"opera","Opera Coast":"opera_coast","Pale Moon":"pale_moon",PhantomJS:"phantomjs",Puffin:"puffin",QupZilla:"qupzilla",QQ:"qq",QQLite:"qqlite",Safari:"safari",Sailfish:"sailfish","Samsung Internet for Android":"samsung_internet",SeaMonkey:"seamonkey",Sleipnir:"sleipnir",Swing:"swing",Tizen:"tizen","UC Browser":"uc",Vivaldi:"vivaldi","WebOS Browser":"webos",WeChat:"wechat","Yandex Browser":"yandex",Roku:"roku"},Ts={amazon_silk:"Amazon Silk",android:"Android Browser",bada:"Bada",blackberry:"BlackBerry",chrome:"Chrome",chromium:"Chromium",electron:"Electron",epiphany:"Epiphany",firefox:"Firefox",focus:"Focus",generic:"Generic",googlebot:"Googlebot",google_search:"Google Search",ie:"Internet Explorer",k_meleon:"K-Meleon",maxthon:"Maxthon",edge:"Microsoft Edge",mz:"MZ Browser",naver:"NAVER Whale Browser",opera:"Opera",opera_coast:"Opera Coast",pale_moon:"Pale Moon",phantomjs:"PhantomJS",puffin:"Puffin",qupzilla:"QupZilla",qq:"QQ Browser",qqlite:"QQ Browser Lite",safari:"Safari",sailfish:"Sailfish",samsung_internet:"Samsung Internet for Android",seamonkey:"SeaMonkey",sleipnir:"Sleipnir",swing:"Swing",tizen:"Tizen",uc:"UC Browser",vivaldi:"Vivaldi",webos:"WebOS Browser",wechat:"WeChat",yandex:"Yandex Browser"},Es={tablet:"tablet",mobile:"mobile",desktop:"desktop",tv:"tv",bot:"bot"},Is={WindowsPhone:"Windows Phone",Windows:"Windows",MacOS:"macOS",iOS:"iOS",Android:"Android",WebOS:"WebOS",BlackBerry:"BlackBerry",Bada:"Bada",Tizen:"Tizen",Linux:"Linux",ChromeOS:"Chrome OS",PlayStation4:"PlayStation 4",Roku:"Roku"},Ps={EdgeHTML:"EdgeHTML",Blink:"Blink",Trident:"Trident",Presto:"Presto",Gecko:"Gecko",WebKit:"WebKit"};class Os{static getFirstMatch(t,e){const i=e.match(t);return i&&i.length>0&&i[1]||""}static getSecondMatch(t,e){const i=e.match(t);return i&&i.length>1&&i[2]||""}static matchAndReturnConst(t,e,i){if(t.test(e))return i}static getWindowsVersionName(t){switch(t){case"NT":return"NT";case"XP":case"NT 5.1":return"XP";case"NT 5.0":return"2000";case"NT 5.2":return"2003";case"NT 6.0":return"Vista";case"NT 6.1":return"7";case"NT 6.2":return"8";case"NT 6.3":return"8.1";case"NT 10.0":return"10";default:return}}static getMacOSVersionName(t){const e=t.split(".").splice(0,2).map(t=>parseInt(t,10)||0);if(e.push(0),10===e[0])switch(e[1]){case 5:return"Leopard";case 6:return"Snow Leopard";case 7:return"Lion";case 8:return"Mountain Lion";case 9:return"Mavericks";case 10:return"Yosemite";case 11:return"El Capitan";case 12:return"Sierra";case 13:return"High Sierra";case 14:return"Mojave";case 15:return"Catalina";default:return}}static getAndroidVersionName(t){const e=t.split(".").splice(0,2).map(t=>parseInt(t,10)||0);if(e.push(0),!(1===e[0]&&e[1]<5))return 1===e[0]&&e[1]<6?"Cupcake":1===e[0]&&e[1]>=6?"Donut":2===e[0]&&e[1]<2?"Eclair":2===e[0]&&2===e[1]?"Froyo":2===e[0]&&e[1]>2?"Gingerbread":3===e[0]?"Honeycomb":4===e[0]&&e[1]<1?"Ice Cream Sandwich":4===e[0]&&e[1]<4?"Jelly Bean":4===e[0]&&e[1]>=4?"KitKat":5===e[0]?"Lollipop":6===e[0]?"Marshmallow":7===e[0]?"Nougat":8===e[0]?"Oreo":9===e[0]?"Pie":void 0}static getVersionPrecision(t){return t.split(".").length}static compareVersions(t,e,i=!1){const r=Os.getVersionPrecision(t),o=Os.getVersionPrecision(e);let s=Math.max(r,o),n=0;const a=Os.map([t,e],t=>{const e=s-Os.getVersionPrecision(t),i=t+new Array(e+1).join(".0");return Os.map(i.split("."),t=>new Array(20-t.length).join("0")+t).reverse()});for(i&&(n=s-Math.min(r,o)),s-=1;s>=n;){if(a[0][s]>a[1][s])return 1;if(a[0][s]===a[1][s]){if(s===n)return 0;s-=1}else if(a[0][s]<a[1][s])return-1}}static map(t,e){const i=[];let r;if(Array.prototype.map)return Array.prototype.map.call(t,e);for(r=0;r<t.length;r+=1)i.push(e(t[r]));return i}static find(t,e){let i,r;if(Array.prototype.find)return Array.prototype.find.call(t,e);for(i=0,r=t.length;i<r;i+=1){const r=t[i];if(e(r,i))return r}}static assign(t,...e){const i=t;let r,o;if(Object.assign)return Object.assign(t,...e);for(r=0,o=e.length;r<o;r+=1){const t=e[r];if("object"==typeof t&&null!==t){Object.keys(t).forEach(e=>{i[e]=t[e]})}}return t}static getBrowserAlias(t){return Cs[t]}static getBrowserTypeByAlias(t){return Ts[t]||""}}const Ms=/version\/(\d+(\.?_?\d+)+)/i,Rs=[{test:[/googlebot/i],describe(t){const e={name:"Googlebot"},i=Os.getFirstMatch(/googlebot\/(\d+(\.\d+))/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/opera/i],describe(t){const e={name:"Opera"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:opera)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/opr\/|opios/i],describe(t){const e={name:"Opera"},i=Os.getFirstMatch(/(?:opr|opios)[\s/](\S+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/SamsungBrowser/i],describe(t){const e={name:"Samsung Internet for Android"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:SamsungBrowser)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/Whale/i],describe(t){const e={name:"NAVER Whale Browser"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:whale)[\s/](\d+(?:\.\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/PaleMoon/i],describe(t){const e={name:"Pale Moon"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:PaleMoon)[\s/](\d+(?:\.\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/MZBrowser/i],describe(t){const e={name:"MZ Browser"},i=Os.getFirstMatch(/(?:MZBrowser)[\s/](\d+(?:\.\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/focus/i],describe(t){const e={name:"Focus"},i=Os.getFirstMatch(/(?:focus)[\s/](\d+(?:\.\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/swing/i],describe(t){const e={name:"Swing"},i=Os.getFirstMatch(/(?:swing)[\s/](\d+(?:\.\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/coast/i],describe(t){const e={name:"Opera Coast"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:coast)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/opt\/\d+(?:.?_?\d+)+/i],describe(t){const e={name:"Opera Touch"},i=Os.getFirstMatch(/(?:opt)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/yabrowser/i],describe(t){const e={name:"Yandex Browser"},i=Os.getFirstMatch(/(?:yabrowser)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/ucbrowser/i],describe(t){const e={name:"UC Browser"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:ucbrowser)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/Maxthon|mxios/i],describe(t){const e={name:"Maxthon"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:Maxthon|mxios)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/epiphany/i],describe(t){const e={name:"Epiphany"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:epiphany)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/puffin/i],describe(t){const e={name:"Puffin"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:puffin)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/sleipnir/i],describe(t){const e={name:"Sleipnir"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:sleipnir)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/k-meleon/i],describe(t){const e={name:"K-Meleon"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/(?:k-meleon)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/micromessenger/i],describe(t){const e={name:"WeChat"},i=Os.getFirstMatch(/(?:micromessenger)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/qqbrowser/i],describe(t){const e={name:/qqbrowserlite/i.test(t)?"QQ Browser Lite":"QQ Browser"},i=Os.getFirstMatch(/(?:qqbrowserlite|qqbrowser)[/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/msie|trident/i],describe(t){const e={name:"Internet Explorer"},i=Os.getFirstMatch(/(?:msie |rv:)(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/\sedg\//i],describe(t){const e={name:"Microsoft Edge"},i=Os.getFirstMatch(/\sedg\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/edg([ea]|ios)/i],describe(t){const e={name:"Microsoft Edge"},i=Os.getSecondMatch(/edg([ea]|ios)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/vivaldi/i],describe(t){const e={name:"Vivaldi"},i=Os.getFirstMatch(/vivaldi\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/seamonkey/i],describe(t){const e={name:"SeaMonkey"},i=Os.getFirstMatch(/seamonkey\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/sailfish/i],describe(t){const e={name:"Sailfish"},i=Os.getFirstMatch(/sailfish\s?browser\/(\d+(\.\d+)?)/i,t);return i&&(e.version=i),e}},{test:[/silk/i],describe(t){const e={name:"Amazon Silk"},i=Os.getFirstMatch(/silk\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/phantom/i],describe(t){const e={name:"PhantomJS"},i=Os.getFirstMatch(/phantomjs\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/slimerjs/i],describe(t){const e={name:"SlimerJS"},i=Os.getFirstMatch(/slimerjs\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/blackberry|\bbb\d+/i,/rim\stablet/i],describe(t){const e={name:"BlackBerry"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/blackberry[\d]+\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/(web|hpw)[o0]s/i],describe(t){const e={name:"WebOS Browser"},i=Os.getFirstMatch(Ms,t)||Os.getFirstMatch(/w(?:eb)?[o0]sbrowser\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/bada/i],describe(t){const e={name:"Bada"},i=Os.getFirstMatch(/dolfin\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/tizen/i],describe(t){const e={name:"Tizen"},i=Os.getFirstMatch(/(?:tizen\s?)?browser\/(\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/qupzilla/i],describe(t){const e={name:"QupZilla"},i=Os.getFirstMatch(/(?:qupzilla)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/firefox|iceweasel|fxios/i],describe(t){const e={name:"Firefox"},i=Os.getFirstMatch(/(?:firefox|iceweasel|fxios)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/electron/i],describe(t){const e={name:"Electron"},i=Os.getFirstMatch(/(?:electron)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/MiuiBrowser/i],describe(t){const e={name:"Miui"},i=Os.getFirstMatch(/(?:MiuiBrowser)[\s/](\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/chromium/i],describe(t){const e={name:"Chromium"},i=Os.getFirstMatch(/(?:chromium)[\s/](\d+(\.?_?\d+)+)/i,t)||Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/chrome|crios|crmo/i],describe(t){const e={name:"Chrome"},i=Os.getFirstMatch(/(?:chrome|crios|crmo)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/GSA/i],describe(t){const e={name:"Google Search"},i=Os.getFirstMatch(/(?:GSA)\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test(t){const e=!t.test(/like android/i),i=t.test(/android/i);return e&&i},describe(t){const e={name:"Android Browser"},i=Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/playstation 4/i],describe(t){const e={name:"PlayStation 4"},i=Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/safari|applewebkit/i],describe(t){const e={name:"Safari"},i=Os.getFirstMatch(Ms,t);return i&&(e.version=i),e}},{test:[/.*/i],describe(t){const e=-1!==t.search("\\(")?/^(.*)\/(.*)[ \t]\((.*)/:/^(.*)\/(.*) /;return{name:Os.getFirstMatch(e,t),version:Os.getSecondMatch(e,t)}}}];var Bs=[{test:[/Roku\/DVP/],describe(t){const e=Os.getFirstMatch(/Roku\/DVP-(\d+\.\d+)/i,t);return{name:Is.Roku,version:e}}},{test:[/windows phone/i],describe(t){const e=Os.getFirstMatch(/windows phone (?:os)?\s?(\d+(\.\d+)*)/i,t);return{name:Is.WindowsPhone,version:e}}},{test:[/windows /i],describe(t){const e=Os.getFirstMatch(/Windows ((NT|XP)( \d\d?.\d)?)/i,t),i=Os.getWindowsVersionName(e);return{name:Is.Windows,version:e,versionName:i}}},{test:[/Macintosh(.*?) FxiOS(.*?)\//],describe(t){const e={name:Is.iOS},i=Os.getSecondMatch(/(Version\/)(\d[\d.]+)/,t);return i&&(e.version=i),e}},{test:[/macintosh/i],describe(t){const e=Os.getFirstMatch(/mac os x (\d+(\.?_?\d+)+)/i,t).replace(/[_\s]/g,"."),i=Os.getMacOSVersionName(e),r={name:Is.MacOS,version:e};return i&&(r.versionName=i),r}},{test:[/(ipod|iphone|ipad)/i],describe(t){const e=Os.getFirstMatch(/os (\d+([_\s]\d+)*) like mac os x/i,t).replace(/[_\s]/g,".");return{name:Is.iOS,version:e}}},{test(t){const e=!t.test(/like android/i),i=t.test(/android/i);return e&&i},describe(t){const e=Os.getFirstMatch(/android[\s/-](\d+(\.\d+)*)/i,t),i=Os.getAndroidVersionName(e),r={name:Is.Android,version:e};return i&&(r.versionName=i),r}},{test:[/(web|hpw)[o0]s/i],describe(t){const e=Os.getFirstMatch(/(?:web|hpw)[o0]s\/(\d+(\.\d+)*)/i,t),i={name:Is.WebOS};return e&&e.length&&(i.version=e),i}},{test:[/blackberry|\bbb\d+/i,/rim\stablet/i],describe(t){const e=Os.getFirstMatch(/rim\stablet\sos\s(\d+(\.\d+)*)/i,t)||Os.getFirstMatch(/blackberry\d+\/(\d+([_\s]\d+)*)/i,t)||Os.getFirstMatch(/\bbb(\d+)/i,t);return{name:Is.BlackBerry,version:e}}},{test:[/bada/i],describe(t){const e=Os.getFirstMatch(/bada\/(\d+(\.\d+)*)/i,t);return{name:Is.Bada,version:e}}},{test:[/tizen/i],describe(t){const e=Os.getFirstMatch(/tizen[/\s](\d+(\.\d+)*)/i,t);return{name:Is.Tizen,version:e}}},{test:[/linux/i],describe:()=>({name:Is.Linux})},{test:[/CrOS/],describe:()=>({name:Is.ChromeOS})},{test:[/PlayStation 4/],describe(t){const e=Os.getFirstMatch(/PlayStation 4[/\s](\d+(\.\d+)*)/i,t);return{name:Is.PlayStation4,version:e}}}],Ns=[{test:[/googlebot/i],describe:()=>({type:Es.bot,vendor:"Google"})},{test:[/huawei/i],describe(t){const e=Os.getFirstMatch(/(can-l01)/i,t)&&"Nova",i={type:Es.mobile,vendor:"Huawei"};return e&&(i.model=e),i}},{test:[/nexus\s*(?:7|8|9|10).*/i],describe:()=>({type:Es.tablet,vendor:"Nexus"})},{test:[/ipad/i],describe:()=>({type:Es.tablet,vendor:"Apple",model:"iPad"})},{test:[/Macintosh(.*?) FxiOS(.*?)\//],describe:()=>({type:Es.tablet,vendor:"Apple",model:"iPad"})},{test:[/kftt build/i],describe:()=>({type:Es.tablet,vendor:"Amazon",model:"Kindle Fire HD 7"})},{test:[/silk/i],describe:()=>({type:Es.tablet,vendor:"Amazon"})},{test:[/tablet(?! pc)/i],describe:()=>({type:Es.tablet})},{test(t){const e=t.test(/ipod|iphone/i),i=t.test(/like (ipod|iphone)/i);return e&&!i},describe(t){const e=Os.getFirstMatch(/(ipod|iphone)/i,t);return{type:Es.mobile,vendor:"Apple",model:e}}},{test:[/nexus\s*[0-6].*/i,/galaxy nexus/i],describe:()=>({type:Es.mobile,vendor:"Nexus"})},{test:[/Nokia/i],describe(t){const e=Os.getFirstMatch(/Nokia\s+([0-9]+(\.[0-9]+)?)/i,t),i={type:Es.mobile,vendor:"Nokia"};return e&&(i.model=e),i}},{test:[/[^-]mobi/i],describe:()=>({type:Es.mobile})},{test:t=>"blackberry"===t.getBrowserName(!0),describe:()=>({type:Es.mobile,vendor:"BlackBerry"})},{test:t=>"bada"===t.getBrowserName(!0),describe:()=>({type:Es.mobile})},{test:t=>"windows phone"===t.getBrowserName(),describe:()=>({type:Es.mobile,vendor:"Microsoft"})},{test(t){const e=Number(String(t.getOSVersion()).split(".")[0]);return"android"===t.getOSName(!0)&&e>=3},describe:()=>({type:Es.tablet})},{test:t=>"android"===t.getOSName(!0),describe:()=>({type:Es.mobile})},{test:t=>"macos"===t.getOSName(!0),describe:()=>({type:Es.desktop,vendor:"Apple"})},{test:t=>"windows"===t.getOSName(!0),describe:()=>({type:Es.desktop})},{test:t=>"linux"===t.getOSName(!0),describe:()=>({type:Es.desktop})},{test:t=>"playstation 4"===t.getOSName(!0),describe:()=>({type:Es.tv})},{test:t=>"roku"===t.getOSName(!0),describe:()=>({type:Es.tv})}],js=[{test:t=>"microsoft edge"===t.getBrowserName(!0),describe(t){if(/\sedg\//i.test(t))return{name:Ps.Blink};const e=Os.getFirstMatch(/edge\/(\d+(\.?_?\d+)+)/i,t);return{name:Ps.EdgeHTML,version:e}}},{test:[/trident/i],describe(t){const e={name:Ps.Trident},i=Os.getFirstMatch(/trident\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:t=>t.test(/presto/i),describe(t){const e={name:Ps.Presto},i=Os.getFirstMatch(/presto\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test(t){const e=t.test(/gecko/i),i=t.test(/like gecko/i);return e&&!i},describe(t){const e={name:Ps.Gecko},i=Os.getFirstMatch(/gecko\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}},{test:[/(apple)?webkit\/537\.36/i],describe:()=>({name:Ps.Blink})},{test:[/(apple)?webkit/i],describe(t){const e={name:Ps.WebKit},i=Os.getFirstMatch(/webkit\/(\d+(\.?_?\d+)+)/i,t);return i&&(e.version=i),e}}];class Ls{constructor(t,e=!1){if(null==t||""===t)throw new Error("UserAgent parameter can't be empty");this._ua=t,this.parsedResult={},!0!==e&&this.parse()}getUA(){return this._ua}test(t){return t.test(this._ua)}parseBrowser(){this.parsedResult.browser={};const t=Os.find(Rs,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.browser=t.describe(this.getUA())),this.parsedResult.browser}getBrowser(){return this.parsedResult.browser?this.parsedResult.browser:this.parseBrowser()}getBrowserName(t){return t?String(this.getBrowser().name).toLowerCase()||"":this.getBrowser().name||""}getBrowserVersion(){return this.getBrowser().version}getOS(){return this.parsedResult.os?this.parsedResult.os:this.parseOS()}parseOS(){this.parsedResult.os={};const t=Os.find(Bs,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.os=t.describe(this.getUA())),this.parsedResult.os}getOSName(t){const{name:e}=this.getOS();return t?String(e).toLowerCase()||"":e||""}getOSVersion(){return this.getOS().version}getPlatform(){return this.parsedResult.platform?this.parsedResult.platform:this.parsePlatform()}getPlatformType(t=!1){const{type:e}=this.getPlatform();return t?String(e).toLowerCase()||"":e||""}parsePlatform(){this.parsedResult.platform={};const t=Os.find(Ns,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.platform=t.describe(this.getUA())),this.parsedResult.platform}getEngine(){return this.parsedResult.engine?this.parsedResult.engine:this.parseEngine()}getEngineName(t){return t?String(this.getEngine().name).toLowerCase()||"":this.getEngine().name||""}parseEngine(){this.parsedResult.engine={};const t=Os.find(js,t=>{if("function"==typeof t.test)return t.test(this);if(Array.isArray(t.test))return t.test.some(t=>this.test(t));throw new Error("Browser's test function is not valid")});return t&&(this.parsedResult.engine=t.describe(this.getUA())),this.parsedResult.engine}parse(){return this.parseBrowser(),this.parseOS(),this.parsePlatform(),this.parseEngine(),this}getResult(){return Os.assign({},this.parsedResult)}satisfies(t){const e={};let i=0;const r={};let o=0;if(Object.keys(t).forEach(s=>{const n=t[s];"string"==typeof n?(r[s]=n,o+=1):"object"==typeof n&&(e[s]=n,i+=1)}),i>0){const t=Object.keys(e),i=Os.find(t,t=>this.isOS(t));if(i){const t=this.satisfies(e[i]);if(void 0!==t)return t}const r=Os.find(t,t=>this.isPlatform(t));if(r){const t=this.satisfies(e[r]);if(void 0!==t)return t}}if(o>0){const t=Object.keys(r),e=Os.find(t,t=>this.isBrowser(t,!0));if(void 0!==e)return this.compareVersion(r[e])}}isBrowser(t,e=!1){const i=this.getBrowserName().toLowerCase();let r=t.toLowerCase();const o=Os.getBrowserTypeByAlias(r);return e&&o&&(r=o.toLowerCase()),r===i}compareVersion(t){let e=[0],i=t,r=!1;const o=this.getBrowserVersion();if("string"==typeof o)return">"===t[0]||"<"===t[0]?(i=t.substr(1),"="===t[1]?(r=!0,i=t.substr(2)):e=[],">"===t[0]?e.push(1):e.push(-1)):"="===t[0]?i=t.substr(1):"~"===t[0]&&(r=!0,i=t.substr(1)),e.indexOf(Os.compareVersions(o,i,r))>-1}isOS(t){return this.getOSName(!0)===String(t).toLowerCase()}isPlatform(t){return this.getPlatformType(!0)===String(t).toLowerCase()}isEngine(t){return this.getEngineName(!0)===String(t).toLowerCase()}is(t,e=!1){return this.isBrowser(t,e)||this.isOS(t)||this.isPlatform(t)}some(t=[]){return t.some(t=>this.is(t))}}class Us{static getParser(t,e=!1){if("string"!=typeof t)throw new Error("UserAgent should be a string");return new Ls(t,e)}static parse(t){return new Ls(t).getResult()}static get BROWSER_MAP(){return Ts}static get ENGINE_MAP(){return Ps}static get OS_MAP(){return Is}static get PLATFORMS_MAP(){return Es}}const Fs=new URL(new URL("D9xn2E7Y.gif",import.meta.url).href).href;let Ds=class extends(Et(ht)){#nt;get dialog(){return this.#nt}set dialog(t){this.#nt=t}#Bt;get main(){return this.#Bt}set main(t){this.#Bt=t}#Nt;get cropperCanvas(){return this.#Nt}set cropperCanvas(t){this.#Nt=t}#jt;get cropperSelection(){return this.#jt}set cropperSelection(t){this.#jt=t}#Lt;get cropperImage(){return this.#Lt}set cropperImage(t){this.#Lt=t}#Ut;get cropperShade(){return this.#Ut}set cropperShade(t){this.#Ut=t}#Ft;get forcePNGOutput(){return this.#Ft}set forcePNGOutput(t){this.#Ft=t}#Dt;get options(){return this.#Dt}set options(t){this.#Dt=t}#ut="";get fileName(){return this.#ut}set fileName(t){this.#ut=t}#Gt="";get src(){return this.#Gt}set src(t){this.#Gt=t}#qt="";#Ht="";#Vt=!1;firstUpdated(){const t=Us.getParser(window.navigator.userAgent),e=t?.getOS?.()?.name??"";this.#qt="iOS"===e||"macOS"===e||this.forcePNGOutput?"image/png":"image/webp",this.#Ht="iOS"===e||"macOS"===e||this.forcePNGOutput?"png":"webp",this.#Wt()}#Xt;#Wt(){this.#Xt=new ResizeObserver(()=>{this.#Vt&&this.cropperImage.$center("cover")}),this.#Xt.observe(this.main)}#Yt;#j;async open(t,e,i){return this.#Vt=!1,this.#Yt=i,this.dialog.returnValue="",this.reset(),this.fileName=e,this.src=t,await this.updateComplete,this.dialog.show(),this.cropperImage.$ready(async t=>{this.cropperCanvas.style.width=`${t.naturalWidth}px`,this.cropperCanvas.style.aspectRatio=`${t.naturalWidth} / ${t.naturalHeight}`;const e=this.cropperCanvas.getBoundingClientRect(),i=e.width/e.height,r=this.options?.selectionAspectRatio??i;this.options||(this.options={});const o=this.options.constrainSelectionTo;this.options.constrainSelectionTo=null,this.options?.maximizeSelection?(this.cropperSelection.width=i>r?e.height*r:e.width,this.cropperSelection.height=i<r?e.width/r:e.height):(this.cropperSelection.width=e.width/2,this.cropperSelection.height=e.height/2),this.cropperImage.$center("cover"),this.cropperSelection.$center(),this.options.constrainSelectionTo=o,this.#Vt=!0}),await new Promise(t=>{this.#j=t})}reset(){this.cropperImage.$resetTransform()}blobToFile(t,e){return new File([t],e,{lastModified:(new Date).getTime()})}#Jt(t,e){return t.slice(0,t.lastIndexOf("."))+`.${e}`}async#Kt(t){const e=document.createElement("canvas"),i=new Image,r=new Promise(t=>{i.onload=()=>{const r=Math.min(i.naturalWidth,i.naturalHeight);e.width=r,e.height=r;const o=e.getContext("2d");o.drawImage(i,0,0),o.globalCompositeOperation="destination-in",o.fillStyle="#000",o.beginPath(),o.arc(.5*r,.5*r,.5*r,0,2*Math.PI),o.fill(),o.globalCompositeOperation="source-over",t(e.toDataURL())}});return i.src=t,await r}#Qt(t,e){return t.x>=e.x&&t.y>=e.y&&t.x+t.width<=e.x+e.width&&t.y+t.height<=e.y+e.height}#Zt(t){if(!this.cropperCanvas||"image"!==this.options?.constrainSelectionTo)return;const e=this.cropperImage,i=this.cropperSelection,r=this.cropperCanvas.getBoundingClientRect(),o=e.cloneNode();o.style.transform=`matrix(${t.detail.matrix.join(", ")})`,o.style.opacity="0",this.cropperCanvas.appendChild(o);const s=o.getBoundingClientRect();this.cropperCanvas.removeChild(o);const n=i,a={x:s.left-r.left,y:s.top-r.top,width:s.width,height:s.height};this.#Qt(n,a)||t.preventDefault()}#te(t){if(!this.cropperCanvas||!this.options?.constrainSelectionTo)return;const e=this.cropperCanvas.getBoundingClientRect(),i={x:t.detail.x,y:t.detail.y,width:t.detail.width-1,height:t.detail.height-1};switch(this.options?.constrainSelectionTo){case"canvas":{const r={x:0,y:0,width:e.width,height:e.height};this.#Qt(i,r)||(t.preventDefault(),this.#ee());break}case"image":{if(!this.#Vt)return;const r=this.cropperImage.getBoundingClientRect(),o={x:r.left-e.left,y:r.top-e.top,width:r.width,height:r.height};this.#Qt(i,o)||(t.preventDefault(),this.#ee());break}}}#ee(){setTimeout(()=>this.cropperShade.$change(this.cropperSelection.x,this.cropperSelection.y,this.cropperSelection.width,this.cropperSelection.height),0)}static{this.styles=[bs,ks,gs,d`
          ...
          >
            <cropper-canvas ?background=${!this.options?.canvasHideBackground}>
              ...
              <cropper-selection
                ...
                resizable
                precise
                aspect-ratio=${"circle"===this.options?.shape?1:As(this.options?.selectionAspectRatio)}
                @change=${this.#te}
              >
    ...
    `}};r([yt("md-dialog")],Ds.prototype,"dialog",null),r([yt("main")],Ds.prototype,"main",null),r([yt("cropper-canvas")],Ds.prototype,"cropperCanvas",null),r([yt("cropper-selection")],Ds.prototype,"cropperSelection",null),r([yt("cropper-image")],Ds.prototype,"cropperImage",null),r([yt("cropper-shade")],Ds.prototype,"cropperShade",null),r([vt({type:Boolean,reflect:!0,attribute:"force-png"})],Ds.prototype,"forcePNGOutput",null),r([vt({type:Object})],Ds.prototype,"options",null),r([gt()],Ds.prototype,"fileName",null),r([gt()],Ds.prototype,"src",null),Ds=r([pt("crop-and-save-image-dialog")],Ds);let Gs=class extends ht{#ie;get imageUrl(){return this.#ie}set imageUrl(t){this.#ie=t}#re;get downloadSrc(){return this.#re}set downloadSrc(t){this.#re=t}#oe;get filename(){return this.#oe}set filename(t){this.#oe=t}#nt;get dialog(){return this.#nt}set dialog(t){this.#nt=t}async open(t,e,i){return this.imageUrl=void 0,this.filename=i,this.downloadSrc=e,this.imageUrl=t,this.dialog.show()}static{this.styles=[d`
      div[header] {
    ...
    `}};r([gt()],Gs.prototype,"imageUrl",null),r([gt()],Gs.prototype,"downloadSrc",null),r([gt()],Gs.prototype,"filename",null),r([yt("md-dialog")],Gs.prototype,"dialog",null),Gs=r([pt("image-preview-dialog")],Gs);const qs=he(ht);class Hs extends qs{get rippleDisabled(){return this.disabled||this.softDisabled}constructor(){super(),this.disabled=!1,this.softDisabled=!1,this.alwaysFocusable=!1,this.label="",this.hasIcon=!1,this.addEventListener("click",this.handleClick.bind(this))}focus(t){this.disabled&&!this.alwaysFocusable||super.focus(t)}render(){return V`
  ...
  `}function Ys(t){if(this.disabled||this.softDisabled)return;t.stopPropagation();!this.dispatchEvent(new Event("remove",{cancelable:!0}))||this.remove()}class Js extends Ws{constructor(){super(...arguments),this.avatar=!1,this.href="",this.target="",this.removeOnly=!1,this.selected=!1}get primaryId(){return this.href?"link":this.removeOnly?"":"button"}get rippleDisabled(){return!this.href&&(this.disabled||this.softDisabled)}get primaryAction(){return this.removeOnly?null:this.renderRoot.querySelector(".primary.action")}getContainerClasses(){return{...super.getContainerClasses(),avatar:this.avatar,disabled:!this.href&&(this.disabled||this.softDisabled),link:!!this.href,selected:this.selected,"has-trailing":!0}}renderPrimaryAction(t){const{ariaLabel:e}=this;return this.href?V`
        <a
...
`;let en=class extends Js{};en.styles=[Zs,tn,Qs,Ks],en=r([pt("md-input-chip")],en);const rn=(t,e,i)=>{const r=new Map;for(let o=e;o<=i;o++)r.set(t[o],o);return r},on=Jt(class extends Kt{constructor(t){if(super(t),t.type!==Wt)throw Error("repeat() can only be used in text expressions")}dt(t,e,i){let r;void 0===i?i=e:void 0!==e&&(r=e);const o=[],s=[];let n=0;for(const e of t)o[n]=r?r(e,n):n,s[n]=i(e,n),n++;return{values:s,keys:o}}render(t,e,i){return this.dt(t,e,i).values}update(t,[e,i,r]){const o=(t=>t._$AH)(t),{values:s,keys:n}=this.dt(e,i,r);if(!Array.isArray(o))return this.ut=n,s;const a=this.ut??=[],l=[];let c,d,h=0,u=o.length-1,p=0,m=s.length-1;for(;h<=u&&p<=m;)if(null===o[h])h++;else if(null===o[u])u--;else if(a[h]===n[p])l[p]=or(o[h],s[p]),h++,p++;else if(a[u]===n[m])l[m]=or(o[u],s[m]),u--,m--;else if(a[h]===n[m])l[m]=or(o[h],s[m]),rr(t,l[m+1],o[h]),h++,m--;else if(a[u]===n[p])l[p]=or(o[u],s[p]),rr(t,o[h],o[u]),u--,p++;else if(void 0===c&&(c=rn(n,p,m),d=rn(a,h,u)),c.has(a[h]))if(c.has(a[u])){const e=d.get(n[p]),i=void 0!==e?o[e]:null;if(null===i){const e=rr(t,o[h]);or(e,s[p]),l[p]=e}else l[p]=or(i,s[p]),rr(t,o[h],i),o[e]=null;p++}else ar(o[u]),u--;else ar(o[h]),h++;for(;p<=m;){const e=rr(t,l[m+1]);or(e,s[p]),l[p++]=e}for(;h<=u;){const t=o[h++];null!==t&&ar(t)}return this.ut=n,nr(t,l),W}}),sn=["tiff","pjp","jfif","bmp","gif","svg","png","xbm","dib","jxl","jpeg","svgz","jpg","webp","ico","tif","pjpeg","avif"];function nn(t){const e=t.split(".");return e?.[e.length-1]||""}function an(t){return"pdf"===t.toLowerCase()?new URL(new URL("BrwlMowD.png",import.meta.url).href).href:new URL(new URL("Ciwo_vsG.png",import.meta.url).href).href}function ln(t,e){if(t?.CdnFileName&&!e)return`https://cdn.leavitt.com/${t.CdnFileName}.${t.Extension}?d=${encodeURIComponent(`${t.Name}.${t.Extension}`)}`}function cn(t,e){if(t?.CdnFileName)return t?.PreviewSizes&&t?.PreviewSizes?.split(",").includes(String(e))&&"svg"!==t.Extension?`https://cdn.leavitt.com/${t.CdnFileName}-${e}.${t.PreviewExtension}`:function(t){return"png"===t?.Extension||"jpg"===t?.Extension||"jpeg"===t?.Extension||"gif"===t?.Extension||"svg"===t?.Extension||"webp"===t?.Extension}(t)?`https://cdn.leavitt.com/${t.CdnFileName}.${t.Extension}`:void 0}let dn=class extends ht{#se=[];get files(){return this.#se}set files(t){this.#se=t}#ne=!1;get isOver(){return this.#ne}set isOver(t){this.#ne=t}#ae=void 0;get previewSrc(){return this.#ae}set previewSrc(t){this.#ae=t}#le;get input(){return this.#le}set input(t){this.#le=t}#ce;get imagePreviewDialog(){return this.#ce}set imagePreviewDialog(t){this.#ce=t}#de;get cropperDialog(){return this.#de}set cropperDialog(t){this.#de=t}#he;get confirmDeleteDialog(){return this.#he}set confirmDeleteDialog(t){this.#he=t}#ue;get chipMultiSelect(){return this.#ue}set chipMultiSelect(t){this.#ue=t}#pe=[];#me="image/*,.pdf";get accept(){return this.#me}set accept(t){this.#me=t}#fe=!1;get multiple(){return this.#fe}set multiple(t){this.#fe=t}#Ct=!1;get required(){return this.#Ct}set required(t){this.#Ct=t}#Mt=!1;get disabled(){return this.#Mt}set disabled(t){this.#Mt=t}#ve=!1;get confirmDelete(){return this.#ve}set confirmDelete(t){this.#ve=t}#ge="Confirm delete";get confirmDeleteHeader(){return this.#ge}set confirmDeleteHeader(t){this.#ge=t}#be="Are you sure you would like to delete this attachment?";get confirmDeleteText(){return this.#be}set confirmDeleteText(t){this.#be=t}#ye="Add attachment";get addButtonLabel(){return this.#ye}set addButtonLabel(t){this.#ye=t}#zt="Attachments";get label(){return this.#zt}set label(t){this.#zt=t}#Et;get supportingText(){return this.#Et}set supportingText(t){this.#Et=t}#At="No attachments";get noItemsText(){return this.#At}set noItemsText(t){this.#At=t}#Dt;get options(){return this.#Dt}set options(t){this.#Dt=t}#Ft;get forcePNGOutput(){return this.#Ft}set forcePNGOutput(t){this.#Ft=t}#xe=["tiff","pjp","jfif","bmp","gif","svg","png","xbm","dib","jxl","jpeg","svgz","jpg","webp","ico","tif","pjpeg","avif"];get croppableImageFormats(){return this.#xe}set croppableImageFormats(t){this.#xe=t}getFiles(){return this.files}setFiles(...t){this.files=[...t].map(t=>({file:new File([""],t.fileName),previewSrc:t.previewSrc,downloadSrc:t.downloadSrc,id:t.id})),this.#pe=structuredClone(this.files)}setFilesFromDatabaseAttachments(...t){this.files=[...t].filter(t=>t.Name&&t.Extension).map(t=>({id:t.Id,file:new File([""],`${t?.Name}.${t?.Extension}`),previewSrc:cn(t,512),downloadSrc:ln(t)})),this.#pe=structuredClone(this.files)}checkValidity(){return this.chipMultiSelect.checkValidity()}reportValidity(){return this.chipMultiSelect.reportValidity()}hasChanges(){return JSON.stringify(this.#pe)!==JSON.stringify(this.files)}async reset(){this.#pe=[],this.previewSrc=void 0,this.files=[],this.isOver=!1,await this.updateComplete,this.chipMultiSelect.reset()}async handleNewFile(t){let e=!1;for(let i=0;i<(t?.length??0);i++){const r=t?.item(i);if(r){const t=this.croppableImageFormats.some(t=>r.name?.toLowerCase()?.endsWith(t?.toLowerCase()));if(t){"cropped"===await this.cropperDialog.open(URL.createObjectURL(r),r.name,async(t,e)=>{const i={file:t,previewSrc:e??void 0};this.multiple?this.files=[...this.files,i]:this.files=[i]})&&(this.reportValidity(),e=!0),await It(500)}else{const t={file:r},i=sn.some(t=>r.name.endsWith(t));if(i)try{const e=await this.toBase64(r);"string"==typeof e&&(t.previewSrc=e??void 0)}catch{}this.multiple?this.files=[...this.files,t]:this.files=[t],this.reportValidity(),e=!0}}}e&&this.#we()}#_e=null;#ke(t){const e=this.files.findIndex(e=>e===t);this.files.splice(e,1),this.requestUpdate("files"),this.reportValidity(),this.#we()}toBase64(t){return new Promise((e,i)=>{const r=new FileReader;r.readAsDataURL(t),r.onload=()=>e(r.result),r.onerror=t=>i(t)})}#we(){this.dispatchEvent(new Event("change"))}static{this.styles=[ks,d`
      :host {
        display: block;
      }
    ...
    `]}render(){return V`
      ...
      >
        ...
        >
        ${on(this.files,t=>t.file.name,t=>V`<md-input-chip
    ...
    `}};r([vt({type:Array})],dn.prototype,"files",null),r([vt({type:Boolean,reflect:!0,attribute:"is-over"})],dn.prototype,"isOver",null),r([vt({type:String})],dn.prototype,"previewSrc",null),r([yt("input")],dn.prototype,"input",null),r([yt("image-preview-dialog")],dn.prototype,"imagePreviewDialog",null),r([yt("crop-and-save-image-dialog")],dn.prototype,"cropperDialog",null),r([yt("md-dialog[confirm-delete]")],dn.prototype,"confirmDeleteDialog",null),r([yt("titanium-chip-multi-select")],dn.prototype,"chipMultiSelect",null),r([vt({type:String})],dn.prototype,"accept",null),r([vt({type:Boolean})],dn.prototype,"multiple",null),r([vt({type:Boolean})],dn.prototype,"required",null),r([vt({type:Boolean,reflect:!0})],dn.prototype,"disabled",null),r([vt({type:Boolean})],dn.prototype,"confirmDelete",null),r([vt({type:String})],dn.prototype,"confirmDeleteHeader",null),r([vt({type:String})],dn.prototype,"confirmDeleteText",null),r([vt({type:String})],dn.prototype,"addButtonLabel",null),r([vt({type:String})],dn.prototype,"label",null),r([vt({type:String})],dn.prototype,"supportingText",null),r([vt({type:String})],dn.prototype,"noItemsText",null),r([vt({type:Object})],dn.prototype,"options",null),r([vt({type:Boolean,reflect:!0,attribute:"force-png"})],dn.prototype,"forcePNGOutput",null),r([vt({type:Array})],dn.prototype,"croppableImageFormats",null),dn=r([pt("titanium-smart-attachment-input")],dn);class hn{async _getBearerTokenAsync(){return await Rt().getAccessTokenAsync()}}class un{constructor(t,e){this.status=t.status,this.headers=t.headers,this.blob=e}}class pn{constructor(){this.type=null,this.shortType=null}}class mn{constructor(t=new pn){this._odataInfo=t}}class fn{static#$e(t){const e=new Map;return Object.keys(t).filter(t=>0===t.indexOf("@odata")).forEach(i=>e.set(i.replace("@odata.",""),t[i])),e}#Se(t){return null===t.value||void 0===t.value||Array.isArray(t.value)?t:t.value}static#ze(t){return Array.isArray(t.value)?t.value:[]}get odataCount(){return this.metadata.has("count")?this.metadata.get("count"):0}count(){return this.entities.length}firstOrDefault(){return this.count()>0?this.entities[0]:null}toList(){return this.entities}constructor(t,e){this.status=t.status,this.headers=t.headers,this.metadata=fn.#$e(e),this.entities=fn.#ze(e),this.entity=0===this.entities.length?this.#Se(e):null}get containsMultipleEntities(){return this.entities.length>0}}const vn=new Map;vn.set(0,"CORS Error"),vn.set(200,"OK"),vn.set(201,"Created"),vn.set(202,"Accepted"),vn.set(203,"Non-Authoritative Information"),vn.set(204,"No Content"),vn.set(205,"Reset Content"),vn.set(206,"Partial Content"),vn.set(300,"Multiple Choices"),vn.set(301,"Moved Permanently"),vn.set(302,"Found"),vn.set(303,"See Other"),vn.set(304,"Not Modified"),vn.set(305,"Use Proxy"),vn.set(306,"Unused"),vn.set(307,"Temporary Redirect"),vn.set(400,"Bad Request"),vn.set(401,"Unauthorized"),vn.set(402,"Payment Required"),vn.set(403,"Forbidden"),vn.set(404,"Not Found"),vn.set(405,"Method Not Allowed"),vn.set(406,"Not Acceptable"),vn.set(407,"Proxy Authentication Required"),vn.set(408,"Request Timeout"),vn.set(409,"Conflict"),vn.set(410,"Gone"),vn.set(411,"Length Required"),vn.set(412,"Precondition Required"),vn.set(413,"Request Entry Too Large"),vn.set(414,"Request-URI Too Long"),vn.set(415,"Unsupported Media Type"),vn.set(416,"Requested Range Not Satisfiable"),vn.set(417,"Expectation Failed"),vn.set(418,"I'm a teapot"),vn.set(429,"Too Many Requests"),vn.set(500,"Internal Server Error"),vn.set(501,"Not Implemented"),vn.set(502,"Bad Gateway"),vn.set(503,"Service Unavailable"),vn.set(504,"Gateway Timeout"),vn.set(505,"HTTP Version Not Supported");class gn{constructor(t,e){this.headers={},this.baseUrl="https://api2.leavitt.com/",this.#Ae=t,this.addHeader("Content-Type","application/json"),this.#Ce=e?.appNameHeaderKey?e?.appNameHeaderKey:"X-LGAppName",this.addHeader(this.#Ce,"General")}#Ae;#Ce;addHeader(t,e){this.headers[t]=e}deleteHeader(t){delete this.headers[t]}#Te(t){return this.baseUrl?.endsWith("/")&&t?.startsWith("/")&&Tt&&alert(`API Service Warning: Malformed url, double slashes present. \r\n\r\n${this.baseUrl}${t}`),`${this.baseUrl}${t}`}async uploadFile(t,e,i,r){try{if(r?.abortController?.signal&&r?.abortController.signal.aborted)throw new bn;const o=4;if(!e||!e.name)throw new Error("ArgumentException: Invalid file passed to uploadFile.");const s=new XMLHttpRequest;s.onabort=function(){throw new bn},r?.abortController?.signal&&(r?.abortController.signal.addEventListener("abort",()=>s.abort()),s.onreadystatechange=function(){s.readyState===o&&r?.abortController?.signal.removeEventListener("abort",()=>s.abort())}),s.upload.addEventListener("progress",t=>{i(t,s)}),s.open("POST",this.#Te(t),!0);const n={...this.headers},a=await this.#Ae._getBearerTokenAsync();null!==a&&(n.Authorization=`Bearer ${a}`),n["X-LGAttachmentName"]=e.name;for(const t in n)s.setRequestHeader(t,n[t]);return new Promise((i,o)=>{s.addEventListener("loadend",()=>{try{const e={text:()=>s.response,status:s.status};if("blob"===r?.responseType){const r=this.#Ee(e,"UPLOAD",t);return i(r)}{const r=this.#Ie(e,"UPLOAD",t);return i(r)}}catch(t){return o(t)}},!1),s.send(e)})}catch(e){return Promise.reject(this.#Pe(e,"UPLOAD",t))}}async postAsync(t,e={},i){e instanceof mn&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers};i?.sendAsFormData&&delete r["Content-Type"];const o=await this.#Ae._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#Te(t),{method:"POST",body:i?.sendAsFormData?this.#Oe(e):JSON.stringify(e),headers:r,signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Pe(e,"POST",t))}return"blob"===i?.responseType?await this.#Ee(s,"POST",t):await this.#Ie(s,"POST",t)}async patchAsync(t,e,i){e instanceof mn&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers},o=await this.#Ae._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#Te(t),{method:"PATCH",body:JSON.stringify(e),headers:r,signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Pe(e,"PATCH",t))}return"blob"===i?.responseType?await this.#Ee(s,"PATCH",t):await this.#Ie(s,"PATCH",t)}async patchReturnDtoAsync(t,e,i){e instanceof mn&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers},o=await this.#Ae._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#Te(t),{method:"PATCH",body:JSON.stringify(e),headers:{...r,Prefer:"return=representation"},signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Pe(e,"PATCH",t))}return"blob"===i?.responseType?await this.#Ee(s,"PATCH",t):await this.#Ie(s,"PATCH",t)}async deleteAsync(t,e){const i={...this.headers},r=await this.#Ae._getBearerTokenAsync();let o;null!==r&&(i.Authorization=`Bearer ${r}`);try{o=await fetch(this.#Te(t),{method:"DELETE",headers:i,signal:e?.abortController?.signal})}catch(e){return Promise.reject(this.#Pe(e,"DELETE",t))}return"blob"===e?.responseType?await this.#Ee(o,"DELETE",t):await this.#Ie(o,"DELETE",t)}async getAsync(t,e){const i={...this.headers},r=await this.#Ae._getBearerTokenAsync();let o;null!==r&&(i.Authorization=`Bearer ${r}`);try{o=await fetch(this.#Te(t),{method:"GET",headers:i,signal:e?.abortController?.signal})}catch(e){return Promise.reject(this.#Pe(e,"GET",t))}return"blob"===e?.responseType?await this.#Ee(o,"GET",t):await this.#Ie(o,"GET",t)}#Me(t,e,i){return i.indexOf(t)===e}async aggregateResponses(t){const e=new Map,i=[],r=t.map(async t=>{try{await t()}catch(t){i.push(t);const r=t.message;e.set(r,(e.get(r)??0)+1)}});if(await Promise.allSettled(r),e.size>0){const r={type:"HttpError",action:i.map(t=>t.action).filter(this.#Me).join(", "),message:`${i.length} of ${t.length} actions failed`,detail:Array.from(e.keys()).map(t=>`${e.get(t)} error(s):  ${t}`).join("\n"),baseUrl:i.map(t=>t.baseUrl).filter(this.#Me).join(", "),path:i.map(t=>t.path).filter(this.#Me).join(", ")};return Promise.reject(r)}}#Pe(t,e,i,r=void 0){const o=t?.message?.includes("Failed to fetch")?"Network error. Check your connection and try again.":"AbortError"===t?.name?"Abort error. Request has been aborted.":t?.message||t;return{type:"HttpError",statusCode:r,baseUrl:this.baseUrl,message:o,action:e,path:i}}async#Ee(t,e,i){try{if(0===t.status||t.status>=400&&t.status<=600){const r=await t.text(),o=r.length?JSON.parse(r):{},s=o?.error?.message||(o.error&&"string"==typeof o.error?o.error:void 0)||o?.value||vn.get(t.status)||"unknown";o?.details&&console.warn(o.details);const n={type:"HttpError",statusCode:t.status,baseUrl:this.baseUrl,message:s,detail:o?.details||o?.error_description,raw:o,action:e,path:i};return Promise.reject(n)}{const e=await t.blob();return Promise.resolve(new un(t,e))}}catch(t){return Promise.reject(`The server sent back invalid JSON. ${t}`)}}async#Ie(t,e,i){const r=await t.text();let o;try{if(o=r.length?JSON.parse(r):{},0===t.status||t.status>=400&&t.status<=600){const r=o?.error?.message||(o.error&&"string"==typeof o.error?o.error:void 0)||o?.value||vn.get(t.status)||"unknown";o?.details&&console.warn(o.details);const s={type:"HttpError",statusCode:t.status,baseUrl:this.baseUrl,message:r,detail:o?.details||o?.error_description,raw:o,action:e,path:i};return Promise.reject(s)}return Promise.resolve(new fn(t,o))}catch(t){return Promise.reject(`The server sent back invalid JSON. ${t}`)}}#Oe(t,e,i){const r=e||new FormData;let o;for(const e in t)if(Object.hasOwn(t,e)){if(void 0===t[e])continue;o=i?t[e]instanceof File?i:i+"["+e+"]":e,"object"!=typeof t[e]||t[e]instanceof File?r.append(o,t[e]):this.#Oe(t[e],r,o)}return r}}class bn extends Error{constructor(){super(...arguments),this.name="AbortError",this.message="Aborted"}}function yn(t){const e=()=>{t?.open&&t.close("navigation-close")};t.i=e,window.addEventListener("popstate",e,!1)}function xn(t){t?.i&&(window.removeEventListener("popstate",t.i,!1),t.i=void 0)}const wn=new gn(new hn);wn.baseUrl=Tt?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",wn.addHeader("X-LGAppName","IssueTracking"),Object.freeze(wn);let _n=class extends(Et(ht)){#nt;get dialog(){return this.#nt}set dialog(t){this.#nt=t}#Re;get snackbar(){return this.#Re}set snackbar(t){this.#Re=t}#Be;get textArea(){return this.#Be}set textArea(t){this.#Be=t}#Ne;get imageInput(){return this.#Ne}set imageInput(t){this.#Ne=t}show(){this.reset(),this.dialog.show()}reset(){this.dialog.returnValue="",this.imageInput?.reset(),this.textArea?.reset()}async#je(){if(!this.textArea.reportValidity()||this.isLoading)return;const t={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Bug",Description:this.textArea.value,Attachments:(this.imageInput?.getFiles()??[]).map(t=>t.file)};try{const e=wn.postAsync("Issues/ReportIssue",t,{sendAsFormData:!0});this.dispatchEvent(new Ee(e)),this.loadWhile(e);if(!(await e).entity)throw new Error("Error submitting problem. Please try again.");document.dispatchEvent(new Ce("",{overrideTemplate:V`Thank you for bringing this issue to our attention!<br />
              <br />
...
`;let En=class extends Cn{};En.styles=[Tn],En=r([pt("md-list")],En);class In extends ht{constructor(){super(...arguments),this.multiline=!1}render(){return V`
      <slot name="container"></slot>
...
`;let Mn=class extends In{};Mn.styles=[On],Mn=r([pt("md-item")],Mn);const Rn=he(ht);class Bn extends Rn{constructor(){super(...arguments),this.disabled=!1,this.type="text",this.isListItem=!0,this.href="",this.target=""}get isDisabled(){return this.disabled&&"link"!==this.type}willUpdate(t){this.href&&(this.type="link"),super.willUpdate(t)}render(){return this.renderListItem(V`
      <md-item>
        <div slot="container">
...
`;let jn=class extends Bn{};jn.styles=[Nn],jn=r([pt("md-list-item")],jn);var Ln=function(){return Ln=Object.assign||function(t){for(var e,i=1,r=arguments.length;i<r;i++)for(var o in e=arguments[i])Object.prototype.hasOwnProperty.call(e,o)&&(t[o]=e[o]);return t},Ln.apply(this,arguments)},Un=function(){function t(t,e,i){var r=this;this.endVal=e,this.options=i,this.version="2.9.0",this.defaults={startVal:0,decimalPlaces:0,duration:2,useEasing:!0,useGrouping:!0,useIndianSeparators:!1,smartEasingThreshold:999,smartEasingAmount:333,separator:",",decimal:".",prefix:"",suffix:"",enableScrollSpy:!1,scrollSpyDelay:200,scrollSpyOnce:!1},this.finalEndVal=null,this.useEasing=!0,this.countDown=!1,this.error="",this.startVal=0,this.paused=!0,this.once=!1,this.count=function(t){r.startTime||(r.startTime=t);var e=t-r.startTime;r.remaining=r.duration-e,r.useEasing?r.countDown?r.frameVal=r.startVal-r.easingFn(e,0,r.startVal-r.endVal,r.duration):r.frameVal=r.easingFn(e,r.startVal,r.endVal-r.startVal,r.duration):r.frameVal=r.startVal+(r.endVal-r.startVal)*(e/r.duration);var i=r.countDown?r.frameVal<r.endVal:r.frameVal>r.endVal;r.frameVal=i?r.endVal:r.frameVal,r.frameVal=Number(r.frameVal.toFixed(r.options.decimalPlaces)),r.printValue(r.frameVal),e<r.duration?r.rAF=requestAnimationFrame(r.count):null!==r.finalEndVal?r.update(r.finalEndVal):r.options.onCompleteCallback&&r.options.onCompleteCallback()},this.formatNumber=function(t){var e,i,o,s,n=t<0?"-":"";e=Math.abs(t).toFixed(r.options.decimalPlaces);var a=(e+="").split(".");if(i=a[0],o=a.length>1?r.options.decimal+a[1]:"",r.options.useGrouping){s="";for(var l=3,c=0,d=0,h=i.length;d<h;++d)r.options.useIndianSeparators&&4===d&&(l=2,c=1),0!==d&&c%l==0&&(s=r.options.separator+s),c++,s=i[h-d-1]+s;i=s}return r.options.numerals&&r.options.numerals.length&&(i=i.replace(/[0-9]/g,function(t){return r.options.numerals[+t]}),o=o.replace(/[0-9]/g,function(t){return r.options.numerals[+t]})),n+r.options.prefix+i+o+r.options.suffix},this.easeOutExpo=function(t,e,i,r){return i*(1-Math.pow(2,-10*t/r))*1024/1023+e},this.options=Ln(Ln({},this.defaults),i),this.formattingFn=this.options.formattingFn?this.options.formattingFn:this.formatNumber,this.easingFn=this.options.easingFn?this.options.easingFn:this.easeOutExpo,this.el="string"==typeof t?document.getElementById(t):t,e=e??this.parse(this.el.innerHTML),this.startVal=this.validateValue(this.options.startVal),this.frameVal=this.startVal,this.endVal=this.validateValue(e),this.options.decimalPlaces=Math.max(this.options.decimalPlaces),this.resetDuration(),this.options.separator=String(this.options.separator),this.useEasing=this.options.useEasing,""===this.options.separator&&(this.options.useGrouping=!1),this.el?this.printValue(this.startVal):this.error="[CountUp] target is null or undefined","undefined"!=typeof window&&this.options.enableScrollSpy&&(this.error?console.error(this.error,t):(window.onScrollFns=window.onScrollFns||[],window.onScrollFns.push(function(){return r.handleScroll(r)}),window.onscroll=function(){window.onScrollFns.forEach(function(t){return t()})},this.handleScroll(this)))}return t.prototype.handleScroll=function(t){if(t&&window&&!t.once){var e=window.innerHeight+window.scrollY,i=t.el.getBoundingClientRect(),r=i.top+window.pageYOffset,o=i.top+i.height+window.pageYOffset;o<e&&o>window.scrollY&&t.paused?(t.paused=!1,setTimeout(function(){return t.start()},t.options.scrollSpyDelay),t.options.scrollSpyOnce&&(t.once=!0)):(window.scrollY>o||r>e)&&!t.paused&&t.reset()}},t.prototype.determineDirectionAndSmartEasing=function(){var t=this.finalEndVal?this.finalEndVal:this.endVal;this.countDown=this.startVal>t;var e=t-this.startVal;if(Math.abs(e)>this.options.smartEasingThreshold&&this.options.useEasing){this.finalEndVal=t;var i=this.countDown?1:-1;this.endVal=t+i*this.options.smartEasingAmount,this.duration=this.duration/2}else this.endVal=t,this.finalEndVal=null;null!==this.finalEndVal?this.useEasing=!1:this.useEasing=this.options.useEasing},t.prototype.start=function(t){this.error||(this.options.onStartCallback&&this.options.onStartCallback(),t&&(this.options.onCompleteCallback=t),this.duration>0?(this.determineDirectionAndSmartEasing(),this.paused=!1,this.rAF=requestAnimationFrame(this.count)):this.printValue(this.endVal))},t.prototype.pauseResume=function(){this.paused?(this.startTime=null,this.duration=this.remaining,this.startVal=this.frameVal,this.determineDirectionAndSmartEasing(),this.rAF=requestAnimationFrame(this.count)):cancelAnimationFrame(this.rAF),this.paused=!this.paused},t.prototype.reset=function(){cancelAnimationFrame(this.rAF),this.paused=!0,this.resetDuration(),this.startVal=this.validateValue(this.options.startVal),this.frameVal=this.startVal,this.printValue(this.startVal)},t.prototype.update=function(t){cancelAnimationFrame(this.rAF),this.startTime=null,this.endVal=this.validateValue(t),this.endVal!==this.frameVal&&(this.startVal=this.frameVal,null==this.finalEndVal&&this.resetDuration(),this.finalEndVal=null,this.determineDirectionAndSmartEasing(),this.rAF=requestAnimationFrame(this.count))},t.prototype.printValue=function(t){var e;if(this.el){var i=this.formattingFn(t);(null===(e=this.options.plugin)||void 0===e?void 0:e.render)?this.options.plugin.render(this.el,i):"INPUT"===this.el.tagName?this.el.value=i:"text"===this.el.tagName||"tspan"===this.el.tagName?this.el.textContent=i:this.el.innerHTML=i}},t.prototype.ensureNumber=function(t){return"number"==typeof t&&!isNaN(t)},t.prototype.validateValue=function(t){var e=Number(t);return this.ensureNumber(e)?e:(this.error="[CountUp] invalid start or end value: ".concat(t),null)},t.prototype.resetDuration=function(){this.startTime=null,this.duration=1e3*Number(this.options.duration),this.remaining=this.duration},t.prototype.parse=function(t){var e=function(t){return t.replace(/([.,'  ])/g,"\\$1")},i=e(this.options.separator),r=e(this.options.decimal),o=t.replace(new RegExp(i,"g"),"").replace(new RegExp(r,"g"),".");return parseFloat(o)},t}();let Fn=class extends ht{#Le;get major(){return this.#Le}set major(t){this.#Le=t}#Ue;get minor(){return this.#Ue}set minor(t){this.#Ue=t}#Fe;get rev(){return this.#Fe}set rev(t){this.#Fe=t}#De;get downloads(){return this.#De}set downloads(t){this.#De=t}#Ge="@leavittsoftware%2Fweb";async firstUpdated(){const t=await this.#qe(this.#Ge);if(t){const[e,i,r]=t.version?.split(".")?.map(t=>Number(t))??[],o=new Un(this.major,e,{suffix:".",duration:1}),s=new Un(this.minor,i,{suffix:".",duration:1}),n=new Un(this.rev,r,{duration:1});o.start(),setTimeout(()=>{s.start()},500),setTimeout(()=>{n.start()},1e3);new Un(this.downloads,t.downloads??0,{useGrouping:!0,suffix:" weekly downloads"}).start()}}async#qe(t){try{const e=await fetch(`https://api.npmjs.org/versions/${t}/last-week`,{method:"GET"}),i=await e.text(),r=i.length?JSON.parse(i):{},o=Object.entries(r.downloads).map(t=>({version:t?.[0]?.split(".").map(t=>+t+1e5).join("."),downloads:t?.[1]})).sort((t,e)=>t.version.localeCompare(e.version)).map(t=>({...t,version:t.version?.split(".").map(t=>+t-1e5).join(".")}));return o?.pop()}catch(t){console.warn(t)}return null}static{this.styles=[d`
    ...
    `}};r([yt("span.major")],Fn.prototype,"major",null),r([yt("span.minor")],Fn.prototype,"minor",null),r([yt("span.rev")],Fn.prototype,"rev",null),r([yt("span.downloads")],Fn.prototype,"downloads",null),Fn=r([pt("npm-stats")],Fn);class Dn extends CustomEvent{static{this.eventName="change-route"}constructor(t){super(Dn.eventName,{bubbles:!0,composed:!0,detail:{path:t}})}}class Gn extends CustomEvent{static{this.eventName="redirect-route"}constructor(t){super(Gn.eventName,{bubbles:!0,composed:!0,detail:{path:t}})}}class qn extends CustomEvent{static{this.eventName="site-error"}constructor(t){super(qn.eventName,{bubbles:!0,composed:!0,detail:t})}}class Hn extends Event{static{this.eventType="confirm-dialog-open"}constructor(t,e){super(Hn.eventType,{bubbles:!0,composed:!0}),this.header=t,this.text=e,this.dialogResult=new Promise(t=>{this.resolver=t})}}const Vn=d`
  :host {
    display: grid;
    grid:
...
`;var Wn=Array.isArray||function(t){return"[object Array]"==Object.prototype.toString.call(t)},Xn=aa,Yn=ta,Jn=function(t){return ea(ta(t))},Kn=ea,Qn=na,Zn=new RegExp(["(\\\\.)","([\\/.])?(?:(?:\\:(\\w+)(?:\\(((?:\\\\.|[^()])+)\\))?|\\(((?:\\\\.|[^()])+)\\))([+*?])?|(\\*))"].join("|"),"g");function ta(t){for(var e,i=[],r=0,o=0,s="";null!=(e=Zn.exec(t));){var n=e[0],a=e[1],l=e.index;if(s+=t.slice(o,l),o=l+n.length,a)s+=a[1];else{s&&(i.push(s),s="");var c=e[2],d=e[3],h=e[4],u=e[5],p=e[6],m=e[7],f="+"===p||"*"===p,v="?"===p||"*"===p,g=c||"/",b=h||u||(m?".*":"[^"+g+"]+?");i.push({name:d||r++,prefix:c||"",delimiter:g,optional:v,repeat:f,pattern:ra(b)})}}return o<t.length&&(s+=t.substr(o)),s&&i.push(s),i}function ea(t){for(var e=new Array(t.length),i=0;i<t.length;i++)"object"==typeof t[i]&&(e[i]=new RegExp("^"+t[i].pattern+"$"));return function(i){for(var r="",o=i||{},s=0;s<t.length;s++){var n=t[s];if("string"!=typeof n){var a,l=o[n.name];if(null==l){if(n.optional)continue;throw new TypeError('Expected "'+n.name+'" to be defined')}if(Wn(l)){if(!n.repeat)throw new TypeError('Expected "'+n.name+'" to not repeat, but received "'+l+'"');if(0===l.length){if(n.optional)continue;throw new TypeError('Expected "'+n.name+'" to not be empty')}for(var c=0;c<l.length;c++){if(a=encodeURIComponent(l[c]),!e[s].test(a))throw new TypeError('Expected all "'+n.name+'" to match "'+n.pattern+'", but received "'+a+'"');r+=(0===c?n.prefix:n.delimiter)+a}}else{if(a=encodeURIComponent(l),!e[s].test(a))throw new TypeError('Expected "'+n.name+'" to match "'+n.pattern+'", but received "'+a+'"');r+=n.prefix+a}}else r+=n}return r}}function ia(t){return t.replace(/([.+*?=^!:${}()[\]|\/])/g,"\\$1")}function ra(t){return t.replace(/([=!:$\/()])/g,"\\$1")}function oa(t,e){return t.keys=e,t}function sa(t){return t.sensitive?"":"i"}function na(t,e){for(var i=(e=e||{}).strict,r=!1!==e.end,o="",s=t[t.length-1],n="string"==typeof s&&/\/$/.test(s),a=0;a<t.length;a++){var l=t[a];if("string"==typeof l)o+=ia(l);else{var c=ia(l.prefix),d=l.pattern;l.repeat&&(d+="(?:"+c+d+")*"),o+=d=l.optional?c?"(?:"+c+"("+d+"))?":"("+d+")?":c+"("+d+")"}}return i||(o=(n?o.slice(0,-2):o)+"(?:\\/(?=$))?"),o+=r?"$":i&&n?"":"(?=\\/|$)",new RegExp("^"+o,sa(e))}function aa(t,e,i){return Wn(e=e||[])?i||(i={}):(i=e,e=[]),t instanceof RegExp?function(t,e){var i=t.source.match(/\((?!\?)/g);if(i)for(var r=0;r<i.length;r++)e.push({name:r,prefix:null,delimiter:null,optional:!1,repeat:!1,pattern:null});return oa(t,e)}(t,e):Wn(t)?function(t,e,i){for(var r=[],o=0;o<t.length;o++)r.push(aa(t[o],e,i).source);return oa(new RegExp("(?:"+r.join("|")+")",sa(i)),e)}(t,e,i):function(t,e,i){for(var r=ta(t),o=na(r,i),s=0;s<r.length;s++)"string"!=typeof r[s]&&e.push(r[s]);return oa(o,e)}(t,e,i)}Xn.parse=Yn,Xn.compile=Jn,Xn.tokensToFunction=Kn,Xn.tokensToRegExp=Qn;var la,ca="undefined"!=typeof document,da="undefined"!=typeof window,ha="undefined"!=typeof history,ua="undefined"!=typeof process,pa=ca&&document.ontouchstart?"touchstart":"click",ma=da&&!(!window.history.location&&!window.location);function fa(){this.callbacks=[],this.exits=[],this.current="",this.len=0,this._decodeURLComponents=!0,this._base="",this._strict=!1,this._running=!1,this._hashbang=!1,this.clickHandler=this.clickHandler.bind(this),this._onpopstate=this._onpopstate.bind(this)}function va(t,e){if("function"==typeof t)return va.call(this,"*",t);if("function"==typeof e)for(var i=new ya(t,null,this),r=1;r<arguments.length;++r)this.callbacks.push(i.middleware(arguments[r]));else"string"==typeof t?this["string"==typeof e?"redirect":"show"](t,e):this.start(t)}function ga(t){if(!t.handled){var e=this,i=e._window;(e._hashbang?ma&&this._getBase()+i.location.hash.replace("#!",""):ma&&i.location.pathname+i.location.search)!==t.canonicalPath&&(e.stop(),t.handled=!1,ma&&(i.location.href=t.canonicalPath))}}function ba(t,e,i){var r=this.page=i||va,o=r._window,s=r._hashbang,n=r._getBase();"/"===t[0]&&0!==t.indexOf(n)&&(t=n+(s?"#!":"")+t);var a=t.indexOf("?");this.canonicalPath=t;var l=new RegExp("^"+function(t){return t.replace(/([.+*?=^!:${}()[\]|/\\])/g,"\\$1")}(n));if(this.path=t.replace(l,"")||"/",s&&(this.path=this.path.replace("#!","")||"/"),this.title=ca&&o.document.title,this.state=e||{},this.state.path=t,this.querystring=~a?r._decodeURLEncodedURIComponent(t.slice(a+1)):"",this.pathname=r._decodeURLEncodedURIComponent(~a?t.slice(0,a):t),this.params={},this.hash="",!s){if(!~this.path.indexOf("#"))return;var c=this.path.split("#");this.path=this.pathname=c[0],this.hash=r._decodeURLEncodedURIComponent(c[1])||"",this.querystring=this.querystring.split("#")[0]}}function ya(t,e,i){var r=this.page=i||xa,o=e||{};o.strict=o.strict||r._strict,this.path="*"===t?"(.*)":t,this.method="GET",this.regexp=Xn(this.path,this.keys=[],o)}fa.prototype.configure=function(t){var e=t||{};this._window=e.window||da&&window,this._decodeURLComponents=!1!==e.decodeURLComponents,this._popstate=!1!==e.popstate&&da,this._click=!1!==e.click&&ca,this._hashbang=!!e.hashbang;var i=this._window;this._popstate?i.addEventListener("popstate",this._onpopstate,!1):da&&i.removeEventListener("popstate",this._onpopstate,!1),this._click?i.document.addEventListener(pa,this.clickHandler,!1):ca&&i.document.removeEventListener(pa,this.clickHandler,!1),this._hashbang&&da&&!ha?i.addEventListener("hashchange",this._onpopstate,!1):da&&i.removeEventListener("hashchange",this._onpopstate,!1)},fa.prototype.base=function(t){if(0===arguments.length)return this._base;this._base=t},fa.prototype._getBase=function(){var t=this._base;if(t)return t;var e=da&&this._window&&this._window.location;return da&&this._hashbang&&e&&"file:"===e.protocol&&(t=e.pathname),t},fa.prototype.strict=function(t){if(0===arguments.length)return this._strict;this._strict=t},fa.prototype.start=function(t){var e=t||{};if(this.configure(e),!1!==e.dispatch){var i;if(this._running=!0,ma){var r=this._window.location;i=this._hashbang&&~r.hash.indexOf("#!")?r.hash.substr(2)+r.search:this._hashbang?r.search+r.hash:r.pathname+r.search+r.hash}this.replace(i,null,!0,e.dispatch)}},fa.prototype.stop=function(){if(this._running){this.current="",this.len=0,this._running=!1;var t=this._window;this._click&&t.document.removeEventListener(pa,this.clickHandler,!1),da&&t.removeEventListener("popstate",this._onpopstate,!1),da&&t.removeEventListener("hashchange",this._onpopstate,!1)}},fa.prototype.show=function(t,e,i,r){var o=new ba(t,e,this),s=this.prevContext;return this.prevContext=o,this.current=o.path,!1!==i&&this.dispatch(o,s),!1!==o.handled&&!1!==r&&o.pushState(),o},fa.prototype.back=function(t,e){var i=this;if(this.len>0){var r=this._window;ha&&r.history.back(),this.len--}else t?setTimeout(function(){i.show(t,e)}):setTimeout(function(){i.show(i._getBase(),e)})},fa.prototype.redirect=function(t,e){var i=this;"string"==typeof t&&"string"==typeof e&&va.call(this,t,function(t){setTimeout(function(){i.replace(e)},0)}),"string"==typeof t&&void 0===e&&setTimeout(function(){i.replace(t)},0)},fa.prototype.replace=function(t,e,i,r){var o=new ba(t,e,this),s=this.prevContext;return this.prevContext=o,this.current=o.path,o.init=i,o.save(),!1!==r&&this.dispatch(o,s),o},fa.prototype.dispatch=function(t,e){var i=0,r=0,o=this;function s(){var e=o.callbacks[i++];if(t.path===o.current)return e?void e(t,s):ga.call(o,t);t.handled=!1}e?function t(){var i=o.exits[r++];if(!i)return s();i(e,t)}():s()},fa.prototype.exit=function(t,e){if("function"==typeof t)return this.exit("*",t);for(var i=new ya(t,null,this),r=1;r<arguments.length;++r)this.exits.push(i.middleware(arguments[r]))},fa.prototype.clickHandler=function(t){if(1===this._which(t)&&!(t.metaKey||t.ctrlKey||t.shiftKey||t.defaultPrevented)){var e=t.target,i=t.path||(t.composedPath?t.composedPath():null);if(i)for(var r=0;r<i.length;r++)if(i[r].nodeName&&"A"===i[r].nodeName.toUpperCase()&&i[r].href){e=i[r];break}for(;e&&"A"!==e.nodeName.toUpperCase();)e=e.parentNode;if(e&&"A"===e.nodeName.toUpperCase()){var o="object"==typeof e.href&&"SVGAnimatedString"===e.href.constructor.name;if(!e.hasAttribute("download")&&"external"!==e.getAttribute("rel")){var s=e.getAttribute("href");if((this._hashbang||!this._samePath(e)||!e.hash&&"#"!==s)&&!(s&&s.indexOf("mailto:")>-1)&&!(o?e.target.baseVal:e.target)&&(o||this.sameOrigin(e.href))){var n=o?e.href.baseVal:e.pathname+e.search+(e.hash||"");n="/"!==n[0]?"/"+n:n,ua&&n.match(/^\/[a-zA-Z]:\//)&&(n=n.replace(/^\/[a-zA-Z]:\//,"/"));var a=n,l=this._getBase();0===n.indexOf(l)&&(n=n.substr(l.length)),this._hashbang&&(n=n.replace("#!","")),(!l||a!==n||ma&&"file:"===this._window.location.protocol)&&(t.preventDefault(),this.show(a))}}}}},fa.prototype._onpopstate=(la=!1,da?(ca&&"complete"===document.readyState?la=!0:window.addEventListener("load",function(){setTimeout(function(){la=!0},0)}),function(t){if(la){var e=this;if(t.state){var i=t.state.path;e.replace(i,t.state)}else if(ma){var r=e._window.location;e.show(r.pathname+r.search+r.hash,void 0,void 0,!1)}}}):function(){}),fa.prototype._which=function(t){return null==(t=t||da&&this._window.event).which?t.button:t.which},fa.prototype._toURL=function(t){var e=this._window;if("function"==typeof URL&&ma)return new URL(t,e.location.toString());if(ca){var i=e.document.createElement("a");return i.href=t,i}},fa.prototype.sameOrigin=function(t){if(!t||!ma)return!1;var e=this._toURL(t),i=this._window.location;return i.protocol===e.protocol&&i.hostname===e.hostname&&(i.port===e.port||""===i.port&&(80==e.port||443==e.port))},fa.prototype._samePath=function(t){if(!ma)return!1;var e=this._window.location;return t.pathname===e.pathname&&t.search===e.search},fa.prototype._decodeURLEncodedURIComponent=function(t){return"string"!=typeof t?t:this._decodeURLComponents?decodeURIComponent(t.replace(/\+/g," ")):t},ba.prototype.pushState=function(){var t=this.page,e=t._window,i=t._hashbang;t.len++,ha&&e.history.pushState(this.state,this.title,i&&"/"!==this.path?"#!"+this.path:this.canonicalPath)},ba.prototype.save=function(){var t=this.page;ha&&t._window.history.replaceState(this.state,this.title,t._hashbang&&"/"!==this.path?"#!"+this.path:this.canonicalPath)},ya.prototype.middleware=function(t){var e=this;return function(i,r){if(e.match(i.path,i.params))return i.routePath=e.path,t(i,r);r()}},ya.prototype.match=function(t,e){var i=this.keys,r=t.indexOf("?"),o=~r?t.slice(0,r):t,s=this.regexp.exec(decodeURIComponent(o));if(!s)return!1;delete e[0];for(var n=1,a=s.length;n<a;++n){var l=i[n-1],c=this.page._decodeURLEncodedURIComponent(s[n]);void 0===c&&hasOwnProperty.call(e,l.name)||(e[l.name]=c)}return!0};var xa=function t(){var e=new fa;function i(){return va.apply(e,arguments)}return i.callbacks=e.callbacks,i.exits=e.exits,i.base=e.base.bind(e),i.strict=e.strict.bind(e),i.start=e.start.bind(e),i.stop=e.stop.bind(e),i.show=e.show.bind(e),i.back=e.back.bind(e),i.redirect=e.redirect.bind(e),i.replace=e.replace.bind(e),i.dispatch=e.dispatch.bind(e),i.exit=e.exit.bind(e),i.configure=e.configure.bind(e),i.sameOrigin=e.sameOrigin.bind(e),i.clickHandler=e.clickHandler.bind(e),i.create=t,Object.defineProperty(i,"len",{get:function(){return e.len},set:function(t){e.len=t}}),Object.defineProperty(i,"current",{get:function(){return e.current},set:function(t){e.current=t}}),i.Context=ba,i.Route=ya,i}(),wa=xa,_a=xa;wa.default=_a;class ka{#He=[];subscribe(t,e,i){Array.isArray(t)?t.forEach(t=>this.subscribe(t,e,i)):Array.isArray(e)?e.forEach(e=>this.subscribe(t,e,i)):this.#Ve(t,e,i)}subscribeAll(t,e){Array.isArray(t)?t.forEach(t=>this.#Ve(t,"All",e)):this.#Ve(t,"All",e)}#Ve(t,e,i){const r={entityType:t,eventTypes:e,callback:i};this.#He.push(r)}unsubscribe(t,e,i){Array.isArray(t)?t.forEach(t=>this.unsubscribe(t,e,i)):Array.isArray(e)?e.forEach(e=>this.unsubscribe(t,e,i)):this.#We(t,e,i)}#We(t,e,i){this.#He=this.#He.filter(r=>r.callback!==i||r.entityType!==t||r.eventTypes!==e)}dispatch(t,e,i){this.#He.filter(i=>i.entityType===t&&("All"===i.eventTypes||i.eventTypes===e)).forEach(t=>t.callback(i))}}const $a=new ka;Object.freeze($a);const Sa=new URL(new URL("WQLuWBBr.svg",import.meta.url).href).href,za=new URL(new URL("BTVD-IEO.svg",import.meta.url).href).href;let Aa=class extends ht{#Xe;get page(){return this.#Xe}set page(t){this.#Xe=t}#Ye="";get fatalErrorMessage(){return this.#Ye}set fatalErrorMessage(t){this.#Ye=t}#Je=!1;get isWideViewPort(){return this.#Je}set isWideViewPort(t){this.#Je=t}#Ke=!1;get collapseMainMenu(){return this.#Ke}set collapseMainMenu(t){this.#Ke=t}#Qe;get confirmDialog(){return this.#Qe}set confirmDialog(t){this.#Qe=t}#Ze;get loadingIndicator(){return this.#Ze}set loadingIndicator(t){this.#Ze=t}#ti;get drawer(){return this.#ti}set drawer(t){this.#ti=t}get themePreference(){return localStorage.getItem("theme-preference")||(window.matchMedia("(prefers-color-scheme: dark)").matches?"dark":"light")}set themePreference(t){localStorage.setItem("theme-preference",t),this.#ei()}get prefersCollapsedMenu(){return JSON.parse(localStorage.getItem("prefers-collapsed-menu")||"false")}set prefersCollapsedMenu(t){localStorage.setItem("prefers-collapsed-menu",t.toString())}#ei(){document.firstElementChild?.setAttribute("data-theme",this.themePreference),$a.dispatch("theme-preference","change",this.themePreference)}async firstUpdated(){this.#ei(),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",({matches:t})=>{this.themePreference=t?"dark":"light",this.#ei()}),((t,e)=>{const i=window.matchMedia(t);i.addEventListener("change",t=>e(t.matches)),e(i.matches)})("(max-width: 920px)",async t=>{this.isWideViewPort=!t,this.isWideViewPort&&(this.drawer.closeQuick(),this.collapseMainMenu=this.prefersCollapsedMenu)}),await this.loadingIndicator.updateComplete,this.addEventListener(Hn.eventType,async t=>{await import("./XfEqRMZH.js"),this.confirmDialog.handleEvent(t)}),this.addEventListener(Dn.eventName,t=>{wa.show(t.detail.path)}),this.addEventListener(Gn.eventName,t=>{wa.redirect(t.detail.path)}),this.addEventListener(qn.eventName,t=>{this.fatalErrorMessage=t.detail,this.#ii("error")}),wa("*",(t,e)=>{this.drawer?.close(),e()}),wa("/",async()=>{wa.show("/getting-started")}),wa("/getting-started",()=>this.#ii("getting-started",()=>import("./DvGygnmv.js"))),wa("/titanium-full-page-loading-indicator",()=>this.#ii("titanium-full-page-loading-indicator",()=>import("./ejGYtRQw.js"))),wa("/available-cdn-icons",()=>this.#ii("available-cdn-icons",()=>import("./fUmj1Anl.js"))),wa("/leavitt-company-select",()=>this.#ii("leavitt-company-select",()=>import("./CbJNYa7R.js"))),wa("/leavitt-file-explorer",()=>this.#ii("leavitt-file-explorer",()=>import("./CpWAHOBD.js"))),wa("/titanium-date-range-selector",()=>this.#ii("titanium-date-range-selector",()=>import("./BmrAkqgw.js"))),wa("/titanium-data-table-item",()=>this.#ii("titanium-data-table-item",()=>import("./PNpd6bIJ.js"))),wa("/leavitt-person-select",()=>this.#ii("leavitt-person-select",()=>import("./BtW187gX.js"))),wa("/leavitt-person-company-select",()=>this.#ii("leavitt-person-company-select",()=>import("./C7C-DUKf.js"))),wa("/leavitt-person-group-select",()=>this.#ii("leavitt-person-group-select",()=>import("./Dw5Xjev7.js"))),wa("/leavitt-user-feedback",()=>this.#ii("leavitt-user-feedback",()=>import("./BfOOnlXY.js"))),wa("/profile-picture",()=>this.#ii("profile-picture",()=>import("./skovihXg.js"))),wa("/profile-picture-menu",()=>this.#ii("profile-picture-menu",()=>import("./B-wJjbKW.js"))),wa("/titanium-access-denied-page",()=>this.#ii("titanium-access-denied-page",()=>import("./Dj-5H2HF.js"))),wa("/titanium-data-table",()=>this.#ii("titanium-data-table",()=>import("./BIzU1s0u.js"))),wa("/titanium-data-table-item",()=>this.#ii("titanium-data-table-item",()=>import("./PNpd6bIJ.js"))),wa("/titanium-drawer",()=>this.#ii("titanium-drawer",()=>import("./2T7tEH8l.js"))),wa("/titanium-error-page",()=>this.#ii("titanium-error-page",()=>import("./CbBSynIu.js"))),wa("/titanium-address-input",()=>this.#ii("titanium-address-input",()=>import("./BVLmn7-S.js"))),wa("/titanium-header",()=>this.#ii("titanium-header",()=>import("./DmgNyMyr.js"))),wa("/titanium-icon-picker",()=>this.#ii("titanium-icon-picker",()=>import("./AaYnb3N1.js"))),wa("/titanium-header",()=>this.#ii("titanium-header",()=>import("./DmgNyMyr.js"))),wa("/titanium-chip-multi-select",()=>this.#ii("titanium-chip-multi-select",()=>import("./DBZzmbFq.js"))),wa("/titanium-input-validator",()=>this.#ii("titanium-input-validator",()=>import("./7oxSoTxH.js"))),wa("/titanium-data-table-header",()=>this.#ii("titanium-data-table-header",()=>import("./RFbrfW1G.js"))),wa("/titanium-full-page-loading-indicator",()=>this.#ii("titanium-full-page-loading-indicator",()=>import("./ejGYtRQw.js"))),wa("/titanium-page-control",()=>this.#ii("titanium-page-control",()=>import("./Bj84wuCa.js"))),wa("/titanium-smart-attachment-input",()=>this.#ii("titanium-smart-attachment-input",()=>import("./NdlaKLT2.js"))),wa("/titanium-date-input",()=>this.#ii("titanium-date-input",()=>import("./DxU064mZ.js"))),wa("/titanium-search-input",()=>this.#ii("titanium-search-input",()=>import("./rvLN49H5.js"))),wa("/titanium-toolbar",()=>this.#ii("titanium-toolbar",()=>import("./B-_9pSm8.js"))),wa("/titanium-styles",()=>this.#ii("titanium-styles",()=>import("./Brx0Psdl.js"))),wa("/titanium-snackbar",()=>this.#ii("titanium-snackbar",()=>import("./BpmW9i18.js"))),wa("/titanium-card",()=>this.#ii("titanium-card",()=>import("./xvCVVyCE.js"))),wa("/titanium-chip",()=>this.#ii("titanium-chip",()=>import("./9rp3rAV8.js"))),wa("/titanium-youtube-input",()=>this.#ii("titanium-youtube-input",()=>import("./BLiWBfmv.js"))),wa("/titanium-show-hide",()=>this.#ii("titanium-show-hide",()=>import("./wRmDE3nP.js"))),wa("/titanium-duration-input",()=>this.#ii("titanium-duration-input",()=>import("./XjgY3duL.js"))),wa("/titanium-profile-picture-stack",()=>this.#ii("titanium-profile-picture-stack",()=>import("./BD4RdeUW.js"))),wa("/titanium-confirm-dialog",()=>this.#ii("titanium-confirm-dialog",()=>import("./DeJ0uoij.js"))),wa("/titanium-confirmation-dialog",()=>this.#ii("titanium-confirmation-dialog",()=>import("./CHglLDc3.js"))),wa("*",()=>{this.fatalErrorMessage="We were unable to find the page you are looking for",this.#ii("error")}),wa.start()}async#ii(t,e){this.page=t;try{const t=e?.();t&&this.dispatchEvent(new Ee(t)),await t}catch(t){console.warn(t),this.fatalErrorMessage=t,this.page="error"}}static{this.styles=[Vn,ks,d`
    ...
    `]}render(){return V`<titanium-full-page-loading-indicator></titanium-full-page-loading-indicator>
      ...
      <titanium-toolbar>
        ...
        <a logo href="/" title="Back to home"><img src=${"dark"===this.themePreference?za:Sa} /></a>
      ...
      <titanium-drawer ?always-show-content=${this.isWideViewPort&&!this.collapseMainMenu}>
        <a slot="header" logo href="/" title="Back to home"><img src=${"dark"===this.themePreference?za:Sa} /></a>
      ...
      <titanium-service-worker-notifier></titanium-service-worker-notifier>`}};r([gt()],Aa.prototype,"page",null),r([gt()],Aa.prototype,"fatalErrorMessage",null),r([gt()],Aa.prototype,"isWideViewPort",null),r([vt({type:Boolean,reflect:!0,attribute:"collapse-main-menu"})],Aa.prototype,"collapseMainMenu",null),r([yt("titanium-confirm-dialog")],Aa.prototype,"confirmDialog",null),r([yt("titanium-full-page-loading-indicator")],Aa.prototype,"loadingIndicator",null),r([yt("titanium-drawer")],Aa.prototype,"drawer",null),r([gt()],Aa.prototype,"themePreference",null),r([gt()],Aa.prototype,"prefersCollapsedMenu",null),Aa=r([pt("my-app")],Aa);export{xs as $,gn as A,Tt as B,Hn as C,on as D,X as E,Yi as F,Rt as G,he as H,Oi as I,fr as J,br as K,Et as L,ve as M,ye as N,be as O,Ee as P,Qt as Q,vr as R,Ce as S,Er as T,gr as U,dr as V,hr as W,zr as X,Vn as Y,vs as Z,r as _,ys as a,Re as a0,$a as a1,_t as a2,Ei as a3,ct as a4,$r as a5,gi as a6,hi as a7,yr as a8,Oe as a9,fi as aa,di as ab,Je as ac,ci as ad,oi as ae,li as af,ni as ag,lr as ah,cr as ai,ws as aj,yn as ak,xn as al,bt as am,Hs as an,Zs as ao,Zt as ap,qn as aq,_e as ar,Nt as as,e as at,o as au,i as av,$s as b,d as c,hn as d,yt as e,wt as f,ka as g,bs as h,ht as i,Ci as j,Pr as k,_s as l,zs as m,vt as n,Ss as o,ks as p,Pt as q,gt as r,Qi as s,pt as t,As as u,cn as v,ln as w,V as x,Mi as y,Fi as z};
