...
${this.folder.FilesCount} file${1===this.folder.FilesCount?"":"s"}, ${this.folder.FoldersCount} folder${1===this.folder.FoldersCount?"":"s"}"
    ...
    `}};n([c()],J.prototype,"fileExplorerApiService",void 0),J=n([p("leavitt-file-explorer-playground")],J);let V=class extends s{#G=null;get refreshToken(){return this.#G}set refreshToken(e){this.#G=e}static{this.styles=[N,a``]}async firstUpdated(){const e=await C();await e.authenticateAsync(),this.refreshToken=window.localStorage.getItem("LG-AUTH-RT")}render(){return l`
    ...
    `}};n([c()],V.prototype,"refreshToken",null),V=n([p("leavitt-file-explorer-demo")],V);export{V as LeavittUserFileExplorerDemo};
