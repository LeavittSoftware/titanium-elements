import{i as e,h as t,p as a,c as n,x as s,_ as i,e as r,r as o,t as d}from"./CjNQuVkO.js";import{S as m}from"./C1gdeTM2.js";import"./Bje6lWER.js";import{D as l}from"./D-sA4sri.js";import{d as c}from"./fEBq_QNq.js";import"./DQLhV9sL.js";import"./Bz8i6eju.js";let u=class extends e{#e;get eventsDemoInput(){return this.#e}set eventsDemoInput(e){this.#e=e}#t="2020-01-02";get startDate(){return this.#t}set startDate(e){this.#t=e}#a="2020-01-04";get endDate(){return this.#a}set endDate(e){this.#a=e}#n=!1;get eventFired(){return this.#n}set eventFired(e){this.#n=e}static{this.styles=[t,a,n`
      :host {
        display: flex;
    ...
    `}};i([r("titanium-date-range-selector[events]")],u.prototype,"eventsDemoInput",null),i([o()],u.prototype,"startDate",null),i([o()],u.prototype,"endDate",null),i([o()],u.prototype,"eventFired",null),u=i([d("titanium-date-range-selector-playground")],u);let g=class extends e{static{this.styles=[m,n``]}render(){return s`
    ...
    `}};g=i([d("titanium-date-range-selector-demo")],g);export{g as TitaniumDateRangeSelectorDemo};
