import{i as t,h as e,p as i,c as a,x as n,_ as s,r as m,e as r,t as u}from"./-Qu_smub.js";import{S as l}from"./cOSQ4pB9.js";import"./BUX6rFny.js";let p=class extends t{constructor(){super(...arguments),this.getFilesResult=null,this.hasChanges=!1}#t;get getFilesInput(){return this.#t}set getFilesInput(t){this.#t=t}#e;get preselectFilesInput(){return this.#e}set preselectFilesInput(t){this.#e=t}#i;get preselectDisabledFilesInput(){return this.#i}set preselectDisabledFilesInput(t){this.#i=t}#a;get resetInput(){return this.#a}set resetInput(t){this.#a=t}static{this.styles=[e,i,a`
      :host {
        display: flex;
