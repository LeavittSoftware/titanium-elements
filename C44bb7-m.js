...
`;let h=class extends c{#e="";get iconSelected(){return this.#e}set iconSelected(o){this.#e=o}#t;get validators(){return this.#t}set validators(o){this.#t=o}static{this.styles=[n,s,y,o`
      :host {
        display: flex;
        flex-direction: column;
        margin: 24px 12px;
    ...
    `]}render(){return u`
      ...
      <div>
        ...
        <section buttons>
          ...
          <md-outlined-button
            @click=${()=>this.dispatchEvent(new d(`Check Validity is ${Array.from(this.validators).map(o=>o.checkValidity())}`))}
          >
    ...
    `}};t([p()],h.prototype,"iconSelected",null),t([m("titanium-input-validator")],h.prototype,"validators",null),h=t([r("titanium-input-validator-playground")],h);let _=class extends c{static{this.styles=[v,o``]}render(){return u`
    ...
    `}};_=t([r("titanium-input-validator-demo")],_);export{_ as TitaniumInputValidatorDemo};
