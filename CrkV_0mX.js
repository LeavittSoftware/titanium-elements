import{x as e,S as t,c as s,_ as a,n as i,t as o,i as l,A as r,d as n,h as c,p as d,r as p,e as m,f as h,G as u,E as g}from"./DVlkqJv5.js";import{S as y}from"./DVDJXYGh.js";import"./Cg1yvRmS.js";import"./BGWzdnGp.js";import{F as v}from"./BDKkuyyK.js";import{T as b}from"./0GZ-Rj3p.js";import{D as S}from"./Bbv0u4bt.js";import"./KOWsEieL.js";let _=class extends b{#e="Company";get label(){return this.#e}set label(e){this.#e=e}#t="Search for a company";get placeholder(){return this.#t}set placeholder(e){this.#t=e}#s="Name";get pathToSelectedText(){return this.#s}set pathToSelectedText(e){this.#s=e}#a=[];get companies(){return this.#a}set companies(e){this.#a=e}#i;get apiService(){return this.#i}set apiService(e){this.#i=e}#o=!1;get disableAutoLoad(){return this.#o}set disableAutoLoad(e){this.#o=e}#l=["orderby=Name","select=Name,ShortName,MarkUrl,Id"];get odataParts(){return this.#l}set odataParts(e){this.#l=e}#r="Companies";get apiControllerName(){return this.#r}set apiControllerName(e){this.#r=e}#n="off";get autocomplete(){return this.#n}set autocomplete(e){this.#n=e}#c=!1;get spellcheck(){return this.#c}set spellcheck(e){this.#c=e}#d="off";get autocorrect(){return this.#d}set autocorrect(e){this.#d=e}#p=t=>e`<md-menu-item .item=${t}>
