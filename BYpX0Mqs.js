import{Z as e,i as t,o as a,h as o,_ as r,n as i,k as s,R as n,D as l,t as c,a as d,p as h,r as p,e as v,z as m,Y as b,$ as u}from"./BDVm1clO.js";import"./B29NwKRo.js";function g(t){return(a,o)=>{const{slot:r}=t??{},i="slot"+(r?`[name=${r}]`:":not([name])");return e(a,o,{get(){const e=this.renderRoot?.querySelector(i);return e?.assignedNodes(t)??[]}})}}const y=t`
  titanium-card {
    margin-bottom: 36px;
  }
...
`,_=a(o);class w extends _{get rippleDisabled(){return this.disabled||this.softDisabled}constructor(){super(),this.disabled=!1,this.softDisabled=!1,this.alwaysFocusable=!1,this.label="",this.hasIcon=!1,this.addEventListener("click",this.handleClick.bind(this))}focus(e){this.disabled&&!this.alwaysFocusable||super.focus(e)}render(){return s`
      <div class="container ${n(this.getContainerClasses())}">
        ${this.renderContainerContent()}
      </div>
    `}updated(e){e.has("disabled")&&void 0!==e.get("disabled")&&this.dispatchEvent(new Event("update-focus",{bubbles:!0}))}getContainerClasses(){return{disabled:this.disabled||this.softDisabled,"has-icon":this.hasIcon}}renderContainerContent(){return s`
      ${this.renderOutline()}
    ...
    `}handleIconChange(e){const t=e.target;this.hasIcon=t.assignedElements({flatten:!0}).length>0}handleClick(e){if(this.softDisabled||this.disabled&&this.alwaysFocusable)return e.stopImmediatePropagation(),void e.preventDefault()}}w.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0},r([i({type:Boolean,reflect:!0})],w.prototype,"disabled",void 0),r([i({type:Boolean,attribute:"soft-disabled",reflect:!0})],w.prototype,"softDisabled",void 0),r([i({type:Boolean,attribute:"always-focusable"})],w.prototype,"alwaysFocusable",void 0),r([i()],w.prototype,"label",void 0),r([i({type:Boolean,reflect:!0,attribute:"has-icon"})],w.prototype,"hasIcon",void 0);class $ extends w{constructor(){super(...arguments),this.elevated=!1,this.href="",this.target=""}get primaryId(){return this.href?"link":"button"}get rippleDisabled(){return!this.href&&(this.disabled||this.softDisabled)}getContainerClasses(){return{...super.getContainerClasses(),disabled:!this.href&&(this.disabled||this.softDisabled),elevated:this.elevated,link:!!this.href}}renderPrimaryAction(e){const{ariaLabel:t}=this;return this.href?s`
        <a
...
`;let S=class extends k{};S.styles=[x,f,z],S=r([c("md-suggestion-chip")],S);let C=null;const T=async e=>{try{const t=await fetch(e,{method:"GET"}),a=await t.text();return a.length?JSON.parse(a):{}}catch(e){console.warn(e)}return null};let N=class extends o{#e;get name(){return this.#e}set name(e){this.#e=e}#t;get className(){return this.#t}set className(e){this.#t=e}#a;get deprecatedReason(){return this.#a}set deprecatedReason(e){this.#a=e}#o=null;get customElementDeclaration(){return this.#o}set customElementDeclaration(e){this.#o=e}#r=null;get customElementsJSON(){return this.#r}set customElementsJSON(e){this.#r=e}async updated(e){e.has("className")&&this.className&&(this.customElementsJSON=await(async()=>(C||(C=await T("/custom-elements.json")),C))(),this.customElementDeclaration=this.customElementsJSON?.modules.flatMap((e=>e.declarations)).find((e=>e.name===this.className))??null)}static{this.styles=[d,h,t`
    ...
    `]}render(){return s`
      ...
      <chip-container>
        ${this.deprecatedReason?s`<md-suggestion-chip disabled label="Deprecated (${this.deprecatedReason})"></md-suggestion-chip>`:l}
      </chip-container>
    `}};r([i({type:String})],N.prototype,"name",null),r([i({type:String})],N.prototype,"className",null),r([i({type:String})],N.prototype,"deprecatedReason",null),r([p()],N.prototype,"customElementDeclaration",null),r([p()],N.prototype,"customElementsJSON",null),N=r([c("story-header")],N);const I=Symbol("isFocusable"),E=Symbol("privateIsFocusable"),B=Symbol("externalTabIndex"),j=Symbol("isUpdatingTabIndex"),F=Symbol("updateTabIndex");var D;const R=Symbol("indicator"),O=Symbol("animateIndicator"),A=function(e){var t,a,o;class s extends e{constructor(){super(...arguments),this[t]=!0,this[a]=null,this[o]=!1}get[I](){return this[E]}set[I](e){this[I]!==e&&(this[E]=e,this[F]())}connectedCallback(){super.connectedCallback(),this[F]()}attributeChangedCallback(e,t,a){if("tabindex"===e){if(this.requestUpdate("tabIndex",Number(t??-1)),!this[j])return this.hasAttribute("tabindex")?void(this[B]=this.tabIndex):(this[B]=null,void this[F]())}else super.attributeChangedCallback(e,t,a)}[(t=E,a=B,o=j,F)](){const e=this[I]?0:-1,t=this[B]??e;this[j]=!0,this.tabIndex=t,this[j]=!1}}return r([i({noAccessor:!0})],s.prototype,"tabIndex",void 0),s}(o);class J extends A{get selected(){return this.active}set selected(e){this.active=e}constructor(){super(),this.isTab=!0,this.active=!1,this.hasIcon=!1,this.iconOnly=!1,this.fullWidthIndicator=!1,this.internals=this.attachInternals(),this.internals.role="tab",this.addEventListener("keydown",this.handleKeydown.bind(this))}render(){const e=s`<div class="indicator"></div>`;return s`<div
      class="button"
      role="presentation"
...
`;let H=class extends M{};H.styles=[P],H=r([c("md-tabs")],H);let X=class extends o{#i="simple";get selectedTab(){return this.#i}set selectedTab(e){this.#i=e}#s;get projectSrc(){return this.#s}set projectSrc(e){this.#s=e}#n="index.html";get htmlFile(){return this.#n}set htmlFile(e){this.#n=e}#l;get lineNumbers(){return this.#l}set lineNumbers(e){this.#l=e}#c;get lineWrapping(){return this.#c}set lineWrapping(e){this.#c=e}updated(e){if(e.has("selectedTab")&&"playground"===this.selectedTab)try{import("./q3sbMxXw.js")}catch(e){this.dispatchEvent(new u(e))}}static{this.styles=[t`
    ...
    `}};r([i({type:String})],X.prototype,"selectedTab",null),r([i({type:String,attribute:"project-src"})],X.prototype,"projectSrc",null),r([i({type:String,attribute:"html-file"})],X.prototype,"htmlFile",null),r([i({type:Boolean,attribute:"line-numbers"})],X.prototype,"lineNumbers",null),r([i({type:Boolean,attribute:"line-wrapping"})],X.prototype,"lineWrapping",null),r([i({type:Boolean})],X.prototype,"resizable",void 0),X=r([c("smart-demo")],X);export{w as C,y as S,g as n,x as s};
