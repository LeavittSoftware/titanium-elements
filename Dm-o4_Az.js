import{S as e,b as t,c as a,_ as o,n as r,t as s,i,A as l,U as n,r as c,e as p}from"./C4zC-QpX.js";import{S as m}from"./BuWE4gAm.js";import"./iIryJ62l.js";import"./C5JZ_0-E.js";import"@leavittsoftware/web/leavitt/user-manager/user-manager";import{T as h}from"./C87bHxUk.js";import{g as d}from"./OXmljVLM.js";import{D as u}from"./DTS7lhmZ.js";import{F as v}from"./BU8LG2ZX.js";import{g as y}from"./wLIUKFBh.js";import"./C5_Ye6jZ.js";import"./hR9ebjVF.js";import"./rrxT2ZHw.js";let g=class extends h{#e="Person or company";get label(){return this.#e}set label(e){this.#e=e}#t="Search for a person or company";get placeholder(){return this.#t}set placeholder(e){this.#t=e}#a="People";get peopleApiControllerName(){return this.#a}set peopleApiControllerName(e){this.#a=e}#o="Companies";get companyApiControllerName(){return this.#o}set companyApiControllerName(e){this.#o=e}#r="Name";get pathToSelectedText(){return this.#r}set pathToSelectedText(e){this.#r=e}#s;get apiService(){return this.#s}set apiService(e){this.#s=e}#i="off";get autocomplete(){return this.#i}set autocomplete(e){this.#i=e}#l=!1;get spellcheck(){return this.#l}set spellcheck(e){this.#l=e}#n=new u(e=>this.#c(e));#p=new AbortController;searchTermToOData(e){const t=d(e);return t.length<1?null:t.map(e=>`contains(tolower(Name), '${e.toLowerCase()}')`).join(" and ")}async#c(e){if(!e)return;this.#p.abort(),this.#p=new AbortController;const t=Promise.all([this.#m(e),this.#h(e)]);this.loadWhile(t);const a=await t,o=[...a[0]?.entities??[],...a[1]?.entities??[]],r=(a[0]?.odataCount??0)+(a[1]?.odataCount??0),s=new v(o,{includeScore:!0,keys:["Name"],shouldSort:!0,ignoreLocation:!0,threshold:.3}).search(e);this.showSuggestions(s.map(e=>e.item)??[],r??0)}async#m(t){if(!t)return null;try{const e=["top=100","count=true","compute=FullName as Name","select=Name,Id,CompanyName,ProfilePictureCdnFileName"],a=d(t);if(a.length>0){const t=a.map(e=>`contains(tolower(Name), '${e.toLowerCase()}')`).join(" and ");e.push(`filter=${t}`)}const o=await(this.apiService?.getAsync(`${this.peopleApiControllerName}?${e.join("&")}`,{abortController:this.#p}));return o?.entities.forEach(e=>e.type="Person"),o}catch(t){t?.message?.includes("Abort error")||this.dispatchEvent(new e(t))}return null}async#h(t){if(!t)return null;try{const e=["top=100","count=true","select=Name,Shortname,MarkUrl,DarkMarkUrl,Id"],a=d(t);if(a.length>0){const t=a.map(e=>`(contains(Name, '${e}') OR (contains(Shortname, '${e}')))`).join(" and ");e.push(`$filter=${t}`)}const o=await(this.apiService?.getAsync(`Companies?${e.join("&")}`,{abortController:this.#p}));return o?.entities.forEach(e=>e.type="Company"),o}catch(t){t?.message?.includes("Abort error")||this.dispatchEvent(new e(t))}return null}static{this.styles=[...h.styles,t`
    ...
    `]}onInputChanged(e){this.#n.debounce(e)}renderSelectedLeadingInputSlot(e){return"Person"===e.type?a`<profile-picture slot="leading-icon" .fileName=${e?.ProfilePictureCdnFileName||null} shape="circle" size="24"></profile-picture>`:"Company"===e.type?a`<img leading slot="leading-icon" src=${y(e,this.themePreference)} />`:a``}renderSuggestion(e){return"Person"===e.type?a`<md-menu-item .item=${e} ?selected=${this.selected?.Id===e.Id}>
          ...
          </md-menu-item>`:a``}};o([r({type:String})],g.prototype,"label",null),o([r({type:String})],g.prototype,"placeholder",null),o([r({type:String})],g.prototype,"peopleApiControllerName",null),o([r({type:String})],g.prototype,"companyApiControllerName",null),o([r({type:String})],g.prototype,"pathToSelectedText",null),o([r({attribute:!1})],g.prototype,"apiService",null),o([r({reflect:!0,type:String})],g.prototype,"autocomplete",null),o([r({reflect:!0,type:Boolean})],g.prototype,"spellcheck",null),g=o([s("leavitt-person-company-select")],g);let S=class extends i{#s;get apiService(){return this.#s}set apiService(e){this.#s=e}#d;get methodsSelect(){return this.#d}set methodsSelect(e){this.#d=e}constructor(){super(),this.apiService=new l(n),this.apiService.baseUrl="https://devapi3.leavitt.com/",this.apiService.addHeader("X-LGAppName","Testing")}static{this.styles=[m]}render(){return a`
    ...
    `}};o([c()],S.prototype,"apiService",null),o([p("leavitt-person-company-select[methods-demo]")],S.prototype,"methodsSelect",null),S=o([s("leavitt-person-company-select-demo")],S);export{S as LeavittPersonCompanySelectDemo};
