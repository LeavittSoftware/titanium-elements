...
`;let _e=class extends xe{};_e.styles=[Nt,we],_e=r([ut("md-text-button")],_e);let ke=class extends ht{#F;#D;get open(){return this.#D}set open(t){this.#D=t}#G;get noAction(){return this.#G}set noAction(t){this.#G=t}#H;get actionText(){return this.#H}set actionText(t){this.#H=t}#q;get message(){return this.#q}set message(t){this.#q=t}show(t,e){if(this.showPopover?this.showPopover():this.open=!0,this.message=e?.overrideTemplate?e?.overrideTemplate:t,this.noAction=e?.noAction??!1,this.actionText=e?.actionText??"Dismiss",e?.autoHide){const t="number"==typeof e?.autoHide?e?.autoHide:5e3;this.#V=window.setTimeout(()=>this.close("auto-close"),t)}return new Promise(t=>{this.#F=t})}#V=0;close(t=""){clearTimeout(this.#V),this.hidePopover?this.hidePopover():this.open=!1,this.#F(t)}static{this.styles=[d`
    ...
    `}};r([vt({type:Boolean,reflect:!0})],$e.prototype,"open",null),r([vt({type:Array})],$e.prototype,"httpErrors",null),$e=r([ut("titanium-http-error-snackbar")],$e);class ze extends Event{static{this.eventName="show-snackbar"}constructor(t,e){super(ze.eventName,{bubbles:!0,composed:!0}),this.SnackbarMessage=t,this.SnackbarOptions=e}}let Ae=class extends ht{constructor(){super(...arguments),this.SnackbarStack=[]}#K;get eventListenerTarget(){return this.#K}set eventListenerTarget(t){this.#K=t}connectedCallback(){super.connectedCallback(),(this.eventListenerTarget||this.getRootNode()).addEventListener(ze.eventName,t=>{t.stopImmediatePropagation(),this.open(t.SnackbarMessage,t.SnackbarOptions)})}static{this.styles=[d`
      :host {
        display: contents;
      }
