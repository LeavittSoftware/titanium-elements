import{aq as e,c as t,_ as a,n as o,ar as r,E as i,x as s,as as n,t as l,i as c,h as d,p as h,r as p,e as v,a7 as m,U as b,at as u,au as g}from"./CU2mI_nZ.js";function y(t){return(a,o)=>{const{slot:r}=t??{},i="slot"+(r?`[name=${r}]`:":not([name])");return e(a,o,{get(){const e=this.renderRoot?.querySelector(i);return e?.assignedNodes(t)??[]}})}}const f=t`
  titanium-card {
    margin-bottom: 36px;
  }
