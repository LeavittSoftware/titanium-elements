          ...
          <leavitt-app-width-limiter max-width="1000px">
            ...
            <main>
              ...
              <titanium-data-table-core
                ...
                @sort-changed=${async e=>{this.sort=e.target.sort;const t=i(300);this.tableCore.trackLoadingPromise(t),await t,this.items=this.sortItems(this.items,this.sort),this.requestUpdate("items")}}
