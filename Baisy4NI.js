import{A as e,d as t,z as i,L as s,P as a,S as r,k as o,a as n,p as d,i as l,_ as c,r as p,h as m,n as u,e as h,t as b,f,G as g,D as v}from"./CzHvl5jm.js";import{S as w}from"./CYtDMjId.js";import"./BngvSuhr.js";import"./DvvAwdf6.js";import"./u8AVqufc.js";import"./QJssaeMz.js";const k=new e(new t);k.baseUrl=i?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",k.addHeader("X-LGAppName","IssueTracking"),Object.freeze(k);const x=new e(new t);x.baseUrl=i?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",x.addHeader("X-LGAppName","IssueTracking"),Object.freeze(x);let y=class extends(s(m)){#e=!1;get isActive(){return this.#e}set isActive(e){this.#e=e}#t=0;get activeIndex(){return this.#t}set activeIndex(e){this.#t=e}#i;get textArea(){return this.#i}set textArea(e){this.#i=e}#s;get imageInput(){return this.#s}set imageInput(e){this.#s=e}async updated(e){e.has("isActive")&&this.isActive&&this.reset()}reset(){this.imageInput?.reset(),this.textArea?.reset()}async#a(){if(!this.textArea.reportValidity()||this.isLoading)return;const e={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Bug",Description:this.textArea.value,Attachments:(this.imageInput?.getFiles()??[]).map((e=>e.file))};try{const t=k.postAsync("Issues/ReportIssue",e,{sendAsFormData:!0});this.dispatchEvent(new a(t)),this.loadWhile(t);if(!(await t).entity)throw new Error("Error submitting problem. Please try again.");this.dispatchEvent(new r("",{overrideTemplate:o`Thank you for bringing this issue to our attention!<br />
              <br />
              Our engineering teams will promptly investigate and address it.`})),this.reset()}catch(e){this.dispatchEvent(new r(e))}}async#r(){if(!this.textArea.reportValidity()||this.isLoading)return;const e={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Feedback",Description:this.textArea.value,Attachments:[]};try{const t=x.postAsync("Issues/ReportIssue",e,{sendAsFormData:!0});this.dispatchEvent(new a(t)),this.loadWhile(t);if(!(await t).entity)throw new Error("Error submitting feedback. Please try again.");this.dispatchEvent(new r("We appreciate your input, and we will promptly conduct a review!")),this.reset()}catch(e){this.dispatchEvent(new r(e))}}static{this.styles=[n,d,l`
      :host {
        display: grid;
