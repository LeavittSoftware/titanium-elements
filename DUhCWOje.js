import{h as t,m as i,i as e,k as n,_ as a,n as o,a0 as s,t as l,a as r,p as c}from"./CzHvl5jm.js";import{S as h}from"./CYtDMjId.js";import"./BngvSuhr.js";let p=class extends t{#t;get label(){return this.#t}set label(t){this.#t=t}#i;get selected(){return this.#i}set selected(t){this.#i=t}#e;get inputChip(){return this.#e}set inputChip(t){this.#e=t}#n;get nonInteractive(){return this.#n}set nonInteractive(t){this.#n=t}#a="close";get inputChipRemoveIcon(){return this.#a}set inputChipRemoveIcon(t){this.#a=t}#o=!1;get disabled(){return this.#o}set disabled(t){this.#o=t}#s=!1;get hasLeadingItems(){return this.#s}set hasLeadingItems(t){this.#s=t}#l=!1;get hasTrailingItems(){return this.#l}set hasTrailingItems(t){this.#l=t}static{this.styles=[i,e`
      :host {
        display: grid;
        height: 32px;
        width: auto;
