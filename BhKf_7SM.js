...
`;let O=class extends D{#E;get item(){return this.#E}set item(t){this.#E=t}#f=null;get tableMetaData(){return this.#f}set tableMetaData(t){this.#f=t}#A=null;get supplementalItemStyles(){return this.#A}set supplementalItemStyles(t){this.#A=t}get items(){return Array.from(this.parentElement?.querySelectorAll("titanium-data-table-core-reorder-item")??[])}get itemsContainer(){return this.parentElement}static{this.styles=[D.styles,e`
    ...
    `]}render(){return n`
              ...
              <content-container>
                ...
                >
                  ...
                  ${this.items.length>0?n`<md-divider role="separator" tabindex="-1"></md-divider>
                        <md-menu-item
                          .action=${()=>{const t=k().format("YYYY-MM-DD HH-mm-ss"),e=K({filename:`web export ${t}`,useKeysAsHeaders:!0}),i=this.orderByUserPreference(this.tableMetaData?.itemMetaData?.filter(t=>!t.hideByDefault&&this.userSettings.find(e=>e.key===t.key)?.show||this.userSettings.find(e=>e.key===t.key)?.show)??[],this.userSettings)??[],s=this.items.map(t=>{const e={};for(const s of i)e[s.key]=s.csvValue?s.csvValue(t):t[s.key];return e})??[],o=st(e)(s);ot(e)(o)}}
                        >
      ...
      ></titanium-data-table-core-settings-choose-columns-dialog>
    `}};i([s({type:Array})],at.prototype,"items",null),i([s({type:Object})],at.prototype,"tableMetaData",null),i([s({type:Object})],at.prototype,"supplementalItemStyles",null),i([s({type:Boolean,reflect:!0})],at.prototype,"disabled",null),i([s({type:Boolean,attribute:"sticky-header",reflect:!0})],at.prototype,"stickyHeader",null),i([s({type:String,attribute:"selection-mode",reflect:!0})],at.prototype,"selectionMode",null),i([s({type:Array})],at.prototype,"selected",null),i([h("titanium-data-table-core-settings-choose-columns-dialog")],at.prototype,"chooseColumnsDialog",null),i([h("titanium-data-table-core-settings-sort-dialog")],at.prototype,"sortDialog",null),i([h("titanium-data-table-core-reorder-dialog")],at.prototype,"reorderDialog",null),i([s({type:String,attribute:"local-storage-key"})],at.prototype,"localStorageKey",null),i([o()],at.prototype,"customSortApplied",null),i([o()],at.prototype,"customColumnsApplied",null),i([o()],at.prototype,"sort",null),i([o()],at.prototype,"userSettings",null),at=i([a("titanium-data-table-core")],at);class rt extends Event{static{this.eventType="titanium-data-table-items-reorder"}constructor(){super(rt.eventType)}}let lt=class extends t{#b=[];get selected(){return this.#b}set selected(t){this.#b=t}#U=!1;get hasSelected(){return this.#U}set hasSelected(t){this.#U=t}#K;get hasAddButton(){return this.#K}set hasAddButton(t){this.#K=t}#P;get addButtonElements(){return this.#P}set addButtonElements(t){this.#P=t}updated(t){t.has("selected")&&(this.hasSelected=this.selected.length>0)}static{this.styles=[w,g,e`
      :host {
        display: grid;
        padding: 12px 16px;
        background-color: var(--md-sys-color-surface-container-lowest);
