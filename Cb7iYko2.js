import{h as t,i as e,k as a,_ as s,r as i,n,e as r,t as o,a as d,p as l}from"./BDVm1clO.js";import{S as c}from"./BYpX0Mqs.js";import"./BSBJUm6d.js";import"./y3grKe00.js";import"./Bx5lyspZ.js";import{Q as m,M as h,D as u,d as p}from"./CaDY519L.js";import{r as g}from"./BwleRb8i.js";import"./B29NwKRo.js";import"./DihM7gpy.js";import"./BnAFKI1h.js";import"./bsH9U0_p.js";p.extend((function(t,e){var a=e.prototype;a.quarter=function(t){return this.$utils().u(t)?Math.ceil((this.month()+1)/3):this.month(this.month()%3+3*(t-1))};var s=a.add;a.add=function(t,e){return t=Number(t),this.$utils().p(e)===m?this.add(3*t,h):s.bind(this)(t,e)};var i=a.startOf;a.startOf=function(t,e){var a=this.$utils(),s=!!a.u(e)||e;if(a.p(t)===m){var n=this.quarter()-1;return s?this.month(3*n).startOf(h).startOf(u):this.month(3*n+2).endOf(h).endOf(u)}return i.bind(this)(t,e)}}));const D="quarter",Y=new Map([["allTime",{name:"All time",startDate:()=>"",endDate:()=>"",icon:"watch_later"}],["today",{name:"Today",startDate:()=>p().format("YYYY-MM-DD"),endDate:()=>p().format("YYYY-MM-DD"),icon:"today"}],["thisWeek",{name:"This week",startDate:()=>p().startOf("week").format("YYYY-MM-DD"),endDate:()=>p().endOf("week").format("YYYY-MM-DD"),icon:"calendar_view_week"}],["thisMonth",{name:"This month",startDate:()=>p().startOf("month").format("YYYY-MM-DD"),endDate:()=>p().endOf("month").format("YYYY-MM-DD"),icon:"calendar_month"}],["thisQuarter",{name:"This quarter",startDate:()=>p().startOf(D).format("YYYY-MM-DD"),endDate:()=>p().endOf(D).format("YYYY-MM-DD"),icon:"event"}],["thisYear",{name:"This year",startDate:()=>p().startOf("year").format("YYYY-MM-DD"),endDate:()=>p().endOf("year").format("YYYY-MM-DD"),icon:"calendar_today"}],["thisYearToDate",{name:"This year to date",startDate:()=>p().startOf("year").format("YYYY-MM-DD"),endDate:()=>p().format("YYYY-MM-DD"),icon:"calendar_view_day"}],["lastWeek",{name:"Last week",startDate:()=>p().subtract(1,"week").startOf("week").format("YYYY-MM-DD"),endDate:()=>p().subtract(1,"week").endOf("week").format("YYYY-MM-DD"),icon:"calendar_view_week"}],["lastMonth",{name:"Last month",startDate:()=>p().subtract(1,"month").startOf("month").format("YYYY-MM-DD"),endDate:()=>p().subtract(1,"month").endOf("month").format("YYYY-MM-DD"),icon:"calendar_month"}],["lastQuarter",{name:"Last quarter",startDate:()=>p().subtract(1,"quarter").startOf(D).format("YYYY-MM-DD"),endDate:()=>p().subtract(1,"quarter").endOf(D).format("YYYY-MM-DD"),icon:"event"}],["lastYear",{name:"Last year",startDate:()=>p().subtract(1,"year").startOf("year").format("YYYY-MM-DD"),endDate:()=>p().subtract(1,"year").endOf("year").format("YYYY-MM-DD"),icon:"calendar_today"}],["last12Months",{name:"Last 12 months",startDate:()=>p().add(-1,"year").format("YYYY-MM-DD"),endDate:()=>p().format("YYYY-MM-DD"),icon:"calendar_today"}],["lastYearToDate",{name:"Last year to date",startDate:()=>p().subtract(1,"year").startOf("year").format("YYYY-MM-DD"),endDate:()=>p().format("YYYY-MM-DD"),icon:"calendar_view_day"}],["yesterday",{name:"Yesterday",startDate:()=>p().subtract(1,"day").format("YYYY-MM-DD"),endDate:()=>p().subtract(1,"day").format("YYYY-MM-DD"),icon:"event_repeat"}]]);let y=class extends t{#t="custom";get range(){return this.#t}set range(t){this.#t=t}#e="";get startDate(){return this.#e}set startDate(t){this.#e=t}#a="";get endDate(){return this.#a}set endDate(t){this.#a=t}#s="";get label(){return this.#s}set label(t){this.#s=t}#i="date";get type(){return this.#i}set type(t){this.#i=t}#n=!1;get disabled(){return this.#n}set disabled(t){this.#n=t}#r=null;get customDateRanges(){return this.#r}set customDateRanges(t){this.#r=t}#o="";get supportingText(){return this.#o}set supportingText(t){this.#o=t}#d="popover";get positioning(){return this.#d}set positioning(t){this.#d=t}#l;get menu(){return this.#l}set menu(t){this.#l=t}#c;get list(){return this.#c}set list(t){this.#c=t}#m="custom";get proposedRange(){return this.#m}set proposedRange(t){this.#m=t}#h="";get proposedStartDate(){return this.#h}set proposedStartDate(t){this.#h=t}#u="";get proposedEndDate(){return this.#u}set proposedEndDate(t){this.#u=t}#p;get open(){return this.#p}set open(t){this.#p=t}#g=!1;get focused(){return this.#g}set focused(t){this.#g=t}async updated(t){if(t.has("range")||t.has("open")){const t=this.#D(this.range);t&&(this.startDate=t.startDate(),this.endDate=t.endDate())}(t.has("endDate")||t.has("startDate"))&&(this.range=Array.from(this.customDateRanges?this.customDateRanges:Y).find((t=>t[1].startDate()===this.startDate&&t[1].endDate()===this.endDate))?.[0]||"custom"),t.has("positioning")&&"popover"===this.positioning&&!this.showPopover&&(this.positioning="fixed")}async reset(){this.range="allTime"}#Y(t,e){return!(t&&e&&p(t).isAfter(p(e)))}static{this.styles=e`
  ...
  `}#D(t){return this.customDateRanges?this.customDateRanges.get(t):Y.get(t)}#y(t=!1){if(!this.list)return;const e=this.list.items,a=e.find((t=>t.hasAttribute("selected")))||e[0];a&&(this.list.scrollTop=a.offsetTop-10,a.tabIndex=0,t&&a.focus())}render(){return a`
      ...
      <md-menu
        ...
        anchor="field"
        .open=${this.open}
        @closing=${t=>{this.open=!1,g(this,t)}}
        @opening=${async t=>{this.proposedEndDate=this.endDate,this.proposedStartDate=this.startDate,this.proposedRange=this.range,g(this,t),await this.updateComplete,this.#y()}}
      >
        <main>
          <section>
            <md-list>
