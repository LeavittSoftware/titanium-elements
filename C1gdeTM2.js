import{as as e,c as t,_ as a,n as o,at as r,E as i,x as s,au as n,t as l,i as c,h as d,p as h,r as p,e as v,a9 as m,W as b,av as u,aw as g}from"./CjNQuVkO.js";function y(t){return(a,o)=>{const{slot:r}=t??{},i="slot"+(r?`[name=${r}]`:":not([name])");return e(a,o,{get(){const e=this.renderRoot?.querySelector(i);return e?.assignedNodes(t)??[]}})}}const f=t`
  titanium-card {
    margin-bottom: 36px;
  }
