import{L as t,i as e,S as i,c as s,u as a,v as l,w as r,x as o,_ as n,n as c,r as h,e as d,t as m,y as p,E as g,z as u,T as v,B as f,p as y,a as b,D as $,k as x,b as w,h as _,F as D,G as T,P as S,A as k,U as E}from"./BriKlvrl.js";import{S as j}from"./BYDhJ-qH.js";import"./B5dYKavm.js";import{F as C}from"./CnF9HEZs.js";import"./B686K5_l.js";import"./DsFYjnf8.js";import"./DEp7IXki.js";import"./Dn-7KkpK.js";import{D as I,r as R}from"./DbVmU92k.js";import"./Um3mYSyR.js";import"./DDyV-Jf6.js";import{d as A}from"./fEBq_QNq.js";import{D as N}from"./DTS7lhmZ.js";import{g as L}from"./OXmljVLM.js";import"./Drnf-8aB.js";import"./7XIo79ZR.js";import"./Dd1qmxE6.js";import"./CgKZkKuN.js";import"./C5wQzWBc.js";import{n as M}from"./4NUcxRo8.js";import{T as H}from"./9nIrBYgP.js";import"./C-S6ieI7.js";import"./CgOa3T5m.js";import"./DMSUW3hk.js";import"./BQXTOG09.js";import"./doSzMn6v.js";import"./c5f0ayQ_.js";import"./CSGmXuum.js";let Y=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#i;get filterController(){return this.#i}set filterController(t){this.#i=t}#s=[];get template(){return this.#s}set template(t){this.#s=t}#a;get templateId(){return this.#a}set templateId(t){this.#a=t}#l=!0;#r;get startDate(){return this.#r}set startDate(t){this.#r=t}#o;get endDate(){return this.#o}set endDate(t){this.#o=t}#n;get dialog(){return this.#n}set dialog(t){this.#n=t}#c;get dateRangeSelect(){return this.#c}set dateRangeSelect(t){this.#c=t}async firstUpdated(){this.filterController.subscribeToFilterChange(async()=>{this.#h(),this.requestUpdate("filterController")})}async updated(t){this.isActive&&t.has("isActive")&&this.#h()}async#h(){this.filterController.getValue("template")&&this.#l&&(this.template=await this.#d())}async#d(){if(!this.apiService)return console.warn("No api service provided"),[];const t=["select=Id,Name,IsExpired","orderby=Name"];try{const e=this.apiService.getAsync(`EmailTemplates?${t.join("&")}`);this.loadWhile(e);const i=(await e).toList();return this.#l=!1,i}catch(t){this.dispatchEvent(new i(t))}return[]}async open(){this.#l&&(this.template=await this.#d()),this.templateId=this.filterController.getValue("template")??"";const t=this.filterController.getValue("dateRange");this.startDate=("custom"===t?this.filterController.getValue("startDate"):I.get(t)?.startDate())||"",this.endDate=("custom"===t?this.filterController.getValue("endDate"):I.get(t)?.endDate())||"",this.dialog.show()}static{this.styles=[s`
      :host {
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    `}};n([c({type:Boolean})],Y.prototype,"isActive",null),n([c({type:Object})],Y.prototype,"apiService",null),n([h()],Y.prototype,"filterController",null),n([h()],Y.prototype,"template",null),n([h()],Y.prototype,"templateId",null),n([h()],Y.prototype,"startDate",null),n([h()],Y.prototype,"endDate",null),n([d("md-dialog")],Y.prototype,"dialog",null),n([d("titanium-date-range-selector")],Y.prototype,"dateRangeSelect",null),Y=n([m("leavitt-email-history-view-list-filter-dialog")],Y);class z extends p{constructor(t){if(super(t),this.it=g,t.type!==u.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===g||null==t)return this._t=void 0,this.it=t;if(t===v)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const e=[t];return e.raw=e,this._t={_$litType$:this.constructor.resultType,strings:e,values:[]}}}z.directiveName="unsafeHTML",z.resultType=1;const B=f(z);let O=class extends(t(e)){#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#m;get emailTemplateLogId(){return this.#m}set emailTemplateLogId(t){this.#m=t}#p;get emailTemplateLog(){return this.#p}set emailTemplateLog(t){this.#p=t}#g;get snackbar(){return this.#g}set snackbar(t){this.#g=t}#n;get dialog(){return this.#n}set dialog(t){this.#n=t}#u;async open(t){return this.emailTemplateLogId=t,this.emailTemplateLog=null,this.dialog.returnValue="",await this.updateComplete,this.dialog.show(),this.emailTemplateLog=await this.#v(t),await new Promise(t=>{this.#u=t})}async#v(t){if(!this.apiService)return console.warn("No api service provided"),null;const e=[];try{const i=this.apiService.getAsync(`EmailTemplateLogs(${t})?${e.join("&")}`);this.loadWhile(i);const s=await i;return s?.entity}catch(t){this.dispatchEvent(new i(t))}return null}static{this.styles=[y,s`
      md-dialog {
        max-width: 750px;
        width: calc(100vw - 24px);
    ...
    `]}render(){return o`
      ...
      >
        ...
        ${this.isLoading?o`<main slot="content">Loading...</main>`:this.emailTemplateLog?o`<main slot="content" email-body>${B(this.emailTemplateLog?.EmailBody??"")}</main>`:o`<main slot="content">No email template log found</main>`}
    ...
    `}};n([c({type:Object})],O.prototype,"apiService",null),n([h()],O.prototype,"emailTemplateLogId",null),n([h()],O.prototype,"emailTemplateLog",null),n([d("titanium-snackbar-stack")],O.prototype,"snackbar",null),n([d("md-dialog")],O.prototype,"dialog",null),O=n([m("leavitt-view-sent-email-dialog")],O);let P=class extends(t(e)){#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#f;get emailTemplates(){return this.#f}set emailTemplates(t){this.#f=t}#g;get snackbar(){return this.#g}set snackbar(t){this.#g=t}#n;get dialog(){return this.#n}set dialog(t){this.#n=t}#u;async open(){return this.emailTemplates=[],this.dialog.returnValue="",await this.updateComplete,this.dialog.show(),this.emailTemplates=await this.#y(),await new Promise(t=>{this.#u=t})}async#y(){if(!this.apiService)return console.warn("No api service provided"),[];const t=["select=Id,Name,IsExpired,Description","orderby=Name","filter=not IsExpired"];try{const e=this.apiService.getAsync(`EmailTemplates?${t.join("&")}`);this.loadWhile(e);const i=await e;return i?.entities}catch(t){this.dispatchEvent(new i(t))}return[]}static{this.styles=[b,y,s`
      md-dialog {
        max-width: 750px;
        width: calc(100vw - 24px);
    ...
    `}};n([c({type:Object})],P.prototype,"apiService",null),n([h()],P.prototype,"emailTemplates",null),n([d("titanium-snackbar-stack")],P.prototype,"snackbar",null),n([d("md-dialog")],P.prototype,"dialog",null),P=n([m("leavitt-view-email-template-info-dialog")],P);let W=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#b;get path(){return this.#b}set path(t){this.#b=t}#$=[];get logs(){return this.#$}set logs(t){this.#$=t}#x=[];get selected(){return this.#x}set selected(t){this.#x=t}#w="";get searchTerm(){return this.#w}set searchTerm(t){this.#w=t}#_=0;get resultTotal(){return this.#_}set resultTotal(t){this.#_=t}#D="desc";get sortDirection(){return this.#D}set sortDirection(t){this.#D=t}#T="SentDate";get sortBy(){return this.#T}set sortBy(t){this.#T=t}#i;get filterController(){return this.#i}set filterController(t){this.#i=t}#S;get dataTable(){return this.#S}set dataTable(t){this.#S=t}#k;get viewDialog(){return this.#k}set viewDialog(t){this.#k=t}#E;get filterModal(){return this.#E}set filterModal(t){this.#E=t}#j;get viewEmailTemplateInfoDialog(){return this.#j}set viewEmailTemplateInfoDialog(t){this.#j=t}#C=!0;constructor(){super(),this.filterController=new C(""),this.filterController.setFilter("dateRange",()=>""),this.filterController.setFilter("startDate",()=>""),this.filterController.setFilter("endDate",()=>""),this.filterController.setFilter("template",t=>`EmailTemplateId eq ${t}`),this.filterController.subscribeToFilterChange(async()=>{this.isActive?(this.dataTable.resetPage(),this.#I()):this.#C=!0}),this.filterController.loadFromQueryString()}updated(t){this.isActive&&t.has("isActive")&&this.#C&&this.#I(),t.has("path")&&(this.filterController.path=this.path)}#I(){this.#R(this.searchTerm)}#A(t){this.sortDirection=t.detail,this.dataTable.resetPage(),this.#I()}#N(t){this.sortBy=t.detail,this.dataTable.resetPage(),this.#I()}#L=new N(t=>this.#R(t));renderRecipients(t,e=1){const i=t?.split(",").filter(t=>!!t).map(t=>t.trim()).reverse()??[];return i?.length>e?o`${$(i.slice(0,e),t=>t,t=>o`${t} <br />`)} <span more> ${i.length-e} more... </span>`:$(i,t=>t,t=>o`${t} <br />`)}async#R(t){if(!this.apiService)return void console.warn("No api service provided");let e=[];const s=L(t),a=s.map(t=>`(contains(Subject, '${t}') or contains(Recipients, '${t}'))`).join(" and ");s.length>0&&e.push(`${a}`);const l=this.filterController.getValue("dateRange"),r="custom"===l?this.filterController.getValue("startDate"):I.get(l)?.startDate(),o="custom"===l?this.filterController.getValue("endDate"):I.get(l)?.endDate();r&&e.push(`SentDate ge ${A(r).format("YYYY-MM-DD")}`),o&&e.push(`SentDate le ${A(o).format("YYYY-MM-DD")}`),e=[...e,...this.filterController.getActiveFilterOdata()];const n=["select=Id,Recipients,SentDate,Subject","expand=EmailTemplate(select=Id,Name,IsExpired)",`top=${await this.dataTable.getTake()}`,`orderby=${this.sortBy} ${this.sortDirection}`,"skip="+await this.dataTable.getTake()*await this.dataTable.getPage(),"count=true"];e.length>0&&n.push(`filter=${e.join(" and ")}`);try{const t=this.apiService.getAsync(`EmailTemplateLogs/?${n.join("&")}`);this.dataTable.loadWhile(t),this.loadWhile(t);const e=await t;this.resultTotal=e.odataCount,this.logs=e.toList(),this.#C=!1}catch(t){this.dispatchEvent(new i(t))}}static{this.styles=[x,w,s`
      :host {
        display: grid;
        ...
        ${$(this.logs??[],t=>t.Id,t=>o`
            <titanium-data-table-item disable-select .item=${t} slot="items">
              <row-item width="150px" ellipsis date
                >${t.SentDate?o`${A(t.SentDate).format("MMM DD, YY")}<br /><span time>${A(t.SentDate).format("h:mm A")}</span>`:"-"}</row-item
              >
    ...
    `}};async function V(t){let e=t;for(;e;){await(e?.updateComplete);const t=e.scrollContainer;if(null!=t)return t;e=e.parentElement??null}return null}n([c({type:Boolean})],W.prototype,"isActive",null),n([c({type:Object})],W.prototype,"apiService",null),n([c({type:String})],W.prototype,"path",null),n([h()],W.prototype,"logs",null),n([h()],W.prototype,"selected",null),n([h()],W.prototype,"searchTerm",null),n([h()],W.prototype,"resultTotal",null),n([h()],W.prototype,"sortDirection",null),n([h()],W.prototype,"sortBy",null),n([h()],W.prototype,"filterController",null),n([d("titanium-data-table")],W.prototype,"dataTable",null),n([d("leavitt-view-sent-email-dialog")],W.prototype,"viewDialog",null),n([d("leavitt-email-history-view-list-filter-dialog")],W.prototype,"filterModal",null),n([d("leavitt-view-email-template-info-dialog")],W.prototype,"viewEmailTemplateInfoDialog",null),W=n([m("leavitt-email-history-viewer")],W);let F=class extends e{#M=!1;get stickyTop(){return this.#M}set stickyTop(t){this.#M=t}#H=null;get scrollableParent(){return this.#H}set scrollableParent(t){this.#H=t}#Y;get level1Text(){return this.#Y}set level1Text(t){this.#Y=t}#z;get level1Href(){return this.#z}set level1Href(t){this.#z=t}#B;get level2Text(){return this.#B}set level2Text(t){this.#B=t}#O;get level2Href(){return this.#O}set level2Href(t){this.#O=t}#P;get level3Text(){return this.#P}set level3Text(t){this.#P=t}#W;get level3Href(){return this.#W}set level3Href(t){this.#W=t}#V;get level4Text(){return this.#V}set level4Text(t){this.#V=t}#F;get level4Href(){return this.#F}set level4Href(t){this.#F=t}#q=!1;get isScrolled(){return this.#q}set isScrolled(t){this.#q=t}#U=null;static{this.styles=[_,x,s`
      :host {
        display: grid;
        grid:
          'main gap trailing'
    ...
    `]}async connectedCallback(){super.connectedCallback();const t=await V(this);this.#U=this.scrollableParent||t,this.#U&&this.#U.addEventListener("scroll",this.#G.bind(this),!1)}async disconnectedCallback(){this.#U&&this.#U.removeEventListener("scroll",this.#G.bind(this),!1),super.disconnectedCallback()}async updated(t){if(t.has("scrollableParent")){this.#U?.removeEventListener("scroll",this.#G.bind(this),!1);const t=await V(this);this.#U=this.scrollableParent||t,this.#U&&this.#U.addEventListener("scroll",this.#G.bind(this),!1)}}#G(){this.isScrolled=(this.#U?.scrollTop||0)>0}render(){return o`
    ...
    `}};n([c({type:Boolean,reflect:!0,attribute:"sticky-top"})],F.prototype,"stickyTop",null),n([c({type:Object,attribute:"scrollable-parent"})],F.prototype,"scrollableParent",null),n([c({type:String})],F.prototype,"level1Text",null),n([c({type:String})],F.prototype,"level1Href",null),n([c({type:String})],F.prototype,"level2Text",null),n([c({type:String})],F.prototype,"level2Href",null),n([c({type:String})],F.prototype,"level3Text",null),n([c({type:String})],F.prototype,"level3Href",null),n([c({type:String})],F.prototype,"level4Text",null),n([c({type:String})],F.prototype,"level4Href",null),n([c({type:Boolean,reflect:!0,attribute:"is-scrolled"})],F.prototype,"isScrolled",null),F=n([m("leavitt-app-navigation-header")],F);let q=class extends e{#K=!1;get isOverflowed(){return this.#K}set isOverflowed(t){this.#K=t}#X="640px";get maxWidth(){return this.#X}set maxWidth(t){this.#X=t}#H=null;get scrollableParent(){return this.#H}set scrollableParent(t){this.#H=t}#Z=!1;get hasLeading(){return this.#Z}set hasLeading(t){this.#Z=t}#J=!1;get hasTrailing(){return this.#J}set hasTrailing(t){this.#J=t}#Q;get leadingElements(){return this.#Q}set leadingElements(t){this.#Q=t}#tt;get trailingElements(){return this.#tt}set trailingElements(t){this.#tt=t}#U=null;#et=null;async connectedCallback(){super.connectedCallback();const t=await V(this);this.#U=this.scrollableParent||t,this.#U&&(this.#et=new ResizeObserver(()=>{this.#it()}),this.#et.observe(this.#U))}disconnectedCallback(){this.#U&&this.#et?.disconnect(),super.disconnectedCallback()}async updated(t){if(t.has("scrollableParent")){this.#et?.disconnect();const t=await V(this);this.#U=this.scrollableParent||t,this.#U&&(this.#et=new ResizeObserver(()=>{this.#it()}),this.#et.observe(this.#U))}}isOverflown(t){return t.scrollHeight>t.clientHeight}#it(){this.#U&&(this.isOverflowed=this.isOverflown(this.#U))}static{this.styles=[s`
      :host {
        display: grid;
    ...
    `}};n([c({type:Boolean})],U.prototype,"isActive",null),n([c({type:Object})],U.prototype,"apiService",null),n([h()],U.prototype,"filterController",null),n([h()],U.prototype,"template",null),n([h()],U.prototype,"templateId",null),n([h()],U.prototype,"startDate",null),n([h()],U.prototype,"endDate",null),n([d("md-dialog")],U.prototype,"dialog",null),n([d("titanium-date-range-selector")],U.prototype,"dateRangeSelect",null),U=n([m("leavitt-email-history-viewer-filled-filter-dialog")],U);let G=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#b;get path(){return this.#b}set path(t){this.#b=t}#st="";get toolbarSearchTerm(){return this.#st}set toolbarSearchTerm(t){this.#st=t}#w="";get searchTerm(){return this.#w}set searchTerm(t){this.#w=t}#at=[];get items(){return this.#at}set items(t){this.#at=t}#x=[];get selected(){return this.#x}set selected(t){this.#x=t}#lt={uniqueKey:t=>t.Id?.toString()??"",itemMetaData:[{key:"SentDate",friendlyName:"Sent",render:t=>o`<div>
            ${t.SentDate?o`${A(t.SentDate).format("MMM DD, YY")}<br /><span time>${A(t.SentDate).format("h:mm A")}</span>`:"-"}
    ...
    `]}render(){return o`
      ...
      <leavitt-view-sent-email-dialog .apiService=${this.apiService}></leavitt-view-sent-email-dialog>
      <leavitt-view-email-template-info-dialog .apiService=${this.apiService}></leavitt-view-email-template-info-dialog>
    `}};n([c({type:Boolean})],G.prototype,"isActive",null),n([c({type:Object})],G.prototype,"apiService",null),n([c({type:String})],G.prototype,"path",null),n([c({type:String})],G.prototype,"toolbarSearchTerm",null),n([h()],G.prototype,"searchTerm",null),n([h()],G.prototype,"items",null),n([h()],G.prototype,"selected",null),n([h()],G.prototype,"tableMetaData",null),n([h()],G.prototype,"resultTotal",null),n([h()],G.prototype,"filterController",null),n([d("titanium-data-table-core")],G.prototype,"dataTable",null),n([d("leavitt-email-history-viewer-filled-filter-dialog")],G.prototype,"filterDialog",null),n([d("titanium-page-control")],G.prototype,"pageControl",null),n([d("leavitt-app-main-content-container")],G.prototype,"mainContentContainer",null),n([d("leavitt-view-sent-email-dialog")],G.prototype,"viewDialog",null),n([d("leavitt-view-email-template-info-dialog")],G.prototype,"viewEmailTemplateInfoDialog",null),G=n([m("leavitt-email-history-viewer-filled")],G);let K=class extends(H(e)){#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#ht;get demo1(){return this.#ht}set demo1(t){this.#ht=t}#dt;get demo2(){return this.#dt}set demo2(t){this.#dt=t}constructor(){super(),this.apiService=new k(E),this.apiService.baseUrl="https://devapi3.leavitt.com/",this.apiService.addHeader("X-LGAppName","EducationAdminV2")}static{this.styles=[_,y,s`
      :host {
        display: flex;
    ...
    `}};n([h()],K.prototype,"apiService",null),n([d("leavitt-email-history-viewer")],K.prototype,"demo1",null),n([d("leavitt-email-history-viewer-filled")],K.prototype,"demo2",null),K=n([m("leavitt-email-history-viewer-playground")],K);let X=class extends e{static{this.styles=[j,s``]}render(){return o`
    ...
    `}};X=n([m("leavitt-email-history-viewer-demo")],X);export{X as LeavittEmailHistoryViewerDemo};
