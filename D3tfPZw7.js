import{L as t,i as e,S as i,c as s,u as a,v as l,w as r,x as o,_ as n,n as c,r as h,e as d,t as m,y as p,E as g,z as u,T as v,B as f,p as y,a as b,D as $,k as x,b as w,h as _,F as D,H as T,P as S,A as k,d as j,G as E}from"./BF9KQ0mY.js";import{S as C}from"./DXaJJx1J.js";import"./iTE8CZYn.js";import{F as I}from"./DGNIJfvx.js";import"./DLJBUJr7.js";import"./wEL5MDqj.js";import"./Dy2cGRb8.js";import"./D57K8xkA.js";import{D as R,r as A}from"./CeUtpidu.js";import"./BthTaK6W.js";import"./BuKrzXxR.js";import{d as N}from"./fEBq_QNq.js";import{D as L}from"./DTS7lhmZ.js";import{g as M}from"./OXmljVLM.js";import"./BGYvjniv.js";import"./Bx9dlzGj.js";import"./DPg37U5c.js";import"./DD-GFxTs.js";import"./CiQrRD4v.js";import{n as H}from"./LVYw1ajr.js";import{T as z}from"./DDVBGAZ1.js";import"./CIYJjYuD.js";import"./BlOdz-y1.js";import"./DBI2Eh_k.js";import"./DDCTfBKc.js";import"./ibNYHw9C.js";import"./CNMGvOUD.js";import"./BFSatKRf.js";let Y=class extends(t(e)){#t;get isActive(){return this.#t}set isActive(t){this.#t=t}#e;get apiService(){return this.#e}set apiService(t){this.#e=t}#i;get filterController(){return this.#i}set filterController(t){this.#i=t}#s=[];get template(){return this.#s}set template(t){this.#s=t}#a;get templateId(){return this.#a}set templateId(t){this.#a=t}#l=!0;#r;get startDate(){return this.#r}set startDate(t){this.#r=t}#o;get endDate(){return this.#o}set endDate(t){this.#o=t}#n;get dialog(){return this.#n}set dialog(t){this.#n=t}#c;get dateRangeSelect(){return this.#c}set dateRangeSelect(t){this.#c=t}async firstUpdated(){this.filterController.subscribeToFilterChange(async()=>{this.#h(),this.requestUpdate("filterController")})}async updated(t){this.isActive&&t.has("isActive")&&this.#h()}async#h(){this.filterController.getValue("template")&&this.#l&&(this.template=await this.#d())}async#d(){if(!this.apiService)return console.warn("No api service provided"),[];const t=["select=Id,Name,IsExpired","orderby=Name"];try{const e=this.apiService.getAsync(`EmailTemplates?${t.join("&")}`);this.loadWhile(e);const i=(await e).toList();return this.#l=!1,i}catch(t){this.dispatchEvent(new i(t))}return[]}async open(){this.#l&&(this.template=await this.#d()),this.templateId=this.filterController.getValue("template")??"";const t=this.filterController.getValue("dateRange");this.startDate=("custom"===t?this.filterController.getValue("startDate"):R.get(t)?.startDate())||"",this.endDate=("custom"===t?this.filterController.getValue("endDate"):R.get(t)?.endDate())||"",this.dialog.show()}static{this.styles=[s`
    ...
    `]}#U=null;async connectedCallback(){super.connectedCallback(),this.#U=await F(this),this.#U&&this.#U.addEventListener("scroll",this.#q.bind(this),!1)}disconnectedCallback(){this.#U&&this.#U.removeEventListener("scroll",this.#q,!1),super.disconnectedCallback()}#q(){this.isScrolled=(this.#U?.scrollTop||0)>0}render(){return o`
    ...
    `}};n([c({type:Boolean,reflect:!0,attribute:"sticky-top"})],U.prototype,"stickyTop",null),n([c({type:String})],U.prototype,"level1Text",null),n([c({type:String})],U.prototype,"level1Href",null),n([c({type:String})],U.prototype,"level2Text",null),n([c({type:String})],U.prototype,"level2Href",null),n([c({type:String})],U.prototype,"level3Text",null),n([c({type:String})],U.prototype,"level3Href",null),n([c({type:String})],U.prototype,"level4Text",null),n([c({type:String})],U.prototype,"level4Href",null),n([c({type:Boolean,reflect:!0,attribute:"is-scrolled"})],U.prototype,"isScrolled",null),U=n([m("leavitt-app-navigation-header")],U);let q=class extends e{#G=!1;get isOverflowed(){return this.#G}set isOverflowed(t){this.#G=t}#K="640px";get maxWidth(){return this.#K}set maxWidth(t){this.#K=t}#X=null;get scrollableParent(){return this.#X}set scrollableParent(t){this.#X=t}#Z=!1;get hasLeading(){return this.#Z}set hasLeading(t){this.#Z=t}#J=!1;get hasTrailing(){return this.#J}set hasTrailing(t){this.#J=t}#Q;get leadingElements(){return this.#Q}set leadingElements(t){this.#Q=t}#tt;get trailingElements(){return this.#tt}set trailingElements(t){this.#tt=t}#U=null;#et=null;async connectedCallback(){super.connectedCallback(),this.#U=this.scrollableParent??await F(this),this.#U&&(this.#et=new ResizeObserver(()=>{this.#it()}),this.#et.observe(this.#U))}disconnectedCallback(){this.#U&&this.#et?.disconnect(),super.disconnectedCallback()}async updated(t){t.has("scrollableParent")&&(this.#et?.disconnect(),this.#U=this.scrollableParent??await F(this),this.#U&&(this.#et=new ResizeObserver(()=>{this.#it()}),this.#et.observe(this.#U)))}isOverflown(t){return t.scrollHeight>t.clientHeight}#it(){this.#U&&(this.isOverflowed=this.isOverflown(this.#U))}static{this.styles=[s`
      :host {
        display: grid;
