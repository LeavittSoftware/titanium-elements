import{E as e,g as t,L as i,i as s,P as o,S as r,c as a,x as l,_ as n,n as d,r as c,e as h,t as p,p as m,h as u,j as f,b as g,k as x,l as y,m as v,o as b,q as w,s as $,C as _,a as F,A as k,U as E}from"./BriKlvrl.js";import{S as C}from"./BYDhJ-qH.js";import"./Cl1zg2Ou.js";import"./doSzMn6v.js";import"./CoIpDvd9.js";import{d as N}from"./fEBq_QNq.js";import"./DDyV-Jf6.js";import"./c5f0ayQ_.js";function I(t,i){return t.map((s,o)=>[s,o<t.length-1?i:e])}const S=new t;Object.freeze(S);let z=class extends(i(s)){#e;get apiService(){return this.#e}set apiService(e){this.#e=e}#t;get fileExplorerId(){return this.#t}set fileExplorerId(e){this.#t=e}#i;get parentFolderId(){return this.#i}set parentFolderId(e){this.#i=e}#s="";get folderName(){return this.#s}set folderName(e){this.#s=e}#o;get dialog(){return this.#o}set dialog(e){this.#o=e}async open(){return this.folderName="",this.dialog.show(),new Promise(e=>{this.resolve=e})}async#r(){if(!this.apiService)return;const e={FileExplorerId:this.fileExplorerId,Name:this.folderName,ParentFolderId:this.parentFolderId||void 0};try{const t=this.apiService.postAsync("FileExplorerFolders?expand=CreatorPerson(select=FullName,ProfilePictureCdnFileName)",e);this.dispatchEvent(new o(t)),this.loadWhile(t);const i=(await t)?.entity;return{...i,CreatorProfilePictureCndFileName:i?.CreatorPerson?.ProfilePictureCdnFileName,CreatorFullName:i?.CreatorPerson?.FullName}}catch(e){this.dispatchEvent(new r(e))}return null}static{this.styles=a`
  ...
  `}render(){return l`
    ...
    `}};D=n([p("leavitt-file-explorer-no-files")],D);let M=class extends s{static{this.styles=[m,a`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};M=n([p("leavitt-file-explorer-error")],M);let P=class extends s{static{this.styles=[m,a`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};function A(e){return"pdf"===e||"txt"===e||"rtf"===e||"doc"===e||"docx"===e||"csv"===e?"article":"pptx"===e||"pptm"===e||"ppt"===e?"slideshow":"xlsx"===e||"xlsx"===e?"text_snippet":"jpg"===e||"jpeg"===e||"png"===e||"webp"===e||"ico"===e||"svg"===e?"photo":"mp4"===e?"movie":"article"}n([d({attribute:!1})],U.prototype,"apiService",null),n([d({type:Boolean})],U.prototype,"enableEditing",null),n([c()],U.prototype,"state",null),n([c()],U.prototype,"folder",null),n([c()],U.prototype,"folderName",null),n([h("md-dialog")],U.prototype,"dialog",null),U=n([p("leavitt-folder-modal")],U);let Y=class extends s{#f;get attachment(){return this.#f}set attachment(e){this.#f=e}static{this.styles=a`
    :host {
      user-select: none;
      display: flex;
      justify-content: center;
  ...
  `}render(){return l`
      ${this.attachment?.PreviewSizes?.includes("512")?l`<img draggable="false" loading="lazy" src=${b(w(this.attachment,512))} />`:l` <md-icon>${A(this.attachment?.Extension??"")}</md-icon>`}
    `}};function B(e,t=2){if(0===e)return"0 Bytes";const i=t||2,s=Math.floor(Math.log(e)/Math.log(1024));return parseFloat((e/Math.pow(1024,s)).toFixed(i))+" "+["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"][s]}n([d({type:Object})],Y.prototype,"attachment",null),Y=n([p("leavitt-file-explorer-image")],Y);let L=class extends s{#n;get file(){return this.#n}set file(e){this.#n=e}#g=!1;get selected(){return this.#g}set selected(e){this.#g=e}#x=0;get selectedCount(){return this.#x}set selectedCount(e){this.#x=e}#y="grid";get display(){return this.#y}set display(e){this.#y=e}static{this.styles=a`
    :host {
      display: grid;
    }
  ...
  `}render(){return l` <button
    ...
    >
      ...
      <file-name>
        <md-icon>${"list"===this.display&&this.selected?"check":A(this.file.Extension??"")}</md-icon>
...
${this.folder.FilesCount} file${1===this.folder.FilesCount?"":"s"}, ${this.folder.FoldersCount} folder${1===this.folder.FoldersCount?"":"s"}"
      ...
      <footer>
        ...
        ${this.isAdmin?l`
              <footer-actions>
                ...
                <input
                  folders
                  @change=${async()=>this.#T(this.folderInput.files)}
                  type="file"
                  webkitdirectory
                  directory
                  multiple
    ...
    `}};n([d({attribute:!1})],V.prototype,"apiService",null),n([d({type:Number,attribute:"file-explorer-id"})],V.prototype,"fileExplorerId",null),n([d({type:Number,attribute:"folder-id"})],V.prototype,"folderId",null),n([d({type:String,attribute:"local-storage-display-key"})],V.prototype,"localStorageDisplayKey",null),n([d({type:Boolean,reflect:!0,attribute:"prevent-navigation-up"})],V.prototype,"preventNavigationUp",null),n([d({type:String,reflect:!0,attribute:"display"})],V.prototype,"display",null),n([d({type:String})],V.prototype,"state",null),n([c()],V.prototype,"isAdmin",null),n([c()],V.prototype,"fileExplorer",null),n([c()],V.prototype,"files",null),n([c()],V.prototype,"folders",null),n([c()],V.prototype,"path",null),n([c()],V.prototype,"selected",null),n([h("md-menu[upload-menu]")],V.prototype,"uploadMenu",null),n([h("leavitt-folder-modal")],V.prototype,"folderDialog",null),n([h("leavitt-add-folder-modal")],V.prototype,"addFolderDialog",null),n([h("leavitt-file-modal")],V.prototype,"fileDialog",null),n([h("input[files]")],V.prototype,"fileInput",null),n([h("input[folders]")],V.prototype,"folderInput",null),n([h("titanium-confirm-dialog")],V.prototype,"confirmDialog",null),V=n([p("leavitt-file-explorer")],V);let q=class extends s{static{this.styles=[u,m,a`
      :host {
        display: flex;
        flex-direction: column;
        margin: 24px 12px;
      }
    `]}constructor(){super(),this.fileExplorerApiService=new k(E),this.fileExplorerApiService.baseUrl="https://devapi3.leavitt.com/",this.fileExplorerApiService.addHeader("X-LGAppName","FileExplorer")}render(){return l`
      <leavitt-file-explorer file-explorer-id="1" .apiService=${this.fileExplorerApiService}></leavitt-file-explorer>
      <titanium-snackbar-stack></titanium-snackbar-stack>
    `}};n([c()],q.prototype,"fileExplorerApiService",void 0),q=n([p("leavitt-file-explorer-playground")],q);let W=class extends s{static{this.styles=[C,a``]}render(){return l`
    ...
    `}};W=n([p("leavitt-file-explorer-demo")],W);export{W as LeavittUserFileExplorerDemo};
