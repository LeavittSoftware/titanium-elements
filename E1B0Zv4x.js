import{h as t,a as e,p as i,i as n,k as a,_ as u,r as o,e as d,t as s}from"./CzHvl5jm.js";import{S as l}from"./CYtDMjId.js";import"./BngvSuhr.js";import"./u8AVqufc.js";import"./DtBbzv6O.js";let r=class extends t{#t;get input(){return this.#t}set input(t){this.#t=t}#e;get value(){return this.#e}set value(t){this.#e=t}static{this.styles=[e,i,n`
      :host {
        display: flex;
    ...
    `}};u([d("titanium-date-input[demo1]")],r.prototype,"input",null),u([o()],r.prototype,"value",null),r=u([s("titanium-date-input-playground")],r);let m=class extends t{static{this.styles=[l,n``]}render(){return a`
    ...
    `}};m=u([s("titanium-date-input-demo")],m);export{m as TitaniumDateInputItemDemo};
