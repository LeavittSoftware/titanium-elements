import{s as t,g as i,i as e,x as n,_ as a,n as o,A as s,t as l,h as r,p as c}from"./d0ace671.js";import{S as h}from"./9e8552c1.js";import"./41178c5b.js";import"./ec341a4d.js";let p=class extends t{#t;get label(){return this.#t}set label(t){this.#t=t}#i;get selected(){return this.#i}set selected(t){this.#i=t}#e;get inputChip(){return this.#e}set inputChip(t){this.#e=t}#n="close";get inputChipRemoveIcon(){return this.#n}set inputChipRemoveIcon(t){this.#n=t}#a=!1;get disabled(){return this.#a}set disabled(t){this.#a=t}#o=!1;get hasLeadingItems(){return this.#o}set hasLeadingItems(t){this.#o=t}#s=!1;get hasTrailingItems(){return this.#s}set hasTrailingItems(t){this.#s=t}static{this.styles=[i,e`
      :host {
        display: grid;
        height: 32px;
        width: auto;
    ...
    `]}render(){return n`<button part="button">
    ...
    </button>`}};a([o({type:String})],p.prototype,"label",null),a([o({type:Boolean,reflect:!0})],p.prototype,"selected",null),a([o({type:Boolean,reflect:!0,attribute:"input-chip"})],p.prototype,"inputChip",null),a([o({type:String})],p.prototype,"inputChipRemoveIcon",null),a([o({type:Boolean,reflect:!0})],p.prototype,"disabled",null),a([o({type:Boolean,reflect:!0,attribute:"has-leading-items"})],p.prototype,"hasLeadingItems",null),a([o({type:Boolean,reflect:!0,attribute:"has-trailing-items"})],p.prototype,"hasTrailingItems",null),a([s({slot:"icon"})],p.prototype,"leadingSlotElements",void 0),a([s({slot:"trailing"})],p.prototype,"trailingSlotElements",void 0),p=a([l("titanium-chip")],p);let d=class extends t{static{this.styles=[r,c,e`
      :host {
        display: flex;
        flex-direction: row;
        flex-wrap: wrap;
