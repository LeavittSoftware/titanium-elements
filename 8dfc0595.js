...
`;let p=class extends u{};p.styles=[g],p=i([o("md-circular-progress")],p);let m=class extends(d(a)){constructor(){super(...arguments),this.#t=[],this.#r=[],this.#e="Single select",this.#i="Search for a entity",this.#o=null,this.#s=!1,this.#a=!1,this.#n=!1,this.#c="Name",this.positioning="popover"}#l;get searchTerm(){return this.#l}set searchTerm(t){this.#l=t}#t;get suggestions(){return this.#t}set suggestions(t){this.#t=t}#r;get defaultSuggestions(){return this.#r}set defaultSuggestions(t){this.#r=t}#d;get menu(){return this.#d}set menu(t){this.#d=t}#h;get textfield(){return this.#h}set textfield(t){this.#h=t}#e;get label(){return this.#e}set label(t){this.#e=t}#i;get placeholder(){return this.#i}set placeholder(t){this.#i=t}#o;get selected(){return this.#o}set selected(t){this.#o=t}#s;get disabled(){return this.#s}set disabled(t){this.#s=t}#a;get error(){return this.#a}set error(t){this.#a=t}#u;get errorText(){return this.#u}set errorText(t){this.#u=t}#n;get required(){return this.#n}set required(t){this.#n=t}#g;get prefixText(){return this.#g}set prefixText(t){this.#g=t}#p;get suffixText(){return this.#p}set suffixText(t){this.#p=t}#m;get hasLeadingIcon(){return this.#m}set hasLeadingIcon(t){this.#m=t}#f;get hasTrailingIcon(){return this.#f}set hasTrailingIcon(t){this.#f=t}#v;get disableMenuOpenOnFocus(){return this.#v}set disableMenuOpenOnFocus(t){this.#v=t}#x;get supportingText(){return this.#x}set supportingText(t){this.#x=t}#_;get textDirection(){return this.#_}set textDirection(t){this.#_=t}#c;get pathToSelectedText(){return this.#c}set pathToSelectedText(t){this.#c=t}#b;get count(){return this.#b}set count(t){this.#b=t}async firstUpdated(){if(this.textfield&&this.required){const t=this.textfield?.checkValidity;this.textfield.checkValidity=()=>!!this.selected&&t.bind(this.textfield)}}update(t){t.has("positioning")&&"popover"===this.positioning&&!this.showPopover&&(this.positioning="fixed"),super.update(t)}setCustomValidity(t){this.textfield?.setCustomValidity(t)}async reset(){this.softReset(),this.selected=null,this.textfield&&(this.textfield.error=!1,this.textfield.errorText="",this.textfield.reset())}softReset(){this.searchTerm="",this.suggestions=[]}async select(){this.textfield?.select()}async focus(){this.textfield?.focus()}checkValidity(){return this.textfield?.checkValidity()&&this.customCheckValidity()}reportValidity(){return this.textfield?.reportValidity()&&this.customReportValidity()}customCheckValidity(){return this.errorText="Please fill out this field",!(!this.selected&&this.textfield?.value)&&(!this.required&&!this.selected||!!this.selected)}customReportValidity(){return this.customCheckValidity()?(this.error=!1,this.errorText=""):this.error=!0,!this.error}async setSelected(t){const r=this.selected;this.selected=t,this.selected&&(this.softReset(),setTimeout((()=>{this.reportValidity()}),0)),r?.Id!==this.selected?.Id&&this.dispatchEvent(new Event("selected"))}onInputChanged(t){console.log(t)}async showSuggestions(t,r){this.suggestions=t,this.count=r,await this.updateComplete,this.menu.show()}async#y(t){!t&&this.defaultSuggestions.length||this.menu.close(),this.setSelected(null),this.suggestions=t?[]:this.defaultSuggestions,this.count=t?0:this.defaultSuggestions.length,this.searchTerm=t,await this.updateComplete,this.onInputChanged(t)}static{this.styles=[e`
    ...
    `]}renderSuggestion(t){return r`<md-menu-item .item=${t} ?selected=${this.selected?.Id===t.Id}>
    ...
    </md-menu-item>`}renderSelectedLeadingInputSlot(t){}#T(){return r`<div slot="trailing-icon">
      ...
      <md-outlined-text-field
        ...
        @input=${async t=>this.#y(t.target.value)}
      ...
      >
        ${this.selected?this.renderSelectedLeadingInputSlot(this.selected):this.renderLeadingInputSlot()} ${this.#T()}
      </md-outlined-text-field>
      <md-menu
        suggestions
        @opening=${t=>h(this,t)}
    ...
    `}};i([s()],m.prototype,"searchTerm",null),i([s()],m.prototype,"suggestions",null),i([s()],m.prototype,"defaultSuggestions",null),i([n("md-menu[suggestions]")],m.prototype,"menu",null),i([n("md-outlined-text-field")],m.prototype,"textfield",null),i([c({type:String})],m.prototype,"label",null),i([c({type:String})],m.prototype,"placeholder",null),i([c({type:Object})],m.prototype,"selected",null),i([c({type:Boolean})],m.prototype,"disabled",null),i([c({type:Boolean})],m.prototype,"error",null),i([c({type:String})],m.prototype,"errorText",null),i([c({type:Boolean})],m.prototype,"required",null),i([c({type:String})],m.prototype,"prefixText",null),i([c({type:String})],m.prototype,"suffixText",null),i([c({type:Boolean})],m.prototype,"hasLeadingIcon",null),i([c({type:Boolean})],m.prototype,"hasTrailingIcon",null),i([c({type:Boolean,attribute:"disable-menu-open-on-focus"})],m.prototype,"disableMenuOpenOnFocus",null),i([c({type:String})],m.prototype,"supportingText",null),i([c({type:String})],m.prototype,"textDirection",null),i([c({type:String})],m.prototype,"pathToSelectedText",null),i([c()],m.prototype,"positioning",void 0),i([s()],m.prototype,"count",null),m=i([o("titanium-single-select-base")],m);export{m as T};
