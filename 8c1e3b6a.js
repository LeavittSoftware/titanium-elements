import{i as t,x as e,T as i,_ as o,n as l,t as n}from"./d0ace671.js";import{E as s}from"./ebc3e1dc.js";let d=class extends s{#t=!1;get hideClearButton(){return this.#t}set hideClearButton(t){this.#t=t}#e=!1;get preventCollapse(){return this.#e}set preventCollapse(t){this.#e=t}#i=!0;get hasValue(){return this.#i}set hasValue(t){this.#i=t}async updated(t){t.has("value")&&(this.hasValue=!!this.value)}static{this.styles=t`
    :host {
      display: block;
      cursor: pointer;
      overflow: hidden;
