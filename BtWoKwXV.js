import{i as e,p as t,m as i,c as r,E as s,x as a,B as o,_ as l,n,r as p,t as u,h as c}from"./-Qu_smub.js";import{S as m}from"./cOSQ4pB9.js";import"./BUX6rFny.js";import"./DI_DkRUs.js";let h=class extends e{#e;get people(){return this.#e}set people(e){this.#e=e}#t=5;get max(){return this.#t}set max(e){this.#t=e}#i=!1;get enableDirectoryHref(){return this.#i}set enableDirectoryHref(e){this.#i=e}#r=!1;get showFullName(){return this.#r}set showFullName(e){this.#r=e}#s=!1;get autoResize(){return this.#s}set autoResize(e){this.#s=e}#a=30;get size(){return this.#a}set size(e){this.#a=e}#o=8;get overlap(){return this.#o}set overlap(e){this.#o=e}#l=0;get autoMax(){return this.#l}set autoMax(e){this.#l=e}#n;updated(e){e.has("autoResize")&&(this.autoResize?this.#p():this.#n?.disconnect?.()),e.has("overlap")&&this.style.setProperty("--profile-picture-stack-overlap",`${this.overlap}px`)}#p(){this.#n=new ResizeObserver(e=>{for(const t of e)this.autoMax=this.#u(this.size,this.overlap,t?.contentBoxSize?.[0]?.inlineSize||0)}),this.#n.observe(this)}#u(e,t,i){return i<e?0:Math.floor((i-e)/(e-t))}static{this.styles=[t,i,r`
      :host {
        display: flex;
