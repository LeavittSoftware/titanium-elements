...
`;let U=class extends O{};U.styles=[E],U=r([c("md-switch")],U);class F{constructor(e,t,a=null){this.key=e,this.oDataFilter=t,this.value=a}getOdataFilter(){return null===this.value?null:this.oDataFilter(this.value)}}function H(e,t){if(e instanceof RegExp)return{keys:!1,pattern:e};var a,s,i,r,o=[],l="",n=e.split("/");for(n[0]||n.shift();i=n.shift();)"*"===(a=i[0])?(o.push(a),l+="?"===i[1]?"(?:/(.*))?":"/(.*)"):":"===a?(s=i.indexOf("?",1),r=i.indexOf(".",1),o.push(i.substring(1,~s?s:~r?r:i.length)),l+=~s&&!~r?"(?:/([^/]+?))?":"/([^/]+?)",~r&&(l+=(~s?"?":"")+"\\"+i.substring(r))):l+="/"+i;return{keys:o,pattern:new RegExp("^"+l+"/?$","i")}}class L{#_=new Map;#A=[];#C;get path(){return this.#C}set path(e){this.#C=e}subscribeToFilterChange(e){this.#A.push(e)}unsubscribeFromFilterChange(e){this.#A=this.#A.filter(t=>t!=e)}#T(){this.#A.forEach(e=>e())}constructor(e){this.path=e;const t=history.pushState.bind(history);history.pushState=(...e)=>{t(...e);H(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()};const a=history.replaceState.bind(history);history.replaceState=(...e)=>{a(...e);H(this.path).pattern.test(window.location.pathname)&&this.loadFromQueryString()}}loadFromQueryString(){const e=new URLSearchParams(location.search);let t=!1;return this.#_.forEach(a=>{let s=null;e.has(a.key)&&(s=e.get(a.key)),a.value!==s&&(a.value=s,t=!0)}),t&&this.#T(),t}get filters(){return Array.from(this.#_.values())}getActiveFilterOdata(){const e=[];return this.filters.forEach(t=>{const a=t.getOdataFilter();a&&e.push(a)}),e}setValue(e,t){if(this.#_.has(e)){const a=this.#_.get(e);a&&a?.value!==t&&(a.value=t,this.#z())}}getValue(e){if(!this.#_.has(e))return null;const t=this.#_.get(e);return t?.value}setFilter(e,t,a=null){this.#_.set(e,new F(e,t,a))}getFilter(e){return this.#_.get(e)}#N;#z(){clearTimeout(this.#N),this.#P(),this.#N=window.setTimeout(()=>{this.#T()},50)}#P(){const e=new URLSearchParams(location.search);this.#_.forEach(t=>{void 0!==t.value&&null!==t.value?e.set(t.key,String(t.value)):e.has(t.key)&&e.delete(t.key)});const t=`${location.pathname}?${e}`;window.history.replaceState({path:t},"",t)}}const W=[{Name:"Model 3",Appearance:"Slick"},{Name:"Model X",Appearance:"Slick"},{Name:"Model Y",Appearance:"Slick"},{Name:"Model S",Appearance:"Slick"},{Name:"Cybertruck",Appearance:"Ugly"},{Name:"Tesla Semi",Appearance:"Ugly"},{Name:"Model X Plaid",Appearance:"Plaid"},{Name:"Model S Plaid",Appearance:"Plaid"},{Name:"Model S Plaid+",Appearance:"Plaid"},{Name:"Gen. 2 Roadster",Appearance:"Slick"}];let K=class extends e{#M=[];get allItems(){return this.#M}set allItems(e){this.#M=e}#r=[];get items(){return this.#r}set items(e){this.#r=e}#d=[];get selected(){return this.#d}set selected(e){this.#d=e}#o="";get searchTerm(){return this.#o}set searchTerm(e){this.#o=e}#D=0;get resultTotal(){return this.#D}set resultTotal(e){this.#D=e}#j="asc";get sortDirection(){return this.#j}set sortDirection(e){this.#j=e}#B="Name";get sortBy(){return this.#B}set sortBy(e){this.#B=e}#I;get filterController(){return this.#I}set filterController(e){this.#I=e}#l=!1;get singleSelect(){return this.#l}set singleSelect(e){this.#l=e}#n=!1;get disableSelect(){return this.#n}set disableSelect(e){this.#n=e}#c=!1;get disablePaging(){return this.#c}set disablePaging(e){this.#c=e}#R;get dataTable(){return this.#R}set dataTable(e){this.#R=e}#O;get filterModal(){return this.#O}set filterModal(e){this.#O=e}constructor(){super(),this.filterController=new L("/titanium-data-table"),this.filterController.setFilter("Appearance",e=>`BasketId eq ${e}`),this.filterController.subscribeToFilterChange(async()=>{this.dataTable&&(this.dataTable?.resetPage(),this.#E())}),this.filterController.loadFromQueryString()}firstUpdated(){this.#U(),this.items=this.allItems.slice(0)}#E(){this.getItemsAsync(this.searchTerm)}#U(){this.allItems=W.map(e=>({Name:e.Name,Appearance:e.Appearance})),this.#E()}#F(e){this.sortDirection=e.detail,this.dataTable.resetPage(),this.#E()}#H(e){this.sortBy=e.detail,this.dataTable.resetPage(),this.#E()}#L=new P(e=>this.getItemsAsync(e));async getItemsAsync(e){const t=N(e),a=await this.dataTable.getTake(),s=await this.dataTable.getPage(),i="asc"===this.sortDirection?1:-1;let r=this.allItems.filter(e=>t.every(t=>e.Name?.trim().toLowerCase()?.includes(t.trim().toLowerCase())));const o=this.filterController.getValue("Appearance");o&&(r=r.filter(e=>e.Appearance===o)),this.items=r.slice(0).sort((e,t)=>e[this.sortBy]===t[this.sortBy]?0:(e[this.sortBy]??"")<(t[this.sortBy]??"")?i:-i).slice(a*s,a*s+a),this.resultTotal=r.length}static{this.styles=[t,d,h,s`
    ...
    `]}render(){return i`
      ...
      <md-icon-button
        ...
        @click=${()=>{const e=W[this.allItems.length%W.length],t={Name:e.Name,Appearance:e.Appearance};this.allItems.push(t),this.#E()}}>
    ...
    `}};r([n()],K.prototype,"allItems",null),r([n()],K.prototype,"items",null),r([n()],K.prototype,"selected",null),r([n()],K.prototype,"searchTerm",null),r([n()],K.prototype,"resultTotal",null),r([n()],K.prototype,"sortDirection",null),r([n()],K.prototype,"sortBy",null),r([n()],K.prototype,"filterController",null),r([n()],K.prototype,"singleSelect",null),r([n()],K.prototype,"disableSelect",null),r([n()],K.prototype,"disablePaging",null),r([l("titanium-data-table")],K.prototype,"dataTable",null),r([l("data-table-demo-filter-modal")],K.prototype,"filterModal",null),K=r([c("titanium-data-table-full-playground")],K);let G=class extends e{#I;get filterController(){return this.#I}set filterController(e){this.#I=e}#W;get appearance(){return this.#W}set appearance(e){this.#W=e}#K;get dialog(){return this.#K}set dialog(e){this.#K=e}async firstUpdated(){this.filterController.subscribeToFilterChange(async()=>{this.requestUpdate("filterController")})}async open(){this.dialog.show()}#G(){const e=this.dialog.shadowRoot?.querySelector("dialog"),t=e?.querySelector(".container"),a=t?.querySelector(".scroller");a&&(a.style.overflow="initial"),t&&(t.style.overflow="initial")}#q(){const e=this.dialog.shadowRoot?.querySelector("dialog"),t=e?.querySelector(".container"),a=t?.querySelector(".scroller");a&&(a.style.overflow=""),t&&(t.style.overflow="")}static{this.styles=[s`
      :host {
        display: flex;
        flex-wrap: wrap;
        align-items: center;
    ...
    `}};r([n()],G.prototype,"filterController",null),r([n()],G.prototype,"appearance",null),r([l("md-dialog")],G.prototype,"dialog",null),G=r([c("data-table-demo-filter-modal")],G);let q=class extends e{static{this.styles=[A,s``]}render(){return i`
