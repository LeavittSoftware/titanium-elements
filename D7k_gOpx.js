import{r as t,h as e,p as i,i as s,x as l,B as n,_ as o,d as a,e as d,t as r}from"./jlnXwjN8.js";import{S as u}from"./B3_5_T76.js";import"./CZXsZd7R.js";const m=["Dog","Cat","Lion","Hedgehog","Turtle","Monkey","Owl","Peacock","Pigeon","Spider","Tortoise","Zebra"];let c=class extends t{#t=m.slice(0,4);get demoItems(){return this.#t}set demoItems(t){this.#t=t}#e=!1;get disabled(){return this.#e}set disabled(t){this.#e=t}#i="Service animals are welcome.";get supportingText(){return this.#i}set supportingText(t){this.#i=t}#s;get titaniumChipMultiSelect(){return this.#s}set titaniumChipMultiSelect(t){this.#s=t}static{this.styles=[e,i,s`
      :host {
        display: flex;
