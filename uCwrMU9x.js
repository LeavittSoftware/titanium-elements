import{i as t,k as i,c as e,x as n,E as a,_ as l,n as o,G as s,t as c,h as r,p as h}from"./BriKlvrl.js";import{S as d}from"./BYDhJ-qH.js";import"./B5dYKavm.js";let p=class extends t{constructor(){super(...arguments),this.href="",this.download="",this.target="",this.#t="close",this.#i=!1,this.#e=!1,this.#n=!1,this.#a=!1}#l;get label(){return this.#l}set label(t){this.#l=t}#o;get selected(){return this.#o}set selected(t){this.#o=t}#s;get inputChip(){return this.#s}set inputChip(t){this.#s=t}#c;get nonInteractive(){return this.#c}set nonInteractive(t){this.#c=t}#t;get inputChipRemoveIcon(){return this.#t}set inputChipRemoveIcon(t){this.#t=t}#i;get disabled(){return this.#i}set disabled(t){this.#i=t}#e;get filled(){return this.#e}set filled(t){this.#e=t}#n;get hasLeadingItems(){return this.#n}set hasLeadingItems(t){this.#n=t}#a;get hasTrailingItems(){return this.#a}set hasTrailingItems(t){this.#a=t}static{this.styles=[i,e`
      :host {
        display: grid;
        height: 32px;
        width: auto;
