import{i,b as t,c as e,_ as a,r as o,e as n,t as r}from"./D-PdOFNH.js";import{S as s}from"./-nlQtSV8.js";import"./Cf3bE9pS.js";import"./Br0ktJq7.js";import{C as m}from"./Clj5KWzE.js";let d=class extends i{#i=!1;get confirmed(){return this.#i}set confirmed(i){this.#i=i}#t;get confirmDialog(){return this.#t}set confirmDialog(i){this.#t=i}async#e(){const i=new m("Confirm delete?","Are you sure you would like to delete the universe? Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Turpis massa tincidunt dui ut ornare. Ut tortor pretium viverra suspendisse potenti nullam. Dolor morbi non arcu risus. Porttitor rhoncus dolor purus non. Vitae justo eget magna fermentum iaculis eu non diam. Pretium quam vulputate dignissim suspendisse in est ante in. Semper quis lectus nulla at volutpat. Id volutpat lacus laoreet non curabitur gravida arcu ac tortor. Orci dapibus ultrices in iaculis.");this.dispatchEvent(i),this.confirmed=await i.dialogResult}firstUpdated(){this.addEventListener(m.eventType,async i=>{await import("./Clj5KWzE.js").then(function(i){return i.c}),this.confirmDialog.handleEvent(i)})}static{this.styles=[s,t`
      h3 {
        margin-bottom: 12px;
      }
    `]}render(){return e`
