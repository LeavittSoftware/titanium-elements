import{x as e,S as t,c as s,_ as a,n as i,t as o,i as l,A as r,d as n,h as c,p as d,r as p,e as m,f as h,G as u,E as g}from"./DozyzFHA.js";import{S as y}from"./BfdpRqvS.js";import"./BDVeJ6T9.js";import"./DoQo2N7-.js";import{F as b}from"./CkDJilkW.js";import{T as v}from"./BFY8byxP.js";import{D as S}from"./DTS7lhmZ.js";import{g as x}from"./wLIUKFBh.js";import{T as $}from"./ri41u_fe.js";import"./Dv1n3xXv.js";let f=class extends v{#e="Company";get label(){return this.#e}set label(e){this.#e=e}#t="Search for a company";get placeholder(){return this.#t}set placeholder(e){this.#t=e}#s="Name";get pathToSelectedText(){return this.#s}set pathToSelectedText(e){this.#s=e}#a=[];get companies(){return this.#a}set companies(e){this.#a=e}#i;get apiService(){return this.#i}set apiService(e){this.#i=e}#o=!1;get disableAutoLoad(){return this.#o}set disableAutoLoad(e){this.#o=e}#l=["orderby=Name","select=Name,ShortName,MarkUrl,DarkMarkUrl,Id"];get odataParts(){return this.#l}set odataParts(e){this.#l=e}#r="Companies";get apiControllerName(){return this.#r}set apiControllerName(e){this.#r=e}#n="off";get autocomplete(){return this.#n}set autocomplete(e){this.#n=e}#c=!1;get spellcheck(){return this.#c}set spellcheck(e){this.#c=e}#d=t=>e`<md-menu-item .item=${t}>
      <slot name="trailing-icon" slot="trailing-icon"></slot>
      <span slot="headline">${t.Name}</span>
      <span slot="supporting-text">${t.ShortName||"-"}</span>
      <img loading="lazy" company-mark slot="start" src=${x(t,this.themePreference)} />
    ...
    `]}#h=new S(e=>this.#u(e));#g=new AbortController;async#u(e){this.#g.abort(),this.#g=new AbortController;const t={includeScore:!0,keys:["Name","ShortName"],shouldSort:!0,ignoreLocation:!0,threshold:.3};if(this.searchTerm){const s=new b(this.companies,t).search(e);this.showSuggestions(s.map(e=>e.item).slice(0,15),s.length)}}onInputChanged(e){this.#h.debounce(e)}renderSelectedLeadingInputSlot(t){return e` <img leading slot="leading-icon" src=${x(t,this.themePreference)} />`}renderSuggestion(e){return this.renderMenuItemContentTemplate(e)}};a([i({type:String})],f.prototype,"label",null),a([i({type:String})],f.prototype,"placeholder",null),a([i({type:String})],f.prototype,"pathToSelectedText",null),a([i({type:Array})],f.prototype,"companies",null),a([i({attribute:!1})],f.prototype,"apiService",null),a([i({type:Boolean})],f.prototype,"disableAutoLoad",null),a([i({type:Array})],f.prototype,"odataParts",null),a([i({type:String})],f.prototype,"apiControllerName",null),a([i({reflect:!0,type:String})],f.prototype,"autocomplete",null),a([i({reflect:!0,type:Boolean})],f.prototype,"spellcheck",null),a([i({type:Object})],f.prototype,"renderMenuItemContentTemplate",null),f=a([o("leavitt-company-select")],f);let _=class extends($(l)){#i;get apiService(){return this.#i}set apiService(e){this.#i=e}#y=!1;get disableMenuOpenOnFocus(){return this.#y}set disableMenuOpenOnFocus(e){this.#y=e}#b;get methodsSelect(){return this.#b}set methodsSelect(e){this.#b=e}#v;get inputs(){return this.#v}set inputs(e){this.#v=e}constructor(){super(),this.apiService=new r(new n),this.apiService.baseUrl="https://devapi3.leavitt.com/",this.apiService.addHeader("X-LGAppName","Testing")}static{this.styles=[c,d,s`
      :host {
        display: flex;
    ...
    `}};a([p()],_.prototype,"apiService",null),a([p()],_.prototype,"disableMenuOpenOnFocus",null),a([m("leavitt-company-select[methods-demo]")],_.prototype,"methodsSelect",null),a([h("leavitt-company-select")],_.prototype,"inputs",null),_=a([o("leavitt-company-select-playground")],_);let k=class extends l{#S=null;get refreshToken(){return this.#S}set refreshToken(e){this.#S=e}static{this.styles=[y,s``]}async firstUpdated(){const e=await u();await e.authenticateAsync(),this.refreshToken=window.localStorage.getItem("LG-AUTH-RT")}render(){return e`
    ...
    `}};a([p()],k.prototype,"refreshToken",null),k=a([o("leavitt-company-select-demo")],k);export{k as LeavittCompanySelectDemo};
