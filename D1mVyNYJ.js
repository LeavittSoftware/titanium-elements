...
`;u.styleSheet;let v=class extends r{getRenderClasses(){return{...super.getRenderClasses(),outlined:!0}}};v.styles=[o,u],v=t([i("md-outlined-icon-button")],v);let p=class extends a{#e="";get filledIconSelected(){return this.#e}set filledIconSelected(e){this.#e=e}#o;get filledValidators(){return this.#o}set filledValidators(e){this.#o=e}static{this.styles=[s,e`
            ...
            <div>
              ...
              <section buttons>
                ...
                <md-filled-tonal-button
                  @click=${()=>this.dispatchEvent(new l(`Check Validity is ${Array.from(this.filledValidators).map(e=>e.checkValidity())}`))}
                >
    ...
    `}};t([n()],p.prototype,"filledIconSelected",null),t([c("titanium-filled-input-validator")],p.prototype,"filledValidators",null),p=t([i("titanium-input-validator-demo")],p);export{p as TitaniumInputValidatorDemo};
