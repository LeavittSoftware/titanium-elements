import{i as t,b as e,A as i,s,c as a,_ as l,n,u as r,t as o,S as h,v as c,w as d,x as m,d as p,r as g,e as u,q as v,p as f,y as w,z as b,B as y,C as x,D as $,F as _,G as T,P as S,g as D,a as k,T as C,H as E}from"./BBslpa0R.js";import{A as L,S as N}from"./DCcDto7J.js";import{f as F}from"./27LYmq_e.js";import"./CKpbYwcJ.js";import{n as j}from"./C_Nxz0Ck.js";import"./B06KsFh_.js";import{D as I,r as A}from"./F4l0nwrC.js";import"./8C8D4GeV.js";import"./CYgcybcL.js";import{g as M}from"./OXmljVLM.js";import{D as R}from"./DTS7lhmZ.js";import{d as P}from"./CuDVc1pF.js";import{a as O}from"./DidIV4XK.js";import"./CyhS4dNd.js";import"./sEvpWrqd.js";import"./By2_9INO.js";import"./CR5Fz5DO.js";let z=class extends t{#t=!1;get isOverflowed(){return this.#t}set isOverflowed(t){this.#t=t}#e="640px";get maxWidth(){return this.#e}set maxWidth(t){this.#e=t}#i=null;get scrollableParent(){return this.#i}set scrollableParent(t){this.#i=t}#s=!1;get hasLeading(){return this.#s}set hasLeading(t){this.#s=t}#a=!1;get hasTrailing(){return this.#a}set hasTrailing(t){this.#a=t}#l=!1;get hasMain(){return this.#l}set hasMain(t){this.#l=t}#n;get leadingElements(){return this.#n}set leadingElements(t){this.#n=t}#r;get trailingElements(){return this.#r}set trailingElements(t){this.#r=t}#o;get mainElements(){return this.#o}set mainElements(t){this.#o=t}#h=null;#c=null;async connectedCallback(){super.connectedCallback();const t=await F(this);this.#h=this.scrollableParent||t,this.#h&&(this.#c=new ResizeObserver(()=>{this.#d()}),this.#c.observe(this.#h))}disconnectedCallback(){this.#h&&this.#c?.disconnect(),super.disconnectedCallback()}async updated(t){if(t.has("scrollableParent")){this.#c?.disconnect();const t=await F(this);this.#h=this.scrollableParent||t,this.#h&&(this.#c=new ResizeObserver(()=>{this.#d()}),this.#c.observe(this.#h))}}isOverflown(t){return t.scrollHeight>t.clientHeight}#d(){this.#h&&(this.isOverflowed=this.isOverflown(this.#h))}static{this.styles=[e`
      :host {
        display: grid;
