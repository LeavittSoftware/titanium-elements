import{T as e,L as t,i as s,b as i,M as r,K as n,N as l,C as o,_ as a,r as h,e as d,n as c,t as u}from"./06xqLdmj.js";import"./DumMRtbi.js";let p=class extends(e(t(s))){constructor(){super(...arguments),this.#e=[],this.#t=[],this.#s="Single select",this.#i=!1,this.#r="Search for a entity",this.#n=null,this.#l=!1,this.#o=!1,this.#a="",this.#h=!1,this.#d=!1,this.#c=!1,this.#u="Name",this.positioning="popover",this.#p=!1,this.#m=null,this.#g=!1,this.#f=!1}#x;get searchTerm(){return this.#x}set searchTerm(e){this.#x=e}#e;get suggestions(){return this.#e}set suggestions(e){this.#e=e}#t;get defaultSuggestions(){return this.#t}set defaultSuggestions(e){this.#t=e}#y;get menu(){return this.#y}set menu(e){this.#y=e}#s;get label(){return this.#s}set label(e){this.#s=e}#i;get filled(){return this.#i}set filled(e){this.#i=e}#r;get placeholder(){return this.#r}set placeholder(e){this.#r=e}#n;get selected(){return this.#n}set selected(e){this.#n=e}#l;get disabled(){return this.#l}set disabled(e){this.#l=e}#o;get noAsterisk(){return this.#o}set noAsterisk(e){this.#o=e}#a;get autocomplete(){return this.#a}set autocomplete(e){this.#a=e}#h;get spellcheck(){return this.#h}set spellcheck(e){this.#h=e}#d;get error(){return this.#d}set error(e){this.#d=e}#_;get errorText(){return this.#_}set errorText(e){this.#_=e}#c;get required(){return this.#c}set required(e){this.#c=e}#v;get prefixText(){return this.#v}set prefixText(e){this.#v=e}#$;get suffixText(){return this.#$}set suffixText(e){this.#$=e}#T;get hasLeadingIcon(){return this.#T}set hasLeadingIcon(e){this.#T=e}#b;get hasTrailingIcon(){return this.#b}set hasTrailingIcon(e){this.#b=e}#S;get disableMenuOpenOnFocus(){return this.#S}set disableMenuOpenOnFocus(e){this.#S=e}#I;get supportingText(){return this.#I}set supportingText(e){this.#I=e}#k;get textDirection(){return this.#k}set textDirection(e){this.#k=e}#u;get pathToSelectedText(){return this.#u}set pathToSelectedText(e){this.#u=e}#p;get matchInputWidth(){return this.#p}set matchInputWidth(e){this.#p=e}#w;get menuWidth(){return this.#w}set menuWidth(e){this.#w=e}#m;#O;get count(){return this.#O}set count(e){this.#O=e}#g;get menuOpen(){return this.#g}set menuOpen(e){this.#g=e}#f;get large(){return this.#f}set large(e){this.#f=e}getTextField(){return this.filled?this.shadowRoot?.querySelector("md-filled-text-field"):this.shadowRoot?.querySelector("md-outlined-text-field")}async firstUpdated(){const e=this.getTextField();if(e&&this.required){const t=e?.checkValidity;e.checkValidity=()=>!!this.selected&&t.bind(e)}}#B(){this.#m?.disconnect(),this.#m=new ResizeObserver(e=>{for(const t of e)this.menuWidth=t.contentRect.width}),this.#m.observe(this)}#W(){this.#m?.disconnect(),this.#m=null,this.menuWidth=void 0}connectedCallback(){super.connectedCallback(),this.matchInputWidth&&this.#B()}disconnectedCallback(){super.disconnectedCallback(),this.#W()}update(e){e.has("positioning")&&"popover"===this.positioning&&!this.showPopover&&(this.positioning="fixed"),e.has("matchInputWidth")&&(this.matchInputWidth?this.#B():this.#W()),super.update(e)}setCustomValidity(e){this.getTextField()?.setCustomValidity(e)}async reset(){this.softReset(),this.selected=null;const e=this.getTextField();e&&(e.error=!1,e.errorText="",e.reset())}softReset(){this.searchTerm="",this.suggestions=[]}async select(){this.getTextField()?.select()}async focus(){this.getTextField()?.focus()}checkValidity(){return this.getTextField()?.checkValidity()&&this.customCheckValidity()}reportValidity(){return this.getTextField()?.reportValidity()&&this.customReportValidity()}customCheckValidity(){return this.errorText="Please fill out this field",!(!this.selected&&this.getTextField()?.value)&&(!this.required&&!this.selected||!!this.selected)}customReportValidity(){return this.customCheckValidity()?(this.error=!1,this.errorText=""):this.error=!0,!this.error}async setSelected(e){const t=this.selected;this.selected=e,this.selected&&(this.softReset(),setTimeout(()=>{this.reportValidity()},0)),t?.Id!==this.selected?.Id&&this.dispatchEvent(new Event("selected"))}onInputChanged(e){console.log(e)}async showSuggestions(e,t){this.suggestions=e,this.count=t,await this.updateComplete,this.menu.show()}async#L(e){!e&&this.defaultSuggestions.length||this.menu.close(),this.setSelected(null),this.suggestions=e?[]:this.defaultSuggestions,this.count=e?0:this.defaultSuggestions.length,this.searchTerm=e,await this.updateComplete,this.onInputChanged(e)}static{this.styles=[i`
      :host {
        display: block;
        position: relative;
      }
    ...
    `]}renderSuggestion(e){return r`<md-menu-item .item=${e} ?selected=${this.selected?.Id===e.Id}>
    ...
    </md-menu-item>`}renderSelectedLeadingInputSlot(e){}#z(){return r`<div slot="trailing-icon">
      ...
      <${this.filled?n`md-filled-text-field`:n`md-outlined-text-field`}
        ...
        @input=${async e=>this.#L(e.target.value)}
      ...
      >
        ${this.selected?this.renderSelectedLeadingInputSlot(this.selected):this.renderLeadingInputSlot()} ${this.#z()}
        </${this.filled?n`md-filled-text-field`:n`md-outlined-text-field`}>
      <md-menu
        part="menu"
        suggestions
