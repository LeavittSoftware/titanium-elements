import{i,h as e,p as t,c as a,U as s,x as u,_ as o,t as n}from"./BriKlvrl.js";import{S as m}from"./BYDhJ-qH.js";import"./B5dYKavm.js";let r=class extends i{static{this.styles=[e,t,a`
      :host {
        display: block;
      }
    ...
    `]}render(){return u`
      <titanium-toolbar>
        ...
        <profile-picture-menu size="36" .userManager=${s}></profile-picture-menu>
      </titanium-toolbar>
      <main>
        <p>
    ...
    `}};r=o([n("titanium-toolbar-playground")],r);let l=class extends i{static{this.styles=[m,a``]}render(){return u`
    ...
    `}};l=o([n("titanium-toolbar-demo")],l);export{l as TitaniumToolbarDemo};
