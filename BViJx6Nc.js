import{E as e,g as t,L as i,i as s,P as o,S as r,c as a,x as l,_ as n,n as d,r as c,e as h,t as p,p as m,h as u,j as f,b as g,k as x,l as y,m as v,o as b,q as w,s as $,C as _,a as k,A as F,d as E,G as C}from"./Bo8Qgput.js";import{S as N}from"./9v0fXKyk.js";import"./CbBzc5mI.js";import"./BNgjtcVo.js";import"./DVBH-jeI.js";import{d as I}from"./fEBq_QNq.js";import"./Dboe2cPT.js";import"./BJeTwxzT.js";function z(t,i){return t.map((s,o)=>[s,o<t.length-1?i:e])}const S=new t;Object.freeze(S);let D=class extends(i(s)){#e;get apiService(){return this.#e}set apiService(e){this.#e=e}#t;get fileExplorerId(){return this.#t}set fileExplorerId(e){this.#t=e}#i;get parentFolderId(){return this.#i}set parentFolderId(e){this.#i=e}#s="";get folderName(){return this.#s}set folderName(e){this.#s=e}#o;get dialog(){return this.#o}set dialog(e){this.#o=e}async open(){return this.folderName="",this.dialog.show(),new Promise(e=>{this.resolve=e})}async#r(){if(!this.apiService)return;const e={FileExplorerId:this.fileExplorerId,Name:this.folderName,ParentFolderId:this.parentFolderId||void 0};try{const t=this.apiService.postAsync("FileExplorerFolders?expand=CreatorPerson(select=FullName,ProfilePictureCdnFileName)",e);this.dispatchEvent(new o(t)),this.loadWhile(t);const i=(await t)?.entity;return{...i,CreatorProfilePictureCndFileName:i?.CreatorPerson?.ProfilePictureCdnFileName,CreatorFullName:i?.CreatorPerson?.FullName}}catch(e){this.dispatchEvent(new r(e))}return null}static{this.styles=a`
  ...
  `}render(){return l`
    ...
    `}};n([d({attribute:!1})],D.prototype,"apiService",null),n([d({type:Number})],D.prototype,"fileExplorerId",null),n([d({type:Number})],D.prototype,"parentFolderId",null),n([c()],D.prototype,"folderName",null),n([h("md-dialog")],D.prototype,"dialog",null),D=n([p("leavitt-add-folder-modal")],D);let M=class extends s{static{this.styles=[m,a`
      :host {
        display: flex;
    ...
    `}};M=n([p("leavitt-file-explorer-no-files")],M);let j=class extends s{static{this.styles=[m,a`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};j=n([p("leavitt-file-explorer-error")],j);let P=class extends s{static{this.styles=[m,a`
      :host {
        display: flex;
        flex-direction: column;
        align-items: center;
    ...
    `}};P=n([p("leavitt-file-explorer-no-permission")],P);let U=class extends(i(s)){#e;get apiService(){return this.#e}set apiService(e){this.#e=e}#a=!1;get enableEditing(){return this.#a}set enableEditing(e){this.#a=e}#l="view";get state(){return this.#l}set state(e){this.#l=e}#n=null;get file(){return this.#n}set file(e){this.#n=e}#d=!1;get isCopying(){return this.#d}set isCopying(e){this.#d=e}#c=!1;get hasClipboard(){return this.#c}set hasClipboard(e){this.#c=e}#h;get fileName(){return this.#h}set fileName(e){this.#h=e}#o;get dialog(){return this.#o}set dialog(e){this.#o=e}firstUpdated(){S.subscribe("FileExplorerFileDto","Update",e=>{e.Id===this.file?.Id&&(this.file={...this.file,...e})}),navigator.clipboard&&(this.hasClipboard=!0)}async#p(){if(!this.apiService||this.fileName===this.file?.Name||!this.fileName)return;const e={Name:this.fileName};try{const t=this.apiService.patchAsync(`FileExplorerAttachments(${this.file?.Id})`,e);this.loadWhile(t),await t,S.dispatch("FileExplorerFileDto","Update",{...this.file,Name:this.fileName}),this.state="view"}catch(e){this.dispatchEvent(new r(e))}}async open(e){return this.file=e,this.state="view",await this.dialog.show()}static{this.styles=[u,f,m,g,x,y,a`
      :host {
        display: block;
      }
      ...
      <md-dialog>
        ...
        <main ext=${this.file?.Extension??""} slot="content">
          ...
          <data-row force-stacked>
            <h5>Uploaded</h5>
            <p>${I(this.file?.CreatedDate).format("MMM D, YYYY h:mm:ss a")}</p>
          </data-row>
    ...
    `}};n([d({attribute:!1})],U.prototype,"apiService",null),n([d({type:Boolean})],U.prototype,"enableEditing",null),n([c()],U.prototype,"state",null),n([c()],U.prototype,"file",null),n([c()],U.prototype,"isCopying",null),n([c()],U.prototype,"hasClipboard",null),n([c()],U.prototype,"fileName",null),n([h("md-dialog")],U.prototype,"dialog",null),U=n([p("leavitt-file-modal")],U);let A=class extends(i(s)){#e;get apiService(){return this.#e}set apiService(e){this.#e=e}#a=!1;get enableEditing(){return this.#a}set enableEditing(e){this.#a=e}#l="view";get state(){return this.#l}set state(e){this.#l=e}#m=null;get folder(){return this.#m}set folder(e){this.#m=e}#s;get folderName(){return this.#s}set folderName(e){this.#s=e}#o;get dialog(){return this.#o}set dialog(e){this.#o=e}firstUpdated(){S.subscribe("FileExplorerFolder","Update",e=>{e.Id===this.folder?.Id&&(this.folder={...this.folder,...e})})}async#u(){if(!this.apiService||this.folderName===this.folder?.Name||!this.folderName)return;const e={Name:this.folderName};try{const t=this.apiService.patchAsync(`FileExplorerFolders(${this.folder?.Id})`,e);this.loadWhile(t),await t,S.dispatch("FileExplorerFolder","Update",{...this.folder,Name:this.folderName}),this.state="view"}catch(e){this.dispatchEvent(new r(e))}}open(e){this.folder=e,this.state="view",this.dialog.show()}static{this.styles=[u,f,m,g,x,y,a`
      :host {
        display: block;
      }
    ...
    `]}render(){return l`
      <md-dialog>
        ...
        <main slot="content">
          ...
          <data-row force-stacked>
            <h5>Created</h5>
            <p>${I(this.folder?.CreatedDate).format("MMM D, YYYY h:mm:ss a")}</p>
          </data-row>
  ...
  `}render(){return l`
      ${this.attachment?.PreviewSizes?.includes("512")?l`<img draggable="false" loading="lazy" src=${b(w(this.attachment,512))} />`:l` <md-icon>${Y(this.attachment?.Extension??"")}</md-icon>`}
    `}};function T(e,t=2){if(0===e)return"0 Bytes";const i=t||2,s=Math.floor(Math.log(e)/Math.log(1024));return parseFloat((e/Math.pow(1024,s)).toFixed(i))+" "+["Bytes","KB","MB","GB","TB","PB","EB","ZB","YB"][s]}n([d({type:Object})],B.prototype,"attachment",null),B=n([p("leavitt-file-explorer-image")],B);let L=class extends s{#n;get file(){return this.#n}set file(e){this.#n=e}#g=!1;get selected(){return this.#g}set selected(e){this.#g=e}#x=0;get selectedCount(){return this.#x}set selectedCount(e){this.#x=e}#y="grid";get display(){return this.#y}set display(e){this.#y=e}static{this.styles=a`
    :host {
      display: grid;
    }
  ...
  `}render(){return l` <button
    ...
    >
      ...
      <file-name>
        <md-icon>${"list"===this.display&&this.selected?"check":Y(this.file.Extension??"")}</md-icon>
        <span name>${this.file.Name}</span>
        <span ext>${this.file.Extension}</span>
      </file-name>
      ${"list"===this.display?l`
            <span date>${I(this.file.CreatedDate).format("MMM D, YYYY")}</span>
            <span size>${T(this.file.Size)}</span>
    ...
    </button>`}};n([d({type:Object})],L.prototype,"file",null),n([d({type:Boolean,reflect:!0})],L.prototype,"selected",null),n([d({type:Number,reflect:!0,attribute:"selected-count"})],L.prototype,"selectedCount",null),n([d({type:String,reflect:!0,attribute:"display"})],L.prototype,"display",null),L=n([p("file-list-item")],L);let R=class extends s{#m;get folder(){return this.#m}set folder(e){this.#m=e}#g=!1;get selected(){return this.#g}set selected(e){this.#g=e}#x=0;get selectedCount(){return this.#x}set selectedCount(e){this.#x=e}#y="grid";get display(){return this.#y}set display(e){this.#y=e}#v(e){return Math.abs(e)>999?Math.floor(Math.sign(e)*Math.round(Math.abs(e)/100)/10)+"k+":Math.sign(e)*Math.abs(e)}static{this.styles=a`
    :host {
      display: grid;
    }
...
${this.folder.FilesCount} file${1===this.folder.FilesCount?"":"s"}, ${this.folder.FoldersCount} folder${1===this.folder.FoldersCount?"":"s"}"
      ...
      <header>
        <aside ellipsis>
          ...
          <file-summary ?hidden=${!this.fileExplorer} ellipsis heading3
            >${this.fileExplorer?.FilesCount} files | ${this.fileExplorer?.FoldersCount} folders | ${T(this.fileExplorer?.Size)}</file-summary
          >
        </aside>
        <md-icon-button
          ?disabled=${this.isLoading}
        ...
        <section ?hidden=${0===this.folders.length||"files"!=this.state}>
          ${this.folders.map(e=>l`
              <folder-list-item
                ...
                @toggle-selected=${()=>this.#K(e,"folder")}
        ...
        ${this.isAdmin?l`
              <footer-actions>
                ...
                <input
                  ...
                  style="display:none;"
                />
                <input files @change=${async()=>this.#R(this.fileInput.files)} type="file" multiple id="file" style="display:none;" />
              </footer-actions>
            `:e}
      </footer>
    ...
    `}};n([d({attribute:!1})],q.prototype,"apiService",null),n([d({type:Number,attribute:"file-explorer-id"})],q.prototype,"fileExplorerId",null),n([d({type:Number,attribute:"folder-id"})],q.prototype,"folderId",null),n([d({type:String,attribute:"local-storage-display-key"})],q.prototype,"localStorageDisplayKey",null),n([d({type:Boolean,reflect:!0,attribute:"prevent-navigation-up"})],q.prototype,"preventNavigationUp",null),n([d({type:String,reflect:!0,attribute:"display"})],q.prototype,"display",null),n([d({type:String})],q.prototype,"state",null),n([c()],q.prototype,"isAdmin",null),n([c()],q.prototype,"fileExplorer",null),n([c()],q.prototype,"files",null),n([c()],q.prototype,"folders",null),n([c()],q.prototype,"path",null),n([c()],q.prototype,"selected",null),n([h("md-menu[upload-menu]")],q.prototype,"uploadMenu",null),n([h("leavitt-folder-modal")],q.prototype,"folderDialog",null),n([h("leavitt-add-folder-modal")],q.prototype,"addFolderDialog",null),n([h("leavitt-file-modal")],q.prototype,"fileDialog",null),n([h("input[files]")],q.prototype,"fileInput",null),n([h("input[folders]")],q.prototype,"folderInput",null),n([h("titanium-confirm-dialog")],q.prototype,"confirmDialog",null),q=n([p("leavitt-file-explorer")],q);let H=class extends s{static{this.styles=[u,m,a`
      :host {
        display: flex;
        flex-direction: column;
        margin: 24px 12px;
      }
    `]}constructor(){super(),this.fileExplorerApiService=new F(new E),this.fileExplorerApiService.baseUrl="https://devapi3.leavitt.com/",this.fileExplorerApiService.addHeader("X-LGAppName","FileExplorer")}render(){return l`
      <user-manager></user-manager>
      <leavitt-file-explorer file-explorer-id="1" .apiService=${this.fileExplorerApiService}></leavitt-file-explorer>
      <titanium-snackbar-stack></titanium-snackbar-stack>
    `}};n([c()],H.prototype,"fileExplorerApiService",void 0),H=n([p("leavitt-file-explorer-playground")],H);let J=class extends s{#G=null;get refreshToken(){return this.#G}set refreshToken(e){this.#G=e}static{this.styles=[N,a``]}async firstUpdated(){const e=await C();await e.authenticateAsync(),this.refreshToken=window.localStorage.getItem("LG-AUTH-RT")}render(){return l`
    ...
    `}};n([c()],J.prototype,"refreshToken",null),J=n([p("leavitt-file-explorer-demo")],J);export{J as LeavittUserFileExplorerDemo};
