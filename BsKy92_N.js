import{i as a,b as t,c as l,_ as s,n as r,t as c}from"./BkdWKSMI.js";import{S as e}from"./D21mo-gf.js";import"./z-LiiMbg.js";import"./BXTEaQeD.js";let f=class extends a{#a="You do not have permission to access this application.";get message(){return this.#a}set message(a){this.#a=a}static{this.styles=t`
    :host {
      display: flex;
      flex-direction: row;
      align-items: center;
  ...
  `}render(){return l`
    ...
    `}};s([r({type:String})],f.prototype,"message",null),f=s([c("titanium-access-denied-page")],f);let n=class extends a{static{this.styles=[e]}render(){return l`
    ...
    `}};n=s([c("titanium-access-denied-page-demo")],n);export{n as TitaniumAccessDeniedPageDemo};
