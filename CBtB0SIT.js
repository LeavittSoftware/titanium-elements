import{i as t,h as e,W as i,b as o,A as a,c as n,_ as s,n as r,t as h}from"./BwDOgaCl.js";let l=class extends t{#t;get header(){return this.#t}set header(t){this.#t=t}#e;get subHeader(){return this.#e}set subHeader(t){this.#e=t}#i;get icon(){return this.#i}set icon(t){this.#i=t}#o=!1;get noNav(){return this.#o}set noNav(t){this.#o=t}#a=!1;get disableDefaultBackButtonBehavior(){return this.#a}set disableDefaultBackButtonBehavior(t){this.#a=t}#n(){this.disableDefaultBackButtonBehavior?this.dispatchEvent(new CustomEvent("titanium-header-back-click",{composed:!0})):window.history.back()}static{this.styles=[e,i,o`
      :host {
        display: flex;
