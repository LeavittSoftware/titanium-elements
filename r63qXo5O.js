import{i as t,k as e,D as i,_ as u,n as s,t as o,h as r,a as n,p as a,f as l,e as p}from"./CzHvl5jm.js";import{S as d}from"./CYtDMjId.js";import{E as c}from"./CEI7UKhK.js";import"./BngvSuhr.js";let m=class extends c{#t="off";get autocomplete(){return this.#t}set autocomplete(t){this.#t=t}#e=!1;get spellcheck(){return this.#e}set spellcheck(t){this.#e=t}#i="off";get autocorrect(){return this.#i}set autocorrect(t){this.#i=t}firstUpdated(){this.label=this.label||"YouTube video key",this.pattern="^.{11}$"}updated(t){t.has("value")&&(this.value=this.#u(this.input.value))}#u(t){const e=t.match(/^.*((youtu.be\/)|(v\/)|(\/u\/\w\/)|(embed\/)|(watch\?))\??v?=?([^#&?]*).*/),i=!(!e||11!==e[7].length)&&e[7];return i||t}static{this.styles=[t`
    ...
    `}};u([l("titanium-youtube-input")],h.prototype,"inputs",null),u([p("titanium-youtube-input[required]")],h.prototype,"requiredInput",null),h=u([o("titanium-youtube-input-playground")],h);let b=class extends r{static{this.styles=[d,t``]}render(){return e`
