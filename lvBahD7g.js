import{i as t,b as i,S as a,w as e,v as n,x as l,c as s,_ as o,r as m,e as c,t as r}from"./BBslpa0R.js";import{S as p}from"./DCcDto7J.js";import"./27LYmq_e.js";import"./CKpbYwcJ.js";let d=class extends t{#t=[];get files(){return this.#t}set files(t){this.#t=t}#i=["tiff","pjp","jfif","bmp","gif","svg","png","xbm","dib","jxl","jpeg","svgz","jpg","webp","ico","tif","pjpeg","avif"];get selectedCroppableFormats(){return this.#i}set selectedCroppableFormats(t){this.#i=t}#a=["avif","bmp","dib","gif","ico","jfif","jxl","jpeg","jpg","pjp","pjpeg","png","svg","svgz","tif","tiff","webp","xbm"];get allImageFormats(){return this.#a}set allImageFormats(t){this.#a=t}#e;get smartAttachment(){return this.#e}set smartAttachment(t){this.#e=t}#n;get dialog(){return this.#n}set dialog(t){this.#n=t}static{this.styles=[p,i`
        ...
        <main>
          ...
          <leavitt-app-width-limiter max-width="1000px">
            ...
            <div>
              ...
              <section buttons>
                <md-filled-tonal-button @click=${()=>this.smartAttachment.options={outputQuality:1}}
    ...
    `}};o([m()],d.prototype,"files",null),o([m()],d.prototype,"selectedCroppableFormats",null),o([m()],d.prototype,"allImageFormats",null),o([c("titanium-smart-attachment-input[required]")],d.prototype,"smartAttachment",null),o([c("md-dialog")],d.prototype,"dialog",null),d=o([r("titanium-smart-attachment-input-demo")],d);export{d as TitaniumSmartAttachmentInputDemo};
