import{h as t,i as e,k as s,_ as r,n as i,e as a,t as o}from"./BDVm1clO.js";import"./Bca3rEhM.js";let l=class extends t{#t;get label(){return this.#t}set label(t){this.#t=t}#e="No items";get noItemsText(){return this.#e}set noItemsText(t){this.#e=t}#s=!1;get required(){return this.#s}set required(t){this.#s=t}#r;get hasItems(){return this.#r}set hasItems(t){this.#r=t}#i;get supportingText(){return this.#i}set supportingText(t){this.#i=t}#a;get error(){return this.#a}set error(t){this.#a=t}#o;get errorText(){return this.#o}set errorText(t){this.#o=t}#l;get resizable(){return this.#l}set resizable(t){this.#l=t}#n;get disabled(){return this.#n}set disabled(t){this.#n=t}#h;get validator(){return this.#h}set validator(t){this.#h=t}updated(t){(t.get("hasItems")&&t.has("hasItems")||this.hasItems&&t.has("hasItems"))&&this.reportValidity()}checkValidity(){return this.validator?.checkValidity()}reportValidity(){return this.validator?.reportValidity()}reset(){this.validator?.reset()}static{this.styles=[e`
      :host {
        display: block;
        width: 100%;
      }
