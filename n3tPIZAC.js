...
`;let Or=class extends Ir{constructor(){super(...arguments),this.fieldTag=Ci`md-outlined-field`}};Or.styles=[Pr,tr],Or=r([pt("md-outlined-text-field")],Or);let Mr=class extends Zi{constructor(){super(...arguments),this.populated=!0}#zt;get evaluator(){return this.#zt}set evaluator(t){this.#zt=t}firstUpdated(){this.addEventListener("focusin",(()=>this.focused=!0)),this.addEventListener("focusout",(()=>this.focused=!1))}reset(){this.error=!1}reportValidity(){const t=this.checkValidity();return this.error=!t,t}checkValidity(){return!!this.evaluator()}};r([vt({type:Boolean})],Mr.prototype,"populated",void 0),r([vt({type:Object})],Mr.prototype,"evaluator",null),Mr=r([pt("titanium-input-validator")],Mr);let Rr=class extends ht{#St;get label(){return this.#St}set label(t){this.#St=t}#At="No items";get noItemsText(){return this.#At}set noItemsText(t){this.#At=t}#Ct=!1;get required(){return this.#Ct}set required(t){this.#Ct=t}#Tt;get hasItems(){return this.#Tt}set hasItems(t){this.#Tt=t}#Et;get supportingText(){return this.#Et}set supportingText(t){this.#Et=t}#It;get error(){return this.#It}set error(t){this.#It=t}#Pt;get errorText(){return this.#Pt}set errorText(t){this.#Pt=t}#Ot;get resizable(){return this.#Ot}set resizable(t){this.#Ot=t}#Mt;get disabled(){return this.#Mt}set disabled(t){this.#Mt=t}#Rt;get validator(){return this.#Rt}set validator(t){this.#Rt=t}updated(t){(t.get("hasItems")&&t.has("hasItems")||this.hasItems&&t.has("hasItems"))&&this.reportValidity()}checkValidity(){return this.validator?.checkValidity()}reportValidity(){return this.validator?.reportValidity()}reset(){this.validator?.reset()}static{this.styles=[d`
      :host {
        display: block;
        width: 100%;
      }
    ...
    `]}render(){return G`
      ...
      >
        ...
        <div slot="actions">
          ...
          <md-text-button
            ?disabled=${this.isLoading}
            @click=${async()=>{this.isLoading=!0,await this.updateComplete;const t=await(this.cropperSelection?.$toCanvas());if(!t)return;const e="circle"===this.options?.shape?await this.#Kt(t.toDataURL(this.#qt)):t.toDataURL(this.#qt),i=await fetch(e),r=this.blobToFile(await i.blob(),this.#Yt(this.fileName,this.#Ht)),o=this.#Xt?.(r,e)||Promise.resolve();this.loadWhile(o),await o,this.isLoading=!1,this.dialog.close("cropped")}}
            >Save</md-text-button
          >
        </div>
      </md-dialog>
    `}};r([yt("md-dialog")],Ds.prototype,"dialog",null),r([yt("main")],Ds.prototype,"main",null),r([yt("cropper-canvas")],Ds.prototype,"cropperCanvas",null),r([yt("cropper-selection")],Ds.prototype,"cropperSelection",null),r([yt("cropper-image")],Ds.prototype,"cropperImage",null),r([vt({type:Boolean,reflect:!0,attribute:"force-png"})],Ds.prototype,"forcePNGOutput",null),r([vt({type:Object})],Ds.prototype,"options",null),r([gt()],Ds.prototype,"fileName",null),r([gt()],Ds.prototype,"src",null),Ds=r([pt("crop-and-save-image-dialog")],Ds);let qs=class extends ht{#Jt;get imageUrl(){return this.#Jt}set imageUrl(t){this.#Jt=t}#Qt;get downloadSrc(){return this.#Qt}set downloadSrc(t){this.#Qt=t}#Zt;get filename(){return this.#Zt}set filename(t){this.#Zt=t}#nt;get dialog(){return this.#nt}set dialog(t){this.#nt=t}async open(t,e,i){return this.imageUrl=void 0,this.filename=i,this.downloadSrc=e,this.imageUrl=t,this.dialog.show()}static{this.styles=[d`
      div[header] {
...
`;let en=class extends Ks{};en.styles=[Zs,tn,Qs,Js],en=r([pt("md-input-chip")],en);const rn=(t,e,i)=>{const r=new Map;for(let o=e;o<=i;o++)r.set(t[o],o);return r},on=Kt(class extends Jt{constructor(t){if(super(t),t.type!==Wt)throw Error("repeat() can only be used in text expressions")}dt(t,e,i){let r;void 0===i?i=e:void 0!==e&&(r=e);const o=[],s=[];let n=0;for(const e of t)o[n]=r?r(e,n):n,s[n]=i(e,n),n++;return{values:s,keys:o}}render(t,e,i){return this.dt(t,e,i).values}update(t,[e,i,r]){const o=(t=>t._$AH)(t),{values:s,keys:n}=this.dt(e,i,r);if(!Array.isArray(o))return this.ut=n,s;const a=this.ut??=[],l=[];let c,d,h=0,u=o.length-1,p=0,m=s.length-1;for(;h<=u&&p<=m;)if(null===o[h])h++;else if(null===o[u])u--;else if(a[h]===n[p])l[p]=or(o[h],s[p]),h++,p++;else if(a[u]===n[m])l[m]=or(o[u],s[m]),u--,m--;else if(a[h]===n[m])l[m]=or(o[h],s[m]),rr(t,l[m+1],o[h]),h++,m--;else if(a[u]===n[p])l[p]=or(o[u],s[p]),rr(t,o[h],o[u]),u--,p++;else if(void 0===c&&(c=rn(n,p,m),d=rn(a,h,u)),c.has(a[h]))if(c.has(a[u])){const e=d.get(n[p]),i=void 0!==e?o[e]:null;if(null===i){const e=rr(t,o[h]);or(e,s[p]),l[p]=e}else l[p]=or(i,s[p]),rr(t,o[h],i),o[e]=null;p++}else ar(o[u]),u--;else ar(o[h]),h++;for(;p<=m;){const e=rr(t,l[m+1]);or(e,s[p]),l[p++]=e}for(;h<=u;){const t=o[h++];null!==t&&ar(t)}return this.ut=n,nr(t,l),W}}),sn=["tiff","pjp","jfif","bmp","gif","svg","png","xbm","dib","jxl","jpeg","svgz","jpg","webp","ico","tif","pjpeg","avif"];function nn(t){const e=t.split(".");return e?.[e.length-1]||""}function an(t){return"pdf"===t.toLowerCase()?new URL(new URL("BrwlMowD.png",import.meta.url).href,import.meta.url).href:new URL(new URL("Ciwo_vsG.png",import.meta.url).href,import.meta.url).href}function ln(t,e){if(t?.CdnFileName&&!e)return`https://cdn.leavitt.com/${t.CdnFileName}.${t.Extension}?d=${encodeURIComponent(`${t.Name}.${t.Extension}`)}`}function cn(t,e){if(t?.CdnFileName)return t?.PreviewSizes&&t?.PreviewSizes?.split(",").includes(String(e))?`https://cdn.leavitt.com/${t.CdnFileName}-${e}.${t.PreviewExtension}`:function(t){return"png"===t?.Extension||"jpg"===t?.Extension||"jpeg"===t?.Extension||"gif"===t?.Extension||"svg"===t?.Extension||"webp"===t?.Extension}(t)?`https://cdn.leavitt.com/${t.CdnFileName}.${t.Extension}`:void 0}let dn=class extends ht{#te=[];get files(){return this.#te}set files(t){this.#te=t}#ee=!1;get isOver(){return this.#ee}set isOver(t){this.#ee=t}#ie=void 0;get previewSrc(){return this.#ie}set previewSrc(t){this.#ie=t}#re;get input(){return this.#re}set input(t){this.#re=t}#oe;get imagePreviewDialog(){return this.#oe}set imagePreviewDialog(t){this.#oe=t}#se;get cropperDialog(){return this.#se}set cropperDialog(t){this.#se=t}#ne;get confirmDeleteDialog(){return this.#ne}set confirmDeleteDialog(t){this.#ne=t}#ae;get chipMultiSelect(){return this.#ae}set chipMultiSelect(t){this.#ae=t}#le=[];#ce="image/*,.pdf";get accept(){return this.#ce}set accept(t){this.#ce=t}#de=!1;get multiple(){return this.#de}set multiple(t){this.#de=t}#Ct=!1;get required(){return this.#Ct}set required(t){this.#Ct=t}#Mt=!1;get disabled(){return this.#Mt}set disabled(t){this.#Mt=t}#he=!1;get confirmDelete(){return this.#he}set confirmDelete(t){this.#he=t}#ue="Confirm delete";get confirmDeleteHeader(){return this.#ue}set confirmDeleteHeader(t){this.#ue=t}#pe="Are you sure you would like to delete this attachment?";get confirmDeleteText(){return this.#pe}set confirmDeleteText(t){this.#pe=t}#me="Add attachment";get addButtonLabel(){return this.#me}set addButtonLabel(t){this.#me=t}#St="Attachments";get label(){return this.#St}set label(t){this.#St=t}#Et;get supportingText(){return this.#Et}set supportingText(t){this.#Et=t}#At="No attachments";get noItemsText(){return this.#At}set noItemsText(t){this.#At=t}#Ft;get options(){return this.#Ft}set options(t){this.#Ft=t}#fe=["tiff","pjp","jfif","bmp","gif","svg","png","xbm","dib","jxl","jpeg","svgz","jpg","webp","ico","tif","pjpeg","avif"];get croppableImageFormats(){return this.#fe}set croppableImageFormats(t){this.#fe=t}getFiles(){return this.files}setFiles(...t){this.files=[...t].map((t=>({file:new File([""],t.fileName),previewSrc:t.previewSrc,downloadSrc:t.downloadSrc,id:t.id}))),this.#le=structuredClone(this.files)}setFilesFromDatabaseAttachments(...t){this.files=[...t].filter((t=>t.Name&&t.Extension)).map((t=>({id:t.Id,file:new File([""],`${t?.Name}.${t?.Extension}`),previewSrc:cn(t,512),downloadSrc:ln(t)}))),this.#le=structuredClone(this.files)}checkValidity(){return this.chipMultiSelect.checkValidity()}reportValidity(){return this.chipMultiSelect.reportValidity()}hasChanges(){return JSON.stringify(this.#le)!==JSON.stringify(this.files)}async reset(){this.#le=[],this.previewSrc=void 0,this.files=[],this.isOver=!1,await this.updateComplete,this.chipMultiSelect.reset()}async handleNewFile(t){let e=!1;for(let i=0;i<(t?.length??0);i++){const r=t?.item(i);if(r){const t=this.croppableImageFormats.some((t=>r.name?.toLowerCase()?.endsWith(t?.toLowerCase())));if(t){"cropped"===await this.cropperDialog.open(URL.createObjectURL(r),r.name,(async(t,e)=>{const i={file:t,previewSrc:e??void 0};this.multiple?this.files=[...this.files,i]:this.files=[i]}))&&(this.reportValidity(),e=!0),await It(500)}else{const t={file:r},i=sn.some((t=>r.name.endsWith(t)));if(i)try{const e=await this.toBase64(r);"string"==typeof e&&(t.previewSrc=e??void 0)}catch{}this.multiple?this.files=[...this.files,t]:this.files=[t],this.reportValidity(),e=!0}}}e&&this.#ve()}#ge=null;#be(t){const e=this.files.findIndex((e=>e===t));this.files.splice(e,1),this.requestUpdate("files"),this.reportValidity(),this.#ve()}toBase64(t){return new Promise(((e,i)=>{const r=new FileReader;r.readAsDataURL(t),r.onload=()=>e(r.result),r.onerror=t=>i(t)}))}#ve(){this.dispatchEvent(new Event("change"))}static{this.styles=[ks,d`
      :host {
        display: block;
      }
    ...
    `]}render(){return G`
      ...
      >
        ...
        ${on(this.files,(t=>t.file.name),(t=>G`<md-input-chip
              ...
              @remove=${async e=>{e.preventDefault(),this.confirmDelete?(this.#ge=t,this.confirmDeleteDialog?.show()):this.#be(t)}}
      ...
      <md-dialog confirm-delete>
        ...
        <div slot="actions">
          ...
          <md-text-button
            @click=${()=>{this.#ge&&this.#be(this.#ge),this.confirmDeleteDialog.close()}}
            >Confirm</md-text-button
          >
        </div>
      </md-dialog>
    `}};r([vt({type:Array})],dn.prototype,"files",null),r([vt({type:Boolean,reflect:!0,attribute:"is-over"})],dn.prototype,"isOver",null),r([vt({type:String})],dn.prototype,"previewSrc",null),r([yt("input")],dn.prototype,"input",null),r([yt("image-preview-dialog")],dn.prototype,"imagePreviewDialog",null),r([yt("crop-and-save-image-dialog")],dn.prototype,"cropperDialog",null),r([yt("md-dialog[confirm-delete]")],dn.prototype,"confirmDeleteDialog",null),r([yt("titanium-chip-multi-select")],dn.prototype,"chipMultiSelect",null),r([vt({type:String})],dn.prototype,"accept",null),r([vt({type:Boolean})],dn.prototype,"multiple",null),r([vt({type:Boolean})],dn.prototype,"required",null),r([vt({type:Boolean,reflect:!0})],dn.prototype,"disabled",null),r([vt({type:Boolean})],dn.prototype,"confirmDelete",null),r([vt({type:String})],dn.prototype,"confirmDeleteHeader",null),r([vt({type:String})],dn.prototype,"confirmDeleteText",null),r([vt({type:String})],dn.prototype,"addButtonLabel",null),r([vt({type:String})],dn.prototype,"label",null),r([vt({type:String})],dn.prototype,"supportingText",null),r([vt({type:String})],dn.prototype,"noItemsText",null),r([vt({type:Object})],dn.prototype,"options",null),r([vt({type:Array})],dn.prototype,"croppableImageFormats",null),dn=r([pt("titanium-smart-attachment-input")],dn);class hn{async _getBearerTokenAsync(){return await Rt().getAccessTokenAsync()}}class un{constructor(t,e){this.status=t.status,this.headers=t.headers,this.blob=e}}class pn{constructor(){this.type=null,this.shortType=null}}class mn{constructor(t=new pn){this._odataInfo=t}}class fn{static#ye(t){const e=new Map;return Object.keys(t).filter((t=>0===t.indexOf("@odata"))).forEach((i=>e.set(i.replace("@odata.",""),t[i]))),e}#xe(t){return null===t.value||void 0===t.value||Array.isArray(t.value)?t:t.value}static#we(t){return Array.isArray(t.value)?t.value:[]}get odataCount(){return this.metadata.has("count")?this.metadata.get("count"):0}count(){return this.entities.length}firstOrDefault(){return this.count()>0?this.entities[0]:null}toList(){return this.entities}constructor(t,e){this.status=t.status,this.headers=t.headers,this.metadata=fn.#ye(e),this.entities=fn.#we(e),this.entity=0===this.entities.length?this.#xe(e):null}get containsMultipleEntities(){return this.entities.length>0}}const vn=new Map;vn.set(0,"CORS Error"),vn.set(200,"OK"),vn.set(201,"Created"),vn.set(202,"Accepted"),vn.set(203,"Non-Authoritative Information"),vn.set(204,"No Content"),vn.set(205,"Reset Content"),vn.set(206,"Partial Content"),vn.set(300,"Multiple Choices"),vn.set(301,"Moved Permanently"),vn.set(302,"Found"),vn.set(303,"See Other"),vn.set(304,"Not Modified"),vn.set(305,"Use Proxy"),vn.set(306,"Unused"),vn.set(307,"Temporary Redirect"),vn.set(400,"Bad Request"),vn.set(401,"Unauthorized"),vn.set(402,"Payment Required"),vn.set(403,"Forbidden"),vn.set(404,"Not Found"),vn.set(405,"Method Not Allowed"),vn.set(406,"Not Acceptable"),vn.set(407,"Proxy Authentication Required"),vn.set(408,"Request Timeout"),vn.set(409,"Conflict"),vn.set(410,"Gone"),vn.set(411,"Length Required"),vn.set(412,"Precondition Required"),vn.set(413,"Request Entry Too Large"),vn.set(414,"Request-URI Too Long"),vn.set(415,"Unsupported Media Type"),vn.set(416,"Requested Range Not Satisfiable"),vn.set(417,"Expectation Failed"),vn.set(418,"I'm a teapot"),vn.set(429,"Too Many Requests"),vn.set(500,"Internal Server Error"),vn.set(501,"Not Implemented"),vn.set(502,"Bad Gateway"),vn.set(503,"Service Unavailable"),vn.set(504,"Gateway Timeout"),vn.set(505,"HTTP Version Not Supported");class gn{constructor(t,e){this.headers={},this.baseUrl="https://api2.leavitt.com/",this.#_e=t,this.addHeader("Content-Type","application/json"),this.#ke=e?.appNameHeaderKey?e?.appNameHeaderKey:"X-LGAppName",this.addHeader(this.#ke,"General")}#_e;#ke;addHeader(t,e){this.headers[t]=e}deleteHeader(t){delete this.headers[t]}#$e(t){return this.baseUrl?.endsWith("/")&&t?.startsWith("/")&&Tt&&alert(`API Service Warning: Malformed url, double slashes present. \r\n\r\n${this.baseUrl}${t}`),`${this.baseUrl}${t}`}async uploadFile(t,e,i,r){return new Promise((async(o,s)=>{r?.abortController?.signal&&r?.abortController.signal.aborted&&s(new bn);e&&e.name||s("ArgumentException: Invalid file passed to uploadFile.");try{const n=new XMLHttpRequest;n.onabort=function(){s(new bn)},r?.abortController?.signal&&(r?.abortController.signal.addEventListener("abort",(()=>n.abort())),n.onreadystatechange=function(){4===n.readyState&&r?.abortController?.signal.removeEventListener("abort",(()=>n.abort()))}),n.upload.addEventListener("progress",(t=>{i(t,n)})),n.open("POST",this.#$e(t),!0);const a={...this.headers},l=await this.#_e._getBearerTokenAsync();null!==l&&(a.Authorization=`Bearer ${l}`),a["X-LGAttachmentName"]=e.name;for(const t in a)n.setRequestHeader(t,a[t]);n.addEventListener("loadend",(()=>{try{const e={text:()=>n.response,status:n.status};if("blob"===r?.responseType){const i=this.#ze(e,"UPLOAD",t);return o(i)}{const i=this.#Se(e,"UPLOAD",t);return o(i)}}catch(t){return s(t)}}),!1),n.send(e)}catch(e){return Promise.reject(this.#Ae(e,"UPLOAD",t))}}))}async postAsync(t,e={},i){e instanceof mn&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers};i?.sendAsFormData&&delete r["Content-Type"];const o=await this.#_e._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#$e(t),{method:"POST",body:i?.sendAsFormData?this.#Ce(e):JSON.stringify(e),headers:r,signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Ae(e,"POST",t))}return"blob"===i?.responseType?await this.#ze(s,"POST",t):await this.#Se(s,"POST",t)}async patchAsync(t,e,i){e instanceof mn&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers},o=await this.#_e._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#$e(t),{method:"PATCH",body:JSON.stringify(e),headers:r,signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Ae(e,"PATCH",t))}return"blob"===i?.responseType?await this.#ze(s,"PATCH",t):await this.#Se(s,"PATCH",t)}async patchReturnDtoAsync(t,e,i){e instanceof mn&&e._odataInfo&&!e["@odata.type"]&&(e._odataInfo.type&&(e["@odata.type"]=e._odataInfo.type),delete e._odataInfo);const r={...this.headers},o=await this.#_e._getBearerTokenAsync();let s;null!==o&&(r.Authorization=`Bearer ${o}`);try{s=await fetch(this.#$e(t),{method:"PATCH",body:JSON.stringify(e),headers:{...r,Prefer:"return=representation"},signal:i?.abortController?.signal})}catch(e){return Promise.reject(this.#Ae(e,"PATCH",t))}return"blob"===i?.responseType?await this.#ze(s,"PATCH",t):await this.#Se(s,"PATCH",t)}async deleteAsync(t,e){const i={...this.headers},r=await this.#_e._getBearerTokenAsync();let o;null!==r&&(i.Authorization=`Bearer ${r}`);try{o=await fetch(this.#$e(t),{method:"DELETE",headers:i,signal:e?.abortController?.signal})}catch(e){return Promise.reject(this.#Ae(e,"DELETE",t))}return"blob"===e?.responseType?await this.#ze(o,"DELETE",t):await this.#Se(o,"DELETE",t)}async getAsync(t,e){const i={...this.headers},r=await this.#_e._getBearerTokenAsync();let o;null!==r&&(i.Authorization=`Bearer ${r}`);try{o=await fetch(this.#$e(t),{method:"GET",headers:i,signal:e?.abortController?.signal})}catch(e){return Promise.reject(this.#Ae(e,"GET",t))}return"blob"===e?.responseType?await this.#ze(o,"GET",t):await this.#Se(o,"GET",t)}#Te(t,e,i){return i.indexOf(t)===e}async aggregateResponses(t){const e=new Map,i=[],r=t.map((async t=>{try{await t()}catch(t){i.push(t);const r=t.message;e.set(r,(e.get(r)??0)+1)}}));if(await Promise.allSettled(r),e.size>0){const r={type:"HttpError",action:i.map((t=>t.action)).filter(this.#Te).join(", "),message:`${i.length} of ${t.length} actions failed`,detail:Array.from(e.keys()).map((t=>`${e.get(t)} error(s):  ${t}`)).join("\n"),baseUrl:i.map((t=>t.baseUrl)).filter(this.#Te).join(", "),path:i.map((t=>t.path)).filter(this.#Te).join(", ")};return Promise.reject(r)}}#Ae(t,e,i,r=void 0){const o=t?.message?.includes("Failed to fetch")?"Network error. Check your connection and try again.":"AbortError"===t?.name?"Abort error. Request has been aborted.":t?.message||t;return{type:"HttpError",statusCode:r,baseUrl:this.baseUrl,message:o,action:e,path:i}}async#ze(t,e,i){try{if(0===t.status||t.status>=400&&t.status<=600){const r=await t.text(),o=r.length?JSON.parse(r):{},s=o?.error?.message||(o.error&&"string"==typeof o.error?o.error:void 0)||o?.value||vn.get(t.status)||"unknown";o?.details&&console.warn(o.details);const n={type:"HttpError",statusCode:t.status,baseUrl:this.baseUrl,message:s,detail:o?.details||o?.error_description,raw:o,action:e,path:i};return Promise.reject(n)}{const e=await t.blob();return Promise.resolve(new un(t,e))}}catch(t){return Promise.reject(`The server sent back invalid JSON. ${t}`)}}async#Se(t,e,i){const r=await t.text();let o;try{if(o=r.length?JSON.parse(r):{},0===t.status||t.status>=400&&t.status<=600){const r=o?.error?.message||(o.error&&"string"==typeof o.error?o.error:void 0)||o?.value||vn.get(t.status)||"unknown";o?.details&&console.warn(o.details);const s={type:"HttpError",statusCode:t.status,baseUrl:this.baseUrl,message:r,detail:o?.details||o?.error_description,raw:o,action:e,path:i};return Promise.reject(s)}return Promise.resolve(new fn(t,o))}catch(t){return Promise.reject(`The server sent back invalid JSON. ${t}`)}}#Ce(t,e,i){const r=e||new FormData;let o;for(const e in t)if(Object.hasOwn(t,e)){if(void 0===t[e])continue;o=i?t[e]instanceof File?i:i+"["+e+"]":e,"object"!=typeof t[e]||t[e]instanceof File?r.append(o,t[e]):this.#Ce(t[e],r,o)}return r}}class bn extends Error{constructor(){super(...arguments),this.name="AbortError",this.message="Aborted"}}function yn(t){const e=()=>{t?.open&&t.close("navigation-close")};t.i=e,window.addEventListener("popstate",e,!1)}function xn(t){t?.i&&(window.removeEventListener("popstate",t.i,!1),t.i=void 0)}const wn=new gn(new hn);wn.baseUrl=Tt?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",wn.addHeader("X-LGAppName","IssueTracking"),Object.freeze(wn);let _n=class extends(Et(ht)){#nt;get dialog(){return this.#nt}set dialog(t){this.#nt=t}#Ee;get snackbar(){return this.#Ee}set snackbar(t){this.#Ee=t}#Ie;get textArea(){return this.#Ie}set textArea(t){this.#Ie=t}#Pe;get imageInput(){return this.#Pe}set imageInput(t){this.#Pe=t}show(){this.reset(),this.dialog.show()}reset(){this.dialog.returnValue="",this.imageInput?.reset(),this.textArea?.reset()}async#Oe(){if(!this.textArea.reportValidity()||this.isLoading)return;const t={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Bug",Description:this.textArea.value,Attachments:(this.imageInput?.getFiles()??[]).map((t=>t.file))};try{const e=wn.postAsync("Issues/ReportIssue",t,{sendAsFormData:!0});this.dispatchEvent(new Ee(e)),this.loadWhile(e);if(!(await e).entity)throw new Error("Error submitting problem. Please try again.");document.dispatchEvent(new Ce("",{overrideTemplate:G`Thank you for bringing this issue to our attention!<br />
              <br />
