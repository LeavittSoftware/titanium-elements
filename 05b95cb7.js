  ...
  `}render(){return i`
      <table-controls>
        <take-control>
          ...
          >
            ${n(this.pageSizes,(t=>t),(t=>i` <md-select-option ?selected=${this.take===t} value=${t}>
    ...
    `}};s([a({type:Array})],r.prototype,"pageSizes",null),s([a({type:Number,attribute:"default-page-size"})],r.prototype,"defaultPageSize",null),s([a({type:Number})],r.prototype,"page",null),s([a({type:Number})],r.prototype,"count",null),s([a({type:String})],r.prototype,"localStorageKey",null),s([a({type:String})],r.prototype,"label",null),s([a({type:Boolean})],r.prototype,"disabled",null),s([l("md-select")],r.prototype,"select",null),s([a({type:Number})],r.prototype,"take",null),r=s([o("titanium-page-control")],r);
