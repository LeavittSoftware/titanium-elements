import{r as t,h as e,p as i,i as s,B as l,x as n,_ as o,d as a,e as d,t as r}from"./CfPlwXvo.js";import{S as u}from"./CyTQiCeG.js";import"./Lwh4V7PJ.js";const m=["Dog","Cat","Lion","Hedgehog","Turtle","Monkey","Owl","Peacock","Pigeon","Spider","Tortoise","Zebra"];let c=class extends t{#t=m.slice(0,4);get demoItems(){return this.#t}set demoItems(t){this.#t=t}#e=!1;get disabled(){return this.#e}set disabled(t){this.#e=t}#i="Service animals are welcome.";get supportingText(){return this.#i}set supportingText(t){this.#i=t}#s;get titaniumChipMultiSelect(){return this.#s}set titaniumChipMultiSelect(t){this.#s=t}static{this.styles=[e,i,s`
      :host {
        display: flex;
    ...
    `}};o([a()],c.prototype,"demoItems",null),o([a()],c.prototype,"disabled",null),o([a()],c.prototype,"supportingText",null),o([d("titanium-chip-multi-select[demo2]")],c.prototype,"titaniumChipMultiSelect",null),c=o([r("titanium-chip-multi-select-playground")],c);let p=class extends t{static{this.styles=[u,s``]}render(){return n`
