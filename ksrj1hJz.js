import{i as e,h as r,p as s,c as t,x as i,_ as o,t as n,G as l,E as a,r as p}from"./v29v6fYj.js";import{S as u}from"./98-jDCgK.js";import"./B0y45SPD.js";let c=class extends e{static{this.styles=[r,s,t`
      :host {
        display: flex;
    ...
    `}};c=o([n("profile-picture-menu-playground")],c);let m=class extends e{#e=null;get refreshToken(){return this.#e}set refreshToken(e){this.#e=e}static{this.styles=[u,t``]}async firstUpdated(){const e=l();await(e?.authenticate()),this.refreshToken=e?.refreshToken??null}render(){return i`
