import{s as t,C as i,p as e,i as s,x as o,_ as n,r as a,e as d,t as l}from"./d0ace671.js";import"./ffc1a613.js";import{d as r}from"./791b1dff.js";import{d as h,a as c}from"./85c22fe7.js";import"./ec341a4d.js";import"./f42dd0a8.js";let m=class extends t{#t;get text(){return this.#t}set text(t){this.#t=t}#i;get headline(){return this.#i}set headline(t){this.#i=t}#e;get dialog(){return this.#e}set dialog(t){this.#e=t}#s;listenOn(t){t.addEventListener(i.eventType,(async t=>{this.#o(t)}))}async handleEvent(t){this.#o(t)}#o=async t=>{this.headline=t.header,this.text=t.text,this.dialog.returnValue="",this.dialog.show();const i=await new Promise((t=>{this.#s=t}));t.resolver("confirmed"===i)};static{this.styles=[e,s`
      p {
