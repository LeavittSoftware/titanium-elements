import{i as t,h as e,p as i,c as s,N as l,x as n,_ as o,r as a,e as d,t as r}from"./DozyzFHA.js";import{S as u}from"./BfdpRqvS.js";import"./BDVeJ6T9.js";const c=["Dog","Cat","Lion","Hedgehog","Turtle","Monkey","Owl","Peacock","Pigeon","Spider","Tortoise","Zebra"];let m=class extends t{#t=c.slice(0,4);get demoItems(){return this.#t}set demoItems(t){this.#t=t}#e=!1;get disabled(){return this.#e}set disabled(t){this.#e=t}#i="Service animals are welcome.";get supportingText(){return this.#i}set supportingText(t){this.#i=t}#s;get titaniumChipMultiSelect(){return this.#s}set titaniumChipMultiSelect(t){this.#s=t}static{this.styles=[e,i,s`
      :host {
        display: flex;
