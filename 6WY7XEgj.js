  ...
  `}render(){return s`
      <table-controls>
        <take-control>
          ...
          >
            ${i(this.pageSizes,(t=>t),(t=>s` <md-select-option ?selected=${this.take===t} value=${t}>
