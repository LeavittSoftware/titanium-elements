import{s as t,p as e,g as i,i as r,x as s,l as o,T as a,_ as n,r as c,n as p,t as l,h as u}from"./d0ace671.js";import{S as m}from"./9e8552c1.js";import"./41178c5b.js";import"./160da4c0.js";import"./ec341a4d.js";let h=class extends t{#t;get people(){return this.#t}set people(t){this.#t=t}#e=5;get max(){return this.#e}set max(t){this.#e=t}#i=!1;get enableDirectoryHref(){return this.#i}set enableDirectoryHref(t){this.#i=t}#r=!1;get autoResize(){return this.#r}set autoResize(t){this.#r=t}#s=30;get size(){return this.#s}set size(t){this.#s=t}#o=0;get autoMax(){return this.#o}set autoMax(t){this.#o=t}#a;updated(t){t.has("autoResize")&&(this.autoResize?this.#n():this.#a?.disconnect?.())}#n(){this.#a=new ResizeObserver((t=>{for(const e of t)if(e.contentBoxSize){const t=e.contentBoxSize[0].inlineSize;this.autoMax=Math.floor(t/this.size)}})),this.#a.observe(this)}static{this.styles=[e,i,r`
      :host {
        display: flex;
        flex-direction: row;
        position: relative;
    ...
    `}};n([p({type:Array})],h.prototype,"people",null),n([p({type:Number})],h.prototype,"max",null),n([p({type:Boolean,attribute:"enable-directory-href"})],h.prototype,"enableDirectoryHref",null),n([p({type:Boolean,attribute:"auto-resize"})],h.prototype,"autoResize",null),n([p({type:Number})],h.prototype,"size",null),n([c()],h.prototype,"autoMax",null),h=n([l("titanium-profile-picture-stack")],h);const f={Id:771130,FullName:"Kasey Person",ProfilePictureCdnFileName:"_hNIx5g5YkhcC1BCH_-lJBOlMy5urO1kMrmHl-DEyn15qs9IOnAzxXnlV9ed"},d={Id:771130,FullName:"Random Person",ProfilePictureCdnFileName:""};let x=class extends t{constructor(){super(...arguments),this.people=[d,f,d,f,d],this.manyPeople=new Array(25).fill(f)}static{this.styles=[u,e,r`
      :host {
        display: flex;
    ...
    `]}render(){return s`
      <titanium-card>
        ...
        <h1>One person</h1>
        <titanium-profile-picture-stack .people=${[f]}></titanium-profile-picture-stack>
        ...
        <titanium-profile-picture-stack auto-resize size="50" .people=${new Array(25).fill(f)}></titanium-profile-picture-stack>
      </titanium-card>
      ...
      <titanium-card>
        ...
        <button-container>
          ...
          <md-outlined-icon-button @click=${()=>this.manyPeople=[...this.manyPeople,f]}>
            <md-icon>add</md-icon>
          </md-outlined-icon-button>
        </button-container>
      </titanium-card>
    `}};n([c()],x.prototype,"people",void 0),n([c()],x.prototype,"manyPeople",void 0),x=n([l("titanium-profile-picture-stack-playground")],x);let g=class extends t{static{this.styles=[m,r``]}render(){return s`
    ...
    `}};g=n([l("titanium-profile-picture-stack-demo")],g);export{g as TitaniumProfilePictureStackDemo};
