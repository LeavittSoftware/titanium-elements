import{i as t,b as a,c as e,_ as i,e as o,r as n,t as r}from"./D-PdOFNH.js";import{S as s}from"./-nlQtSV8.js";import"./Cf3bE9pS.js";import"./Br0ktJq7.js";import"./uaRM0mzq.js";import"./BwPESRc9.js";import"./Cy54xUru.js";import"./DC7lHW7N.js";import"./U9wdiSdk.js";import"./DICTDe_l.js";let l=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#a=25;get count(){return this.#a}set count(t){this.#a=t}#e;get data(){return this.#e}set data(t){this.#e=t}#i;get filteredData(){return this.#i}set filteredData(t){this.#i=t}firstUpdated(){this.data=Array(25).fill(null).map((t,a)=>({id:a+1,name:"Bob"})),this.#o()}#o(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[s,a`
