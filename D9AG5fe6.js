...
`;let B=class extends P{};B.styles=[j],B=t([h("md-tabs")],B);let E=class extends(p(c)){#t;get userManager(){return this.#t}set userManager(t){this.#t=t}#e=!1;get isActive(){return this.#e}set isActive(t){this.#e=t}#a=0;get activeIndex(){return this.#a}set activeIndex(t){this.#a=t}#r;get textArea(){return this.#r}set textArea(t){this.#r=t}#i;get imageInput(){return this.#i}set imageInput(t){this.#i=t}async updated(t){t.has("isActive")&&this.isActive&&this.reset()}reset(){this.imageInput?.reset(),this.textArea?.reset()}async#o(){if(!this.textArea.reportValidity()||this.isLoading)return;const t={SiteName:location.hostname,PathName:window.location.pathname+window.location.search,IssueType:"Bug",Description:this.textArea.value,Attachments:(this.imageInput?.getFiles()??[]).map(t=>t.file)};try{const e=new m(this.userManager);e.baseUrl=v?"https://devapi3.leavitt.com/":"https://api3.leavitt.com/",e.addHeader("X-LGAppName","IssueTracking");const a=e.postAsync("Issues/ReportIssue",t,{sendAsFormData:!0});this.dispatchEvent(new b(a)),this.loadWhile(a);if(!(await a).entity)throw new Error("Error submitting problem. Please try again.");this.dispatchEvent(new u("",{overrideTemplate:o`Thank you for bringing this issue to our attention!<br />
              <br />
    ...
    `}};t([e({type:Object})],E.prototype,"userManager",null),t([e({type:Boolean})],E.prototype,"isActive",null),t([r()],E.prototype,"activeIndex",null),t([a("md-outlined-text-field")],E.prototype,"textArea",null),t([a("titanium-smart-attachment-input")],E.prototype,"imageInput",null),E=t([h("leavitt-user-feedback")],E);let L=class extends c{#n;get reportAProblemDialog(){return this.#n}set reportAProblemDialog(t){this.#n=t}#l;get provideFeedbackDialog(){return this.#l}set provideFeedbackDialog(t){this.#l=t}static{this.styles=[x]}render(){return o`
