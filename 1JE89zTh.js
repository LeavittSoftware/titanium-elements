import{i as t,p as i,b as e,A as o,q as a,s as n,u as s,c as l,_ as r,n as c,e as d,t as u,r as m}from"./BwDOgaCl.js";import{S as h}from"./DqlEvKiU.js";import"./BDkKqPD2.js";import"./DZ1f3jXa.js";let f=class extends t{constructor(){super(...arguments),this.#t="Confirm",this.#i="Cancel",this.#e=!1,this.#o=!1,this.open=async(t,i)=>(this.headline=t,this.text=i,this.dialog.returnValue="",this.dialog.show(),await new Promise(t=>{this.#a=t}))}#n;get text(){return this.#n}set text(t){this.#n=t}#s;get headline(){return this.#s}set headline(t){this.#s=t}#t;get confirmActionText(){return this.#t}set confirmActionText(t){this.#t=t}#i;get cancelActionText(){return this.#i}set cancelActionText(t){this.#i=t}#e;get disableConfirmationAction(){return this.#e}set disableConfirmationAction(t){this.#e=t}#o;get disableCancelAction(){return this.#o}set disableCancelAction(t){this.#o=t}#l;get dialog(){return this.#l}set dialog(t){this.#l=t}#a;static{this.styles=[i,e`
      main {
        display: grid;
