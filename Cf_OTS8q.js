import{c as e,S as t,b as a,_ as s,n as i,t as l,A as o,U as n,d as r,T as c,i as d,r as p,e as m}from"./DCbxK7kb.js";import{S as h}from"./B4TQG20J.js";import"./D3Z9-Jx-.js";import"./OLgN8cSM.js";import"@leavittsoftware/web/leavitt/user-manager/user-manager";import"./DFYoXuDx.js";import{F as u}from"./BU8LG2ZX.js";import{T as g}from"./DnSP29KJ.js";import{D as v}from"./DTS7lhmZ.js";import{g as y}from"./wLIUKFBh.js";import"./ClRwwxXo.js";import"./DolHmfVc.js";let b=class extends g{#e="Company";get label(){return this.#e}set label(e){this.#e=e}#t="Search for a company";get placeholder(){return this.#t}set placeholder(e){this.#t=e}#a="Name";get pathToSelectedText(){return this.#a}set pathToSelectedText(e){this.#a=e}#s=[];get companies(){return this.#s}set companies(e){this.#s=e}#i;get apiService(){return this.#i}set apiService(e){this.#i=e}#l=!1;get disableAutoLoad(){return this.#l}set disableAutoLoad(e){this.#l=e}#o=["orderby=Name","select=Name,ShortName,MarkUrl,DarkMarkUrl,Id"];get odataParts(){return this.#o}set odataParts(e){this.#o=e}#n="Companies";get apiControllerName(){return this.#n}set apiControllerName(e){this.#n=e}#r="off";get autocomplete(){return this.#r}set autocomplete(e){this.#r=e}#c=!1;get spellcheck(){return this.#c}set spellcheck(e){this.#c=e}#d=t=>{const a=this.shaped&&this.filled?this.shaped&&this.filled&&"dark"===this.themePreference?"light":"dark":this.themePreference;return e`<md-menu-item .item=${t}>
    ...
    `}};s([p()],$.prototype,"disableMenuOpenOnFocus",null),s([m("leavitt-company-select[methods-demo]")],$.prototype,"methodsSelect",null),$=s([l("leavitt-company-select-demo")],$);export{$ as LeavittCompanySelectDemo};
