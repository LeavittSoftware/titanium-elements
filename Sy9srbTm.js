...
${this.folder.FilesCount} file${1===this.folder.FilesCount?"":"s"}, ${this.folder.FoldersCount} folder${1===this.folder.FoldersCount?"":"s"}"
      ...
      <footer>
        ...
        ${this.isAdmin?r`
              <footer-actions>
                ...
                <input
                  folders
                  @change=${async()=>this.#R(this.folderInput.files)}
                  type="file"
                  webkitdirectory
                  directory
                  multiple
    ...
    `}};n([l("trackLoadingPromise"),d()],G.prototype,"isLoading",null),n([c({attribute:!1})],G.prototype,"apiService",null),n([c({type:Number,attribute:"file-explorer-id"})],G.prototype,"fileExplorerId",null),n([c({type:Number,attribute:"folder-id"})],G.prototype,"folderId",null),n([c({type:String,attribute:"local-storage-display-key"})],G.prototype,"localStorageDisplayKey",null),n([c({type:Boolean,reflect:!0,attribute:"prevent-navigation-up"})],G.prototype,"preventNavigationUp",null),n([c({type:String,reflect:!0,attribute:"display"})],G.prototype,"display",null),n([c({type:String})],G.prototype,"state",null),n([d()],G.prototype,"isAdmin",null),n([d()],G.prototype,"fileExplorer",null),n([d()],G.prototype,"files",null),n([d()],G.prototype,"folders",null),n([d()],G.prototype,"path",null),n([d()],G.prototype,"selected",null),n([h("md-menu[upload-menu]")],G.prototype,"uploadMenu",null),n([h("leavitt-folder-modal")],G.prototype,"folderDialog",null),n([h("leavitt-add-folder-modal")],G.prototype,"addFolderDialog",null),n([h("leavitt-file-modal")],G.prototype,"fileDialog",null),n([h("input[files]")],G.prototype,"fileInput",null),n([h("input[folders]")],G.prototype,"folderInput",null),n([h("titanium-confirmation-dialog")],G.prototype,"confirmationDialog",null),G=n([p("leavitt-file-explorer")],G);let q=class extends i{#q=new k(this);connectedCallback(){super.connectedCallback(),C.addHeader("X-LGAppName","FileExplorer")}disconnectedCallback(){super.disconnectedCallback(),"FileExplorer"===C.headers["X-LGAppName"]&&C.addHeader("X-LGAppName","Testing")}static{this.styles=[F]}render(){return r`
