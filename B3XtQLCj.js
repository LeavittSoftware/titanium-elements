import{i as t,b as a,c as e,_ as i,e as o,r as n,t as r}from"./BNhWGDnO.js";import{S as s}from"./B5qTfSaU.js";import"./Qfha4MkO.js";import"./C4DgNi-5.js";import"./BD26z_2B.js";import"./BrTCX2g6.js";import"./AjH3pCGH.js";import"./DimWWTFA.js";import"./_fsBnyJ3.js";import"./Bsj3beOV.js";let l=class extends t{#t;get pageControl(){return this.#t}set pageControl(t){this.#t=t}#a=25;get count(){return this.#a}set count(t){this.#a=t}#e;get data(){return this.#e}set data(t){this.#e=t}#i;get filteredData(){return this.#i}set filteredData(t){this.#i=t}firstUpdated(){this.data=Array(25).fill(null).map((t,a)=>({id:a+1,name:"Bob"})),this.#o()}#o(){const t=this.pageControl.take*this.pageControl.page;this.filteredData=this.data.slice(t,t+this.pageControl.take)}static{this.styles=[s,a`
