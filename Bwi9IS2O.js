import{V as e,N as t,O as i,Q as s,R as r,i as o,_ as a,n,r as d,e as c,W as l,X as h,Y as m,A as u,c as p,K as g,Z as b,$ as v,a0 as f,a1 as y,b as x,t as w,w as k,v as $,x as _,y as S,f as z,p as D,g as C,S as M,d as I,a as B,s as E,q as O,u as A}from"./CdKAnjTr.js";import"./Cnadr092.js";import"./BKZvCGPJ.js";import{d as j}from"./CuDVc1pF.js";class T extends e{computeValidity(e){return this.checkboxControl||(this.checkboxControl=document.createElement("input"),this.checkboxControl.type="checkbox"),this.checkboxControl.checked=e.checked,this.checkboxControl.required=e.required,{validity:this.checkboxControl.validity,validationMessage:this.checkboxControl.validationMessage}}equals(e,t){return e.checked===t.checked&&e.required===t.required}copy({checked:e,required:t}){return{checked:e,required:t}}}const N=t(i(s(r(o))));class H extends N{constructor(){super(),this.checked=!1,this.indeterminate=!1,this.required=!1,this.value="on",this.prevChecked=!1,this.prevDisabled=!1,this.prevIndeterminate=!1,this.addEventListener("click",e=>{l(e)&&this.input&&(this.focus(),h(this.input))})}update(e){(e.has("checked")||e.has("disabled")||e.has("indeterminate"))&&(this.prevChecked=e.get("checked")??this.checked,this.prevDisabled=e.get("disabled")??this.disabled,this.prevIndeterminate=e.get("indeterminate")??this.indeterminate),super.update(e)}render(){const e=!this.prevChecked&&!this.prevIndeterminate,t=this.prevChecked&&!this.prevIndeterminate,i=this.prevIndeterminate,s=this.checked&&!this.indeterminate,r=this.indeterminate,o=m({disabled:this.disabled,selected:s||r,unselected:!s&&!r,checked:s,indeterminate:r,"prev-unselected":e,"prev-checked":t,"prev-indeterminate":i,"prev-disabled":this.prevDisabled}),{ariaLabel:a,ariaInvalid:n}=this;return p`
    ...
    `}handleInput(e){const t=e.target;this.checked=t.checked,this.indeterminate=t.indeterminate}handleChange(e){g(this,e)}[b](){return!this.checked||this.indeterminate?null:this.value}[v](){return String(this.checked)}formResetCallback(){this.checked=this.hasAttribute("checked")}formStateRestoreCallback(e){this.checked="true"===e}[f](){return new T(()=>this)}[y](){return this.input}}H.shadowRootOptions={...o.shadowRootOptions,delegatesFocus:!0},a([n({type:Boolean})],H.prototype,"checked",void 0),a([n({type:Boolean})],H.prototype,"indeterminate",void 0),a([n({type:Boolean})],H.prototype,"required",void 0),a([n()],H.prototype,"value",void 0),a([d()],H.prototype,"prevChecked",void 0),a([d()],H.prototype,"prevDisabled",void 0),a([d()],H.prototype,"prevIndeterminate",void 0),a([c("input")],H.prototype,"input",void 0);const R=x`:host{border-start-start-radius:var(--md-checkbox-container-shape-start-start, var(--md-checkbox-container-shape, 2px));border-start-end-radius:var(--md-checkbox-container-shape-start-end, var(--md-checkbox-container-shape, 2px));border-end-end-radius:var(--md-checkbox-container-shape-end-end, var(--md-checkbox-container-shape, 2px));border-end-start-radius:var(--md-checkbox-container-shape-end-start, var(--md-checkbox-container-shape, 2px));display:inline-flex;height:var(--md-checkbox-container-size, 18px);position:relative;vertical-align:top;width:var(--md-checkbox-container-size, 18px);-webkit-tap-highlight-color:rgba(0,0,0,0);cursor:pointer}:host([disabled]){cursor:default}:host([touch-target=wrapper]){margin:max(0px,(48px - var(--md-checkbox-container-size, 18px))/2)}md-focus-ring{height:44px;inset:unset;width:44px}input{appearance:none;height:48px;margin:0;opacity:0;outline:none;position:absolute;width:48px;z-index:1;cursor:inherit}:host([touch-target=none]) input{height:100%;width:100%}.container{border-radius:inherit;display:flex;height:100%;place-content:center;place-items:center;position:relative;width:100%}.outline,.background,.icon{inset:0;position:absolute}.outline,.background{border-radius:inherit}.outline{border-color:var(--md-checkbox-outline-color, var(--md-sys-color-on-surface-variant, #49454f));border-style:solid;border-width:var(--md-checkbox-outline-width, 2px);box-sizing:border-box}.background{background-color:var(--md-checkbox-selected-container-color, var(--md-sys-color-primary, #6750a4))}.background,.icon{opacity:0;transition-duration:150ms,50ms;transition-property:transform,opacity;transition-timing-function:cubic-bezier(0.3, 0, 0.8, 0.15),linear;transform:scale(0.6)}:where(.selected) :is(.background,.icon){opacity:1;transition-duration:350ms,50ms;transition-timing-function:cubic-bezier(0.05, 0.7, 0.1, 1),linear;transform:scale(1)}md-ripple{border-radius:var(--md-checkbox-state-layer-shape, var(--md-sys-shape-corner-full, 9999px));height:var(--md-checkbox-state-layer-size, 40px);inset:unset;width:var(--md-checkbox-state-layer-size, 40px);--md-ripple-hover-color: var(--md-checkbox-hover-state-layer-color, var(--md-sys-color-on-surface, #1d1b20));--md-ripple-hover-opacity: var(--md-checkbox-hover-state-layer-opacity, 0.08);--md-ripple-pressed-color: var(--md-checkbox-pressed-state-layer-color, var(--md-sys-color-primary, #6750a4));--md-ripple-pressed-opacity: var(--md-checkbox-pressed-state-layer-opacity, 0.12)}.selected md-ripple{--md-ripple-hover-color: var(--md-checkbox-selected-hover-state-layer-color, var(--md-sys-color-primary, #6750a4));--md-ripple-hover-opacity: var(--md-checkbox-selected-hover-state-layer-opacity, 0.08);--md-ripple-pressed-color: var(--md-checkbox-selected-pressed-state-layer-color, var(--md-sys-color-on-surface, #1d1b20));--md-ripple-pressed-opacity: var(--md-checkbox-selected-pressed-state-layer-opacity, 0.12)}.icon{fill:var(--md-checkbox-selected-icon-color, var(--md-sys-color-on-primary, #fff));height:var(--md-checkbox-icon-size, 18px);width:var(--md-checkbox-icon-size, 18px)}.mark.short{height:2px;transition-property:transform,height;width:2px}.mark.long{height:2px;transition-property:transform,width;width:10px}.mark{animation-duration:150ms;animation-timing-function:cubic-bezier(0.3, 0, 0.8, 0.15);transition-duration:150ms;transition-timing-function:cubic-bezier(0.3, 0, 0.8, 0.15)}.selected .mark{animation-duration:350ms;animation-timing-function:cubic-bezier(0.05, 0.7, 0.1, 1);transition-duration:350ms;transition-timing-function:cubic-bezier(0.05, 0.7, 0.1, 1)}.checked .mark,.prev-checked.unselected .mark{transform:scaleY(-1) translate(7px, -14px) rotate(45deg)}.checked .mark.short,.prev-checked.unselected .mark.short{height:5.6568542495px}.checked .mark.long,.prev-checked.unselected .mark.long{width:11.313708499px}.indeterminate .mark,.prev-indeterminate.unselected .mark{transform:scaleY(-1) translate(4px, -10px) rotate(0deg)}.prev-unselected .mark{transition-property:none}.prev-unselected.checked .mark.long{animation-name:prev-unselected-to-checked}@keyframes prev-unselected-to-checked{from{width:0}}:where(:hover) .outline{border-color:var(--md-checkbox-hover-outline-color, var(--md-sys-color-on-surface, #1d1b20));border-width:var(--md-checkbox-hover-outline-width, 2px)}:where(:hover) .background{background:var(--md-checkbox-selected-hover-container-color, var(--md-sys-color-primary, #6750a4))}:where(:hover) .icon{fill:var(--md-checkbox-selected-hover-icon-color, var(--md-sys-color-on-primary, #fff))}:where(:focus-within) .outline{border-color:var(--md-checkbox-focus-outline-color, var(--md-sys-color-on-surface, #1d1b20));border-width:var(--md-checkbox-focus-outline-width, 2px)}:where(:focus-within) .background{background:var(--md-checkbox-selected-focus-container-color, var(--md-sys-color-primary, #6750a4))}:where(:focus-within) .icon{fill:var(--md-checkbox-selected-focus-icon-color, var(--md-sys-color-on-primary, #fff))}:where(:active) .outline{border-color:var(--md-checkbox-pressed-outline-color, var(--md-sys-color-on-surface, #1d1b20));border-width:var(--md-checkbox-pressed-outline-width, 2px)}:where(:active) .background{background:var(--md-checkbox-selected-pressed-container-color, var(--md-sys-color-primary, #6750a4))}:where(:active) .icon{fill:var(--md-checkbox-selected-pressed-icon-color, var(--md-sys-color-on-primary, #fff))}:where(.disabled,.prev-disabled) :is(.background,.icon,.mark){animation-duration:0s;transition-duration:0s}:where(.disabled) .outline{border-color:var(--md-checkbox-disabled-outline-color, var(--md-sys-color-on-surface, #1d1b20));border-width:var(--md-checkbox-disabled-outline-width, 2px);opacity:var(--md-checkbox-disabled-container-opacity, 0.38)}:where(.selected.disabled) .outline{visibility:hidden}:where(.selected.disabled) .background{background:var(--md-checkbox-selected-disabled-container-color, var(--md-sys-color-on-surface, #1d1b20));opacity:var(--md-checkbox-selected-disabled-container-opacity, 0.38)}:where(.disabled) .icon{fill:var(--md-checkbox-selected-disabled-icon-color, var(--md-sys-color-surface, #fef7ff))}@media(forced-colors: active){.background{background-color:CanvasText}.selected.disabled .background{background-color:GrayText;opacity:1}.outline{border-color:CanvasText}.disabled .outline{border-color:GrayText;opacity:1}.icon{fill:Canvas}}
`;let Y=class extends H{};Y.styles=[R],Y=a([w("md-checkbox")],Y);const J=Symbol("dispatchHooks");const L=new WeakMap;const q=t(i(s(r(o))));class F extends q{constructor(){super(),this.selected=!1,this.icons=!1,this.showOnlySelectedIcon=!1,this.required=!1,this.value="on",this.addEventListener("click",e=>{l(e)&&this.input&&(this.focus(),h(this.input))}),function(e,...t){let i=L.get(e);i||(i=new Set,L.set(e,i));for(const s of t){if(i.has(s))continue;let t=!1;e.addEventListener(s,i=>{if(t)return;i.stopImmediatePropagation();const s=Reflect.construct(i.constructor,[i.type,i]),r=new EventTarget;s[J]=r,t=!0;const o=e.dispatchEvent(s);t=!1,o||i.preventDefault(),r.dispatchEvent(new Event("after"))},{capture:!0}),i.add(s)}}(this,"keydown"),this.addEventListener("keydown",e=>{!function(e,t){const i=e[J];if(!i)throw new Error(`'${e.type}' event needs setupDispatchHooks().`);i.addEventListener("after",t)}(e,()=>{e.defaultPrevented||"Enter"!==e.key||this.disabled||!this.input||this.input.click()})})}render(){return p`
...
`;let U=class extends F{};U.styles=[P],U=a([w("md-switch")],U);class G extends Event{static{this.eventType="item-drop"}constructor(e,t){super(G.eventType,{composed:!0,bubbles:!0}),this.hoverIndex=t,this.originIndex=e}}class K extends o{constructor(){super(...arguments),this.#e=!1,this.#t=!1,this.#i=!1,this.#s=!1,this.#r=!1,this.#o=0,this.#a=null,this.#n=null,this.mouseEvent=e=>{if(!this.disableDrag)return this.#d(e,"mouse")},this.touchEvent=e=>{if(!this.disableDrag)return this.#d(e,"touch")}}#e;get nudgeDown(){return this.#e}set nudgeDown(e){this.#e=e}#t;get nudgeUp(){return this.#t}set nudgeUp(e){this.#t=e}#i;get dragged(){return this.#i}set dragged(e){this.#i=e}#s;get dragging(){return this.#s}set dragging(e){this.#s=e}#r;get disableDrag(){return this.#r}set disableDrag(e){this.#r=e}#c;get scrollableContainer(){return this.#c}set scrollableContainer(e){this.#c=e}#o;get nudgeHeight(){return this.#o}set nudgeHeight(e){this.#o=e}#a;get hoverIndex(){return this.#a}set hoverIndex(e){this.#a=e}#n;get originIndex(){return this.#n}set originIndex(e){this.#n=e}static{this.styles=x`
  ...
  `}get items(){return[]}get itemsContainer(){return null}updateDragProps(e,t,i,s){const r=this.items.indexOf(this);this.nudgeDown=null!==t&&null!==i&&r<t&&r>=i,this.nudgeUp=null!==t&&null!==i&&r>t&&r<=i,this.dragged=t===r,this.dragging=e,this.nudgeHeight=s}#l(e,t){for(let i=0;i<e.length;i++){if(t<=e[i])return i}return e.length-1}#h(e,t){const i=Math.max(t??0,e??0)+1;let s=Math.min(t??0,e??0)-1;return s=s<0?0:s,[i,s]}#m(e,t,i,s){const r=this.#h(e,t);for(let e=r[1];e<=r[0];e++){const t=this.items?.[e];t?.updateDragProps(i,this.originIndex,this.hoverIndex,s)}}#u(e,t){const i=this.#h(e,t);for(let e=i[1];e<=i[0];e++){const t=this.items?.[e];t?.updateDragProps(!1,null,null,0)}}#p(e,t){return e>10?t?1:2:e>5?t?1.5:4:t?2:6}#d(e,t){const i=/^((?!chrome|android).)*safari/i.test(navigator.userAgent);if("mouse"===t&&1!==e.which)return;e.preventDefault();let s=0,r=0;this.dragging=!0,this.originIndex=this.items.indexOf(this);const o="touch"===t?"touchmove":"mousemove",a="touch"===t?"touchend":"mouseup",n=(e.pageY??e.touches[0].pageY)+this.scrollableContainer?.scrollTop,d=this.getBoundingClientRect().height;let c=0;const l=this.items.map(e=>(c+=e.getBoundingClientRect().height,c)),h=e=>{const t=e.pageY??e.touches[0].pageY,o=e.clientY??e.touches[0].clientY,a=e=>{const i=this.itemsContainer?.getBoundingClientRect()?.top??0,s=o-i;this.hoverIndex=this.#l(l,s),this.#m(this.originIndex,this.hoverIndex,this.dragging,d),s<l[l.length-1]&&(this.style.transform=`translateY(${t-n+e}px)`)};if(a(this.scrollableContainer?.scrollTop??0),this.scrollableContainer){const e=this.scrollableContainer?.getBoundingClientRect()?.top+window.scrollY,o=this.scrollableContainer?.getBoundingClientRect()?.bottom+window.scrollY,n=t-e,d=o-t,c=10,l=e=>{const t=performance.now();t-r>=c&&(a(this.scrollableContainer?.scrollTop),this.scrollableContainer.scrollBy(0,e),r=t)};if(n<20){clearInterval(s);const e=this.#p(n,i);l(-e),s=window.setInterval(()=>{l(-e)},c)}else if(d<20){clearInterval(s);const e=this.#p(d,i);l(e),s=window.setInterval(()=>{l(e)},c)}else clearInterval(s)}},m=()=>{clearInterval(s),document.removeEventListener(o,h),this.removeEventListener(a,u),this.dragging=!1;const e=()=>{this.#u(this.originIndex,this.hoverIndex),this.originIndex=null,this.hoverIndex=null,this.style.transform="",this.style.transition="",this.removeEventListener("transitionend",e)};this.addEventListener("transitionend",e),this.style.transition="transform 0.1s ease-out",this.style.transform="translate3d(0, 0, 0)",document.removeEventListener("mouseout",m)},u=()=>{clearInterval(s),s=0,this.dragging=!1,this.items.forEach(e=>e.dragging=!1),document.removeEventListener(o,h),document.removeEventListener(a,u),"mouse"===t&&document.removeEventListener("mouseout",m);const e=()=>{null!==this.originIndex&&null!==this.hoverIndex&&this.dispatchEvent(new G(this.originIndex,this.hoverIndex)),this.#u(this.originIndex,this.hoverIndex),this.originIndex=null,this.hoverIndex=null,this.style.transform="",this.style.transition="",this.removeEventListener("transitionend",e)};this.addEventListener("transitionend",e);const i=this.items.filter(e=>e.nudgeUp).map(e=>e.getBoundingClientRect().height>0?e.getBoundingClientRect().height-1:0).reduce((e,t)=>e+t,0),r=this.items.filter(e=>e.nudgeDown).map(e=>-e.getBoundingClientRect().height-1).reduce((e,t)=>e+t,0),n=0!==i?i:r;this.style.transition="transform 0.1s ease-out",this.style.transform=`translate3d(0, ${n}px, 0)`};"mouse"===t&&window.addEventListener("mouseout",m),document.addEventListener(a,u),document.addEventListener(o,h),h(e)}}a([n({type:Boolean,reflect:!0,attribute:"nudge-down"})],K.prototype,"nudgeDown",null),a([n({type:Boolean,reflect:!0,attribute:"nudge-up"})],K.prototype,"nudgeUp",null),a([n({type:Boolean,reflect:!0,attribute:"dragged"})],K.prototype,"dragged",null),a([n({type:Boolean,reflect:!0,attribute:"dragging"})],K.prototype,"dragging",null),a([n({type:Boolean,attribute:"disable-drag",reflect:!0})],K.prototype,"disableDrag",null),a([n({type:Object})],K.prototype,"scrollableContainer",null),a([d()],K.prototype,"nudgeHeight",null),a([d()],K.prototype,"hoverIndex",null),a([d()],K.prototype,"originIndex",null);let W=class extends K{#g="";get name(){return this.#g}set name(e){this.#g=e}#b=!1;get selected(){return this.#b}set selected(e){this.#b=e}#v=!1;get disabled(){return this.#v}set disabled(e){this.#v=e}get items(){return Array.from(this.parentElement?.querySelectorAll("titanium-data-table-core-settings-choose-columns-item")??[])}get itemsContainer(){return this.parentElement}static{this.styles=[K.styles,x`
    ...
    `]}render(){return p` <md-dialog
      @open=${e=>{k(e.target),$(e.target)}}
      @close=${e=>{if("done"===e.target.returnValue||"navigation-close"===e.target.returnValue)return _(e.target),this.#$(e.target.returnValue);e.preventDefault()}}
    >
      ...
      >
        ${S(this.userSettings,e=>e.key,e=>p`
    ...
    </md-dialog>`}};a([n({type:Object})],V.prototype,"tableMetaData",null),a([n({type:Array})],V.prototype,"userSettings",null),a([d()],V.prototype,"customColumnsApplied",null),a([c("md-dialog")],V.prototype,"dialog",null),V=a([w("titanium-data-table-core-settings-choose-columns-dialog")],V);let X=class extends K{#g="";get name(){return this.#g}set name(e){this.#g=e}#_;get sortDirection(){return this.#_}set sortDirection(e){this.#_=e}#S=0;get index(){return this.#S}set index(e){this.#S=e}#v=!1;get disabled(){return this.#v}set disabled(e){this.#v=e}get items(){return Array.from(this.parentElement?.querySelectorAll("data-table-core-settings-sort-item")??[])}get itemsContainer(){return this.parentElement}static{this.styles=[K.styles,z,D,C,x`
      :host {
        display: grid;
...
`;let Q=class extends o{#f=null;get tableMetaData(){return this.#f}set tableMetaData(e){this.#f=e}#w;get dialog(){return this.#w}set dialog(e){this.#w=e}#z;get addMenu(){return this.#z}set addMenu(e){this.#z=e}#D=[];get sort(){return this.#D}set sort(e){this.#D=e}#C=[];async show(e){return this.#C=structuredClone(e),this.sort=structuredClone(e),this.dialog.returnValue="",this.dialog?.show(),await new Promise(e=>{this.#$=e})}hasChanges(e,t){return JSON.stringify(e)!==JSON.stringify(t)}#M;#$;static{this.styles=[D,Z,x`
    ...
    `]}render(){const e=this.tableMetaData?.itemMetaData.filter(e=>!e.disableSort&&!this.sort.some(t=>t.key===e.key))??[];return p` <md-dialog
      @open=${e=>{k(e.target),$(e.target)}}
      @close=${e=>{if("apply"===e.target.returnValue||"cancel"===e.target.returnValue||"navigation-close"===e.target.returnValue)return _(e.target),this.#$(e.target.returnValue);e.preventDefault()}}
    >
      <div slot="headline">
      ...
      <main slot="content">
        ...
        >
          ${this.sort.length?S(this.sort,e=>e.key,(e,t)=>p`<data-table-core-settings-sort-item
                    .index=${t}
                    .name=${this.tableMetaData?.itemMetaData.find(t=>t.key===e.key)?.friendlyName??e.key}
...
`;let te=class extends K{#I;get item(){return this.#I}set item(e){this.#I=e}#f=null;get tableMetaData(){return this.#f}set tableMetaData(e){this.#f=e}#B=null;get supplementalItemStyles(){return this.#B}set supplementalItemStyles(e){this.#B=e}get items(){return Array.from(this.parentElement?.querySelectorAll("titanium-data-table-core-reorder-item")??[])}get itemsContainer(){return this.parentElement}static{this.styles=[K.styles,x`
    ...
    `}};a([n({type:Object})],te.prototype,"item",null),a([n({type:Object})],te.prototype,"tableMetaData",null),a([n({type:Object})],te.prototype,"supplementalItemStyles",null),te=a([w("titanium-data-table-core-reorder-item")],te);let ie=class extends o{#E=!1;get isLoading(){return this.#E}set isLoading(e){this.#E=e}#f=null;get tableMetaData(){return this.#f}set tableMetaData(e){this.#f=e}#B=null;get supplementalItemStyles(){return this.#B}set supplementalItemStyles(e){this.#B=e}#w;get dialog(){return this.#w}set dialog(e){this.#w=e}#O;get snackbar(){return this.#O}set snackbar(e){this.#O=e}#A=[];get items(){return this.#A}set items(e){this.#A=e}#j=[];async show(e){const t=structuredClone(e),i=this.tableMetaData?.reorderConfig?.sortPropertyKey;if(i){t.every(e=>"number"==typeof e[i])?t.sort((e,t)=>e[i]-t[i]):t.sort((e,t)=>e[i].toString().localeCompare(t[i].toString()))}return this.items=t,this.#j=structuredClone(t),this.dialog.returnValue="",this.dialog?.show(),await new Promise(e=>{this.#$=e})}hasChanges(e,t){return JSON.stringify(e)!==JSON.stringify(t)}#$;static{this.styles=[x`
      :host {
        display: grid;
      }
    ...
    `]}render(){return p` <md-dialog
      @open=${e=>{k(e.target),$(e.target)}}
      @close=${e=>{if("apply"===e.target.returnValue||"cancel"===e.target.returnValue||"navigation-close"===e.target.returnValue)return _(e.target),this.snackbar.dismissAll(),this.#$(e.target.returnValue);e.preventDefault()}}
    >
      ...
      >
        ${S(this.items,e=>this.tableMetaData?.uniqueKey(e),e=>p`
      ...
      <div slot="actions">
        ...
        <md-filled-tonal-button
          ...
          @click=${async()=>{let e=()=>{},t=()=>{};const i=new Promise((i,s)=>{e=i,t=s});this.trackLoadingPromise(i),this.dispatchEvent(new CustomEvent("reorder-save-request",{detail:{resolve:e,reject:t,items:this.items}}));try{await i,this.dialog?.close("apply")}catch(e){this.dispatchEvent(new M(e))}}}
          >Save
      ...
      <table part="table" ?has-selected-items=${this.selected.length>0}>
        <thead>
          <tr>
              ...
              <content-container>
                ...
                >
                  ...
                  ${this.items.length>0?p`<md-divider role="separator" tabindex="-1"></md-divider>
                        <md-menu-item
                          .action=${()=>{const e=j().format("YYYY-MM-DD HH-mm-ss"),t=ue({filename:`web export ${e}`,useKeysAsHeaders:!0}),i=this.orderByUserPreference(this.tableMetaData?.itemMetaData?.filter(e=>(!e.hideByDefault&&this.userSettings.find(t=>t.key===e.key)?.show||this.userSettings.find(t=>t.key===e.key)?.show)&&!e.omitFromCsv)??[],this.userSettings)??[],s=this.items.map(e=>{const t={};for(const s of i){t[s.friendlyName??s.key]=s.csvValue?s.csvValue(e):e[s.key]}return t})??[],r=ze(t)(s);De(t)(r)}}
                        >
            ...
            ${S(this.orderByUserPreference(this.tableMetaData?.itemMetaData?.filter(e=>!e.hideByDefault&&this.userSettings.find(t=>t.key===e.key)?.show||this.userSettings.find(t=>t.key===e.key)?.show)??[],this.userSettings)??[],e=>e.key,e=>{const t=this.sort.find(t=>t.key===e.key),i=this.sort.findIndex(t=>t.key===e.key),s=this.tableMetaData?.itemMetaData?.find(t=>t.key===e.key)?.width;return p`<th style=${s?E({minWidth:s}):u}>
                  <button
                    ?active-sort=${-1!==i}
        ...
        <tbody>
          ...
          ${S(this.items??[],e=>this.tableMetaData?.uniqueKey(e)??"",e=>p`
                ...
                >
                  ...
                  ${S(this.orderByUserPreference(this.tableMetaData?.itemMetaData?.filter(e=>!e.hideByDefault&&this.userSettings.find(t=>t.key===e.key)?.show||this.userSettings.find(t=>t.key===e.key)?.show)??[],this.userSettings)?.map(e=>e.key)??[],e=>e,t=>p`<td>
    ...
    `}};a([n({type:Array})],Be.prototype,"selected",null),a([n({type:Boolean,reflect:!0,attribute:"has-selected"})],Be.prototype,"hasSelected",null),a([n({type:Boolean,reflect:!0,attribute:"has-add-button"})],Be.prototype,"hasAddButton",null),a([A({slot:"add-button"})],Be.prototype,"addButtonElements",null),Be=a([w("titanium-data-table-action-bar")],Be);export{Z as n};
