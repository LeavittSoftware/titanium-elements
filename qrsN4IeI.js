import{i as t,p as i,c as o,E as e,u as n,v as a,w as s,x as r,_ as l,n as c,e as u,t as d,h as m,r as g}from"./CIAkX42C.js";import{S as h}from"./DzDchJdO.js";import"./D8Gv_ug3.js";import"./kwKBK7yw.js";import"./ARW3F0re.js";let p=class extends t{constructor(){super(...arguments),this.#t="Confirm",this.#i="Cancel",this.#o=!1,this.#e=!1,this.open=async(t,i)=>(this.headline=t,this.text=i,this.dialog.returnValue="",this.dialog.show(),await new Promise(t=>{this.#n=t}))}#a;get text(){return this.#a}set text(t){this.#a=t}#s;get headline(){return this.#s}set headline(t){this.#s=t}#t;get confirmActionText(){return this.#t}set confirmActionText(t){this.#t=t}#i;get cancelActionText(){return this.#i}set cancelActionText(t){this.#i=t}#o;get disableConfirmationAction(){return this.#o}set disableConfirmationAction(t){this.#o=t}#e;get disableCancelAction(){return this.#e}set disableCancelAction(t){this.#e=t}#r;get dialog(){return this.#r}set dialog(t){this.#r=t}#n;static{this.styles=[i,o`
      main {
        display: grid;
