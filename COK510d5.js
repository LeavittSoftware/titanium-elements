import{i as t,h as e,p as i,c as a,x as n,_ as s,r as m,e as r,t as u}from"./CU2mI_nZ.js";import{S as l}from"./syhS3759.js";import"./g0SGJilc.js";let p=class extends t{constructor(){super(...arguments),this.getFilesResult=null,this.hasChanges=!1}#t;get getFilesInput(){return this.#t}set getFilesInput(t){this.#t=t}#e;get preselectFilesInput(){return this.#e}set preselectFilesInput(t){this.#e=t}#i;get preselectDisabledFilesInput(){return this.#i}set preselectDisabledFilesInput(t){this.#i=t}#a;get resetInput(){return this.#a}set resetInput(t){this.#a=t}static{this.styles=[e,i,a`
      :host {
        display: flex;
    ...
    `}};s([m()],p.prototype,"getFilesResult",void 0),s([m()],p.prototype,"hasChanges",void 0),s([r("titanium-smart-attachment-input[get-files]")],p.prototype,"getFilesInput",null),s([r("titanium-smart-attachment-input[preselect]")],p.prototype,"preselectFilesInput",null),s([r("titanium-smart-attachment-input[preselect-disabled]")],p.prototype,"preselectDisabledFilesInput",null),s([r("titanium-smart-attachment-input[reset]")],p.prototype,"resetInput",null),p=s([u("titanium-smart-attachment-input-playground")],p);let o=class extends t{static{this.styles=[l,a``]}render(){return n`
