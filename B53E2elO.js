import{i as t,k as i,c as e,x as n,E as a,_ as s,n as o,a7 as l,t as r,h as c,p as h}from"./CU2mI_nZ.js";import{S as d}from"./syhS3759.js";import"./g0SGJilc.js";let p=class extends t{constructor(){super(...arguments),this.href="",this.download="",this.target="",this.#t="close",this.#i=!1,this.#e=!1,this.#n=!1}#a;get label(){return this.#a}set label(t){this.#a=t}#s;get selected(){return this.#s}set selected(t){this.#s=t}#o;get inputChip(){return this.#o}set inputChip(t){this.#o=t}#l;get nonInteractive(){return this.#l}set nonInteractive(t){this.#l=t}#t;get inputChipRemoveIcon(){return this.#t}set inputChipRemoveIcon(t){this.#t=t}#i;get disabled(){return this.#i}set disabled(t){this.#i=t}#e;get hasLeadingItems(){return this.#e}set hasLeadingItems(t){this.#e=t}#n;get hasTrailingItems(){return this.#n}set hasTrailingItems(t){this.#n=t}static{this.styles=[i,e`
      :host {
        display: grid;
        height: 32px;
        width: auto;
