...
import '../../../../packages/titanium/date-range-selector/date-range-selector';
import { DateRanges, TitaniumDateRangeSelector } from '../../../../packages/titanium/date-range-selector/date-range-selector';
