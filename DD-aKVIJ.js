import{i as t,j as i,b as e,c as n,f as s,_ as o,n as a,F as r,t as l}from"./06xqLdmj.js";let h=class extends t{constructor(){super(...arguments),this.href="",this.download="",this.target="",this.#t="close",this.#i=!1,this.#e=!1,this.#n=!1,this.#s=!1}#o;get label(){return this.#o}set label(t){this.#o=t}#a;get selected(){return this.#a}set selected(t){this.#a=t}#r;get inputChip(){return this.#r}set inputChip(t){this.#r=t}#l;get nonInteractive(){return this.#l}set nonInteractive(t){this.#l=t}#t;get inputChipRemoveIcon(){return this.#t}set inputChipRemoveIcon(t){this.#t=t}#i;get disabled(){return this.#i}set disabled(t){this.#i=t}#e;get filled(){return this.#e}set filled(t){this.#e=t}#n;get hasLeadingItems(){return this.#n}set hasLeadingItems(t){this.#n=t}#s;get hasTrailingItems(){return this.#s}set hasTrailingItems(t){this.#s=t}static{this.styles=[i,e`
      :host {
        display: grid;
        height: 32px;
        width: auto;
